...
impl AntiDot<MultiVectorAtOrigin> for DualNum {
    type Output = AntiScalar;
...
impl AntiDot<DualNum> for MultiVectorAtOrigin {
    type Output = AntiScalar;
...
impl Dot<MultiVectorAtInfinity> for DualNum {
    type Output = Scalar;
...
impl Dot<DualNum> for MultiVectorAtInfinity {
    type Output = Scalar;
