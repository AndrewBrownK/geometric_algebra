...
impl From<AntiDipoleOnOrigin> for AntiVersorOddOnOrigin {
...
impl From<AntiFlatOrigin> for AntiVersorOddOnOrigin {
...
impl From<AntiFlectorOnOrigin> for AntiVersorOddOnOrigin {
...
impl From<AntiPlaneOnOrigin> for AntiVersorOddOnOrigin {
...
impl From<AntiSphereOnOrigin> for AntiVersorOddOnOrigin {
...
impl From<NullCircleAtOrigin> for AntiVersorOddOnOrigin {
...
impl From<NullVersorEvenAtOrigin> for AntiVersorOddOnOrigin {
...
impl From<Origin> for AntiVersorOddOnOrigin {
...
impl TryFrom<AntiFlatPoint> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(anti_flat_point: AntiFlatPoint) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiFlatPoint do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(AntiVersorOddOnOrigin::from_groups(
            // e423, e431, e412, e321
...
impl TryFrom<AntiFlector> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(anti_flector: AntiFlector) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiFlector do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<AntiPlane> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(anti_plane: AntiPlane) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiPlane do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Circle> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(circle: Circle) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Circle do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<CircleAligningOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(circle_aligning_origin: CircleAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from CircleAligningOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<CircleAtInfinity> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(circle_at_infinity: CircleAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from CircleAtInfinity do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<CircleAtOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(circle_at_origin: CircleAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from CircleAtOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<CircleOnOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(circle_on_origin: CircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from CircleOnOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<CircleOrthogonalOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(circle_orthogonal_origin: CircleOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from CircleOrthogonalOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<MultiVector> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from MultiVector do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<RoundPoint> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(round_point: RoundPoint) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from RoundPoint do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<RoundPointAtOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(round_point_at_origin: RoundPointAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from RoundPointAtOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorEven> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_even: VersorEven) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorEven do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorEvenAligningOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_even_aligning_origin: VersorEvenAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorEvenAligningOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorEvenAtInfinity> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_even_at_infinity: VersorEvenAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorEvenAtInfinity do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorEvenAtOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_even_at_origin: VersorEvenAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorEvenAtOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorEvenOnOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_even_on_origin: VersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorEvenOnOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorEvenOrthogonalOrigin> for AntiVersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_even_orthogonal_origin: VersorEvenOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorEvenOrthogonalOrigin do not fit into AntiVersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
