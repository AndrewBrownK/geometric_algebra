...
impl From<DipoleAtOrigin> for VersorOddAtOrigin {
...
impl From<FlatPointAtInfinity> for VersorOddAtOrigin {
...
impl From<FlectorAtInfinity> for VersorOddAtOrigin {
...
impl From<Horizon> for VersorOddAtOrigin {
...
impl From<NullDipoleAtOrigin> for VersorOddAtOrigin {
...
impl From<NullSphereAtOrigin> for VersorOddAtOrigin {
...
impl From<NullVersorOddAtOrigin> for VersorOddAtOrigin {
...
impl From<SphereAtOrigin> for VersorOddAtOrigin {
...
impl TryFrom<AntiCircleOnOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(anti_circle_on_origin: AntiCircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiCircleOnOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(VersorOddAtOrigin::from_groups(
            // e41, e42, e43, e3215
...
impl TryFrom<AntiDualNum> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(anti_dual_num: AntiDualNum) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiDualNum do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<AntiLine> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(anti_line: AntiLine) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiLine do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<AntiMotor> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(anti_motor: AntiMotor) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiMotor do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<AntiVersorEvenOnOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(anti_versor_even_on_origin: AntiVersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiVersorEvenOnOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Dipole> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole: Dipole) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Dipole do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleAligningOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_aligning_origin: DipoleAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleAligningOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleAtInfinity> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_at_infinity: DipoleAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleAtInfinity do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleOnOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_on_origin: DipoleOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleOnOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleOrthogonalOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_orthogonal_origin: DipoleOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleOrthogonalOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<FlatPoint> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(flat_point: FlatPoint) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from FlatPoint do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Flector> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(flector: Flector) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Flector do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<MultiVector> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from MultiVector do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Plane> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(plane: Plane) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Plane do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Sphere> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(sphere: Sphere) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Sphere do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<SphereOnOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(sphere_on_origin: SphereOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from SphereOnOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOdd> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOdd do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddAligningOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_aligning_origin: VersorOddAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAligningOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(VersorOddAtOrigin::from_groups(
            // e41, e42, e43, e3215
            Simd32x4::from([
                versor_odd_aligning_origin[e41],
                versor_odd_aligning_origin[e42],
                versor_odd_aligning_origin[e43],
...
impl TryFrom<VersorOddAtInfinity> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_at_infinity: VersorOddAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAtInfinity do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddOnOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_on_origin: VersorOddOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddOnOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddOrthogonalOrigin> for VersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_orthogonal_origin: VersorOddOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddOrthogonalOrigin do not fit into VersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
