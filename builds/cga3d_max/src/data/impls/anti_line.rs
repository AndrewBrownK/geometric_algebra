...
impl TryFrom<VersorOddAligningOrigin> for AntiLine {
    type Error = String;
    fn try_from(versor_odd_aligning_origin: VersorOddAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAligningOrigin do not fit into AntiLine { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddAtOrigin> for AntiLine {
    type Error = String;
    fn try_from(versor_odd_at_origin: VersorOddAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAtOrigin do not fit into AntiLine { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
