impl From<NullDipoleAtOrigin> for NullVersorOddAtOrigin {
...
impl From<NullSphereAtOrigin> for NullVersorOddAtOrigin {
    fn from(null_sphere_at_origin: NullSphereAtOrigin) -> Self {
        use crate::elements::*;
        return NullVersorOddAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x4::from([0.0, 0.0, 0.0, null_sphere_at_origin[e1234]]));
    }
}

impl TryFrom<AntiCircleOnOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(anti_circle_on_origin: AntiCircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiCircleOnOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullVersorOddAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x4::from([
...
impl TryFrom<AntiVersorEvenOnOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(anti_versor_even_on_origin: AntiVersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiVersorEvenOnOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Dipole> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole: Dipole) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Dipole do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullVersorOddAtOrigin::from_groups(
            // e41, e42, e43, e1234
...
impl TryFrom<DipoleAligningOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_aligning_origin: DipoleAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleAligningOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleAtOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_at_origin: DipoleAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleAtOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleOnOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_on_origin: DipoleOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleOnOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleOrthogonalOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(dipole_orthogonal_origin: DipoleOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleOrthogonalOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<MultiVector> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from MultiVector do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Sphere> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(sphere: Sphere) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Sphere do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullVersorOddAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x4::from([0.0, 0.0, 0.0, sphere[e1234]])));
    }
}

impl TryFrom<SphereAtOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(sphere_at_origin: SphereAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from SphereAtOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<SphereOnOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(sphere_on_origin: SphereOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from SphereOnOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOdd> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOdd do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddAligningOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_aligning_origin: VersorOddAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAligningOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddAtOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_at_origin: VersorOddAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAtOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullVersorOddAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x4::from([
            versor_odd_at_origin[e41],
            versor_odd_at_origin[e42],
            versor_odd_at_origin[e43],
            versor_odd_at_origin[e1234],
        ])));
    }
}

impl TryFrom<VersorOddOnOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_on_origin: VersorOddOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddOnOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullVersorOddAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x4::from([
            versor_odd_on_origin[e41],
            versor_odd_on_origin[e42],
            versor_odd_on_origin[e43],
            versor_odd_on_origin[e1234],
        ])));
    }
}

impl TryFrom<VersorOddOrthogonalOrigin> for NullVersorOddAtOrigin {
    type Error = String;
    fn try_from(versor_odd_orthogonal_origin: VersorOddOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddOrthogonalOrigin do not fit into NullVersorOddAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
