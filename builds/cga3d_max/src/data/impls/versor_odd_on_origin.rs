impl From<DipoleOnOrigin> for VersorOddOnOrigin {
...
impl From<FlatOrigin> for VersorOddOnOrigin {
...
impl From<FlectorOnOrigin> for VersorOddOnOrigin {
...
impl From<NullDipoleAtOrigin> for VersorOddOnOrigin {
...
impl From<NullSphereAtOrigin> for VersorOddOnOrigin {
...
impl From<NullVersorOddAtOrigin> for VersorOddOnOrigin {
    fn from(null_versor_odd_at_origin: NullVersorOddAtOrigin) -> Self {
        ...
        return VersorOddOnOrigin::from_groups(
            ...
            // e1234, e4235, e4315, e4125
            Simd32x4::from([null_versor_odd_at_origin[e1234], 0.0, 0.0, 0.0]),
        );
    }
}

impl From<PlaneOnOrigin> for VersorOddOnOrigin {
...
impl From<SphereOnOrigin> for VersorOddOnOrigin {
...
impl TryFrom<AntiCircleOnOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(anti_circle_on_origin: AntiCircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiCircleOnOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(VersorOddOnOrigin::from_groups(
            // e41, e42, e43, e45
...
impl TryFrom<AntiVersorEvenOnOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(anti_versor_even_on_origin: AntiVersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiVersorEvenOnOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Dipole> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(dipole: Dipole) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Dipole do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleAligningOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(dipole_aligning_origin: DipoleAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleAligningOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleAtInfinity> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(dipole_at_infinity: DipoleAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleAtInfinity do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleAtOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(dipole_at_origin: DipoleAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleAtOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<DipoleOrthogonalOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(dipole_orthogonal_origin: DipoleOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from DipoleOrthogonalOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<FlatPoint> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(flat_point: FlatPoint) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from FlatPoint do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Flector> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(flector: Flector) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Flector do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<MultiVector> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from MultiVector do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Plane> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(plane: Plane) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Plane do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<Sphere> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(sphere: Sphere) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from Sphere do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<SphereAtOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(sphere_at_origin: SphereAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from SphereAtOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOdd> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_odd: VersorOdd) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOdd do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddAligningOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_odd_aligning_origin: VersorOddAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAligningOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddAtInfinity> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_odd_at_infinity: VersorOddAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAtInfinity do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<VersorOddAtOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_odd_at_origin: VersorOddAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAtOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(VersorOddOnOrigin::from_groups(
            ...
            // e1234, e4235, e4315, e4125
            Simd32x4::from([versor_odd_at_origin[e1234], 0.0, 0.0, 0.0]),
        ));
    }
}

impl TryFrom<VersorOddOrthogonalOrigin> for VersorOddOnOrigin {
    type Error = String;
    fn try_from(versor_odd_orthogonal_origin: VersorOddOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddOrthogonalOrigin do not fit into VersorOddOnOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
