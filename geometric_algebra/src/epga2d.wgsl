...
fn multi_vector_ideal_point_scalar_product(self_: MultiVector, other: IdealPoint) -> Scalar  {
    return Scalar(0.0 - self_.g1.z * other.g0.x - self_.g1.w * other.g0.y);
}
...
fn point_ideal_point_inner_product(self_: Point, other: IdealPoint) -> Scalar  {
    return Scalar(0.0 - self_.g0.y * other.g0.x - self_.g0.z * other.g0.y);
}
...
fn point_translator_left_contraction(self_: Point, other: Translator) -> Scalar  {
    return Scalar(0.0 - self_.g0.y * other.g0.y - self_.g0.z * other.g0.z);
}
...
fn point_motor_dual_left_contraction(self_: Point, other: MotorDual) -> Plane  {
    return Plane(self_.g0 * vec3<f32>(other.g0.x) * vec3<f32>(-1.0));
}
...
fn ideal_point_multi_vector_scalar_product(self_: IdealPoint, other: MultiVector) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g1.z - self_.g0.y * other.g1.w);
}
...
fn ideal_point_point_inner_product(self_: IdealPoint, other: Point) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g0.y - self_.g0.y * other.g0.z);
}
...
fn ideal_point_ideal_point_inner_product(self_: IdealPoint, other: IdealPoint) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g0.x - self_.g0.y * other.g0.y);
}
...
fn ideal_point_motor_geometric_product(self_: IdealPoint, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0.zwxy * vec4<f32>(-1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.y) * other.g0.wzyx * vec4<f32>(-1.0, -1.0, 1.0, 1.0));
}
...
fn ideal_point_motor_left_contraction(self_: IdealPoint, other: Motor) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g0.z - self_.g0.y * other.g0.w);
}
...
fn ideal_point_motor_dual_geometric_product(self_: IdealPoint, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0.zwxy * vec4<f32>(1.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g0.y) * other.g0.wzyx * vec4<f32>(1.0, -1.0, 1.0, -1.0));
}
...
fn ideal_point_motor_dual_inner_product(self_: IdealPoint, other: MotorDual) -> Plane  {
    return Plane(vec3<f32>(self_.g0.x) * vec3<f32>(other.g0.w, other.g0.x, other.g0.y) * vec3<f32>(1.0, -1.0, -1.0) + vec3<f32>(self_.g0.y) * vec3<f32>(other.g0.z, other.g0.y, other.g0.x) * vec3<f32>(-1.0, 1.0, -1.0));
}
...
fn plane_multi_vector_scalar_product(self_: Plane, other: MultiVector) -> Scalar  {
    return Scalar(self_.g0.x * other.g1.x + self_.g0.y * other.g0.w + self_.g0.z * other.g0.z);
}
...
fn translator_point_inner_product(self_: Translator, other: Point) -> Motor  {
    return Motor(vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.y, self_.g0.x, self_.g0.x, self_.g0.x) * vec4<f32>(other.g0.y, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
...
fn translator_ideal_point_inner_product(self_: Translator, other: IdealPoint) -> Translator  {
    return Translator(vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.y) * vec3<f32>(-1.0, 0.0, 0.0) + self_.g0.yxx * vec3<f32>(other.g0.x, other.g0.x, other.g0.y) * vec3<f32>(-1.0, 1.0, 1.0));
}
...
fn translator_motor_geometric_product(self_: Translator, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.y) * other.g0.zwxy * vec4<f32>(-1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.wzyx * vec4<f32>(-1.0, -1.0, 1.0, 1.0));
}
...
fn translator_motor_dual_geometric_product(self_: Translator, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.y) * other.g0.zwxy * vec4<f32>(1.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.wzyx * vec4<f32>(1.0, -1.0, 1.0, -1.0));
}
...
fn motor_ideal_point_inner_product(self_: Motor, other: IdealPoint) -> Translator  {
    return Translator(vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.y) * vec3<f32>(-1.0, 0.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.x, self_.g0.x) * vec3<f32>(other.g0.x, other.g0.x, other.g0.y) * vec3<f32>(-1.0, 1.0, 1.0));
}
...
fn motor_ideal_point_right_contraction(self_: Motor, other: IdealPoint) -> Scalar  {
    return Scalar(0.0 - self_.g0.z * other.g0.x - self_.g0.w * other.g0.y);
}
...
fn motor_motor_dual_geometric_product(self_: Motor, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.y) * other.g0.yxwz * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.z) * other.g0.zwxy * vec4<f32>(1.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g0.w) * other.g0.wzyx * vec4<f32>(1.0, -1.0, 1.0, -1.0));
}
...
fn motor_dual_multi_vector_scalar_product(self_: MotorDual, other: MultiVector) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g1.y + self_.g0.y * other.g1.x + self_.g0.z * other.g0.w + self_.g0.w * other.g0.z);
}
...
fn motor_dual_point_inner_product(self_: MotorDual, other: Point) -> Plane  {
    return Plane(vec3<f32>(0.0) - vec3<f32>(self_.g0.x) * other.g0 + vec3<f32>(self_.g0.z) * other.g0.zzx * vec3<f32>(1.0, 0.0, -1.0) + vec3<f32>(self_.g0.w) * other.g0.yxy * vec3<f32>(-1.0, 1.0, 0.0) + vec3<f32>(self_.g0.x, self_.g0.y, self_.g0.y) * other.g0.xzy * vec3<f32>(0.0, -1.0, 1.0));
}
...
fn motor_dual_point_right_contraction(self_: MotorDual, other: Point) -> Plane  {
    return Plane(vec3<f32>(0.0) - vec3<f32>(self_.g0.x) * other.g0);
}
...
fn motor_dual_ideal_point_inner_product(self_: MotorDual, other: IdealPoint) -> Plane  {
    return Plane(vec3<f32>(self_.g0.y) * vec3<f32>(other.g0.y, other.g0.y, other.g0.x) * vec3<f32>(0.0, -1.0, 1.0) + vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.x) * vec3<f32>(-1.0, 0.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.x, self_.g0.x) * vec3<f32>(other.g0.y, other.g0.x, other.g0.y) * vec3<f32>(1.0, -1.0, -1.0));
}
...
fn motor_dual_translator_right_contraction(self_: MotorDual, other: Translator) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 1.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 0.0, 1.0) + self_.g0.xyxx * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(1.0, 1.0, -1.0, -1.0));
}
