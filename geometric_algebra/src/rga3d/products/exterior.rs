...
impl AntiWedge<Flector> for Flector {
    ...
    fn anti_wedge(self, other: Flector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[3], self.group0()[0]]) * Simd32x2::from([other.group1()[3], other.group1()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[3], self.group1()[0]]) * Simd32x2::from([other.group0()[3], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group1()[3]) * Simd32x3::from([other.group1()[0], other.group1()[1], other.group1()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group1()[0], self.group1()[1], self.group1()[2]]) * Simd32x3::from(other.group1()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Line> for Flector {
    ...
    fn anti_wedge(self, other: Line) -> Point {
        Point { groups: PointGroups { g0: swizzle!(self.group1(), 3, 3, 3, 2) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 2, 2, 1, 0) * Simd32x4::from([other.group1()[1], other.group1()[0], other.group1()[0], other.group1()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * Simd32x4::from([other.group1()[2], other.group1()[2], other.group1()[1], other.group1()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) } }
    }
}
...
impl AntiWedge<LineAtInfinity> for Flector {
    ...
    fn anti_wedge(self, other: LineAtInfinity) -> PointAtInfinity {
        PointAtInfinity { groups: PointAtInfinityGroups { g0: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([-1.0, 1.0, -1.0]) } }
    }
}
...
impl AntiWedge<Motor> for Flector {
    ...
    fn anti_wedge(self, other: Motor) -> Flector {
        Flector { groups: FlectorGroups { g0: self.group0() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group1(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 2, 2, 1, 0) * Simd32x4::from([other.group1()[1], other.group1()[0], other.group1()[0], other.group1()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * Simd32x4::from([other.group1()[2], other.group1()[2], other.group1()[1], other.group1()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g1: self.group1() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<MultiVector> for Flector {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group4()[1], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group4()[2], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[3], self.group0()[0]]) * Simd32x2::from([other.group4()[3], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[3], self.group1()[0]]) * Simd32x2::from([other.group1()[3], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([-1.0, 0.0]), g1: self.group0() * Simd32x4::from(other.group0()[1]) + swizzle!(self.group1(), 3, 3, 3, 2) * Simd32x4::from([other.group2()[0], other.group2()[1], other.group2()[2], other.group2()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * Simd32x4::from([other.group2()[0], other.group2()[0], other.group2()[0], other.group2()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group2()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 2, 2, 1, 0) * Simd32x4::from([other.group3()[1], other.group3()[0], other.group3()[0], other.group3()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * Simd32x4::from([other.group3()[2], other.group3()[2], other.group3()[1], other.group3()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * Simd32x3::from([other.group4()[1], other.group4()[0], other.group4()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * Simd32x3::from([other.group4()[2], other.group4()[2], other.group4()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group1()[3]) * Simd32x3::from([other.group4()[0], other.group4()[1], other.group4()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group1()[0], self.group1()[1], self.group1()[2]]) * Simd32x3::from(other.group4()[3]), g4: self.group1() * Simd32x4::from(other.group0()[1]) } }
    }
}
...
impl AntiWedge<Origin> for Flector {
    ...
    fn anti_wedge(self, other: Origin) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group1()[3] * other.group0() * -1.0 } }
    }
}
...
impl AntiWedge<Plane> for Flector {
    ...
    fn anti_wedge(self, other: Plane) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[3], self.group0()[0]]) * Simd32x2::from([other.group0()[3], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group1()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group1()[0], self.group1()[1], self.group1()[2]]) * Simd32x3::from(other.group0()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for Flector {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group1()[3]) * other.group0() * Simd32x3::from(-1.0), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Point> for Flector {
    ...
    fn anti_wedge(self, other: Point) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group1()[3] * other.group0()[3] * -1.0 + self.group1()[2] * other.group0()[2] * -1.0 + self.group1()[1] * other.group0()[1] * -1.0 + self.group1()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl AntiWedge<PointAtInfinity> for Flector {
    ...
    fn anti_wedge(self, other: PointAtInfinity) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group1()[2] * other.group0()[2] * -1.0 + self.group1()[1] * other.group0()[1] * -1.0 + self.group1()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl AntiWedge<Rotor> for Flector {
    ...
    fn anti_wedge(self, other: Rotor) -> Flector {
        Flector { groups: FlectorGroups { g0: self.group0() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group1(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g1: self.group1() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<Translator> for Flector {
    ...
    fn anti_wedge(self, other: Translator) -> Flector {
        Flector { groups: FlectorGroups { g0: self.group0() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group1(), 2, 2, 1, 0) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g1: self.group1() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<Flector> for Horizon {
    ...
    fn anti_wedge(self, other: Flector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()) * Simd32x2::from([other.group0()[3], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from(self.group0()) * Simd32x3::from([other.group1()[0], other.group1()[1], other.group1()[2]]) * Simd32x3::from(-1.0), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Origin> for Horizon {
    ...
    fn anti_wedge(self, other: Origin) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0() * other.group0() * -1.0 } }
    }
}
...
impl AntiWedge<Plane> for Horizon {
    ...
    fn anti_wedge(self, other: Plane) -> LineAtInfinity {
        LineAtInfinity { groups: LineAtInfinityGroups { g0: Simd32x3::from(self.group0()) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) * Simd32x3::from(-1.0) } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for Horizon {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> LineAtInfinity {
        LineAtInfinity { groups: LineAtInfinityGroups { g0: Simd32x3::from(self.group0()) * other.group0() * Simd32x3::from(-1.0) } }
    }
}
...
impl AntiWedge<Point> for Horizon {
    ...
    fn anti_wedge(self, other: Point) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0() * other.group0()[3] * -1.0 } }
    }
}
...
impl AntiWedge<Line> for Line {
    ...
    fn anti_wedge(self, other: Line) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group1()[0] * -1.0 + self.group0()[1] * other.group1()[1] * -1.0 + self.group0()[2] * other.group1()[2] * -1.0 + self.group1()[2] * other.group0()[2] * -1.0 + self.group1()[1] * other.group0()[1] * -1.0 + self.group1()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl AntiWedge<LineAtInfinity> for Line {
    ...
    fn anti_wedge(self, other: LineAtInfinity) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group0()[0] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[2] * other.group0()[2] * -1.0 } }
    }
}
...
impl AntiWedge<Motor> for Line {
    ...
    fn anti_wedge(self, other: Motor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: self.group0() * Simd32x3::from(other.group0()[3]), g3: self.group1() * Simd32x3::from(other.group0()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<MultiVector> for Line {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group3()[1], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group3()[2], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group2()[2], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group2()[1], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * swizzle!(other.group4(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * swizzle!(other.group4(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * swizzle!(other.group4(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[2], self.group1()[2], self.group1()[1], self.group1()[0]]) * swizzle!(other.group4(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group1()[1], self.group1()[0], self.group1()[0], self.group1()[0]]) * swizzle!(other.group4(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g2: self.group0() * Simd32x3::from(other.group0()[1]), g3: self.group1() * Simd32x3::from(other.group0()[1]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Plane> for Line {
    ...
    fn anti_wedge(self, other: Plane) -> Point {
        Point { groups: PointGroups { g0: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[2], self.group1()[2], self.group1()[1], self.group1()[0]]) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group1()[1], self.group1()[0], self.group1()[0], self.group1()[0]]) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for Line {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> Point {
        Point { groups: PointGroups { g0: Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[2], self.group1()[2], self.group1()[1], self.group1()[0]]) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group1()[1], self.group1()[0], self.group1()[0], self.group1()[0]]) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<Rotor> for Line {
    ...
    fn anti_wedge(self, other: Rotor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: self.group0() * Simd32x3::from(other.group0()[3]), g3: self.group1() * Simd32x3::from(other.group0()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Flector> for LineAtInfinity {
    ...
    fn anti_wedge(self, other: Flector) -> PointAtInfinity {
        PointAtInfinity { groups: PointAtInfinityGroups { g0: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl AntiWedge<Line> for LineAtInfinity {
    ...
    fn anti_wedge(self, other: Line) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[2] * other.group0()[2] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl AntiWedge<Motor> for LineAtInfinity {
    ...
    fn anti_wedge(self, other: Motor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: self.group0() * Simd32x3::from(other.group0()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<MultiVector> for LineAtInfinity {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group2()[2], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group2()[1], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * swizzle!(other.group4(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * swizzle!(other.group4(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g2: Simd32x3::from(0.0), g3: self.group0() * Simd32x3::from(other.group0()[1]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Plane> for LineAtInfinity {
    ...
    fn anti_wedge(self, other: Plane) -> PointAtInfinity {
        PointAtInfinity { groups: PointAtInfinityGroups { g0: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for LineAtInfinity {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> PointAtInfinity {
        PointAtInfinity { groups: PointAtInfinityGroups { g0: swizzle!(self.group0(), 2, 2, 1) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl AntiWedge<Line> for LineAtOrigin {
    ...
    fn anti_wedge(self, other: Line) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group1()[0] * -1.0 + self.group0()[1] * other.group1()[1] * -1.0 + self.group0()[2] * other.group1()[2] * -1.0 } }
    }
}
...
impl AntiWedge<MultiVector> for LineAtOrigin {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group3()[1], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group3()[2], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * swizzle!(other.group4(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * swizzle!(other.group4(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * swizzle!(other.group4(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g2: self.group0() * Simd32x3::from(other.group0()[1]), g3: Simd32x3::from(0.0), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for LineAtOrigin {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> Origin {
        Origin { groups: OriginGroups { g0: self.group0()[0] * other.group0()[0] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[2] * other.group0()[2] * -1.0 } }
    }
}
...
impl AntiWedge<Magnitude> for Magnitude {
    ...
    fn anti_wedge(self, other: Magnitude) -> Magnitude {
        Magnitude { groups: MagnitudeGroups { g0: self.group0() * Simd32x2::from(other.group0()[1]) + swizzle!(self.group0(), 1, 0) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]) } }
    }
}
...
impl AntiWedge<MultiVector> for Magnitude {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[1]) + swizzle!(self.group0(), 1, 0) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]), g1: Simd32x4::from(self.group0()[1]) * other.group1(), g2: Simd32x3::from(self.group0()[1]) * other.group2(), g3: Simd32x3::from(self.group0()[1]) * other.group3(), g4: Simd32x4::from(self.group0()[1]) * other.group4() } }
    }
}
...
impl AntiWedge<Flector> for Motor {
    ...
    fn anti_wedge(self, other: Flector) -> Flector {
        Flector { groups: FlectorGroups { g0: Simd32x4::from(self.group0()[3]) * other.group0() + swizzle!(self.group0(), 0, 1, 2, 0) * swizzle!(other.group1(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[2], self.group1()[2], self.group1()[1], self.group1()[0]]) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group1()[1], self.group1()[0], self.group1()[0], self.group1()[0]]) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g1: Simd32x4::from(self.group0()[3]) * other.group1() } }
    }
}
...
impl AntiWedge<MultiVector> for Motor {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[3]) * other.group0() + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group3()[1], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group3()[2], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group2()[2], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group2()[1], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(self.group0()[3]) * other.group1() + swizzle!(self.group0(), 0, 1, 2, 0) * swizzle!(other.group4(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group4(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * swizzle!(other.group4(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[2], self.group1()[2], self.group1()[1], self.group1()[0]]) * swizzle!(other.group4(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group1()[1], self.group1()[0], self.group1()[0], self.group1()[0]]) * swizzle!(other.group4(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g2: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[1]) + Simd32x3::from(self.group0()[3]) * other.group2(), g3: Simd32x3::from(self.group0()[3]) * other.group3() + self.group1() * Simd32x3::from(other.group0()[1]), g4: Simd32x4::from(self.group0()[3]) * other.group4() } }
    }
}
...
impl AntiWedge<Plane> for Motor {
    ...
    fn anti_wedge(self, other: Plane) -> Flector {
        Flector { groups: FlectorGroups { g0: swizzle!(self.group0(), 0, 1, 2, 0) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[2], self.group1()[2], self.group1()[1], self.group1()[0]]) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group1()[1], self.group1()[0], self.group1()[0], self.group1()[0]]) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g1: Simd32x4::from(self.group0()[3]) * other.group0() } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for Motor {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> Flector {
        Flector { groups: FlectorGroups { g0: Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[2], self.group1()[2], self.group1()[1], self.group1()[0]]) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group1()[1], self.group1()[0], self.group1()[0], self.group1()[0]]) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g1: swizzle!(self.group0(), 3, 3, 3, 0) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<Rotor> for Motor {
    ...
    fn anti_wedge(self, other: Rotor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[3]) + Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]), g3: self.group1() * Simd32x3::from(other.group0()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Translator> for Motor {
    ...
    fn anti_wedge(self, other: Translator) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([-1.0, 1.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[3]), g3: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) + self.group1() * Simd32x3::from(other.group0()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Flector> for MultiVector {
    ...
    fn anti_wedge(self, other: Flector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[3], self.group1()[0]]) * Simd32x2::from([other.group1()[3], other.group1()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group4()[3], self.group4()[0]]) * Simd32x2::from([other.group0()[3], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group4()[2], self.group4()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group4()[1], self.group4()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group4()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(self.group0()[1]) * other.group0() + Simd32x4::from([self.group2()[0], self.group2()[1], self.group2()[2], self.group2()[0]]) * swizzle!(other.group1(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[1]]) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[2]]) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[2], self.group3()[2], self.group3()[1], self.group3()[0]]) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group3()[1], self.group3()[0], self.group3()[0], self.group3()[0]]) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g2: Simd32x3::from([self.group4()[2], self.group4()[2], self.group4()[1]]) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group4()[1], self.group4()[0], self.group4()[0]]) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group4()[3]) * Simd32x3::from([other.group1()[0], other.group1()[1], other.group1()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group4()[0], self.group4()[1], self.group4()[2]]) * Simd32x3::from(other.group1()[3]), g4: Simd32x4::from(self.group0()[1]) * other.group1() } }
    }
}
...
impl AntiWedge<Line> for MultiVector {
    ...
    fn anti_wedge(self, other: Line) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[1], self.group2()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[2], self.group2()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[2], self.group3()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[1], self.group3()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: swizzle!(self.group4(), 3, 3, 3, 2) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group4(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group4()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group4(), 2, 2, 1, 0) * Simd32x4::from([other.group1()[1], other.group1()[0], other.group1()[0], other.group1()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group4(), 1, 0, 0, 0) * Simd32x4::from([other.group1()[2], other.group1()[2], other.group1()[1], other.group1()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: Simd32x3::from(self.group0()[1]) * other.group0(), g3: Simd32x3::from(self.group0()[1]) * other.group1(), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<LineAtInfinity> for MultiVector {
    ...
    fn anti_wedge(self, other: LineAtInfinity) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[1], self.group2()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[2], self.group2()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]), g1: swizzle!(self.group4(), 2, 2, 1, 0) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group4(), 1, 0, 0, 0) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: Simd32x3::from(0.0), g3: Simd32x3::from(self.group0()[1]) * other.group0(), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<LineAtOrigin> for MultiVector {
    ...
    fn anti_wedge(self, other: LineAtOrigin) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group3()[2], self.group3()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[1], self.group3()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: swizzle!(self.group4(), 3, 3, 3, 2) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group4(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group4()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g2: Simd32x3::from(self.group0()[1]) * other.group0(), g3: Simd32x3::from(0.0), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Magnitude> for MultiVector {
    ...
    fn anti_wedge(self, other: Magnitude) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[1]) + swizzle!(self.group0(), 1, 0) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]), g1: self.group1() * Simd32x4::from(other.group0()[1]), g2: self.group2() * Simd32x3::from(other.group0()[1]), g3: self.group3() * Simd32x3::from(other.group0()[1]), g4: self.group4() * Simd32x4::from(other.group0()[1]) } }
    }
}
...
impl AntiWedge<Motor> for MultiVector {
    ...
    fn anti_wedge(self, other: Motor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[3]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[1], self.group2()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[2], self.group2()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[2], self.group3()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[1], self.group3()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: self.group1() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group4(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group4(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group4()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group4(), 2, 2, 1, 0) * Simd32x4::from([other.group1()[1], other.group1()[0], other.group1()[0], other.group1()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group4(), 1, 0, 0, 0) * Simd32x4::from([other.group1()[2], other.group1()[2], other.group1()[1], other.group1()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: Simd32x3::from(self.group0()[1]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) + self.group2() * Simd32x3::from(other.group0()[3]), g3: Simd32x3::from(self.group0()[1]) * other.group1() + self.group3() * Simd32x3::from(other.group0()[3]), g4: self.group4() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<MultiVector> for MultiVector {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[1]) + swizzle!(self.group0(), 1, 0) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group4()[1], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group4()[2], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[3], self.group1()[0]]) * Simd32x2::from([other.group4()[3], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[1], self.group2()[0]]) * Simd32x2::from([other.group3()[1], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[2], self.group2()[0]]) * Simd32x2::from([other.group3()[2], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[2], self.group3()[0]]) * Simd32x2::from([other.group2()[2], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[1], self.group3()[0]]) * Simd32x2::from([other.group2()[1], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group4()[3], self.group4()[0]]) * Simd32x2::from([other.group1()[3], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group4()[2], self.group4()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group4()[1], self.group4()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group4()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(self.group0()[1]) * other.group1() + self.group1() * Simd32x4::from(other.group0()[1]) + Simd32x4::from([self.group2()[0], self.group2()[1], self.group2()[2], self.group2()[0]]) * swizzle!(other.group4(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[1]]) * swizzle!(other.group4(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[2]]) * swizzle!(other.group4(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[2], self.group3()[2], self.group3()[1], self.group3()[0]]) * swizzle!(other.group4(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group3()[1], self.group3()[0], self.group3()[0], self.group3()[0]]) * swizzle!(other.group4(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group4(), 3, 3, 3, 2) * Simd32x4::from([other.group2()[0], other.group2()[1], other.group2()[2], other.group2()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group4(), 0, 0, 0, 1) * Simd32x4::from([other.group2()[0], other.group2()[0], other.group2()[0], other.group2()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group4()[0]) * Simd32x4::from(other.group2()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group4(), 2, 2, 1, 0) * Simd32x4::from([other.group3()[1], other.group3()[0], other.group3()[0], other.group3()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group4(), 1, 0, 0, 0) * Simd32x4::from([other.group3()[2], other.group3()[2], other.group3()[1], other.group3()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: Simd32x3::from(self.group0()[1]) * other.group2() + self.group2() * Simd32x3::from(other.group0()[1]) + Simd32x3::from([self.group4()[2], self.group4()[2], self.group4()[1]]) * Simd32x3::from([other.group4()[1], other.group4()[0], other.group4()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group4()[1], self.group4()[0], self.group4()[0]]) * Simd32x3::from([other.group4()[2], other.group4()[2], other.group4()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group0()[1]) * other.group3() + self.group3() * Simd32x3::from(other.group0()[1]) + Simd32x3::from(self.group4()[3]) * Simd32x3::from([other.group4()[0], other.group4()[1], other.group4()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group4()[0], self.group4()[1], self.group4()[2]]) * Simd32x3::from(other.group4()[3]), g4: Simd32x4::from(self.group0()[1]) * other.group4() + self.group4() * Simd32x4::from(other.group0()[1]) } }
    }
}
...
impl AntiWedge<Plane> for MultiVector {
    ...
    fn anti_wedge(self, other: Plane) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[3], self.group1()[0]]) * Simd32x2::from([other.group0()[3], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]), g1: Simd32x4::from([self.group2()[0], self.group2()[1], self.group2()[2], self.group2()[0]]) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[1]]) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[2]]) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[2], self.group3()[2], self.group3()[1], self.group3()[0]]) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group3()[1], self.group3()[0], self.group3()[0], self.group3()[0]]) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g2: Simd32x3::from([self.group4()[2], self.group4()[2], self.group4()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group4()[1], self.group4()[0], self.group4()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group4()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group4()[0], self.group4()[1], self.group4()[2]]) * Simd32x3::from(other.group0()[3]), g4: Simd32x4::from(self.group0()[1]) * other.group0() } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for MultiVector {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[1], self.group1()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group1()[2], self.group1()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([1.0, 0.0]), g1: Simd32x4::from(self.group2()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[1]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group2()[0], self.group2()[0], self.group2()[0], self.group2()[2]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[2], self.group3()[2], self.group3()[1], self.group3()[0]]) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group3()[1], self.group3()[0], self.group3()[0], self.group3()[0]]) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g2: Simd32x3::from([self.group4()[2], self.group4()[2], self.group4()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group4()[1], self.group4()[0], self.group4()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group4()[3]) * other.group0() * Simd32x3::from(-1.0), g4: Simd32x4::from([self.group0()[1], self.group0()[1], self.group0()[1], self.group0()[0]]) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<Point> for MultiVector {
    ...
    fn anti_wedge(self, other: Point) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group4()[3], self.group4()[0]]) * Simd32x2::from([other.group0()[3], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group4()[2], self.group4()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group4()[1], self.group4()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group4()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(self.group0()[1]) * other.group0(), g2: Simd32x3::from(0.0), g3: Simd32x3::from(0.0), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Rotor> for MultiVector {
    ...
    fn anti_wedge(self, other: Rotor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[3]) + Simd32x2::from([self.group3()[2], self.group3()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group3()[1], self.group3()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: self.group1() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group4(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group4(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group4()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g2: Simd32x3::from(self.group0()[1]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) + self.group2() * Simd32x3::from(other.group0()[3]), g3: self.group3() * Simd32x3::from(other.group0()[3]), g4: self.group4() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<Translator> for MultiVector {
    ...
    fn anti_wedge(self, other: Translator) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[3]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[1], self.group2()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group2()[2], self.group2()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]), g1: self.group1() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group4(), 2, 2, 1, 0) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group4(), 1, 0, 0, 0) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: self.group2() * Simd32x3::from(other.group0()[3]), g3: Simd32x3::from(self.group0()[1]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) + self.group3() * Simd32x3::from(other.group0()[3]), g4: self.group4() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<Flector> for Plane {
    ...
    fn anti_wedge(self, other: Flector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[3], self.group0()[0]]) * Simd32x2::from([other.group0()[3], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group1()[0], other.group1()[1], other.group1()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group1()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Line> for Plane {
    ...
    fn anti_wedge(self, other: Line) -> Point {
        Point { groups: PointGroups { g0: swizzle!(self.group0(), 3, 3, 3, 2) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 2, 2, 1, 0) * Simd32x4::from([other.group1()[1], other.group1()[0], other.group1()[0], other.group1()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * Simd32x4::from([other.group1()[2], other.group1()[2], other.group1()[1], other.group1()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) } }
    }
}
...
impl AntiWedge<LineAtInfinity> for Plane {
    ...
    fn anti_wedge(self, other: LineAtInfinity) -> PointAtInfinity {
        PointAtInfinity { groups: PointAtInfinityGroups { g0: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([-1.0, 1.0, -1.0]) } }
    }
}
...
impl AntiWedge<Motor> for Plane {
    ...
    fn anti_wedge(self, other: Motor) -> Flector {
        Flector { groups: FlectorGroups { g0: swizzle!(self.group0(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 2, 2, 1, 0) * Simd32x4::from([other.group1()[1], other.group1()[0], other.group1()[0], other.group1()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * Simd32x4::from([other.group1()[2], other.group1()[2], other.group1()[1], other.group1()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g1: self.group0() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<MultiVector> for Plane {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[3], self.group0()[0]]) * Simd32x2::from([other.group1()[3], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([-1.0, 0.0]), g1: swizzle!(self.group0(), 3, 3, 3, 2) * Simd32x4::from([other.group2()[0], other.group2()[1], other.group2()[2], other.group2()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group2()[0], other.group2()[0], other.group2()[0], other.group2()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group2()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 2, 2, 1, 0) * Simd32x4::from([other.group3()[1], other.group3()[0], other.group3()[0], other.group3()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * Simd32x4::from([other.group3()[2], other.group3()[2], other.group3()[1], other.group3()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group4()[1], other.group4()[0], other.group4()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group4()[2], other.group4()[2], other.group4()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group4()[0], other.group4()[1], other.group4()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group4()[3]), g4: self.group0() * Simd32x4::from(other.group0()[1]) } }
    }
}
...
impl AntiWedge<Origin> for Plane {
    ...
    fn anti_wedge(self, other: Origin) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[3] * other.group0() * -1.0 } }
    }
}
...
impl AntiWedge<Plane> for Plane {
    ...
    fn anti_wedge(self, other: Plane) -> Line {
        Line { groups: LineGroups { g0: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g1: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) * Simd32x3::from(-1.0) + Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for Plane {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> Line {
        Line { groups: LineGroups { g0: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([-1.0, 1.0, -1.0]), g1: Simd32x3::from(self.group0()[3]) * other.group0() * Simd32x3::from(-1.0) } }
    }
}
...
impl AntiWedge<Point> for Plane {
    ...
    fn anti_wedge(self, other: Point) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[3] * other.group0()[3] * -1.0 + self.group0()[2] * other.group0()[2] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl AntiWedge<Rotor> for Plane {
    ...
    fn anti_wedge(self, other: Rotor) -> Flector {
        Flector { groups: FlectorGroups { g0: swizzle!(self.group0(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g1: self.group0() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<Translator> for Plane {
    ...
    fn anti_wedge(self, other: Translator) -> Flector {
        Flector { groups: FlectorGroups { g0: swizzle!(self.group0(), 2, 2, 1, 0) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g1: self.group0() * Simd32x4::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<Flector> for PlaneAtOrigin {
    ...
    fn anti_wedge(self, other: Flector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group0()[2], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: self.group0() * Simd32x3::from(other.group1()[3]), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<Line> for PlaneAtOrigin {
    ...
    fn anti_wedge(self, other: Line) -> Point {
        Point { groups: PointGroups { g0: Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * Simd32x4::from([other.group1()[1], other.group1()[0], other.group1()[0], other.group1()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * Simd32x4::from([other.group1()[2], other.group1()[2], other.group1()[1], other.group1()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) } }
    }
}
...
impl AntiWedge<LineAtOrigin> for PlaneAtOrigin {
    ...
    fn anti_wedge(self, other: LineAtOrigin) -> Origin {
        Origin { groups: OriginGroups { g0: self.group0()[2] * other.group0()[2] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl AntiWedge<MultiVector> for PlaneAtOrigin {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group1()[2], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group1()[1], other.group1()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * Simd32x4::from([other.group2()[0], other.group2()[0], other.group2()[0], other.group2()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * Simd32x4::from([other.group2()[0], other.group2()[0], other.group2()[0], other.group2()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group2()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * Simd32x4::from([other.group3()[1], other.group3()[0], other.group3()[0], other.group3()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * Simd32x4::from([other.group3()[2], other.group3()[2], other.group3()[1], other.group3()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g2: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group4()[1], other.group4()[0], other.group4()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group4()[2], other.group4()[2], other.group4()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g3: self.group0() * Simd32x3::from(other.group4()[3]), g4: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * Simd32x4::from([other.group0()[1], other.group0()[1], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<Plane> for PlaneAtOrigin {
    ...
    fn anti_wedge(self, other: Plane) -> Line {
        Line { groups: LineGroups { g0: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]), g1: self.group0() * Simd32x3::from(other.group0()[3]) } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for PlaneAtOrigin {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> LineAtOrigin {
        LineAtOrigin { groups: LineAtOriginGroups { g0: swizzle!(self.group0(), 2, 2, 1) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([1.0, -1.0, 1.0]) + swizzle!(self.group0(), 1, 0, 0) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([-1.0, 1.0, -1.0]) } }
    }
}
...
impl AntiWedge<Translator> for PlaneAtOrigin {
    ...
    fn anti_wedge(self, other: Translator) -> Flector {
        Flector { groups: FlectorGroups { g0: Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]), g1: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<MultiVector> for Point {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group4()[1], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group4()[2], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[3], self.group0()[0]]) * Simd32x2::from([other.group4()[3], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]), g1: self.group0() * Simd32x4::from(other.group0()[1]), g2: Simd32x3::from(0.0), g3: Simd32x3::from(0.0), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<MultiVector> for PointAtInfinity {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group4()[1], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group4()[2], other.group4()[0]]) * Simd32x2::from([1.0, 0.0]), g1: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * Simd32x4::from([other.group0()[1], other.group0()[1], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]), g2: Simd32x3::from(0.0), g3: Simd32x3::from(0.0), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<MultiVector> for Rotor {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[3]) * other.group0() + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group3()[1], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group3()[2], other.group3()[0]]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(self.group0()[3]) * other.group1() + swizzle!(self.group0(), 0, 1, 2, 0) * swizzle!(other.group4(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group4(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * swizzle!(other.group4(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g2: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[1]) + Simd32x3::from(self.group0()[3]) * other.group2(), g3: Simd32x3::from(self.group0()[3]) * other.group3(), g4: Simd32x4::from(self.group0()[3]) * other.group4() } }
    }
}
...
impl AntiWedge<Rotor> for Rotor {
    ...
    fn anti_wedge(self, other: Rotor) -> Rotor {
        Rotor { groups: RotorGroups { g0: self.group0() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group0(), 3, 3, 3, 0) * swizzle!(other.group0(), 0, 1, 2, 0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<Flector> for Translator {
    ...
    fn anti_wedge(self, other: Flector) -> Flector {
        Flector { groups: FlectorGroups { g0: Simd32x4::from(self.group0()[3]) * other.group0() + swizzle!(self.group0(), 2, 2, 1, 0) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g1: Simd32x4::from(self.group0()[3]) * other.group1() } }
    }
}
...
impl AntiWedge<Motor> for Translator {
    ...
    fn anti_wedge(self, other: Motor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[2], self.group0()[3]]) * Simd32x2::from([other.group0()[2], other.group0()[3]]) * Simd32x2::from([-1.0, 1.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group0()[1], other.group0()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]), g3: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[3]) + Simd32x3::from(self.group0()[3]) * other.group1(), g4: Simd32x4::from(0.0) } }
    }
}
...
impl AntiWedge<MultiVector> for Translator {
    ...
    fn anti_wedge(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[3]) * other.group0() + Simd32x2::from([self.group0()[2], self.group0()[0]]) * Simd32x2::from([other.group2()[2], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from([self.group0()[1], self.group0()[0]]) * Simd32x2::from([other.group2()[1], other.group2()[0]]) * Simd32x2::from([-1.0, 0.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([-1.0, 0.0]), g1: Simd32x4::from(self.group0()[3]) * other.group1() + swizzle!(self.group0(), 2, 2, 1, 0) * swizzle!(other.group4(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group4(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g2: Simd32x3::from(self.group0()[3]) * other.group2(), g3: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[1]) + Simd32x3::from(self.group0()[3]) * other.group3(), g4: Simd32x4::from(self.group0()[3]) * other.group4() } }
    }
}
...
impl AntiWedge<Plane> for Translator {
    ...
    fn anti_wedge(self, other: Plane) -> Flector {
        Flector { groups: FlectorGroups { g0: swizzle!(self.group0(), 2, 2, 1, 0) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g1: Simd32x4::from(self.group0()[3]) * other.group0() } }
    }
}
...
impl AntiWedge<PlaneAtOrigin> for Translator {
    ...
    fn anti_wedge(self, other: PlaneAtOrigin) -> Flector {
        Flector { groups: FlectorGroups { g0: swizzle!(self.group0(), 2, 2, 1, 0) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]), g1: swizzle!(self.group0(), 3, 3, 3, 0) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl AntiWedge<Translator> for Translator {
    ...
    fn anti_wedge(self, other: Translator) -> Translator {
        Translator { groups: TranslatorGroups { g0: self.group0() * Simd32x4::from(other.group0()[3]) + swizzle!(self.group0(), 3, 3, 3, 0) * swizzle!(other.group0(), 0, 1, 2, 0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl Join<Flector> for Flector {
    ...
    fn join(self, other: Flector) -> Motor {
        Motor { groups: MotorGroups { g0: swizzle!(self.group0(), 3, 3, 3, 0) * swizzle!(other.group0(), 0, 1, 2, 0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) + swizzle!(self.group0(), 0, 1, 2, 0) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([-1.0, -1.0, -1.0, 0.0]) + swizzle!(self.group0(), 0, 0, 0, 3) * swizzle!(other.group1(), 0, 0, 0, 3) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group1()[0]) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 2) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 3) * swizzle!(other.group0(), 0, 0, 0, 3) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g1: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<Line> for Flector {
    ...
    fn join(self, other: Line) -> Plane {
        Plane { groups: PlaneGroups { g0: swizzle!(self.group0(), 2, 2, 1, 0) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 3, 3, 3, 2) * Simd32x4::from([other.group1()[0], other.group1()[1], other.group1()[2], other.group1()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group1()[0], other.group1()[0], other.group1()[0], other.group1()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group1()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<LineAtInfinity> for Flector {
    ...
    fn join(self, other: LineAtInfinity) -> Plane {
        Plane { groups: PlaneGroups { g0: swizzle!(self.group0(), 3, 3, 3, 2) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<LineAtOrigin> for Flector {
    ...
    fn join(self, other: LineAtOrigin) -> PlaneAtOrigin {
        PlaneAtOrigin { groups: PlaneAtOriginGroups { g0: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([-1.0, 1.0, -1.0]) } }
    }
}
...
impl Join<Motor> for Flector {
    ...
    fn join(self, other: Motor) -> Plane {
        Plane { groups: PlaneGroups { g0: swizzle!(self.group0(), 2, 2, 1, 0) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 3, 3, 3, 2) * Simd32x4::from([other.group1()[0], other.group1()[1], other.group1()[2], other.group1()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group1()[0], other.group1()[0], other.group1()[0], other.group1()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group1()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<MultiVector> for Flector {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from([other.group4()[0], other.group4()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group4()[0], other.group4()[2]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group4()[0], other.group4()[1]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group1()[0], self.group1()[1]]) * Simd32x2::from([other.group1()[0], other.group1()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group1()[0], self.group1()[2]]) * Simd32x2::from([other.group1()[0], other.group1()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group1()[0], self.group1()[3]]) * Simd32x2::from([other.group1()[0], other.group1()[3]]) * Simd32x2::from([0.0, -1.0]), g1: self.group0() * Simd32x4::from(other.group0()[0]), g2: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group1()[0], other.group1()[1], other.group1()[2]]) + Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group1()[3]) * Simd32x3::from(-1.0), g3: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]), g4: swizzle!(self.group0(), 2, 2, 1, 0) * Simd32x4::from([other.group2()[1], other.group2()[0], other.group2()[0], other.group2()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * Simd32x4::from([other.group2()[2], other.group2()[2], other.group2()[1], other.group2()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 3, 3, 3, 2) * Simd32x4::from([other.group3()[0], other.group3()[1], other.group3()[2], other.group3()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group3()[0], other.group3()[0], other.group3()[0], other.group3()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group3()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + self.group1() * Simd32x4::from(other.group0()[0]) } }
    }
}
...
impl Join<Origin> for Flector {
    ...
    fn join(self, other: Origin) -> Rotor {
        Rotor { groups: RotorGroups { g0: swizzle!(self.group0(), 0, 1, 2, 0) * Simd32x4::from(other.group0()) * Simd32x4::from([-1.0, -1.0, -1.0, 0.0]) + swizzle!(self.group1(), 0, 0, 0, 3) * Simd32x4::from(other.group0()) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Plane> for Flector {
    ...
    fn join(self, other: Plane) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[3] * other.group0()[3] + self.group0()[2] * other.group0()[2] + self.group0()[1] * other.group0()[1] + self.group0()[0] * other.group0()[0] } }
    }
}
...
impl Join<PlaneAtOrigin> for Flector {
    ...
    fn join(self, other: PlaneAtOrigin) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[2] * other.group0()[2] + self.group0()[1] * other.group0()[1] + self.group0()[0] * other.group0()[0] } }
    }
}
...
impl Join<PointAtInfinity> for Flector {
    ...
    fn join(self, other: PointAtInfinity) -> Motor {
        Motor { groups: MotorGroups { g0: swizzle!(self.group0(), 3, 3, 3, 0) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 2) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]), g1: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<Rotor> for Flector {
    ...
    fn join(self, other: Rotor) -> PlaneAtOrigin {
        PlaneAtOrigin { groups: PlaneAtOriginGroups { g0: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([1.0, -1.0, 1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([-1.0, 1.0, -1.0]) } }
    }
}
...
impl Join<Translator> for Flector {
    ...
    fn join(self, other: Translator) -> Plane {
        Plane { groups: PlaneGroups { g0: swizzle!(self.group0(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Flector> for Horizon {
    ...
    fn join(self, other: Flector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0() * other.group0()[3] * -1.0 } }
    }
}
...
impl Join<Origin> for Horizon {
    ...
    fn join(self, other: Origin) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0() * other.group0() * -1.0 } }
    }
}
...
impl Join<Flector> for Line {
    ...
    fn join(self, other: Flector) -> Plane {
        Plane { groups: PlaneGroups { g0: Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group1()[0], self.group1()[1], self.group1()[2], self.group1()[0]]) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[1]]) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[2]]) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Line> for Line {
    ...
    fn join(self, other: Line) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[2] * other.group1()[2] * -1.0 + self.group0()[1] * other.group1()[1] * -1.0 + self.group0()[0] * other.group1()[0] * -1.0 + self.group1()[0] * other.group0()[0] * -1.0 + self.group1()[1] * other.group0()[1] * -1.0 + self.group1()[2] * other.group0()[2] * -1.0 } }
    }
}
...
impl Join<LineAtInfinity> for Line {
    ...
    fn join(self, other: LineAtInfinity) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[2] * other.group0()[2] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl Join<LineAtOrigin> for Line {
    ...
    fn join(self, other: LineAtOrigin) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group1()[0] * other.group0()[0] * -1.0 + self.group1()[1] * other.group0()[1] * -1.0 + self.group1()[2] * other.group0()[2] * -1.0 } }
    }
}
...
impl Join<MultiVector> for Line {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group3()[0], other.group3()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group3()[0], other.group3()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group1()[0], self.group1()[1]]) * Simd32x2::from([other.group2()[0], other.group2()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group1()[0], self.group1()[2]]) * Simd32x2::from([other.group2()[0], other.group2()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: self.group0() * Simd32x3::from(other.group0()[0]), g3: self.group1() * Simd32x3::from(other.group0()[0]), g4: Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group1()[0], self.group1()[1], self.group1()[2], self.group1()[0]]) * swizzle!(other.group1(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[1]]) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[2]]) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<PointAtInfinity> for Line {
    ...
    fn join(self, other: PointAtInfinity) -> Plane {
        Plane { groups: PlaneGroups { g0: Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[1]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[2]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Line> for LineAtInfinity {
    ...
    fn join(self, other: Line) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[0] * other.group0()[0] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[2] * other.group0()[2] * -1.0 } }
    }
}
...
impl Join<MultiVector> for LineAtInfinity {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group2()[0], other.group2()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group2()[0], other.group2()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: self.group0() * Simd32x3::from(other.group0()[0]), g4: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * swizzle!(other.group1(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<PointAtInfinity> for LineAtInfinity {
    ...
    fn join(self, other: PointAtInfinity) -> Horizon {
        Horizon { groups: HorizonGroups { g0: self.group0()[0] * other.group0()[0] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[2] * other.group0()[2] * -1.0 } }
    }
}
...
impl Join<Flector> for LineAtOrigin {
    ...
    fn join(self, other: Flector) -> PlaneAtOrigin {
        PlaneAtOrigin { groups: PlaneAtOriginGroups { g0: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<Line> for LineAtOrigin {
    ...
    fn join(self, other: Line) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[2] * other.group1()[2] * -1.0 + self.group0()[1] * other.group1()[1] * -1.0 + self.group0()[0] * other.group1()[0] * -1.0 } }
    }
}
...
impl Join<MultiVector> for LineAtOrigin {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group3()[0], other.group3()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group3()[0], other.group3()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: self.group0() * Simd32x3::from(other.group0()[0]), g3: Simd32x3::from(0.0), g4: Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) } }
    }
}
...
impl Join<PointAtInfinity> for LineAtOrigin {
    ...
    fn join(self, other: PointAtInfinity) -> PlaneAtOrigin {
        PlaneAtOrigin { groups: PlaneAtOriginGroups { g0: swizzle!(self.group0(), 2, 2, 1) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<Magnitude> for Magnitude {
    ...
    fn join(self, other: Magnitude) -> Magnitude {
        Magnitude { groups: MagnitudeGroups { g0: self.group0() * Simd32x2::from(other.group0()[0]) + Simd32x2::from(self.group0()[0]) * other.group0() * Simd32x2::from([0.0, 1.0]) } }
    }
}
...
impl Join<MultiVector> for Motor {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group3()[0], other.group3()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group3()[0], other.group3()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group1()[0], self.group1()[1]]) * Simd32x2::from([other.group2()[0], other.group2()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group1()[0], self.group1()[2]]) * Simd32x2::from([other.group2()[0], other.group2()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[0]), g3: self.group1() * Simd32x3::from(other.group0()[0]), g4: swizzle!(self.group0(), 2, 2, 1, 0) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group1()[0], self.group1()[1], self.group1()[2], self.group1()[0]]) * swizzle!(other.group1(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[1]]) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group1()[0], self.group1()[0], self.group1()[0], self.group1()[2]]) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Flector> for MultiVector {
    ...
    fn join(self, other: Flector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group1()[0], self.group1()[3]]) * Simd32x2::from([other.group1()[0], other.group1()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[2]]) * Simd32x2::from([other.group1()[0], other.group1()[2]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[1]]) * Simd32x2::from([other.group1()[0], other.group1()[1]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group4()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[3]]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(self.group0()[0]) * other.group0(), g2: Simd32x3::from(self.group1()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) + Simd32x3::from([self.group1()[0], self.group1()[1], self.group1()[2]]) * Simd32x3::from(other.group0()[3]) * Simd32x3::from(-1.0), g3: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]), g4: Simd32x4::from(self.group0()[0]) * other.group1() + Simd32x4::from([self.group2()[2], self.group2()[2], self.group2()[1], self.group2()[0]]) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group2()[1], self.group2()[0], self.group2()[0], self.group2()[0]]) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group3()[0], self.group3()[1], self.group3()[2], self.group3()[0]]) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[1]]) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[2]]) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Line> for MultiVector {
    ...
    fn join(self, other: Line) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group2()[0], self.group2()[2]]) * Simd32x2::from([other.group1()[0], other.group1()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group2()[0], self.group2()[1]]) * Simd32x2::from([other.group1()[0], other.group1()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(self.group0()[0]) * other.group0(), g3: Simd32x3::from(self.group0()[0]) * other.group1(), g4: swizzle!(self.group1(), 2, 2, 1, 0) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group1(), 3, 3, 3, 2) * Simd32x4::from([other.group1()[0], other.group1()[1], other.group1()[2], other.group1()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * Simd32x4::from([other.group1()[0], other.group1()[0], other.group1()[0], other.group1()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group1()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<LineAtInfinity> for MultiVector {
    ...
    fn join(self, other: LineAtInfinity) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group2()[0], self.group2()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group2()[0], self.group2()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from(self.group0()[0]) * other.group0(), g4: swizzle!(self.group1(), 3, 3, 3, 2) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<LineAtOrigin> for MultiVector {
    ...
    fn join(self, other: LineAtOrigin) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(self.group0()[0]) * other.group0(), g3: Simd32x3::from(0.0), g4: swizzle!(self.group1(), 2, 2, 1, 0) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) } }
    }
}
...
impl Join<Magnitude> for MultiVector {
    ...
    fn join(self, other: Magnitude) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[0]) + Simd32x2::from(self.group0()[0]) * other.group0() * Simd32x2::from([0.0, 1.0]), g1: self.group1() * Simd32x4::from(other.group0()[0]), g2: self.group2() * Simd32x3::from(other.group0()[0]), g3: self.group3() * Simd32x3::from(other.group0()[0]), g4: self.group4() * Simd32x4::from(other.group0()[0]) } }
    }
}
...
impl Join<Motor> for MultiVector {
    ...
    fn join(self, other: Motor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group2()[0], self.group2()[2]]) * Simd32x2::from([other.group1()[0], other.group1()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group2()[0], self.group2()[1]]) * Simd32x2::from([other.group1()[0], other.group1()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(self.group0()[0]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]), g3: Simd32x3::from(self.group0()[0]) * other.group1(), g4: swizzle!(self.group1(), 2, 2, 1, 0) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group1(), 3, 3, 3, 2) * Simd32x4::from([other.group1()[0], other.group1()[1], other.group1()[2], other.group1()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * Simd32x4::from([other.group1()[0], other.group1()[0], other.group1()[0], other.group1()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group1()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<MultiVector> for MultiVector {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group0() * Simd32x2::from(other.group0()[0]) + Simd32x2::from(self.group0()[0]) * other.group0() * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[3]]) * Simd32x2::from([other.group4()[0], other.group4()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[2]]) * Simd32x2::from([other.group4()[0], other.group4()[2]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[1]]) * Simd32x2::from([other.group4()[0], other.group4()[1]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group2()[0], self.group2()[2]]) * Simd32x2::from([other.group3()[0], other.group3()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group2()[0], self.group2()[1]]) * Simd32x2::from([other.group3()[0], other.group3()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[1]]) * Simd32x2::from([other.group2()[0], other.group2()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[2]]) * Simd32x2::from([other.group2()[0], other.group2()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group4()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[1]]) * Simd32x2::from([other.group1()[0], other.group1()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[2]]) * Simd32x2::from([other.group1()[0], other.group1()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[3]]) * Simd32x2::from([other.group1()[0], other.group1()[3]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(self.group0()[0]) * other.group1() + self.group1() * Simd32x4::from(other.group0()[0]), g2: Simd32x3::from(self.group0()[0]) * other.group2() + Simd32x3::from(self.group1()[3]) * Simd32x3::from([other.group1()[0], other.group1()[1], other.group1()[2]]) + Simd32x3::from([self.group1()[0], self.group1()[1], self.group1()[2]]) * Simd32x3::from(other.group1()[3]) * Simd32x3::from(-1.0) + self.group2() * Simd32x3::from(other.group0()[0]), g3: Simd32x3::from(self.group0()[0]) * other.group3() + Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) + self.group3() * Simd32x3::from(other.group0()[0]), g4: Simd32x4::from(self.group0()[0]) * other.group4() + swizzle!(self.group1(), 2, 2, 1, 0) * Simd32x4::from([other.group2()[1], other.group2()[0], other.group2()[0], other.group2()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * Simd32x4::from([other.group2()[2], other.group2()[2], other.group2()[1], other.group2()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group1(), 3, 3, 3, 2) * Simd32x4::from([other.group3()[0], other.group3()[1], other.group3()[2], other.group3()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * Simd32x4::from([other.group3()[0], other.group3()[0], other.group3()[0], other.group3()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group3()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group2()[2], self.group2()[2], self.group2()[1], self.group2()[0]]) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group2()[1], self.group2()[0], self.group2()[0], self.group2()[0]]) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group3()[0], self.group3()[1], self.group3()[2], self.group3()[0]]) * swizzle!(other.group1(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[1]]) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[2]]) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + self.group4() * Simd32x4::from(other.group0()[0]) } }
    }
}
...
impl Join<Plane> for MultiVector {
    ...
    fn join(self, other: Plane) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group1()[0], self.group1()[3]]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, 1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from(0.0), g4: Simd32x4::from(self.group0()[0]) * other.group0() } }
    }
}
...
impl Join<PlaneAtOrigin> for MultiVector {
    ...
    fn join(self, other: PlaneAtOrigin) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group1()[0], self.group1()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group1()[0], self.group1()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group1()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, 1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from(0.0), g4: Simd32x4::from(self.group0()[0]) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl Join<Point> for MultiVector {
    ...
    fn join(self, other: Point) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group4()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[3]]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(self.group0()[0]) * other.group0(), g2: Simd32x3::from(self.group1()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) + Simd32x3::from([self.group1()[0], self.group1()[1], self.group1()[2]]) * Simd32x3::from(other.group0()[3]) * Simd32x3::from(-1.0), g3: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]), g4: Simd32x4::from([self.group2()[2], self.group2()[2], self.group2()[1], self.group2()[0]]) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group2()[1], self.group2()[0], self.group2()[0], self.group2()[0]]) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group3()[0], self.group3()[1], self.group3()[2], self.group3()[0]]) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[1]]) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[2]]) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<PointAtInfinity> for MultiVector {
    ...
    fn join(self, other: PointAtInfinity) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group4()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group4()[0], self.group4()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(self.group0()[0]) * Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], other.group0()[0]]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]), g2: Simd32x3::from(self.group1()[3]) * other.group0(), g3: Simd32x3::from([self.group1()[2], self.group1()[2], self.group1()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group1()[1], self.group1()[0], self.group1()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([1.0, -1.0, 1.0]), g4: Simd32x4::from([self.group2()[2], self.group2()[2], self.group2()[1], self.group2()[0]]) * Simd32x4::from([other.group0()[1], other.group0()[0], other.group0()[0], other.group0()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group2()[1], self.group2()[0], self.group2()[0], self.group2()[0]]) * Simd32x4::from([other.group0()[2], other.group0()[2], other.group0()[1], other.group0()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from(self.group3()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[1]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group3()[0], self.group3()[0], self.group3()[2]]) * Simd32x4::from([other.group0()[0], other.group0()[0], other.group0()[0], other.group0()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Rotor> for MultiVector {
    ...
    fn join(self, other: Rotor) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group3()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group3()[0], self.group3()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(self.group0()[0]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]), g3: Simd32x3::from(0.0), g4: swizzle!(self.group1(), 2, 2, 1, 0) * swizzle!(other.group0(), 1, 0, 0, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * swizzle!(other.group0(), 2, 2, 1, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) } }
    }
}
...
impl Join<Translator> for MultiVector {
    ...
    fn join(self, other: Translator) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from([other.group0()[0], other.group0()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group2()[0], self.group2()[2]]) * Simd32x2::from([other.group0()[0], other.group0()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group2()[0], self.group2()[1]]) * Simd32x2::from([other.group0()[0], other.group0()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group2()[0]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from(self.group0()[0]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]), g4: swizzle!(self.group1(), 3, 3, 3, 2) * swizzle!(other.group0(), 0, 1, 2, 2) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group1(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group1()[0]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Flector> for Origin {
    ...
    fn join(self, other: Flector) -> Rotor {
        Rotor { groups: RotorGroups { g0: Simd32x4::from(self.group0()) * swizzle!(other.group0(), 0, 1, 2, 0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) + Simd32x4::from(self.group0()) * swizzle!(other.group1(), 0, 0, 0, 3) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) } }
    }
}
...
impl Join<Flector> for Plane {
    ...
    fn join(self, other: Flector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[0] * other.group0()[0] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[2] * other.group0()[2] * -1.0 + self.group0()[3] * other.group0()[3] * -1.0 } }
    }
}
...
impl Join<MultiVector> for Plane {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group1()[0], other.group1()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group1()[0], other.group1()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from([other.group1()[0], other.group1()[3]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from(0.0), g4: self.group0() * Simd32x4::from(other.group0()[0]) } }
    }
}
...
impl Join<Origin> for Plane {
    ...
    fn join(self, other: Origin) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[3] * other.group0() * -1.0 } }
    }
}
...
impl Join<MultiVector> for PlaneAtOrigin {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group1()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group1()[0], other.group1()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group1()[0], other.group1()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from(0.0), g4: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]) } }
    }
}
...
impl Join<MultiVector> for Point {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from([other.group4()[0], other.group4()[3]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group4()[0], other.group4()[2]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group4()[0], other.group4()[1]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([0.0, 1.0]), g1: self.group0() * Simd32x4::from(other.group0()[0]), g2: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group1()[0], other.group1()[1], other.group1()[2]]) + Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group1()[3]) * Simd32x3::from(-1.0), g3: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]), g4: swizzle!(self.group0(), 2, 2, 1, 0) * Simd32x4::from([other.group2()[1], other.group2()[0], other.group2()[0], other.group2()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * Simd32x4::from([other.group2()[2], other.group2()[2], other.group2()[1], other.group2()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 3, 3, 3, 2) * Simd32x4::from([other.group3()[0], other.group3()[1], other.group3()[2], other.group3()[2]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * Simd32x4::from([other.group3()[0], other.group3()[0], other.group3()[0], other.group3()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group3()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Point> for Point {
    ...
    fn join(self, other: Point) -> Line {
        Line { groups: LineGroups { g0: Simd32x3::from(self.group0()[3]) * Simd32x3::from([other.group0()[0], other.group0()[1], other.group0()[2]]) + Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[3]) * Simd32x3::from(-1.0), g1: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<PointAtInfinity> for Point {
    ...
    fn join(self, other: PointAtInfinity) -> Line {
        Line { groups: LineGroups { g0: Simd32x3::from(self.group0()[3]) * other.group0(), g1: Simd32x3::from([self.group0()[2], self.group0()[2], self.group0()[1]]) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([-1.0, 1.0, -1.0]) + Simd32x3::from([self.group0()[1], self.group0()[0], self.group0()[0]]) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<Flector> for PointAtInfinity {
    ...
    fn join(self, other: Flector) -> Motor {
        Motor { groups: MotorGroups { g0: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([-1.0, -1.0, -1.0, 0.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group1()[0]) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]), g1: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<LineAtInfinity> for PointAtInfinity {
    ...
    fn join(self, other: LineAtInfinity) -> Horizon {
        Horizon { groups: HorizonGroups { g0: self.group0()[2] * other.group0()[2] * -1.0 + self.group0()[1] * other.group0()[1] * -1.0 + self.group0()[0] * other.group0()[0] * -1.0 } }
    }
}
...
impl Join<MultiVector> for PointAtInfinity {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group4()[0], other.group4()[2]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group4()[0], other.group4()[1]]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group4()[0]) * Simd32x2::from([0.0, 1.0]), g1: Simd32x4::from([self.group0()[0], self.group0()[1], self.group0()[2], self.group0()[0]]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]), g2: self.group0() * Simd32x3::from(other.group1()[3]) * Simd32x3::from(-1.0), g3: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group1()[1], other.group1()[0], other.group1()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group1()[2], other.group1()[2], other.group1()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]), g4: Simd32x4::from([self.group0()[2], self.group0()[2], self.group0()[1], self.group0()[0]]) * Simd32x4::from([other.group2()[1], other.group2()[0], other.group2()[0], other.group2()[0]]) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) + Simd32x4::from([self.group0()[1], self.group0()[0], self.group0()[0], self.group0()[0]]) * Simd32x4::from([other.group2()[2], other.group2()[2], other.group2()[1], other.group2()[0]]) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[2]]) * Simd32x4::from([other.group3()[0], other.group3()[0], other.group3()[0], other.group3()[2]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group0()[0], self.group0()[0], self.group0()[0], self.group0()[1]]) * Simd32x4::from([other.group3()[0], other.group3()[0], other.group3()[0], other.group3()[1]]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from(self.group0()[0]) * Simd32x4::from(other.group3()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<Point> for PointAtInfinity {
    ...
    fn join(self, other: Point) -> Line {
        Line { groups: LineGroups { g0: self.group0() * Simd32x3::from(other.group0()[3]) * Simd32x3::from(-1.0), g1: swizzle!(self.group0(), 2, 2, 1) * Simd32x3::from([other.group0()[1], other.group0()[0], other.group0()[0]]) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * Simd32x3::from([other.group0()[2], other.group0()[2], other.group0()[1]]) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<PointAtInfinity> for PointAtInfinity {
    ...
    fn join(self, other: PointAtInfinity) -> LineAtInfinity {
        LineAtInfinity { groups: LineAtInfinityGroups { g0: swizzle!(self.group0(), 2, 2, 1) * swizzle!(other.group0(), 1, 0, 0) * Simd32x3::from([-1.0, 1.0, -1.0]) + swizzle!(self.group0(), 1, 0, 0) * swizzle!(other.group0(), 2, 2, 1) * Simd32x3::from([1.0, -1.0, 1.0]) } }
    }
}
...
impl Join<MultiVector> for Rotor {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group3()[0], other.group3()[2]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group3()[0], other.group3()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group3()[0]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[0]), g3: Simd32x3::from(0.0), g4: swizzle!(self.group0(), 2, 2, 1, 0) * swizzle!(other.group1(), 1, 0, 0, 0) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group1(), 2, 2, 1, 0) * Simd32x4::from([1.0, -1.0, 1.0, 0.0]) } }
    }
}
...
impl Join<Flector> for Translator {
    ...
    fn join(self, other: Flector) -> Plane {
        Plane { groups: PlaneGroups { g0: swizzle!(self.group0(), 0, 1, 2, 0) * swizzle!(other.group0(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group0(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * swizzle!(other.group0(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
...
impl Join<MultiVector> for Translator {
    ...
    fn join(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x2::from([self.group0()[0], self.group0()[3]]) * Simd32x2::from(other.group0()[0]) * Simd32x2::from([0.0, 1.0]) + Simd32x2::from(self.group0()[0]) * Simd32x2::from(other.group2()[0]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[1]]) * Simd32x2::from([other.group2()[0], other.group2()[1]]) * Simd32x2::from([0.0, -1.0]) + Simd32x2::from([self.group0()[0], self.group0()[2]]) * Simd32x2::from([other.group2()[0], other.group2()[2]]) * Simd32x2::from([0.0, -1.0]), g1: Simd32x4::from(0.0), g2: Simd32x3::from(0.0), g3: Simd32x3::from([self.group0()[0], self.group0()[1], self.group0()[2]]) * Simd32x3::from(other.group0()[0]), g4: swizzle!(self.group0(), 0, 1, 2, 0) * swizzle!(other.group1(), 3, 3, 3, 0) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 1) * swizzle!(other.group1(), 0, 0, 0, 1) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + swizzle!(self.group0(), 0, 0, 0, 2) * swizzle!(other.group1(), 0, 0, 0, 2) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) } }
    }
}
