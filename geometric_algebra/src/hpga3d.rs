...
impl GeometricAntiProduct<MultiVector> for Scalar {
    ...
    fn geometric_anti_product(self, other: MultiVector) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x4::from(self.group0()) * other.group3() * Simd32x4::from([1.0, -1.0, -1.0, -1.0]), g1: Simd32x4::from(0.0) - Simd32x4::from(self.group0()) * other.group2(), g2: Simd32x4::from(self.group0()) * other.group1(), g3: Simd32x4::from(self.group0()) * other.group0() * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]) } }
    }
}
...
impl LeftAntiContraction<MultiVector> for Scalar {
    ...
    fn left_anti_contraction(self, other: MultiVector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0() * other.group0()[0] } }
    }
}
...
impl GeometricAntiProduct<Point> for Scalar {
    ...
    fn geometric_anti_product(self, other: Point) -> Plane {
        Plane { groups: PlaneGroups { g0: Simd32x4::from(self.group0()) * other.group0() * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]) } }
    }
}
...
impl GeometricAntiProduct<Line> for Scalar {
    ...
    fn geometric_anti_product(self, other: Line) -> Line {
        Line { groups: LineGroups { g0: Simd32x3::from(self.group0()) * other.group1(), g1: Simd32x3::from(0.0) - Simd32x3::from(self.group0()) * other.group0() } }
    }
}
...
impl GeometricAntiProduct<PointAndPlane> for Scalar {
    ...
    fn geometric_anti_product(self, other: PointAndPlane) -> PointAndPlane {
        PointAndPlane { groups: PointAndPlaneGroups { g0: Simd32x4::from(self.group0()) * other.group1() * Simd32x4::from([1.0, -1.0, -1.0, -1.0]), g1: Simd32x4::from(self.group0()) * other.group0() * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]) } }
    }
}
...
impl LeftContraction<MultiVector> for AntiScalar {
    ...
    fn left_contraction(self, other: MultiVector) -> Scalar {
        Scalar { groups: ScalarGroups { g0: 0.0 - self.group0() * other.group3()[0] } }
    }
}
...
impl GeometricProduct<Line> for AntiScalar {
    ...
    fn geometric_product(self, other: Line) -> Line {
        Line { groups: LineGroups { g0: Simd32x3::from(0.0) - Simd32x3::from(self.group0()) * other.group1(), g1: Simd32x3::from(self.group0()) * other.group0() } }
    }
}
...
impl GeometricAntiProduct<Scalar> for MultiVector {
    ...
    fn geometric_anti_product(self, other: Scalar) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: self.group3() * Simd32x4::from(other.group0()) * Simd32x4::from([1.0, -1.0, -1.0, -1.0]), g1: self.group2() * Simd32x4::from(other.group0()), g2: self.group1() * Simd32x4::from(other.group0()) * Simd32x4::from(-1.0), g3: self.group0() * Simd32x4::from(other.group0()) * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]) } }
    }
}
...
impl RightAntiContraction<Scalar> for MultiVector {
    ...
    fn right_anti_contraction(self, other: Scalar) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0() } }
    }
}
...
impl RightContraction<AntiScalar> for MultiVector {
    ...
    fn right_contraction(self, other: AntiScalar) -> Scalar {
        Scalar { groups: ScalarGroups { g0: 0.0 - self.group3()[0] * other.group0() } }
    }
}
...
impl AntiScalarProduct<MultiVector> for MultiVector {
    ...
    fn anti_scalar_product(self, other: MultiVector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] + self.group0()[1] * other.group0()[1] + self.group0()[2] * other.group0()[2] + self.group0()[3] * other.group0()[3] - self.group1()[0] * other.group1()[0] + self.group1()[1] * other.group1()[1] + self.group1()[2] * other.group1()[2] + self.group1()[3] * other.group1()[3] - self.group2()[0] * other.group2()[0] + self.group2()[1] * other.group2()[1] + self.group2()[2] * other.group2()[2] + self.group2()[3] * other.group2()[3] + self.group3()[0] * other.group3()[0] - self.group3()[1] * other.group3()[1] - self.group3()[2] * other.group3()[2] - self.group3()[3] * other.group3()[3] } }
    }
}
...
impl ScalarProduct<Point> for MultiVector {
    ...
    fn scalar_product(self, other: Point) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group1()[1] * other.group0()[1] + self.group1()[2] * other.group0()[2] + self.group1()[3] * other.group0()[3] - self.group2()[0] * other.group0()[0] } }
    }
}
...
impl ScalarProduct<IdealPoint> for MultiVector {
    ...
    fn scalar_product(self, other: IdealPoint) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group3()[1] * other.group0()[0] + self.group3()[2] * other.group0()[1] + self.group3()[3] * other.group0()[2] } }
    }
}
...
impl ScalarProduct<Plane> for MultiVector {
    ...
    fn scalar_product(self, other: Plane) -> Scalar {
        Scalar { groups: ScalarGroups { g0: 0.0 - self.group1()[0] * other.group0()[0] + self.group2()[1] * other.group0()[1] + self.group2()[2] * other.group0()[2] + self.group2()[3] * other.group0()[3] } }
    }
}
...
impl AntiScalarProduct<Line> for MultiVector {
    ...
    fn anti_scalar_product(self, other: Line) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[1] * other.group1()[0] + self.group0()[2] * other.group1()[1] + self.group0()[3] * other.group1()[2] - self.group3()[1] * other.group0()[0] - self.group3()[2] * other.group0()[1] - self.group3()[3] * other.group0()[2] } }
    }
}
...
impl GeometricAntiProduct<Translator> for MultiVector {
    ...
    fn geometric_anti_product(self, other: Translator) -> MultiVector {
        MultiVector { groups: MultiVectorGroups { g0: Simd32x4::from(self.group0()[1]) * swizzle!(other.group0(), 1, 1, 3, 2) * Simd32x4::from([1.0, 0.0, 1.0, -1.0]) + Simd32x4::from(self.group0()[2]) * swizzle!(other.group0(), 2, 3, 2, 1) * Simd32x4::from([1.0, -1.0, 0.0, 1.0]) + Simd32x4::from(self.group0()[3]) * swizzle!(other.group0(), 3, 2, 1, 3) * Simd32x4::from([1.0, 1.0, -1.0, 0.0]) + Simd32x4::from(self.group3()[1]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, -1.0, 0.0, 0.0]) + Simd32x4::from(self.group3()[2]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, -1.0, 0.0]) + Simd32x4::from(self.group3()[3]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, -1.0]) + Simd32x4::from([self.group3()[0], self.group0()[0], self.group0()[0], self.group0()[0]]) * other.group0() * Simd32x4::from([1.0, -1.0, -1.0, -1.0]), g1: Simd32x4::from(self.group1()[1]) * swizzle!(other.group0(), 1, 1, 3, 2) * Simd32x4::from([-1.0, 0.0, 1.0, -1.0]) + Simd32x4::from(self.group1()[2]) * swizzle!(other.group0(), 2, 3, 2, 1) * Simd32x4::from([-1.0, -1.0, 0.0, 1.0]) + Simd32x4::from(self.group1()[3]) * swizzle!(other.group0(), 3, 2, 1, 3) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + Simd32x4::from(self.group2()[1]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 1.0, 0.0, 0.0]) + Simd32x4::from(self.group2()[2]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 1.0, 0.0]) + Simd32x4::from(self.group2()[3]) * Simd32x4::from(other.group0()[0]) * Simd32x4::from([0.0, 0.0, 0.0, 1.0]) + Simd32x4::from([self.group2()[0], self.group1()[0], self.group1()[0], self.group1()[0]]) * other.group0(), g2: Simd32x4::from(self.group2()[0]) * swizzle!(other.group0(), 1, 1, 2, 3) * Simd32x4::from([0.0, 1.0, 1.0, 1.0]) + Simd32x4::from(self.group2()[1]) * swizzle!(other.group0(), 1, 1, 3, 2) * Simd32x4::from([-1.0, 0.0, 1.0, -1.0]) + Simd32x4::from(self.group2()[2]) * swizzle!(other.group0(), 2, 3, 2, 1) * Simd32x4::from([-1.0, -1.0, 0.0, 1.0]) + Simd32x4::from(self.group2()[3]) * swizzle!(other.group0(), 3, 2, 1, 3) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + self.group1() * Simd32x4::from(other.group0()[0]) * Simd32x4::from(-1.0), g3: Simd32x4::from(self.group3()[0]) * swizzle!(other.group0(), 1, 1, 2, 3) * Simd32x4::from([0.0, 1.0, 1.0, 1.0]) + Simd32x4::from(self.group3()[1]) * swizzle!(other.group0(), 1, 1, 3, 2) * Simd32x4::from([-1.0, 0.0, 1.0, -1.0]) + Simd32x4::from(self.group3()[2]) * swizzle!(other.group0(), 2, 3, 2, 1) * Simd32x4::from([-1.0, -1.0, 0.0, 1.0]) + Simd32x4::from(self.group3()[3]) * swizzle!(other.group0(), 3, 2, 1, 3) * Simd32x4::from([-1.0, 1.0, -1.0, 0.0]) + self.group0() * Simd32x4::from(other.group0()[0]) * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]) } }
    }
}
...
impl AntiScalarProduct<Translator> for MultiVector {
    ...
    fn anti_scalar_product(self, other: Translator) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] - self.group3()[1] * other.group0()[1] - self.group3()[2] * other.group0()[2] - self.group3()[3] * other.group0()[3] } }
    }
}
...
impl AntiScalarProduct<Motor> for MultiVector {
    ...
    fn anti_scalar_product(self, other: Motor) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] + self.group0()[1] * other.group0()[1] + self.group0()[2] * other.group0()[2] + self.group0()[3] * other.group0()[3] + self.group3()[0] * other.group1()[0] - self.group3()[1] * other.group1()[1] - self.group3()[2] * other.group1()[2] - self.group3()[3] * other.group1()[3] } }
    }
}
...
impl ScalarProduct<PointAndPlane> for MultiVector {
    ...
    fn scalar_product(self, other: PointAndPlane) -> Scalar {
        Scalar { groups: ScalarGroups { g0: 0.0 - self.group1()[0] * other.group1()[0] + self.group1()[1] * other.group0()[1] + self.group1()[2] * other.group0()[2] + self.group1()[3] * other.group0()[3] - self.group2()[0] * other.group0()[0] + self.group2()[1] * other.group1()[1] + self.group2()[2] * other.group1()[2] + self.group2()[3] * other.group1()[3] } }
    }
}
...
impl RightAntiContraction<Plane> for Rotor {
    ...
    fn right_anti_contraction(self, other: Plane) -> Point {
        Point { groups: PointGroups { g0: Simd32x4::from(self.group0()[0]) * other.group0() * Simd32x4::from([1.0, -1.0, -1.0, -1.0]) } }
    }
}
...
impl LeftAntiContraction<Line> for Rotor {
    ...
    fn left_anti_contraction(self, other: Line) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[1] * other.group1()[0] + self.group0()[2] * other.group1()[1] + self.group0()[3] * other.group1()[2] } }
    }
}
...
impl GeometricAntiProduct<Scalar> for Point {
    ...
    fn geometric_anti_product(self, other: Scalar) -> Plane {
        Plane { groups: PlaneGroups { g0: self.group0() * Simd32x4::from(other.group0()) * Simd32x4::from([1.0, -1.0, -1.0, -1.0]) } }
    }
}
...
impl AntiScalarProduct<MultiVector> for Point {
    ...
    fn anti_scalar_product(self, other: MultiVector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group2()[0] + self.group0()[1] * other.group1()[1] + self.group0()[2] * other.group1()[2] + self.group0()[3] * other.group1()[3] } }
    }
}
...
impl InnerAntiProduct<Rotor> for Point {
    ...
    fn inner_anti_product(self, other: Rotor) -> PointAndPlane {
        PointAndPlane { groups: PointAndPlaneGroups { g0: Simd32x4::from(self.group0()[2]) * Simd32x4::from(other.group0()[2]) * Simd32x4::from([-1.0, 0.0, 0.0, 0.0]) + Simd32x4::from(self.group0()[3]) * Simd32x4::from(other.group0()[3]) * Simd32x4::from([-1.0, 0.0, 0.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group0(), 1, 1, 2, 3) * Simd32x4::from(-1.0), g1: self.group0() * Simd32x4::from(other.group0()[0]) * Simd32x4::from([1.0, -1.0, -1.0, -1.0]) } }
    }
}
...
impl LeftContraction<Motor> for Point {
    ...
    fn left_contraction(self, other: Motor) -> Plane {
        Plane { groups: PlaneGroups { g0: self.group0() * Simd32x4::from(other.group1()[0]) * Simd32x4::from([1.0, -1.0, -1.0, -1.0]) } }
    }
}
...
impl ScalarProduct<MultiVector> for IdealPoint {
    ...
    fn scalar_product(self, other: MultiVector) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group3()[1] + self.group0()[1] * other.group3()[2] + self.group0()[2] * other.group3()[3] } }
    }
}
...
impl ScalarProduct<Motor> for IdealPoint {
    ...
    fn scalar_product(self, other: Motor) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group1()[1] + self.group0()[1] * other.group1()[2] + self.group0()[2] * other.group1()[3] } }
    }
}
...
impl ScalarProduct<MultiVector> for Plane {
    ...
    fn scalar_product(self, other: MultiVector) -> Scalar {
        Scalar { groups: ScalarGroups { g0: 0.0 - self.group0()[0] * other.group1()[0] + self.group0()[1] * other.group2()[1] + self.group0()[2] * other.group2()[2] + self.group0()[3] * other.group2()[3] } }
    }
}
...
impl LeftAntiContraction<Rotor> for Plane {
    ...
    fn left_anti_contraction(self, other: Rotor) -> Point {
        Point { groups: PointGroups { g0: self.group0() * Simd32x4::from(other.group0()[0]) * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]) } }
    }
}
...
impl LeftContraction<Translator> for Plane {
    ...
    fn left_contraction(self, other: Translator) -> Plane {
        Plane { groups: PlaneGroups { g0: Simd32x4::from(self.group0()[2]) * Simd32x4::from(other.group0()[2]) * Simd32x4::from([-1.0, 0.0, 0.0, 0.0]) + Simd32x4::from(self.group0()[3]) * Simd32x4::from(other.group0()[3]) * Simd32x4::from([-1.0, 0.0, 0.0, 0.0]) + swizzle!(self.group0(), 1, 0, 0, 0) * swizzle!(other.group0(), 1, 1, 2, 3) * Simd32x4::from(-1.0) } }
    }
}
...
impl RightContraction<PointAndPlane> for Plane {
    ...
    fn right_contraction(self, other: PointAndPlane) -> Scalar {
        Scalar { groups: ScalarGroups { g0: 0.0 - self.group0()[0] * other.group1()[0] + self.group0()[1] * other.group1()[1] + self.group0()[2] * other.group1()[2] + self.group0()[3] * other.group1()[3] } }
    }
}
...
impl GeometricAntiProduct<Scalar> for Line {
    ...
    fn geometric_anti_product(self, other: Scalar) -> Line {
        Line { groups: LineGroups { g0: self.group1() * Simd32x3::from(other.group0()), g1: self.group0() * Simd32x3::from(other.group0()) * Simd32x3::from(-1.0) } }
    }
}
...
impl GeometricProduct<AntiScalar> for Line {
    ...
    fn geometric_product(self, other: AntiScalar) -> Line {
        Line { groups: LineGroups { g0: self.group1() * Simd32x3::from(other.group0()) * Simd32x3::from(-1.0), g1: self.group0() * Simd32x3::from(other.group0()) } }
    }
}
...
impl ScalarProduct<MultiVector> for Line {
    ...
    fn scalar_product(self, other: MultiVector) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group3()[1] + self.group0()[1] * other.group3()[2] + self.group0()[2] * other.group3()[3] - self.group1()[0] * other.group0()[1] - self.group1()[1] * other.group0()[2] - self.group1()[2] * other.group0()[3] } }
    }
}
...
impl RightAntiContraction<Rotor> for Line {
    ...
    fn right_anti_contraction(self, other: Rotor) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group1()[0] * other.group0()[1] + self.group1()[1] * other.group0()[2] + self.group1()[2] * other.group0()[3] } }
    }
}
...
impl InnerProduct<Line> for Line {
    ...
    fn inner_product(self, other: Line) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group0()[0] + self.group0()[1] * other.group0()[1] + self.group0()[2] * other.group0()[2] - self.group1()[0] * other.group1()[0] - self.group1()[1] * other.group1()[1] - self.group1()[2] * other.group1()[2] } }
    }
}
...
impl ScalarProduct<Motor> for Line {
    ...
    fn scalar_product(self, other: Motor) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group0()[0] * other.group1()[1] + self.group0()[1] * other.group1()[2] + self.group0()[2] * other.group1()[3] - self.group1()[0] * other.group0()[1] - self.group1()[1] * other.group0()[2] - self.group1()[2] * other.group0()[3] } }
    }
}
...
impl AntiScalarProduct<MultiVector> for Translator {
    ...
    fn anti_scalar_product(self, other: MultiVector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] - self.group0()[1] * other.group3()[1] - self.group0()[2] * other.group3()[2] - self.group0()[3] * other.group3()[3] } }
    }
}
...
impl AntiScalarProduct<Motor> for Translator {
    ...
    fn anti_scalar_product(self, other: Motor) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] - self.group0()[1] * other.group1()[1] - self.group0()[2] * other.group1()[2] - self.group0()[3] * other.group1()[3] } }
    }
}
...
impl AntiScalarProduct<MultiVector> for Motor {
    ...
    fn anti_scalar_product(self, other: MultiVector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] + self.group0()[1] * other.group0()[1] + self.group0()[2] * other.group0()[2] + self.group0()[3] * other.group0()[3] + self.group1()[0] * other.group3()[0] - self.group1()[1] * other.group3()[1] - self.group1()[2] * other.group3()[2] - self.group1()[3] * other.group3()[3] } }
    }
}
...
impl RightContraction<Point> for Motor {
    ...
    fn right_contraction(self, other: Point) -> Plane {
        Plane { groups: PlaneGroups { g0: Simd32x4::from(self.group1()[0]) * other.group0() * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]) } }
    }
}
...
impl ScalarProduct<IdealPoint> for Motor {
    ...
    fn scalar_product(self, other: IdealPoint) -> Scalar {
        Scalar { groups: ScalarGroups { g0: self.group1()[1] * other.group0()[0] + self.group1()[2] * other.group0()[1] + self.group1()[3] * other.group0()[2] } }
    }
}
...
impl AntiScalarProduct<Line> for Motor {
    ...
    fn anti_scalar_product(self, other: Line) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: self.group0()[1] * other.group1()[0] + self.group0()[2] * other.group1()[1] + self.group0()[3] * other.group1()[2] - self.group1()[1] * other.group0()[0] - self.group1()[2] * other.group0()[1] - self.group1()[3] * other.group0()[2] } }
    }
}
...
impl AntiScalarProduct<Translator> for Motor {
    ...
    fn anti_scalar_product(self, other: Translator) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] - self.group1()[1] * other.group0()[1] - self.group1()[2] * other.group0()[2] - self.group1()[3] * other.group0()[3] } }
    }
}
...
impl AntiScalarProduct<Motor> for Motor {
    ...
    fn anti_scalar_product(self, other: Motor) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group0()[0] + self.group0()[1] * other.group0()[1] + self.group0()[2] * other.group0()[2] + self.group0()[3] * other.group0()[3] + self.group1()[0] * other.group1()[0] - self.group1()[1] * other.group1()[1] - self.group1()[2] * other.group1()[2] - self.group1()[3] * other.group1()[3] } }
    }
}
...
impl GeometricAntiProduct<Scalar> for PointAndPlane {
    ...
    fn geometric_anti_product(self, other: Scalar) -> PointAndPlane {
        PointAndPlane { groups: PointAndPlaneGroups { g0: self.group1() * Simd32x4::from(other.group0()) * Simd32x4::from([-1.0, 1.0, 1.0, 1.0]), g1: self.group0() * Simd32x4::from(other.group0()) * Simd32x4::from([1.0, -1.0, -1.0, -1.0]) } }
    }
}
...
impl AntiScalarProduct<MultiVector> for PointAndPlane {
    ...
    fn anti_scalar_product(self, other: MultiVector) -> AntiScalar {
        AntiScalar { groups: AntiScalarGroups { g0: 0.0 - self.group0()[0] * other.group2()[0] + self.group0()[1] * other.group1()[1] + self.group0()[2] * other.group1()[2] + self.group0()[3] * other.group1()[3] - self.group1()[0] * other.group1()[0] + self.group1()[1] * other.group2()[1] + self.group1()[2] * other.group2()[2] + self.group1()[3] * other.group2()[3] } }
    }
}
...
impl LeftContraction<Translator> for PointAndPlane {
    ...
    fn left_contraction(self, other: Translator) -> Plane {
        Plane { groups: PlaneGroups { g0: Simd32x4::from(self.group1()[2]) * Simd32x4::from(other.group0()[2]) * Simd32x4::from([-1.0, 0.0, 0.0, 0.0]) + Simd32x4::from(self.group1()[3]) * Simd32x4::from(other.group0()[3]) * Simd32x4::from([-1.0, 0.0, 0.0, 0.0]) + swizzle!(self.group1(), 1, 0, 0, 0) * swizzle!(other.group0(), 1, 1, 2, 3) * Simd32x4::from(-1.0) } }
    }
}
