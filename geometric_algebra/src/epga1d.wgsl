...
fn scalar_complex_number_add(self_32: Scalar, other_20: ComplexNumber) -> ComplexNumber {
    var self_33: Scalar;
...
fn scalar_complex_number_sub(self_34: Scalar, other_22: ComplexNumber) -> ComplexNumber {
    var self_35: Scalar;
...
fn scalar_complex_number_geometric_product(self_36: Scalar, other_24: ComplexNumber) -> ComplexNumber {
    var self_37: Scalar;
...
fn scalar_complex_number_regressive_product(self_38: Scalar, other_26: ComplexNumber) -> Scalar {
    var self_39: Scalar;
...
fn scalar_complex_number_outer_product(self_40: Scalar, other_28: ComplexNumber) -> ComplexNumber {
    var self_41: Scalar;
...
fn scalar_complex_number_inner_product(self_42: Scalar, other_30: ComplexNumber) -> ComplexNumber {
    var self_43: Scalar;
...
fn scalar_complex_number_geometric_anti_product(self_44: Scalar, other_32: ComplexNumber) -> ComplexNumber {
    var self_45: Scalar;
...
fn scalar_complex_number_inner_anti_product(self_46: Scalar, other_34: ComplexNumber) -> ComplexNumber {
    var self_47: Scalar;
...
fn scalar_complex_number_left_contraction(self_48: Scalar, other_36: ComplexNumber) -> ComplexNumber {
    var self_49: Scalar;
...
fn scalar_complex_number_right_contraction(self_50: Scalar, other_38: ComplexNumber) -> Scalar {
    var self_51: Scalar;
...
fn scalar_complex_number_right_anti_contraction(self_52: Scalar, other_40: ComplexNumber) -> ComplexNumber {
    var self_53: Scalar;
...
fn scalar_complex_number_scalar_product(self_54: Scalar, other_42: ComplexNumber) -> Scalar {
    var self_55: Scalar;
...
fn complex_number_neg(self_66: ComplexNumber) -> ComplexNumber {
...
fn complex_number_automorphism(self_68: ComplexNumber) -> ComplexNumber {
...
fn complex_number_reversal(self_70: ComplexNumber) -> ComplexNumber {
...
fn complex_number_conjugation(self_72: ComplexNumber) -> ComplexNumber {
...
fn complex_number_dual(self_74: ComplexNumber) -> ComplexNumber {
...
fn complex_number_anti_reversal(self_76: ComplexNumber) -> ComplexNumber {
...
fn complex_number_scalar_into(self_78: ComplexNumber) -> Scalar {
...
fn complex_number_scalar_add(self_80: ComplexNumber, other_46: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_sub(self_82: ComplexNumber, other_48: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_geometric_product(self_84: ComplexNumber, other_50: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_regressive_product(self_86: ComplexNumber, other_52: Scalar) -> Scalar {
...
fn complex_number_scalar_outer_product(self_88: ComplexNumber, other_54: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_inner_product(self_90: ComplexNumber, other_56: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_geometric_anti_product(self_92: ComplexNumber, other_58: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_inner_anti_product(self_94: ComplexNumber, other_60: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_left_contraction(self_96: ComplexNumber, other_62: Scalar) -> Scalar {
...
fn complex_number_scalar_right_contraction(self_98: ComplexNumber, other_64: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_left_anti_contraction(self_100: ComplexNumber, other_66: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_scalar_product(self_102: ComplexNumber, other_68: Scalar) -> Scalar {
...
fn complex_number_complex_number_add(self_104: ComplexNumber, other_70: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_sub(self_106: ComplexNumber, other_72: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_mul(self_108: ComplexNumber, other_74: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_div(self_110: ComplexNumber, other_76: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_geometric_product(self_112: ComplexNumber, other_78: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_regressive_product(self_114: ComplexNumber, other_80: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_outer_product(self_116: ComplexNumber, other_82: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_inner_product(self_118: ComplexNumber, other_84: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_geometric_anti_product(self_120: ComplexNumber, other_86: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_inner_anti_product(self_122: ComplexNumber, other_88: ComplexNumber) -> ComplexNumber {
    ...
    let _e17: ComplexNumber = self_123;
    let _e21: ComplexNumber = other_89;
    return ComplexNumber((((vec2<f32>(_e4.g0_.x) * _e8.g0_.yx) * vec2<f32>(1.0, -(1.0))) + (vec2<f32>(_e17.g0_.y) * _e21.g0_)));
}

fn complex_number_complex_number_left_contraction(self_124: ComplexNumber, other_90: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_right_contraction(self_126: ComplexNumber, other_92: ComplexNumber) -> ComplexNumber {
    ...
    let _e17: ComplexNumber = self_127;
...
fn complex_number_complex_number_left_anti_contraction(self_128: ComplexNumber, other_94: ComplexNumber) -> ComplexNumber {
    ...
    let _e11: ComplexNumber = self_129;
...
fn complex_number_complex_number_right_anti_contraction(self_130: ComplexNumber, other_96: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_scalar_product(self_132: ComplexNumber, other_98: ComplexNumber) -> Scalar {
...
fn complex_number_squared_magnitude(self_134: ComplexNumber) -> Scalar {
    var self_135: ComplexNumber;

    self_135 = self_134;
    let _e2: ComplexNumber = self_135;
    let _e3: ComplexNumber = self_135;
    let _e4: ComplexNumber = complex_number_reversal(_e3);
    let _e5: Scalar = complex_number_complex_number_scalar_product(_e2, _e4);
    return _e5;
}

fn complex_number_magnitude(self_136: ComplexNumber) -> Scalar {
    var self_137: ComplexNumber;

    self_137 = self_136;
    let _e2: ComplexNumber = self_137;
    let _e3: Scalar = complex_number_squared_magnitude(_e2);
    return Scalar(sqrt(_e3.g0_));
}

fn complex_number_scale(self_138: ComplexNumber, other_100: f32) -> ComplexNumber {
...
fn complex_number_signum(self_140: ComplexNumber) -> ComplexNumber {
    var self_141: ComplexNumber;

    self_141 = self_140;
    let _e2: ComplexNumber = self_141;
    let _e3: ComplexNumber = self_141;
...
fn complex_number_powi(self_144: ComplexNumber, exponent: i32) -> ComplexNumber {
    ...
    if (_e8 < 0) {
        let _e11: ComplexNumber = self_145;
        let _e12: ComplexNumber = complex_number_inverse(_e11);
        local = _e12;
    } else {
        let _e14: ComplexNumber = self_145;
        local = _e14;
    }
...
fn complex_number_complex_number_geometric_quotient(self_146: ComplexNumber, other_102: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_transformation(self_148: ComplexNumber, other_104: ComplexNumber) -> ComplexNumber {
    ...
    let _e7: ComplexNumber = self_149;
...
fn complex_number_scalar_geometric_quotient(self_150: ComplexNumber, other_106: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_transformation(self_152: ComplexNumber, other_108: Scalar) -> Scalar {
    var self_153: ComplexNumber;
    var other_109: Scalar;

    self_153 = self_152;
    other_109 = other_108;
    let _e4: ComplexNumber = self_153;
    let _e5: Scalar = other_109;
    let _e6: ComplexNumber = complex_number_scalar_geometric_product(_e4, _e5);
    let _e7: ComplexNumber = self_153;
    let _e8: ComplexNumber = complex_number_reversal(_e7);
    let _e9: ComplexNumber = complex_number_complex_number_geometric_product(_e6, _e8);
...
fn scalar_complex_number_geometric_quotient(self_154: Scalar, other_110: ComplexNumber) -> ComplexNumber {
    var self_155: Scalar;
...
fn scalar_complex_number_transformation(self_156: Scalar, other_112: ComplexNumber) -> ComplexNumber {
    var self_157: Scalar;
