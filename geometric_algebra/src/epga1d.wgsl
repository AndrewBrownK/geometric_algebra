...
fn scalar_complex_number_add(self_34: Scalar, other_20: ComplexNumber) -> ComplexNumber {
    var self_35: Scalar;
...
fn scalar_complex_number_sub(self_36: Scalar, other_22: ComplexNumber) -> ComplexNumber {
    var self_37: Scalar;
...
fn scalar_complex_number_geometric_product(self_38: Scalar, other_24: ComplexNumber) -> ComplexNumber {
    var self_39: Scalar;
...
fn scalar_complex_number_regressive_product(self_40: Scalar, other_26: ComplexNumber) -> Scalar {
    var self_41: Scalar;
...
fn scalar_complex_number_outer_product(self_42: Scalar, other_28: ComplexNumber) -> ComplexNumber {
    var self_43: Scalar;
...
fn scalar_complex_number_inner_product(self_44: Scalar, other_30: ComplexNumber) -> ComplexNumber {
    var self_45: Scalar;
...
fn scalar_complex_number_geometric_anti_product(self_46: Scalar, other_32: ComplexNumber) -> ComplexNumber {
    var self_47: Scalar;
...
fn scalar_complex_number_inner_anti_product(self_48: Scalar, other_34: ComplexNumber) -> ComplexNumber {
    var self_49: Scalar;
...
fn scalar_complex_number_left_contraction(self_50: Scalar, other_36: ComplexNumber) -> ComplexNumber {
    var self_51: Scalar;
...
fn scalar_complex_number_right_contraction(self_52: Scalar, other_38: ComplexNumber) -> Scalar {
    var self_53: Scalar;
...
fn scalar_complex_number_right_anti_contraction(self_54: Scalar, other_40: ComplexNumber) -> ComplexNumber {
    var self_55: Scalar;
...
fn scalar_complex_number_scalar_product(self_56: Scalar, other_42: ComplexNumber) -> Scalar {
    var self_57: Scalar;
...
fn complex_number_neg(self_68: ComplexNumber) -> ComplexNumber {
...
fn complex_number_automorphism(self_70: ComplexNumber) -> ComplexNumber {
...
fn complex_number_reversal(self_72: ComplexNumber) -> ComplexNumber {
...
fn complex_number_conjugation(self_74: ComplexNumber) -> ComplexNumber {
...
fn complex_number_dual(self_76: ComplexNumber) -> ComplexNumber {
...
fn complex_number_anti_reversal(self_78: ComplexNumber) -> ComplexNumber {
    var self_79: ComplexNumber;

    self_79 = self_78;
    let _e2: ComplexNumber = self_79;
    return ComplexNumber((_e2.g0_ * vec2<f32>(1.0, -(1.0))));
}

fn complex_number_right_complement(self_80: ComplexNumber) -> ComplexNumber {
    var self_81: ComplexNumber;

    self_81 = self_80;
    let _e2: ComplexNumber = self_81;
    return ComplexNumber(_e2.g0_.yx);
}

fn complex_number_left_complement(self_82: ComplexNumber) -> ComplexNumber {
    var self_83: ComplexNumber;

    self_83 = self_82;
    let _e2: ComplexNumber = self_83;
    return ComplexNumber(_e2.g0_.yx);
}

fn complex_number_double_complement(self_84: ComplexNumber) -> ComplexNumber {
    var self_85: ComplexNumber;

    self_85 = self_84;
    let _e2: ComplexNumber = self_85;
    return ComplexNumber(_e2.g0_);
}

fn complex_number_scalar_into(self_86: ComplexNumber) -> Scalar {
    var self_87: ComplexNumber;

    self_87 = self_86;
    let _e2: ComplexNumber = self_87;
    return Scalar(_e2.g0_.x);
}

fn complex_number_scalar_add(self_88: ComplexNumber, other_46: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_sub(self_90: ComplexNumber, other_48: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_geometric_product(self_92: ComplexNumber, other_50: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_regressive_product(self_94: ComplexNumber, other_52: Scalar) -> Scalar {
...
fn complex_number_scalar_outer_product(self_96: ComplexNumber, other_54: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_inner_product(self_98: ComplexNumber, other_56: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_geometric_anti_product(self_100: ComplexNumber, other_58: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_inner_anti_product(self_102: ComplexNumber, other_60: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_left_contraction(self_104: ComplexNumber, other_62: Scalar) -> Scalar {
...
fn complex_number_scalar_right_contraction(self_106: ComplexNumber, other_64: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_left_anti_contraction(self_108: ComplexNumber, other_66: Scalar) -> ComplexNumber {
...
fn complex_number_scalar_scalar_product(self_110: ComplexNumber, other_68: Scalar) -> Scalar {
...
fn complex_number_complex_number_add(self_112: ComplexNumber, other_70: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_sub(self_114: ComplexNumber, other_72: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_mul(self_116: ComplexNumber, other_74: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_div(self_118: ComplexNumber, other_76: ComplexNumber) -> ComplexNumber {
    ...
    let _e7: ComplexNumber = self_119;
...
fn complex_number_complex_number_geometric_product(self_120: ComplexNumber, other_78: ComplexNumber) -> ComplexNumber {
    ...
    let _e11: ComplexNumber = self_121;
...
fn complex_number_complex_number_regressive_product(self_122: ComplexNumber, other_80: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_outer_product(self_124: ComplexNumber, other_82: ComplexNumber) -> ComplexNumber {
    ...
    let _e11: ComplexNumber = self_125;
...
fn complex_number_complex_number_inner_product(self_126: ComplexNumber, other_84: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_geometric_anti_product(self_128: ComplexNumber, other_86: ComplexNumber) -> ComplexNumber {
...
fn complex_number_complex_number_inner_anti_product(self_130: ComplexNumber, other_88: ComplexNumber) -> ComplexNumber {
    ...
    let _e17: ComplexNumber = self_131;
    let _e21: ComplexNumber = other_89;
    return ComplexNumber((((vec2<f32>(_e4.g0_.x) * _e8.g0_.yx) * vec2<f32>(1.0, -(1.0))) + (vec2<f32>(_e17.g0_.y) * _e21.g0_)));
}

fn complex_number_complex_number_left_contraction(self_132: ComplexNumber, other_90: ComplexNumber) -> ComplexNumber {
    var self_133: ComplexNumber;
    var other_91: ComplexNumber;

    self_133 = self_132;
    other_91 = other_90;
    let _e4: ComplexNumber = self_133;
    let _e8: ComplexNumber = other_91;
    let _e11: ComplexNumber = self_133;
    let _e14: ComplexNumber = other_91;
    return ComplexNumber(((vec2<f32>(_e4.g0_.x) * _e8.g0_) + ((_e11.g0_.yx * _e14.g0_.yx) * vec2<f32>(-(1.0), 0.0))));
}

fn complex_number_complex_number_right_contraction(self_134: ComplexNumber, other_92: ComplexNumber) -> ComplexNumber {
    var self_135: ComplexNumber;
    var other_93: ComplexNumber;

    self_135 = self_134;
    other_93 = other_92;
    let _e4: ComplexNumber = self_135;
    let _e8: ComplexNumber = other_93;
    let _e17: ComplexNumber = self_135;
...
fn complex_number_complex_number_left_anti_contraction(self_136: ComplexNumber, other_94: ComplexNumber) -> ComplexNumber {
    ...
    let _e11: ComplexNumber = self_137;
...
fn complex_number_complex_number_right_anti_contraction(self_138: ComplexNumber, other_96: ComplexNumber) -> ComplexNumber {
    var self_139: ComplexNumber;
    var other_97: ComplexNumber;

    self_139 = self_138;
    other_97 = other_96;
    let _e4: ComplexNumber = self_139;
    let _e8: ComplexNumber = other_97;
    let _e17: ComplexNumber = self_139;
...
fn complex_number_complex_number_scalar_product(self_140: ComplexNumber, other_98: ComplexNumber) -> Scalar {
    ...
    let _e11: ComplexNumber = self_141;
    let _e14: ComplexNumber = other_99;
    return Scalar(((_e4.g0_.x * _e7.g0_.x) - (_e11.g0_.y * _e14.g0_.y)));
}

fn complex_number_squared_magnitude(self_142: ComplexNumber) -> Scalar {
    var self_143: ComplexNumber;

    self_143 = self_142;
    let _e2: ComplexNumber = self_143;
    let _e3: ComplexNumber = self_143;
    let _e4: ComplexNumber = complex_number_reversal(_e3);
    let _e5: Scalar = complex_number_complex_number_scalar_product(_e2, _e4);
    return _e5;
}

fn complex_number_magnitude(self_144: ComplexNumber) -> Scalar {
    var self_145: ComplexNumber;

    self_145 = self_144;
    let _e2: ComplexNumber = self_145;
    let _e3: Scalar = complex_number_squared_magnitude(_e2);
    return Scalar(sqrt(_e3.g0_));
}

fn complex_number_scale(self_146: ComplexNumber, other_100: f32) -> ComplexNumber {
...
fn complex_number_signum(self_148: ComplexNumber) -> ComplexNumber {
    var self_149: ComplexNumber;

    self_149 = self_148;
    let _e2: ComplexNumber = self_149;
    let _e3: ComplexNumber = self_149;
...
fn complex_number_inverse(self_150: ComplexNumber) -> ComplexNumber {
    var self_151: ComplexNumber;

    self_151 = self_150;
    let _e2: ComplexNumber = self_151;
...
fn complex_number_powi(self_152: ComplexNumber, exponent: i32) -> ComplexNumber {
    var self_153: ComplexNumber;
    var exponent_1: i32;
    ...
    if (_e8 < 0) {
        let _e11: ComplexNumber = self_153;
        let _e12: ComplexNumber = complex_number_inverse(_e11);
        local = _e12;
    } else {
        let _e14: ComplexNumber = self_153;
        local = _e14;
    }
...
fn complex_number_complex_number_geometric_quotient(self_154: ComplexNumber, other_102: ComplexNumber) -> ComplexNumber {
    var self_155: ComplexNumber;
    var other_103: ComplexNumber;

    self_155 = self_154;
    other_103 = other_102;
    let _e4: ComplexNumber = self_155;
...
fn complex_number_complex_number_transformation(self_156: ComplexNumber, other_104: ComplexNumber) -> ComplexNumber {
    var self_157: ComplexNumber;
    var other_105: ComplexNumber;

    self_157 = self_156;
    other_105 = other_104;
    let _e4: ComplexNumber = self_157;
    let _e5: ComplexNumber = other_105;
    let _e6: ComplexNumber = complex_number_complex_number_geometric_product(_e4, _e5);
    let _e7: ComplexNumber = self_157;
...
fn complex_number_scalar_geometric_quotient(self_158: ComplexNumber, other_106: Scalar) -> ComplexNumber {
    var self_159: ComplexNumber;
    var other_107: Scalar;

    self_159 = self_158;
    other_107 = other_106;
    let _e4: ComplexNumber = self_159;
...
fn complex_number_scalar_transformation(self_160: ComplexNumber, other_108: Scalar) -> Scalar {
    var self_161: ComplexNumber;
    var other_109: Scalar;

    self_161 = self_160;
    other_109 = other_108;
    let _e4: ComplexNumber = self_161;
    let _e5: Scalar = other_109;
    let _e6: ComplexNumber = complex_number_scalar_geometric_product(_e4, _e5);
    let _e7: ComplexNumber = self_161;
    let _e8: ComplexNumber = complex_number_reversal(_e7);
    let _e9: ComplexNumber = complex_number_complex_number_geometric_product(_e6, _e8);
...
fn scalar_complex_number_geometric_quotient(self_162: Scalar, other_110: ComplexNumber) -> ComplexNumber {
    var self_163: Scalar;
...
fn scalar_complex_number_transformation(self_164: Scalar, other_112: ComplexNumber) -> ComplexNumber {
    var self_165: Scalar;
...
fn scalar_powi(self_166: Scalar, exponent_2: i32) -> Scalar {
    ...
    if (_e8 < 0) {
        let _e11: Scalar = self_167;
        let _e12: Scalar = scalar_inverse(_e11);
        local_1 = _e12;
    } else {
        let _e14: Scalar = self_167;
        local_1 = _e14;
    }
...
fn scalar_scalar_geometric_quotient(self_168: Scalar, other_114: Scalar) -> Scalar {
    var self_169: Scalar;
...
fn scalar_scalar_transformation(self_170: Scalar, other_116: Scalar) -> Scalar {
    var self_171: Scalar;
