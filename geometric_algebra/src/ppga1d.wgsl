...
fn scalar_dual_number_add(self_30: Scalar, other_20: DualNumber) -> DualNumber {
    var self_31: Scalar;
...
fn scalar_dual_number_sub(self_32: Scalar, other_22: DualNumber) -> DualNumber {
    var self_33: Scalar;
...
fn scalar_dual_number_geometric_product(self_34: Scalar, other_24: DualNumber) -> DualNumber {
    var self_35: Scalar;
...
fn scalar_dual_number_regressive_product(self_36: Scalar, other_26: DualNumber) -> Scalar {
    var self_37: Scalar;
...
fn scalar_dual_number_outer_product(self_38: Scalar, other_28: DualNumber) -> DualNumber {
    var self_39: Scalar;
...
fn scalar_dual_number_inner_product(self_40: Scalar, other_30: DualNumber) -> DualNumber {
    var self_41: Scalar;
...
fn scalar_dual_number_geometric_anti_product(self_42: Scalar, other_32: DualNumber) -> Scalar {
    var self_43: Scalar;
...
fn scalar_dual_number_inner_anti_product(self_44: Scalar, other_34: DualNumber) -> Scalar {
    var self_45: Scalar;
...
fn scalar_dual_number_left_contraction(self_46: Scalar, other_36: DualNumber) -> DualNumber {
    var self_47: Scalar;
...
fn scalar_dual_number_right_contraction(self_48: Scalar, other_38: DualNumber) -> Scalar {
    var self_49: Scalar;
...
fn scalar_dual_number_right_anti_contraction(self_50: Scalar, other_40: DualNumber) -> Scalar {
    var self_51: Scalar;
...
fn scalar_dual_number_scalar_product(self_52: Scalar, other_42: DualNumber) -> Scalar {
    var self_53: Scalar;
...
fn dual_number_neg(self_64: DualNumber) -> DualNumber {
...
fn dual_number_automorphism(self_66: DualNumber) -> DualNumber {
...
fn dual_number_reversal(self_68: DualNumber) -> DualNumber {
...
fn dual_number_conjugation(self_70: DualNumber) -> DualNumber {
...
fn dual_number_dual(self_72: DualNumber) -> DualNumber {
...
fn dual_number_anti_reversal(self_74: DualNumber) -> DualNumber {
...
fn dual_number_scalar_into(self_76: DualNumber) -> Scalar {
...
fn dual_number_scalar_add(self_78: DualNumber, other_46: Scalar) -> DualNumber {
...
fn dual_number_scalar_sub(self_80: DualNumber, other_48: Scalar) -> DualNumber {
...
fn dual_number_scalar_geometric_product(self_82: DualNumber, other_50: Scalar) -> DualNumber {
...
fn dual_number_scalar_regressive_product(self_84: DualNumber, other_52: Scalar) -> Scalar {
...
fn dual_number_scalar_outer_product(self_86: DualNumber, other_54: Scalar) -> DualNumber {
...
fn dual_number_scalar_inner_product(self_88: DualNumber, other_56: Scalar) -> DualNumber {
...
fn dual_number_scalar_geometric_anti_product(self_90: DualNumber, other_58: Scalar) -> Scalar {
...
fn dual_number_scalar_inner_anti_product(self_92: DualNumber, other_60: Scalar) -> Scalar {
...
fn dual_number_scalar_left_contraction(self_94: DualNumber, other_62: Scalar) -> Scalar {
...
fn dual_number_scalar_right_contraction(self_96: DualNumber, other_64: Scalar) -> DualNumber {
...
fn dual_number_scalar_left_anti_contraction(self_98: DualNumber, other_66: Scalar) -> Scalar {
...
fn dual_number_scalar_scalar_product(self_100: DualNumber, other_68: Scalar) -> Scalar {
...
fn dual_number_dual_number_add(self_102: DualNumber, other_70: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_sub(self_104: DualNumber, other_72: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_mul(self_106: DualNumber, other_74: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_div(self_108: DualNumber, other_76: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_geometric_product(self_110: DualNumber, other_78: DualNumber) -> DualNumber {
    ...
    let _e11: DualNumber = self_111;
    let _e13: DualNumber = other_79;
    return DualNumber(((vec2<f32>(_e4.g0_.x) * _e8.g0_) + ((_e11.g0_ * vec2<f32>(_e13.g0_.x)) * vec2<f32>(0.0, 1.0))));
}

fn dual_number_dual_number_regressive_product(self_112: DualNumber, other_80: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_outer_product(self_114: DualNumber, other_82: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_inner_product(self_116: DualNumber, other_84: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_geometric_anti_product(self_118: DualNumber, other_86: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_inner_anti_product(self_120: DualNumber, other_88: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_left_contraction(self_122: DualNumber, other_90: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_right_contraction(self_124: DualNumber, other_92: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_left_anti_contraction(self_126: DualNumber, other_94: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_right_anti_contraction(self_128: DualNumber, other_96: DualNumber) -> DualNumber {
...
fn dual_number_dual_number_scalar_product(self_130: DualNumber, other_98: DualNumber) -> Scalar {
...
fn dual_number_squared_magnitude(self_132: DualNumber) -> Scalar {
    var self_133: DualNumber;

    self_133 = self_132;
    let _e2: DualNumber = self_133;
    let _e3: DualNumber = self_133;
    let _e4: DualNumber = dual_number_reversal(_e3);
    let _e5: Scalar = dual_number_dual_number_scalar_product(_e2, _e4);
    return _e5;
}

fn dual_number_magnitude(self_134: DualNumber) -> Scalar {
...
fn dual_number_scale(self_136: DualNumber, other_100: f32) -> DualNumber {
...
fn dual_number_signum(self_138: DualNumber) -> DualNumber {
    var self_139: DualNumber;

    self_139 = self_138;
    let _e2: DualNumber = self_139;
    let _e3: DualNumber = self_139;
    let _e4: Scalar = dual_number_magnitude(_e3);
    let _e9: DualNumber = dual_number_scalar_geometric_product(_e2, Scalar((1.0 / _e4.g0_)));
    return _e9;
}

fn dual_number_inverse(self_140: DualNumber) -> DualNumber {
...
fn dual_number_powi(self_142: DualNumber, exponent: i32) -> DualNumber {
    ...
    if (_e8 < 0) {
        let _e11: DualNumber = self_143;
        let _e12: DualNumber = dual_number_inverse(_e11);
        local = _e12;
    } else {
        let _e14: DualNumber = self_143;
        local = _e14;
    }
...
fn dual_number_dual_number_geometric_quotient(self_144: DualNumber, other_102: DualNumber) -> DualNumber {
    var self_145: DualNumber;
    var other_103: DualNumber;

    self_145 = self_144;
    other_103 = other_102;
    let _e4: DualNumber = self_145;
...
fn dual_number_dual_number_transformation(self_146: DualNumber, other_104: DualNumber) -> DualNumber {
    ...
    let _e7: DualNumber = self_147;
    let _e8: DualNumber = dual_number_reversal(_e7);
    let _e9: DualNumber = dual_number_dual_number_geometric_product(_e6, _e8);
    return _e9;
}

fn dual_number_scalar_geometric_quotient(self_148: DualNumber, other_106: Scalar) -> DualNumber {
...
fn dual_number_scalar_transformation(self_150: DualNumber, other_108: Scalar) -> Scalar {
...
fn scalar_dual_number_geometric_quotient(self_152: Scalar, other_110: DualNumber) -> DualNumber {
    var self_153: Scalar;
...
fn scalar_dual_number_transformation(self_154: Scalar, other_112: DualNumber) -> DualNumber {
    var self_155: Scalar;
