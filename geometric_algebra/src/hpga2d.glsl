...
Plane scalar_point_geometric_anti_product(Scalar self, Point other) {
    return Plane(vec3(self.g0) * other.g0 * vec3(-1.0, 1.0, 1.0));
}
...
Point scalar_plane_geometric_anti_product(Scalar self, Plane other) {
    return Point(vec3(self.g0) * other.g0 * vec3(-1.0, 1.0, 1.0));
}
...
AntiScalar multi_vector_point_anti_scalar_product(MultiVector self, Point other) {
    return AntiScalar(0.0 - self.g0.y * other.g0.x + self.g1.z * other.g0.y + self.g1.w * other.g0.z);
}
...
MultiVector multi_vector_plane_geometric_anti_product(MultiVector self, Plane other) {
    return MultiVector(vec4(self.g1.x) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.z) * vec4(0.0, 0.0, 1.0, -1.0) + vec4(self.g1.y) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.y) * vec4(0.0, 0.0, 1.0, 1.0) + vec4(self.g1.z) * vec4(other.g0.y, other.g0.z, other.g0.y, other.g0.y) * vec4(1.0, 1.0, 0.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.z, other.g0.y, other.g0.z, other.g0.z) * vec4(1.0, -1.0, 0.0, 0.0) + self.g0.yxwz * vec4(other.g0.x) * vec4(1.0, -1.0, -1.0, 1.0), vec4(self.g0.y) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.y) * vec4(0.0, 0.0, 1.0, -1.0) + vec4(self.g0.w) * vec4(other.g0.z, other.g0.y, other.g0.z, other.g0.z) * vec4(-1.0, 1.0, 0.0, 0.0) + vec4(self.g1.x) * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0) + vec4(self.g1.y) * vec4(other.g0.x) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g1.z) * vec4(other.g0.x) * vec4(0.0, 0.0, 0.0, -1.0) + vec4(self.g1.w) * vec4(other.g0.x) * vec4(0.0, 0.0, 1.0, 0.0) + self.g0.zzxx * vec4(other.g0.y, other.g0.z, other.g0.y, other.g0.z));
}
...
AntiScalar multi_vector_plane_anti_scalar_product(MultiVector self, Plane other) {
    return AntiScalar(self.g0.z * other.g0.z + self.g0.w * other.g0.y - self.g1.x * other.g0.x);
}
...
AntiScalar multi_vector_translator_anti_scalar_product(MultiVector self, Translator other) {
    return AntiScalar(self.g0.x * other.g0.x + self.g1.z * other.g0.y + self.g1.w * other.g0.z);
}
...
AntiScalar multi_vector_motor_anti_scalar_product(MultiVector self, Motor other) {
    return AntiScalar(self.g0.x * other.g0.x - self.g0.y * other.g0.y + self.g1.z * other.g0.z + self.g1.w * other.g0.w);
}
...
AntiScalar multi_vector_motor_dual_anti_scalar_product(MultiVector self, MotorDual other) {
    return AntiScalar(self.g0.z * other.g0.w + self.g0.w * other.g0.z - self.g1.x * other.g0.y + self.g1.y * other.g0.x);
}
...
MotorDual rotor_point_inner_anti_product(Rotor self, Point other) {
    return MotorDual(vec4(self.g0.y, self.g0.x, self.g0.x, self.g0.x) * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(-1.0, -1.0, 1.0, 1.0));
}
...
Point rotor_plane_inner_anti_product(Rotor self, Plane other) {
    return Point(vec3(self.g0.x) * other.g0 * vec3(-1.0, 1.0, 1.0) + vec3(self.g0.x, self.g0.y, self.g0.y) * other.g0.xzy * vec3(0.0, 1.0, -1.0));
}
...
Point rotor_plane_right_anti_contraction(Rotor self, Plane other) {
    return Point(vec3(self.g0.x) * other.g0 * vec3(-1.0, 1.0, 1.0));
}
...
Plane point_scalar_geometric_anti_product(Point self, Scalar other) {
    return Plane(self.g0 * vec3(other.g0) * vec3(-1.0, 1.0, 1.0));
}
...
AntiScalar point_multi_vector_anti_scalar_product(Point self, MultiVector other) {
    return AntiScalar(0.0 - self.g0.x * other.g0.y + self.g0.y * other.g1.z + self.g0.z * other.g1.w);
}
...
MotorDual point_rotor_inner_anti_product(Point self, Rotor other) {
    return MotorDual(vec4(self.g0.x, self.g0.x, self.g0.y, self.g0.z) * vec4(other.g0.y, other.g0.x, other.g0.x, other.g0.x) * vec4(-1.0, -1.0, 1.0, 1.0));
}
...
Point plane_scalar_geometric_anti_product(Plane self, Scalar other) {
    return Point(self.g0 * vec3(other.g0) * vec3(-1.0, 1.0, 1.0));
}
...
Point plane_rotor_inner_anti_product(Plane self, Rotor other) {
    return Point(vec3(self.g0.z) * vec3(other.g0.y, other.g0.y, other.g0.x) * vec3(0.0, -1.0, 1.0) + self.g0.xyy * vec3(other.g0.x, other.g0.x, other.g0.y) * vec3(-1.0, 1.0, 1.0));
}
...
Point plane_rotor_left_anti_contraction(Plane self, Rotor other) {
    return Point(self.g0 * vec3(other.g0.x) * vec3(-1.0, 1.0, 1.0));
}
...
Motor plane_motor_geometric_anti_product(Plane self, Motor other) {
    return Motor(vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, 1.0) + vec4(self.g0.y) * other.g0.zwxy + vec4(self.g0.z) * other.g0.wzyx * vec4(1.0, -1.0, -1.0, 1.0));
}

Point plane_motor_inner_anti_product(Plane self, Motor other) {
    return Point(vec3(self.g0.x) * vec3(other.g0.x, other.g0.w, other.g0.z) * vec3(-1.0, -1.0, 1.0) + vec3(self.g0.y) * vec3(other.g0.w, other.g0.x, other.g0.y) + vec3(self.g0.z) * vec3(other.g0.z, other.g0.y, other.g0.x) * vec3(-1.0, -1.0, 1.0));
}
...
MotorDual plane_motor_dual_geometric_anti_product(Plane self, MotorDual other) {
    return MotorDual(vec4(self.g0.x) * other.g0.yxwz * vec4(-1.0, 1.0, -1.0, 1.0) + vec4(self.g0.y) * other.g0.zwxy * vec4(1.0, -1.0, 1.0, -1.0) + vec4(self.g0.z) * other.g0.wzyx);
}
...
AntiScalar translator_multi_vector_anti_scalar_product(Translator self, MultiVector other) {
    return AntiScalar(self.g0.x * other.g0.x + self.g0.y * other.g1.z + self.g0.z * other.g1.w);
}
...
MotorDual translator_point_inner_anti_product(Translator self, Point other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.z) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g0.y, self.g0.x, self.g0.x, self.g0.x) * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.z) * vec4(1.0, -1.0, 1.0, 1.0));
}
...
Point translator_plane_inner_anti_product(Translator self, Plane other) {
    return Point(vec3(self.g0.x) * other.g0 * vec3(-1.0, 1.0, 1.0) + vec3(self.g0.z) * other.g0.yxy * vec3(-1.0, 1.0, 0.0) + self.g0.yxy * other.g0.zxx * vec3(1.0, 0.0, -1.0));
}
...
AntiScalar translator_motor_anti_scalar_product(Translator self, Motor other) {
    return AntiScalar(self.g0.x * other.g0.x + self.g0.y * other.g0.z + self.g0.z * other.g0.w);
}
...
AntiScalar motor_multi_vector_anti_scalar_product(Motor self, MultiVector other) {
    return AntiScalar(self.g0.x * other.g0.x - self.g0.y * other.g0.y + self.g0.z * other.g1.z + self.g0.w * other.g1.w);
}
...
Point motor_plane_inner_anti_product(Motor self, Plane other) {
    return Point(vec3(self.g0.x) * other.g0 * vec3(-1.0, 1.0, 1.0) + vec3(self.g0.z) * other.g0.zzx * vec3(1.0, 0.0, -1.0) + vec3(self.g0.w) * other.g0.yxy * vec3(-1.0, 1.0, 0.0) + vec3(self.g0.x, self.g0.y, self.g0.y) * other.g0.xzy * vec3(0.0, 1.0, -1.0));
}
...
AntiScalar motor_translator_anti_scalar_product(Motor self, Translator other) {
    return AntiScalar(self.g0.x * other.g0.x + self.g0.z * other.g0.y + self.g0.w * other.g0.z);
}
...
Motor motor_dual_rotor_geometric_anti_product(MotorDual self, Rotor other) {
    return Motor(vec4(self.g0.y) * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.y) * vec4(1.0, -1.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4(0.0, 0.0, -1.0, 1.0) + self.g0.xxzz * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.y));
}

Motor motor_dual_rotor_inner_anti_product(MotorDual self, Rotor other) {
    return Motor(vec4(self.g0.y) * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4(0.0, 0.0, -1.0, 1.0) + self.g0.xxzz * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.y));
}
...
Motor motor_dual_motor_geometric_anti_product(MotorDual self, Motor other) {
    return Motor(vec4(self.g0.x) * other.g0 + vec4(self.g0.y) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, 1.0) + vec4(self.g0.z) * other.g0.zwxy + vec4(self.g0.w) * other.g0.wzyx * vec4(1.0, -1.0, -1.0, 1.0));
}
...
MotorDual motor_dual_motor_dual_geometric_anti_product(MotorDual self, MotorDual other) {
    return MotorDual(vec4(self.g0.x) * other.g0 + vec4(self.g0.y) * other.g0.yxwz * vec4(-1.0, 1.0, -1.0, 1.0) + vec4(self.g0.z) * other.g0.zwxy * vec4(1.0, -1.0, 1.0, -1.0) + vec4(self.g0.w) * other.g0.wzyx);
}
