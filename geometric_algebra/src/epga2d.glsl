...
MultiVector scalar_multi_vector_geometric_anti_product(Scalar self, MultiVector other) {
    return MultiVector(vec4(self.g0) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0), vec4(self.g0) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0));
}
...
Point scalar_plane_geometric_anti_product(Scalar self, Plane other) {
    return Point(vec3(0.0) - vec3(self.g0) * other.g0);
}
...
MotorDual scalar_motor_geometric_anti_product(Scalar self, Motor other) {
    return MotorDual(vec4(self.g0) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0));
}

MotorDual scalar_motor_inner_anti_product(Scalar self, Motor other) {
    return MotorDual(vec4(self.g0) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual scalar_motor_right_anti_contraction(Scalar self, Motor other) {
    return MotorDual(vec4(self.g0) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
Motor scalar_motor_dual_geometric_anti_product(Scalar self, MotorDual other) {
    return Motor(vec4(self.g0) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0));
}

Motor scalar_motor_dual_inner_anti_product(Scalar self, MotorDual other) {
    return Motor(vec4(self.g0) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0));
}
...
Motor scalar_motor_dual_right_anti_contraction(Scalar self, MotorDual other) {
    return Motor(vec4(self.g0) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0));
}
...
Scalar anti_scalar_multi_vector_left_contraction(AntiScalar self, MultiVector other) {
    return Scalar(0.0 - self.g0 * other.g1.y);
}
...
Plane anti_scalar_point_geometric_product(AntiScalar self, Point other) {
    return Plane(vec3(0.0) - vec3(self.g0) * other.g0);
}
...
MotorDual anti_scalar_motor_geometric_product(AntiScalar self, Motor other) {
    return MotorDual(vec4(self.g0) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0));
}
...
MotorDual anti_scalar_motor_inner_product(AntiScalar self, Motor other) {
    return MotorDual(vec4(self.g0) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0));
}
...
MotorDual anti_scalar_motor_right_contraction(AntiScalar self, Motor other) {
    return MotorDual(vec4(self.g0) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0));
}
...
Motor anti_scalar_motor_dual_geometric_product(AntiScalar self, MotorDual other) {
    return Motor(vec4(self.g0) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
Motor anti_scalar_motor_dual_inner_product(AntiScalar self, MotorDual other) {
    return Motor(vec4(self.g0) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
Scalar anti_scalar_motor_dual_left_contraction(AntiScalar self, MotorDual other) {
    return Scalar(0.0 - self.g0 * other.g0.x);
}

Motor anti_scalar_motor_dual_right_contraction(AntiScalar self, MotorDual other) {
    return Motor(vec4(self.g0) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
Scalar anti_scalar_motor_dual_scalar_product(AntiScalar self, MotorDual other) {
    return Scalar(0.0 - self.g0 * other.g0.x);
}
...
MultiVector multi_vector_scalar_geometric_anti_product(MultiVector self, Scalar other) {
    return MultiVector(self.g1.yxwz * vec4(other.g0) * vec4(1.0, -1.0, 1.0, 1.0), self.g0.yxwz * vec4(other.g0) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
Scalar multi_vector_anti_scalar_right_contraction(MultiVector self, AntiScalar other) {
    return Scalar(0.0 - self.g1.y * other.g0);
}
...
MultiVector multi_vector_rotor_geometric_anti_product(MultiVector self, Rotor other) {
    return MultiVector(vec4(self.g1.y) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(1.0, 1.0, 0.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.x, other.g0.x, other.g0.x, other.g0.y) * vec4(0.0, 0.0, 1.0, -1.0) + self.g1.xxzz * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.x) * vec4(1.0, -1.0, 1.0, 1.0), vec4(self.g0.y) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(1.0, 1.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.x, other.g0.x, other.g0.x, other.g0.y) * vec4(0.0, 0.0, -1.0, -1.0) + self.g0.xxzz * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.x) * vec4(1.0, -1.0, 1.0, -1.0));
}

MultiVector multi_vector_rotor_inner_anti_product(MultiVector self, Rotor other) {
    return MultiVector(vec4(self.g1.y) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(1.0, 1.0, 0.0, 0.0) + self.g1.xxwz * vec4(other.g0.x) * vec4(0.0, -1.0, 1.0, 1.0), vec4(self.g0.y) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(1.0, 1.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.x, other.g0.x, other.g0.x, other.g0.y) * vec4(0.0, 0.0, -1.0, -1.0) + self.g0.xxzz * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.x) * vec4(1.0, -1.0, 1.0, -1.0));
}
...
MultiVector multi_vector_rotor_left_anti_contraction(MultiVector self, Rotor other) {
    return MultiVector(vec4(self.g1.y) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(1.0, 1.0, 0.0, 0.0) + self.g1.xxwz * vec4(other.g0.x) * vec4(0.0, -1.0, 1.0, 1.0), vec4(self.g0.y) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(1.0, 1.0, 0.0, 0.0) + self.g0.xxwz * vec4(other.g0.x) * vec4(0.0, -1.0, -1.0, -1.0));
}
...
AntiScalar multi_vector_point_anti_scalar_product(MultiVector self, Point other) {
    return AntiScalar(self.g0.y * other.g0.x + self.g1.z * other.g0.y + self.g1.w * other.g0.z);
}
...
Scalar multi_vector_ideal_point_scalar_product(MultiVector self, IdealPoint other) {
    return Scalar(0.0 - self.g1.z * other.g0.x - self.g1.w * other.g0.y);
}
...
MultiVector multi_vector_plane_geometric_anti_product(MultiVector self, Plane other) {
    return MultiVector(vec4(self.g1.x) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.z) * vec4(0.0, 0.0, 1.0, -1.0) + vec4(self.g1.y) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.y) * vec4(0.0, 0.0, 1.0, 1.0) + vec4(self.g1.z) * vec4(other.g0.y, other.g0.z, other.g0.y, other.g0.y) * vec4(1.0, 1.0, 0.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.z, other.g0.y, other.g0.z, other.g0.z) * vec4(1.0, -1.0, 0.0, 0.0) + self.g0.yxwz * vec4(other.g0.x) * vec4(1.0, -1.0, -1.0, 1.0), vec4(self.g0.y) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.y) * vec4(0.0, 0.0, -1.0, 1.0) + vec4(self.g0.w) * vec4(other.g0.z, other.g0.y, other.g0.z, other.g0.z) * vec4(1.0, -1.0, 0.0, 0.0) + vec4(self.g1.x) * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0) + vec4(self.g1.y) * vec4(other.g0.x) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g1.z) * vec4(other.g0.x) * vec4(0.0, 0.0, 0.0, -1.0) + vec4(self.g1.w) * vec4(other.g0.x) * vec4(0.0, 0.0, 1.0, 0.0) + self.g0.zzxx * vec4(other.g0.y, other.g0.z, other.g0.y, other.g0.z) * vec4(-1.0));
}
...
AntiScalar multi_vector_plane_anti_scalar_product(MultiVector self, Plane other) {
    return AntiScalar(0.0 - self.g0.z * other.g0.z - self.g0.w * other.g0.y - self.g1.x * other.g0.x);
}
...
MultiVector multi_vector_translator_geometric_anti_product(MultiVector self, Translator other) {
    return MultiVector(vec4(self.g0.y) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.z) * vec4(0.0, 0.0, -1.0, 1.0) + vec4(self.g0.w) * vec4(other.g0.y, other.g0.z, other.g0.y, other.g0.y) * vec4(1.0, 1.0, 0.0, 0.0) + vec4(self.g1.x) * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0) + vec4(self.g1.y) * vec4(other.g0.x) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g1.z) * vec4(other.g0.x) * vec4(0.0, 0.0, 0.0, 1.0) + vec4(self.g1.w) * vec4(other.g0.x) * vec4(0.0, 0.0, 1.0, 0.0) + self.g0.zzxx * vec4(other.g0.z, other.g0.y, other.g0.z, other.g0.y) * vec4(1.0, -1.0, 1.0, 1.0), vec4(self.g1.x) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.y) * vec4(0.0, 0.0, -1.0, 1.0) + vec4(self.g1.y) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.z) * vec4(0.0, 0.0, 1.0, 1.0) + vec4(self.g1.z) * vec4(other.g0.z, other.g0.y, other.g0.z, other.g0.z) * vec4(-1.0, 1.0, 0.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.y, other.g0.z, other.g0.y, other.g0.y) * vec4(1.0, 1.0, 0.0, 0.0) + self.g0.yxwz * vec4(other.g0.x) * vec4(1.0, -1.0, -1.0, -1.0));
}

MultiVector multi_vector_translator_inner_anti_product(MultiVector self, Translator other) {
    return MultiVector(vec4(self.g0.w) * vec4(other.g0.z) * vec4(0.0, 1.0, 0.0, 0.0) + vec4(self.g1.x) * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0) + vec4(self.g1.z) * vec4(other.g0.x) * vec4(0.0, 0.0, 0.0, 1.0) + vec4(self.g1.w) * vec4(other.g0.x) * vec4(0.0, 0.0, 1.0, 0.0) + vec4(self.g1.y, self.g0.z, self.g0.x, self.g0.x) * vec4(other.g0.x, other.g0.y, other.g0.z, other.g0.y) * vec4(1.0, -1.0, 1.0, 1.0), vec4(self.g1.x) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.y) * vec4(0.0, 0.0, -1.0, 1.0) + vec4(self.g1.y) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.z) * vec4(0.0, 0.0, 1.0, 1.0) + vec4(self.g1.z) * vec4(other.g0.y) * vec4(0.0, 1.0, 0.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.z) * vec4(0.0, 1.0, 0.0, 0.0) + self.g0.yxwz * vec4(other.g0.x) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
MultiVector multi_vector_translator_left_anti_contraction(MultiVector self, Translator other) {
    return MultiVector(self.g1.yxwz * vec4(other.g0.x) * vec4(1.0, -1.0, 1.0, 1.0), vec4(self.g1.y) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.z) * vec4(0.0, 0.0, 1.0, 1.0) + vec4(self.g1.z) * vec4(other.g0.y) * vec4(0.0, 1.0, 0.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.z) * vec4(0.0, 1.0, 0.0, 0.0) + self.g0.yxwz * vec4(other.g0.x) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
AntiScalar multi_vector_translator_anti_scalar_product(MultiVector self, Translator other) {
    return AntiScalar(0.0 - self.g0.x * other.g0.x + self.g1.z * other.g0.y + self.g1.w * other.g0.z);
}
...
MultiVector multi_vector_motor_left_anti_contraction(MultiVector self, Motor other) {
    return MultiVector(vec4(self.g1.y) * other.g0.xyxx * vec4(1.0, 1.0, 0.0, 0.0) + self.g1.xxwz * vec4(other.g0.x) * vec4(0.0, -1.0, 1.0, 1.0), vec4(self.g0.y) * other.g0.xyxx * vec4(1.0, 1.0, 0.0, 0.0) + vec4(self.g1.y) * other.g0.zzzw * vec4(0.0, 0.0, 1.0, 1.0) + vec4(self.g1.z) * vec4(other.g0.z) * vec4(0.0, 1.0, 0.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.w) * vec4(0.0, 1.0, 0.0, 0.0) + self.g0.xxwz * vec4(other.g0.x) * vec4(0.0, -1.0, -1.0, -1.0));
}
...
AntiScalar multi_vector_motor_anti_scalar_product(MultiVector self, Motor other) {
    return AntiScalar(0.0 - self.g0.x * other.g0.x + self.g0.y * other.g0.y + self.g1.z * other.g0.z + self.g1.w * other.g0.w);
}
...
MultiVector multi_vector_motor_dual_right_anti_contraction(MultiVector self, MotorDual other) {
    return MultiVector(vec4(self.g0.y) * vec4(other.g0.x) * vec4(0.0, 1.0, 0.0, 0.0) + self.g0.xxzw * other.g0.xyxx * vec4(1.0, -1.0, 1.0, 1.0), vec4(self.g0.w) * vec4(other.g0.z) * vec4(0.0, -1.0, 0.0, 0.0) + vec4(self.g1.x) * other.g0.xyxx * vec4(1.0, -1.0, 0.0, 0.0) + vec4(self.g1.y) * vec4(other.g0.x) * vec4(0.0, 1.0, 0.0, 0.0) + vec4(self.g1.z) * vec4(other.g0.x) * vec4(0.0, 0.0, 1.0, 0.0) + vec4(self.g1.w) * vec4(other.g0.x) * vec4(0.0, 0.0, 0.0, 1.0) + self.g0.xzxx * other.g0.xwzw * vec4(0.0, -1.0, -1.0, -1.0));
}
...
AntiScalar multi_vector_motor_dual_anti_scalar_product(MultiVector self, MotorDual other) {
    return AntiScalar(0.0 - self.g0.z * other.g0.w - self.g0.w * other.g0.z - self.g1.x * other.g0.y + self.g1.y * other.g0.x);
}
...
MultiVector rotor_multi_vector_geometric_anti_product(Rotor self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.y) * other.g1 * vec4(1.0, 1.0, -1.0, 1.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.y) * other.g0 * vec4(1.0, 1.0, -1.0, 1.0));
}

MultiVector rotor_multi_vector_inner_anti_product(Rotor self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.x, self.g0.y, self.g0.x, self.g0.x) * other.g1.xyxx * vec4(0.0, 1.0, 0.0, 0.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.y) * other.g0 * vec4(1.0, 1.0, -1.0, 1.0));
}
...
MultiVector rotor_multi_vector_right_anti_contraction(Rotor self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.x, self.g0.y, self.g0.x, self.g0.x) * other.g1.xyxx * vec4(0.0, 1.0, 0.0, 0.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.x, self.g0.y, self.g0.x, self.g0.x) * other.g0.xyxx * vec4(0.0, 1.0, 0.0, 0.0));
}
...
MotorDual rotor_point_geometric_anti_product(Rotor self, Point other) {
...
MotorDual rotor_point_inner_anti_product(Rotor self, Point other) {
...
AntiScalar rotor_point_left_anti_contraction(Rotor self, Point other) {
    return AntiScalar(self.g0.y * other.g0.x);
}

MotorDual rotor_point_right_anti_contraction(Rotor self, Point other) {
    return MotorDual(vec4(self.g0.y, self.g0.x, self.g0.x, self.g0.x) * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z));
}
...
AntiScalar rotor_point_anti_scalar_product(Rotor self, Point other) {
    return AntiScalar(self.g0.y * other.g0.x);
}
...
Motor rotor_plane_geometric_anti_product(Rotor self, Plane other) {
    return Motor(vec4(self.g0.y) * vec4(other.g0.x, other.g0.x, other.g0.z, other.g0.y) * vec4(1.0, 0.0, -1.0, 1.0) + vec4(self.g0.x) * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(0.0, -1.0, -1.0, -1.0));
}

Point rotor_plane_inner_anti_product(Rotor self, Plane other) {
    return Point(vec3(0.0) - vec3(self.g0.x) * other.g0 + vec3(self.g0.x, self.g0.y, self.g0.y) * other.g0.xzy * vec3(0.0, -1.0, 1.0));
}
...
IdealPoint rotor_plane_left_anti_contraction(Rotor self, Plane other) {
    return IdealPoint(vec2(self.g0.y) * vec2(other.g0.z, other.g0.y) * vec2(-1.0, 1.0));
}

Point rotor_plane_right_anti_contraction(Rotor self, Plane other) {
    return Point(vec3(0.0) - vec3(self.g0.x) * other.g0);
}
...
MotorDual rotor_translator_geometric_anti_product(Rotor self, Translator other) {
    return MotorDual(vec4(self.g0.y) * vec4(other.g0.x, other.g0.x, other.g0.z, other.g0.y) * vec4(0.0, 1.0, 1.0, -1.0) + vec4(self.g0.x) * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(-1.0, 0.0, 1.0, 1.0));
}

MotorDual rotor_translator_inner_anti_product(Rotor self, Translator other) {
    return MotorDual(vec4(self.g0.x, self.g0.y, self.g0.x, self.g0.x) * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual rotor_motor_geometric_anti_product(Rotor self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.y) * other.g0.yxwz * vec4(1.0, 1.0, 1.0, -1.0));
}

MotorDual rotor_motor_inner_anti_product(Rotor self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.y, self.g0.y, self.g0.x, self.g0.x) * other.g0.yxxx * vec4(1.0, 1.0, 0.0, 0.0));
}
...
MotorDual rotor_motor_right_anti_contraction(Rotor self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.y, self.g0.x, self.g0.x, self.g0.x) * other.g0.yxxx * vec4(1.0, 0.0, 0.0, 0.0));
}
...
Motor rotor_motor_dual_geometric_anti_product(Rotor self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.y) * other.g0.yxwz * vec4(1.0, 1.0, -1.0, 1.0));
}

Motor rotor_motor_dual_inner_anti_product(Rotor self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.x, self.g0.y, self.g0.y, self.g0.y) * other.g0.xxwz * vec4(0.0, 1.0, -1.0, 1.0));
}
...
IdealPoint rotor_motor_dual_left_anti_contraction(Rotor self, MotorDual other) {
    return IdealPoint(vec2(self.g0.y) * vec2(other.g0.w, other.g0.z) * vec2(-1.0, 1.0));
}

Motor rotor_motor_dual_right_anti_contraction(Rotor self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.x, self.g0.y, self.g0.x, self.g0.x) * vec4(other.g0.x) * vec4(0.0, 1.0, 0.0, 0.0));
}
...
Plane point_anti_scalar_geometric_product(Point self, AntiScalar other) {
    return Plane(self.g0 * vec3(other.g0) * vec3(-1.0));
}
...
MultiVector point_multi_vector_geometric_anti_product(Point self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1 * vec4(1.0, 1.0, -1.0, 1.0) + vec4(self.g0.y) * other.g0.wzyx + vec4(self.g0.z) * other.g0.zwxy * vec4(1.0, -1.0, 1.0, -1.0), vec4(self.g0.x) * other.g0 * vec4(1.0, 1.0, -1.0, 1.0) + vec4(self.g0.y) * other.g1.wzyx * vec4(-1.0, 1.0, 1.0, -1.0) + vec4(self.g0.z) * other.g1.zwxy);
}
...
AntiScalar point_multi_vector_anti_scalar_product(Point self, MultiVector other) {
    return AntiScalar(self.g0.x * other.g0.y + self.g0.y * other.g1.z + self.g0.z * other.g1.w);
}
...
MotorDual point_rotor_geometric_anti_product(Point self, Rotor other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4(0.0, 0.0, -1.0, 1.0) + vec4(self.g0.x, self.g0.x, self.g0.y, self.g0.y) * vec4(other.g0.y, other.g0.x, other.g0.x, other.g0.y));
}

MotorDual point_rotor_inner_anti_product(Point self, Rotor other) {
...
MotorDual point_rotor_left_anti_contraction(Point self, Rotor other) {
    return MotorDual(vec4(self.g0.x, self.g0.x, self.g0.y, self.g0.z) * vec4(other.g0.y, other.g0.x, other.g0.x, other.g0.x));
}

AntiScalar point_rotor_right_anti_contraction(Point self, Rotor other) {
    return AntiScalar(self.g0.x * other.g0.y);
}
...
AntiScalar point_rotor_anti_scalar_product(Point self, Rotor other) {
    return AntiScalar(self.g0.x * other.g0.y);
}
...
Scalar point_ideal_point_inner_product(Point self, IdealPoint other) {
    return Scalar(0.0 - self.g0.y * other.g0.x - self.g0.z * other.g0.y);
}
...
MotorDual point_translator_inner_anti_product(Point self, Translator other) {
...
Scalar point_translator_left_contraction(Point self, Translator other) {
    return Scalar(0.0 - self.g0.y * other.g0.y - self.g0.z * other.g0.z);
}
...
MotorDual point_translator_left_anti_contraction(Point self, Translator other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.x) * vec4(1.0, 0.0, 0.0, 1.0) + vec4(self.g0.y, self.g0.x, self.g0.y, self.g0.x) * vec4(other.g0.y, other.g0.x, other.g0.x, other.g0.x) * vec4(1.0, 1.0, 1.0, 0.0));
}
...
MotorDual point_motor_inner_anti_product(Point self, Motor other) {
...
MotorDual point_motor_left_anti_contraction(Point self, Motor other) {
    return MotorDual(vec4(self.g0.y) * other.g0.zzxz * vec4(1.0, 0.0, 1.0, 0.0) + vec4(self.g0.z) * other.g0.wwwx * vec4(1.0, 0.0, 0.0, 1.0) + vec4(self.g0.x) * other.g0.yxxx * vec4(1.0, 1.0, 0.0, 0.0));
}
...
Point point_motor_dual_inner_anti_product(Point self, MotorDual other) {
    return Point(vec3(self.g0.x) * vec3(other.g0.x, other.g0.w, other.g0.z) * vec3(1.0, -1.0, 1.0) + vec3(self.g0.y) * vec3(other.g0.w, other.g0.x, other.g0.y) * vec3(1.0, 1.0, -1.0) + vec3(self.g0.z) * vec3(other.g0.z, other.g0.y, other.g0.x) * vec3(-1.0, 1.0, 1.0));
}

Plane point_motor_dual_left_contraction(Point self, MotorDual other) {
    return Plane(self.g0 * vec3(other.g0.x) * vec3(-1.0));
}
...
Scalar ideal_point_multi_vector_scalar_product(IdealPoint self, MultiVector other) {
    return Scalar(0.0 - self.g0.x * other.g1.z - self.g0.y * other.g1.w);
}
...
Scalar ideal_point_point_inner_product(IdealPoint self, Point other) {
    return Scalar(0.0 - self.g0.x * other.g0.y - self.g0.y * other.g0.z);
}
...
Scalar ideal_point_ideal_point_inner_product(IdealPoint self, IdealPoint other) {
    return Scalar(0.0 - self.g0.x * other.g0.x - self.g0.y * other.g0.y);
}
...
Scalar ideal_point_motor_left_contraction(IdealPoint self, Motor other) {
    return Scalar(0.0 - self.g0.x * other.g0.z - self.g0.y * other.g0.w);
}
...
Plane ideal_point_motor_dual_inner_product(IdealPoint self, MotorDual other) {
    return Plane(vec3(self.g0.x) * vec3(other.g0.w, other.g0.x, other.g0.y) * vec3(1.0, -1.0, -1.0) + vec3(self.g0.y) * vec3(other.g0.z, other.g0.y, other.g0.x) * vec3(-1.0, 1.0, -1.0));
}
...
Point plane_scalar_geometric_anti_product(Plane self, Scalar other) {
    return Point(self.g0 * vec3(other.g0) * vec3(-1.0));
}
...
Scalar plane_multi_vector_scalar_product(Plane self, MultiVector other) {
    return Scalar(self.g0.x * other.g1.x + self.g0.y * other.g0.w + self.g0.z * other.g0.z);
}

AntiScalar plane_multi_vector_anti_scalar_product(Plane self, MultiVector other) {
    return AntiScalar(0.0 - self.g0.x * other.g1.x - self.g0.y * other.g0.w - self.g0.z * other.g0.z);
}
...
Motor plane_rotor_geometric_anti_product(Plane self, Rotor other) {
    return Motor(vec4(self.g0.z) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4(0.0, 0.0, 1.0, -1.0) + vec4(self.g0.x, self.g0.x, self.g0.y, self.g0.y) * vec4(other.g0.y, other.g0.x, other.g0.x, other.g0.y) * vec4(1.0, -1.0, -1.0, -1.0));
}

Point plane_rotor_inner_anti_product(Plane self, Rotor other) {
    return Point(vec3(self.g0.z) * vec3(other.g0.y, other.g0.y, other.g0.x) * vec3(0.0, 1.0, -1.0) + self.g0.xyy * vec3(other.g0.x, other.g0.x, other.g0.y) * vec3(-1.0));
}
...
Point plane_rotor_left_anti_contraction(Plane self, Rotor other) {
    return Point(self.g0 * vec3(other.g0.x) * vec3(-1.0));
}

IdealPoint plane_rotor_right_anti_contraction(Plane self, Rotor other) {
    return IdealPoint(vec2(self.g0.z, self.g0.y) * vec2(other.g0.y) * vec2(1.0, -1.0));
}
...
MotorDual plane_plane_geometric_anti_product(Plane self, Plane other) {
    return MotorDual(vec4(self.g0.y) * vec4(other.g0.y, other.g0.z, other.g0.y, other.g0.x) * vec4(-1.0, 1.0, 0.0, -1.0) + vec4(self.g0.z) * vec4(other.g0.z, other.g0.y, other.g0.x, other.g0.z) * vec4(-1.0, -1.0, 1.0, 0.0) + vec4(self.g0.x) * vec4(other.g0.x, other.g0.x, other.g0.z, other.g0.y) * vec4(-1.0, 0.0, -1.0, 1.0));
}
...
Point plane_translator_inner_anti_product(Plane self, Translator other) {
    return Point(vec3(self.g0.x) * other.g0.xzy * vec3(-1.0, -1.0, 1.0) + vec3(self.g0.z) * other.g0.yyx * vec3(-1.0, 0.0, -1.0) + self.g0.yyx * other.g0.zxx * vec3(1.0, -1.0, 0.0));
}
...
MultiVector translator_multi_vector_geometric_anti_product(Translator self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.y) * other.g0.wzyx + vec4(self.g0.z) * other.g0.zwxy * vec4(1.0, -1.0, 1.0, -1.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.y) * other.g1.wzyx * vec4(-1.0, 1.0, 1.0, -1.0) + vec4(self.g0.z) * other.g1.zwxy);
}

MultiVector translator_multi_vector_inner_anti_product(Translator self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.z) * other.g0.wwxw * vec4(0.0, -1.0, 1.0, 0.0) + vec4(self.g0.x, self.g0.y, self.g0.x, self.g0.y) * other.g0.xzxx * vec4(0.0, 1.0, 0.0, 1.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.z) * other.g1.wwxy * vec4(0.0, 1.0, 1.0, 1.0) + vec4(self.g0.x, self.g0.y, self.g0.y, self.g0.y) * other.g1.xzyx * vec4(0.0, 1.0, 1.0, -1.0));
}
...
MultiVector translator_multi_vector_right_anti_contraction(Translator self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.z) * other.g1.wwwy * vec4(0.0, 1.0, 0.0, 1.0) + vec4(self.g0.x, self.g0.y, self.g0.y, self.g0.x) * other.g1.xzyx * vec4(0.0, 1.0, 1.0, 0.0));
}
...
AntiScalar translator_multi_vector_anti_scalar_product(Translator self, MultiVector other) {
    return AntiScalar(0.0 - self.g0.x * other.g0.x + self.g0.y * other.g1.z + self.g0.z * other.g1.w);
}
...
MotorDual translator_rotor_geometric_anti_product(Translator self, Rotor other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4(0.0, 0.0, -1.0, 1.0) + vec4(self.g0.x, self.g0.x, self.g0.y, self.g0.y) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.y) * vec4(-1.0, 1.0, 1.0, 1.0));
}

MotorDual translator_rotor_inner_anti_product(Translator self, Rotor other) {
    return MotorDual(vec4(self.g0.x, self.g0.x, self.g0.y, self.g0.z) * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
Motor translator_point_inner_product(Translator self, Point other) {
    return Motor(vec4(self.g0.z) * vec4(other.g0.z) * vec4(-1.0, 0.0, 0.0, 0.0) + vec4(self.g0.y, self.g0.x, self.g0.x, self.g0.x) * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.z) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual translator_point_inner_anti_product(Translator self, Point other) {
...
MotorDual translator_point_right_anti_contraction(Translator self, Point other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.z) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g0.y, self.g0.x, self.g0.x, self.g0.x) * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.z));
}
...
Translator translator_ideal_point_inner_product(Translator self, IdealPoint other) {
    return Translator(vec3(self.g0.z) * vec3(other.g0.y) * vec3(-1.0, 0.0, 0.0) + self.g0.yxx * vec3(other.g0.x, other.g0.x, other.g0.y) * vec3(-1.0, 1.0, 1.0));
}
...
Point translator_plane_inner_anti_product(Translator self, Plane other) {
    return Point(vec3(0.0) - vec3(self.g0.x) * other.g0 + vec3(self.g0.z) * other.g0.yxy * vec3(-1.0, 1.0, 0.0) + self.g0.yxy * other.g0.zxx * vec3(1.0, 0.0, -1.0));
}
...
MotorDual translator_translator_geometric_anti_product(Translator self, Translator other) {
    return MotorDual(vec4(self.g0.y) * vec4(other.g0.y, other.g0.z, other.g0.x, other.g0.y) * vec4(1.0, -1.0, 1.0, 0.0) + vec4(self.g0.z) * vec4(other.g0.z, other.g0.y, other.g0.z, other.g0.x) * vec4(1.0, 1.0, 0.0, 1.0) + vec4(self.g0.x) * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(-1.0, 0.0, 1.0, 1.0));
}
...
Motor translator_motor_geometric_product(Translator self, Motor other) {
    return Motor(vec4(self.g0.x) * other.g0 + vec4(self.g0.y) * other.g0.zwxy * vec4(-1.0, 1.0, 1.0, -1.0) + vec4(self.g0.z) * other.g0.wzyx * vec4(-1.0, -1.0, 1.0, 1.0));
}
...
MotorDual translator_motor_geometric_anti_product(Translator self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.y) * other.g0.zwxy * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.z) * other.g0.wzyx * vec4(1.0, 1.0, -1.0, 1.0));
}

MotorDual translator_motor_inner_anti_product(Translator self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.z) * other.g0.wwwx * vec4(1.0, 0.0, 0.0, 1.0) + vec4(self.g0.y, self.g0.x, self.g0.y, self.g0.x) * other.g0.zxxx * vec4(1.0, 0.0, 1.0, 0.0));
}
...
MotorDual translator_motor_right_anti_contraction(Translator self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.z) * vec4(other.g0.w) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g0.y, self.g0.x, self.g0.x, self.g0.x) * other.g0.zxxx * vec4(1.0, 0.0, 0.0, 0.0));
}
...
AntiScalar translator_motor_anti_scalar_product(Translator self, Motor other) {
    return AntiScalar(0.0 - self.g0.x * other.g0.x + self.g0.y * other.g0.z + self.g0.z * other.g0.w);
}

MotorDual translator_motor_dual_geometric_product(Translator self, MotorDual other) {
    return MotorDual(vec4(self.g0.x) * other.g0 + vec4(self.g0.y) * other.g0.zwxy * vec4(1.0, 1.0, -1.0, -1.0) + vec4(self.g0.z) * other.g0.wzyx * vec4(1.0, -1.0, 1.0, -1.0));
}
...
Motor translator_motor_dual_geometric_anti_product(Translator self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.y) * other.g0.zwxy * vec4(1.0, 1.0, 1.0, -1.0) + vec4(self.g0.z) * other.g0.wzyx * vec4(1.0, -1.0, 1.0, 1.0));
}

Motor translator_motor_dual_inner_anti_product(Translator self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.z) * other.g0.zzyx * vec4(0.0, -1.0, 1.0, 1.0) + vec4(self.g0.x, self.g0.y, self.g0.y, self.g0.y) * other.g0.xwxy * vec4(0.0, 1.0, 1.0, -1.0));
}
...
Motor translator_motor_dual_right_anti_contraction(Translator self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.x, self.g0.x, self.g0.y, self.g0.z) * vec4(other.g0.x) * vec4(0.0, 0.0, 1.0, 1.0));
}
...
MotorDual motor_scalar_geometric_anti_product(Motor self, Scalar other) {
    return MotorDual(self.g0 * vec4(other.g0) * vec4(-1.0, 1.0, 1.0, 1.0));
}

MotorDual motor_scalar_inner_anti_product(Motor self, Scalar other) {
    return MotorDual(self.g0 * vec4(other.g0) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual motor_scalar_left_anti_contraction(Motor self, Scalar other) {
    return MotorDual(self.g0 * vec4(other.g0) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual motor_anti_scalar_geometric_product(Motor self, AntiScalar other) {
    return MotorDual(self.g0 * vec4(other.g0) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
MotorDual motor_anti_scalar_inner_product(Motor self, AntiScalar other) {
    return MotorDual(self.g0 * vec4(other.g0) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
MotorDual motor_anti_scalar_left_contraction(Motor self, AntiScalar other) {
    return MotorDual(self.g0 * vec4(other.g0) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
MultiVector motor_multi_vector_geometric_anti_product(Motor self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.y) * other.g1 * vec4(1.0, 1.0, -1.0, 1.0) + vec4(self.g0.z) * other.g0.wzyx + vec4(self.g0.w) * other.g0.zwxy * vec4(1.0, -1.0, 1.0, -1.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.y) * other.g0 * vec4(1.0, 1.0, -1.0, 1.0) + vec4(self.g0.z) * other.g1.wzyx * vec4(-1.0, 1.0, 1.0, -1.0) + vec4(self.g0.w) * other.g1.zwxy);
}

MultiVector motor_multi_vector_inner_anti_product(Motor self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + vec4(self.g0.z) * other.g0.zzzx * vec4(0.0, 1.0, 0.0, 1.0) + vec4(self.g0.w) * other.g0.wwxw * vec4(0.0, -1.0, 1.0, 0.0) + self.g0.xyxx * other.g1.xyxx * vec4(0.0, 1.0, 0.0, 0.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.y) * other.g0 * vec4(1.0, 1.0, -1.0, 1.0) + vec4(self.g0.w) * other.g1.wwxy * vec4(0.0, 1.0, 1.0, 1.0) + self.g0.xzzz * other.g1.xzyx * vec4(0.0, 1.0, 1.0, -1.0));
}
...
MultiVector motor_multi_vector_right_anti_contraction(Motor self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g1.yxwz * vec4(1.0, -1.0, 1.0, 1.0) + self.g0.xyxx * other.g1.xyxx * vec4(0.0, 1.0, 0.0, 0.0), vec4(self.g0.x) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.z) * other.g1.zzyz * vec4(0.0, 1.0, 1.0, 0.0) + vec4(self.g0.w) * other.g1.wwwy * vec4(0.0, 1.0, 0.0, 1.0) + self.g0.xyxx * other.g0.xyxx * vec4(0.0, 1.0, 0.0, 0.0));
}
...
AntiScalar motor_multi_vector_anti_scalar_product(Motor self, MultiVector other) {
    return AntiScalar(0.0 - self.g0.x * other.g0.x + self.g0.y * other.g0.y + self.g0.z * other.g1.z + self.g0.w * other.g1.w);
}
...
MotorDual motor_rotor_geometric_anti_product(Motor self, Rotor other) {
...
MotorDual motor_rotor_inner_anti_product(Motor self, Rotor other) {
    return MotorDual(vec4(self.g0.y) * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.y) * vec4(1.0, 1.0, 0.0, 0.0) + self.g0.xxzw * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual motor_rotor_left_anti_contraction(Motor self, Rotor other) {
...
MotorDual motor_point_inner_anti_product(Motor self, Point other) {
...
MotorDual motor_point_right_anti_contraction(Motor self, Point other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.y) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.z) * vec4(1.0, 0.0, 0.0, 0.0) + self.g0.yxxx * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z));
}
...
Translator motor_ideal_point_inner_product(Motor self, IdealPoint other) {
    return Translator(vec3(self.g0.w) * vec3(other.g0.y) * vec3(-1.0, 0.0, 0.0) + vec3(self.g0.z, self.g0.x, self.g0.x) * vec3(other.g0.x, other.g0.x, other.g0.y) * vec3(-1.0, 1.0, 1.0));
}
...
Scalar motor_ideal_point_right_contraction(Motor self, IdealPoint other) {
    return Scalar(0.0 - self.g0.z * other.g0.x - self.g0.w * other.g0.y);
}
...
Point motor_plane_inner_anti_product(Motor self, Plane other) {
    return Point(vec3(0.0) - vec3(self.g0.x) * other.g0 + vec3(self.g0.z) * other.g0.zzx * vec3(1.0, 0.0, -1.0) + vec3(self.g0.w) * other.g0.yxy * vec3(-1.0, 1.0, 0.0) + vec3(self.g0.x, self.g0.y, self.g0.y) * other.g0.xzy * vec3(0.0, -1.0, 1.0));
}
...
MotorDual motor_translator_inner_anti_product(Motor self, Translator other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.y, other.g0.y, other.g0.x, other.g0.y) * vec4(1.0, 0.0, 1.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.z, other.g0.z, other.g0.z, other.g0.x) * vec4(1.0, 0.0, 0.0, 1.0) + self.g0.xyxx * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual motor_translator_left_anti_contraction(Motor self, Translator other) {
...
AntiScalar motor_translator_anti_scalar_product(Motor self, Translator other) {
    return AntiScalar(0.0 - self.g0.x * other.g0.x + self.g0.z * other.g0.y + self.g0.w * other.g0.z);
}
...
MotorDual motor_motor_inner_anti_product(Motor self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.z) * other.g0.zzxz * vec4(1.0, 0.0, 1.0, 0.0) + vec4(self.g0.w) * other.g0.wwwx * vec4(1.0, 0.0, 0.0, 1.0) + self.g0.yyxx * other.g0.yxxx * vec4(1.0, 1.0, 0.0, 0.0));
}
...
MotorDual motor_motor_left_anti_contraction(Motor self, Motor other) {
...
MotorDual motor_motor_right_anti_contraction(Motor self, Motor other) {
    return MotorDual(vec4(self.g0.x) * other.g0 * vec4(-1.0, 1.0, 1.0, 1.0) + vec4(self.g0.z) * vec4(other.g0.z) * vec4(1.0, 0.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.w) * vec4(1.0, 0.0, 0.0, 0.0) + self.g0.yxxx * other.g0.yxxx * vec4(1.0, 0.0, 0.0, 0.0));
}
...
MotorDual motor_motor_dual_geometric_product(Motor self, MotorDual other) {
    return MotorDual(vec4(self.g0.x) * other.g0 + vec4(self.g0.y) * other.g0.yxwz * vec4(1.0, -1.0, -1.0, 1.0) + vec4(self.g0.z) * other.g0.zwxy * vec4(1.0, 1.0, -1.0, -1.0) + vec4(self.g0.w) * other.g0.wzyx * vec4(1.0, -1.0, 1.0, -1.0));
}
...
Motor motor_motor_dual_inner_anti_product(Motor self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + vec4(self.g0.z) * other.g0.wwxy * vec4(0.0, 1.0, 1.0, -1.0) + vec4(self.g0.w) * other.g0.zzyx * vec4(0.0, -1.0, 1.0, 1.0) + self.g0.xyyy * other.g0.xxwz * vec4(0.0, 1.0, -1.0, 1.0));
}
...
Motor motor_motor_dual_right_anti_contraction(Motor self, MotorDual other) {
    return Motor(vec4(self.g0.x) * other.g0 * vec4(1.0, -1.0, -1.0, -1.0) + self.g0 * vec4(other.g0.x) * vec4(0.0, 1.0, 1.0, 1.0));
}
...
Motor motor_dual_scalar_geometric_anti_product(MotorDual self, Scalar other) {
    return Motor(self.g0 * vec4(other.g0) * vec4(1.0, -1.0, -1.0, -1.0));
}

Motor motor_dual_scalar_inner_anti_product(MotorDual self, Scalar other) {
    return Motor(self.g0 * vec4(other.g0) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
Motor motor_dual_scalar_left_anti_contraction(MotorDual self, Scalar other) {
    return Motor(self.g0 * vec4(other.g0) * vec4(1.0, -1.0, -1.0, -1.0));
}
...
Motor motor_dual_anti_scalar_geometric_product(MotorDual self, AntiScalar other) {
    return Motor(self.g0 * vec4(other.g0) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
Motor motor_dual_anti_scalar_inner_product(MotorDual self, AntiScalar other) {
    return Motor(self.g0 * vec4(other.g0) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
Motor motor_dual_anti_scalar_left_contraction(MotorDual self, AntiScalar other) {
    return Motor(self.g0 * vec4(other.g0) * vec4(-1.0, 1.0, 1.0, 1.0));
}

Scalar motor_dual_anti_scalar_right_contraction(MotorDual self, AntiScalar other) {
    return Scalar(0.0 - self.g0.x * other.g0);
}
...
Scalar motor_dual_anti_scalar_scalar_product(MotorDual self, AntiScalar other) {
    return Scalar(0.0 - self.g0.x * other.g0);
}
...
MultiVector motor_dual_multi_vector_inner_anti_product(MotorDual self, MultiVector other) {
    return MultiVector(vec4(self.g0.x) * other.g0 + vec4(self.g0.z) * other.g1.wwwy * vec4(0.0, 1.0, 0.0, 1.0) + vec4(self.g0.w) * other.g1.zzyz * vec4(0.0, -1.0, 1.0, 0.0) + self.g0.xyxx * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0), vec4(self.g0.x) * other.g1 + vec4(self.g0.y) * other.g1.yxwz * vec4(1.0, -1.0, -1.0, 1.0) + vec4(self.g0.w) * other.g0.zzyx * vec4(0.0, -1.0, 1.0, -1.0) + self.g0.xzzz * other.g0.xwxy * vec4(0.0, -1.0, -1.0, -1.0));
}
...
Scalar motor_dual_multi_vector_scalar_product(MotorDual self, MultiVector other) {
    return Scalar(0.0 - self.g0.x * other.g1.y + self.g0.y * other.g1.x + self.g0.z * other.g0.w + self.g0.w * other.g0.z);
}

AntiScalar motor_dual_multi_vector_anti_scalar_product(MotorDual self, MultiVector other) {
    return AntiScalar(self.g0.x * other.g1.y - self.g0.y * other.g1.x - self.g0.z * other.g0.w - self.g0.w * other.g0.z);
}
...
Motor motor_dual_rotor_geometric_anti_product(MotorDual self, Rotor other) {
    return Motor(vec4(self.g0.y) * vec4(other.g0.y, other.g0.x, other.g0.y, other.g0.y) * vec4(1.0, -1.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4(0.0, 0.0, 1.0, -1.0) + self.g0.xxzz * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.y) * vec4(1.0, 1.0, -1.0, -1.0));
}

Motor motor_dual_rotor_inner_anti_product(MotorDual self, Rotor other) {
    return Motor(vec4(self.g0.y) * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4(0.0, 0.0, 1.0, -1.0) + self.g0.xxzz * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.y) * vec4(1.0, 1.0, -1.0, -1.0));
}
...
Motor motor_dual_rotor_left_anti_contraction(MotorDual self, Rotor other) {
    return Motor(vec4(self.g0.y) * vec4(other.g0.x) * vec4(0.0, -1.0, 0.0, 0.0) + self.g0.xxzw * vec4(other.g0.x, other.g0.y, other.g0.x, other.g0.x) * vec4(1.0, 1.0, -1.0, -1.0));
}

IdealPoint motor_dual_rotor_right_anti_contraction(MotorDual self, Rotor other) {
    return IdealPoint(vec2(self.g0.w, self.g0.z) * vec2(other.g0.y) * vec2(1.0, -1.0));
}
...
Plane motor_dual_point_inner_product(MotorDual self, Point other) {
    return Plane(vec3(0.0) - vec3(self.g0.x) * other.g0 + vec3(self.g0.z) * other.g0.zzx * vec3(1.0, 0.0, -1.0) + vec3(self.g0.w) * other.g0.yxy * vec3(-1.0, 1.0, 0.0) + vec3(self.g0.x, self.g0.y, self.g0.y) * other.g0.xzy * vec3(0.0, -1.0, 1.0));
}
...
Point motor_dual_point_inner_anti_product(MotorDual self, Point other) {
    return Point(vec3(self.g0.x) * other.g0 + vec3(self.g0.z) * other.g0.zzx * vec3(1.0, 0.0, -1.0) + vec3(self.g0.w) * other.g0.yxy * vec3(-1.0, 1.0, 0.0) + vec3(self.g0.x, self.g0.y, self.g0.y) * other.g0.xzy * vec3(0.0, -1.0, 1.0));
}
...
Plane motor_dual_point_right_contraction(MotorDual self, Point other) {
    return Plane(vec3(0.0) - vec3(self.g0.x) * other.g0);
}
...
Plane motor_dual_ideal_point_inner_product(MotorDual self, IdealPoint other) {
    return Plane(vec3(self.g0.y) * vec3(other.g0.y, other.g0.y, other.g0.x) * vec3(0.0, -1.0, 1.0) + vec3(self.g0.w) * vec3(other.g0.x) * vec3(-1.0, 0.0, 0.0) + vec3(self.g0.z, self.g0.x, self.g0.x) * vec3(other.g0.y, other.g0.x, other.g0.y) * vec3(1.0, -1.0, -1.0));
}
...
MotorDual motor_dual_plane_inner_anti_product(MotorDual self, Plane other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.y) * vec4(-1.0, 0.0, 0.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.z) * vec4(-1.0, 0.0, 0.0, 0.0) + self.g0.yxxx * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(-1.0, 1.0, 1.0, 1.0));
}
...
MotorDual motor_dual_translator_right_contraction(MotorDual self, Translator other) {
    return MotorDual(vec4(self.g0.z) * vec4(other.g0.x) * vec4(0.0, 0.0, 1.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.x) * vec4(0.0, 0.0, 0.0, 1.0) + self.g0.xyxx * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(1.0, 1.0, -1.0, -1.0));
}

Motor motor_dual_translator_left_anti_contraction(MotorDual self, Translator other) {
    return Motor(vec4(self.g0.z) * vec4(other.g0.x) * vec4(0.0, 0.0, -1.0, 0.0) + vec4(self.g0.w) * vec4(other.g0.x) * vec4(0.0, 0.0, 0.0, -1.0) + self.g0.xyxx * vec4(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4(1.0, -1.0, 1.0, 1.0));
}
...
Motor motor_dual_motor_inner_anti_product(MotorDual self, Motor other) {
    return Motor(vec4(self.g0.x) * other.g0 + vec4(self.g0.z) * other.g0.wwxy * vec4(0.0, 1.0, -1.0, -1.0) + vec4(self.g0.w) * other.g0.zzyx * vec4(0.0, -1.0, 1.0, -1.0) + self.g0.xyyy * other.g0.xxwz * vec4(0.0, -1.0, -1.0, 1.0));
}
...
MotorDual motor_dual_motor_dual_inner_anti_product(MotorDual self, MotorDual other) {
    return MotorDual(vec4(self.g0.x) * other.g0 + vec4(self.g0.z) * other.g0.zzxz * vec4(-1.0, 0.0, 1.0, 0.0) + vec4(self.g0.w) * other.g0.wwwx * vec4(-1.0, 0.0, 0.0, 1.0) + self.g0.yyxx * other.g0.yxxx * vec4(-1.0, 1.0, 0.0, 0.0));
}
...
MotorDual motor_dual_attitude(MotorDual self) {
    return motor_dual_anti_scalar_regressive_product(self, AntiScalar(1.0));
}
...
MotorDual anti_scalar_motor_geometric_quotient(AntiScalar self, Motor other) {
...
Motor anti_scalar_motor_transformation(AntiScalar self, Motor other) {
    return motor_dual_anti_scalar_geometric_product(anti_scalar_motor_geometric_product(self, other), anti_scalar_reversal(self));
}

Motor anti_scalar_motor_dual_geometric_quotient(AntiScalar self, MotorDual other) {
    return anti_scalar_motor_dual_geometric_product(self, motor_dual_inverse(other));
}

MotorDual anti_scalar_motor_dual_transformation(AntiScalar self, MotorDual other) {
    return motor_anti_scalar_geometric_product(anti_scalar_motor_dual_geometric_product(self, other), anti_scalar_reversal(self));
}
...
MotorDual motor_anti_scalar_geometric_quotient(Motor self, AntiScalar other) {
...
AntiScalar motor_anti_scalar_transformation(Motor self, AntiScalar other) {
    return motor_dual_anti_scalar_into(motor_dual_motor_geometric_product(motor_anti_scalar_geometric_product(self, other), motor_reversal(self)));
}
...
Motor motor_dual_anti_scalar_geometric_quotient(MotorDual self, AntiScalar other) {
    return motor_dual_anti_scalar_geometric_product(self, anti_scalar_inverse(other));
}

AntiScalar motor_dual_anti_scalar_transformation(MotorDual self, AntiScalar other) {
    return motor_dual_anti_scalar_into(motor_motor_dual_geometric_product(motor_dual_anti_scalar_geometric_product(self, other), motor_dual_reversal(self)));
}
...
AntiScalar plane_anti_scalar_transformation(Plane self, AntiScalar other) {
    return motor_dual_anti_scalar_into(point_plane_geometric_product(plane_anti_scalar_geometric_product(self, other), plane_reversal(self)));
}
...
AntiScalar point_anti_scalar_transformation(Point self, AntiScalar other) {
    return motor_dual_anti_scalar_into(plane_point_geometric_product(point_anti_scalar_geometric_product(self, other), point_reversal(self)));
}
