...
impl RightComplement for ComplexNumber {
    type Output = ComplexNumber;

    fn right_complement(self) -> ComplexNumber {
        ComplexNumber { groups: ComplexNumberGroups { g0: swizzle!(self.group0(), 1, 0) } }
    }
}

impl LeftComplement for ComplexNumber {
    type Output = ComplexNumber;

    fn left_complement(self) -> ComplexNumber {
        ComplexNumber { groups: ComplexNumberGroups { g0: swizzle!(self.group0(), 1, 0) } }
    }
}

impl DoubleComplement for ComplexNumber {
    type Output = ComplexNumber;

    fn double_complement(self) -> ComplexNumber {
        ComplexNumber { groups: ComplexNumberGroups { g0: self.group0() } }
    }
}
