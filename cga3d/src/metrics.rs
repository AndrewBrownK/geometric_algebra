...
impl CosineAngle<Radial> for Circle {
    type Output = Scalar;

    fn cosine_angle(self, other: Radial) -> Scalar {
        self.unitize().weight_contraction(other.unitize()).bulk_norm()
    }
}
...
impl CosineAngle<Radial> for Dipole {
    type Output = Scalar;
...
impl CosineAngle<Radial> for Line {
    type Output = Scalar;
...
impl CosineAngle<Radial> for LineAtOrigin {
    type Output = Scalar;
...
impl CosineAngle<Radial> for Origin {
    type Output = Scalar;
...
impl CosineAngle<Radial> for Plane {
    type Output = Scalar;
...
impl CosineAngle<Radial> for PlaneAtOrigin {
    type Output = Scalar;
...
impl CosineAngle<Radial> for Point {
    type Output = Scalar;
...
impl CosineAngle<Radial> for Radial {
    type Output = Scalar;
...
impl CosineAngle<Radial> for Sphere {
    type Output = Scalar;
