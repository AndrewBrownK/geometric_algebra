...
impl std::ops::DivAssign<right_anti_dual> for AntiPlaneOnOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for CircleAligningOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for CircleAtOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for CircleOnOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for FlatOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for Horizon {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for LineAtInfinity {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for LineOnOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for NullCircleAtOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
...
impl std::ops::DivAssign<right_anti_dual> for NullSphereAtOrigin {
    fn div_assign(&mut self, _rhs: right_anti_dual) {
        *self = self.right_anti_dual()
    }
}
