...
impl One for AntiCircleRotorAtInfinity {
    fn one() -> Self {
        return AntiCircleRotorAtInfinity::from_groups(/* e23, e31, e12, e45 */ Simd32x4::from(0.0), /* e15, e25, e35, scalar */ Simd32x3::from(0.0).with_w(1.0));
    }
}
impl One for AntiCircleRotorOnOrigin {
    fn one() -> Self {
        return AntiCircleRotorOnOrigin::from_groups(/* e41, e42, e43, scalar */ Simd32x3::from(0.0).with_w(1.0), /* e23, e31, e12 */ Simd32x3::from(0.0));
    }
}
...
impl One for AntiMotorOnOrigin {
    fn one() -> Self {
        return AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ Simd32x3::from(0.0).with_w(1.0));
    }
}
...
impl One for AntiVersorEvenOnOrigin {
    fn one() -> Self {
        return AntiVersorEvenOnOrigin::from_groups(/* e41, e42, e43, scalar */ Simd32x3::from(0.0).with_w(1.0), /* e23, e31, e12, e1234 */ Simd32x4::from(0.0));
    }
}
