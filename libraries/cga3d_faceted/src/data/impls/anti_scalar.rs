...
impl std::ops::Add<DualNum> for AntiScalar {
    ...
    fn add(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let addition = DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([other.group0()[0], (self[e12345] + other.group0()[1])]));
        return addition;
    }
}
...
impl std::ops::Add<Infinity> for AntiScalar {
    ...
    fn add(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        let addition = DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([other[e5], self[e12345]]));
        return addition;
    }
}
...
impl std::ops::Not for AntiScalar {
    ...
    fn not(self) -> Self::Output {
        use crate::elements::*;
        let dual = Scalar::from_groups(/* scalar */ (self[e12345] * -1.0));
        return dual;
    }
}
...
impl std::ops::Sub<DualNum> for AntiScalar {
    ...
    fn sub(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let subtraction = DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([(other.group0()[0] * -1.0), (self[e12345] - other.group0()[1])]));
        return subtraction;
    }
}
...
impl std::ops::Sub<Infinity> for AntiScalar {
    ...
    fn sub(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        let subtraction = DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([(other[e5] * -1.0), self[e12345]]));
        return subtraction;
    }
}
