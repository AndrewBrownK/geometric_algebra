...
impl std::ops::Add<AntiSphereOnOrigin> for RoundPoint {
    ...
    fn add(self, other: AntiSphereOnOrigin) -> Self::Output {
        use crate::elements::*;
        return RoundPoint::from_groups(/* e1, e2, e3, e4 */ (other.group0() + self.group0()), /* e5 */ self[e2]);
    }
}
impl std::ops::AddAssign<AntiSphereOnOrigin> for RoundPoint {
    fn add_assign(&mut self, other: AntiSphereOnOrigin) {
        use crate::elements::*;
        *self = RoundPoint::from_groups(/* e1, e2, e3, e4 */ (other.group0() + self.group0()), /* e5 */ self[e2]);
    }
}
...
impl std::ops::Add<Infinity> for RoundPoint {
    ...
    fn add(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        return RoundPoint::from_groups(/* e1, e2, e3, e4 */ self.group0(), /* e5 */ (other[e5] + self[e2]));
    }
}
impl std::ops::AddAssign<Infinity> for RoundPoint {
    fn add_assign(&mut self, other: Infinity) {
        use crate::elements::*;
        *self = RoundPoint::from_groups(/* e1, e2, e3, e4 */ self.group0(), /* e5 */ (other[e5] + self[e2]));
    }
}
