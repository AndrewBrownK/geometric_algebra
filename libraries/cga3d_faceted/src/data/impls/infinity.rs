...
impl std::ops::Sub<AntiPlane> for Infinity {
    ...
    fn sub(self, other: AntiPlane) -> Self::Output {
        use crate::elements::*;
        return AntiPlane::from_groups(/* e1, e2, e3, e5 */ Simd32x4::from([other[e1] * -1.0, other[e2] * -1.0, other[e3] * -1.0, self[e5] - other[e5]]));
    }
}
impl std::ops::Sub<AntiPlaneOnOrigin> for Infinity {
    ...
    fn sub(self, other: AntiPlaneOnOrigin) -> Self::Output {
        use crate::elements::*;
        return AntiPlane::from_groups(/* e1, e2, e3, e5 */ Simd32x4::from([other[e1] * -1.0, other[e2] * -1.0, other[e3] * -1.0, self[e5]]));
    }
}
...
impl std::ops::Sub<LineAtInfinity> for Infinity {
    ...
    fn sub(self, other: LineAtInfinity) -> Self::Output {
        use crate::elements::*;
        return MotorAtInfinity::from_groups(/* e235, e315, e125, e5 */ Simd32x4::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0, self[e5]]));
    }
}
...
impl std::ops::Sub<RoundPointAtOrigin> for Infinity {
    ...
    fn sub(self, other: RoundPointAtOrigin) -> Self::Output {
        use crate::elements::*;
        return RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([other[e4] * -1.0, self[e5] - other[e5]]));
    }
}
