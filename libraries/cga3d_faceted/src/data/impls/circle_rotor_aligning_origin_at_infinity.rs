...
impl std::ops::Add<AntiDipoleInversionOrthogonalOrigin> for CircleRotorAligningOriginAtInfinity {
    ...
    fn add(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorEvenAligningOrigin::from_groups(
            ...
            Simd32x4::from([other[e423], other[e431], other[e412], self[e12345]]),
            // e415, e425, e435, e4
            (other.group1() + self.group0()).extend_to_4(other[e4]),
            // e235, e315, e125, e5
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group2().truncate_to_3().extend_to_4(other[e5]),
        );
    }
...
impl std::ops::Add<AntiScalar> for CircleRotorAligningOriginAtInfinity {
    ...
    fn add(self, other: AntiScalar) -> Self::Output {
        ...
        return CircleRotorAligningOriginAtInfinity::from_groups(
            ...
            self.group0(),
            // e235, e315, e125, e12345
            self.group1() + Simd32x3::from(0.0).extend_to_4(other[e12345]),
        );
    }
}
...
impl std::ops::Add<LineOnOrigin> for CircleRotorAligningOriginAtInfinity {
    ...
    fn add(self, other: LineOnOrigin) -> Self::Output {
        return CircleRotorAligningOriginAtInfinity::from_groups(/* e415, e425, e435 */ self.group0() + other.group0(), /* e235, e315, e125, e12345 */ self.group1());
    }
}
...
impl std::ops::Add<Motor> for CircleRotorAligningOriginAtInfinity {
    ...
    fn add(self, other: Motor) -> Self::Output {
        ...
        return Motor::from_groups(
            ...
            // e235, e315, e125, e5
            Simd32x4::from([other[e235], other[e315], other[e125], 0.0]) + self.group1().truncate_to_3().extend_to_4(other[e5]),
        );
    }
}
...
impl std::ops::Add<VersorEvenAligningOrigin> for CircleRotorAligningOriginAtInfinity {
    ...
    fn add(self, other: VersorEvenAligningOrigin) -> Self::Output {
        ...
        return VersorEvenAligningOrigin::from_groups(
            ...
            other.group0().truncate_to_3().extend_to_4(self[e12345] + other[e12345]),
            // e415, e425, e435, e4
            Simd32x4::from([other[e415], other[e425], other[e435], 0.0]) + self.group0().extend_to_4(other[e4]),
            // e235, e315, e125, e5
            Simd32x4::from([other[e235], other[e315], other[e125], 0.0]) + self.group1().truncate_to_3().extend_to_4(other[e5]),
        );
    }
...
impl std::ops::BitXor<AntiDualNum> for CircleRotorAligningOriginAtInfinity {
    type Output = CircleRotorAligningOriginAtInfinity;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //    simd3        0        1        0
...
impl std::ops::BitXorAssign<AntiDualNum> for CircleRotorAligningOriginAtInfinity {
...
impl std::ops::BitXor<DualNum> for CircleRotorAligningOriginAtInfinity {
    type Output = PlaneOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd3        0        2        0
...
impl From<LineOnOrigin> for CircleRotorAligningOriginAtInfinity {
    fn from(from_line_on_origin: LineOnOrigin) -> Self {
        return CircleRotorAligningOriginAtInfinity::from_groups(/* e415, e425, e435 */ from_line_on_origin.group0(), /* e235, e315, e125, e12345 */ Simd32x4::from(0.0));
    }
}
...
impl From<MotorOnOrigin> for CircleRotorAligningOriginAtInfinity {
    fn from(from_motor_on_origin: MotorOnOrigin) -> Self {
        ...
        return CircleRotorAligningOriginAtInfinity::from_groups(
            // e415, e425, e435
            from_motor_on_origin.group0().truncate_to_3(),
            // e235, e315, e125, e12345
...
impl std::ops::Sub<AntiDipoleInversion> for CircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            // e235, e315, e125, e5
            (self.group1().truncate_to_3() - other.group2().truncate_to_3()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e1, e2, e3, e4
...
impl std::ops::Sub<AntiDipoleInversionAtInfinity> for CircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: AntiDipoleInversionAtInfinity) -> Self::Output {
        ...
        return VersorEvenAtInfinity::from_groups(
            ...
            // e235, e315, e125, e5
            (self.group1().truncate_to_3() - other.group1()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<AntiDipoleInversionOrthogonalOrigin> for CircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorEvenAligningOrigin::from_groups(
            ...
            other.group0().truncate_to_3().extend_to_4(self[e12345]) * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]),
            // e415, e425, e435, e4
            (self.group0() - other.group1()).extend_to_4(other[e4]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e235, e315, e125, e5
            (self.group1().truncate_to_3() - other.group2().truncate_to_3()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
...
impl std::ops::Sub<AntiFlector> for CircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: AntiFlector) -> Self::Output {
        ...
        return VersorEvenAtInfinity::from_groups(
            ...
            self.group0().extend_to_4(other[e321] * -1.0),
            // e235, e315, e125, e5
            (self.group1().truncate_to_3() - other.group0().truncate_to_3()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<AntiPlane> for CircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: AntiPlane) -> Self::Output {
        ...
        return VersorEvenAtInfinity::from_groups(
            ...
            self.group0().extend_to_4(0.0),
            // e235, e315, e125, e5
            self.group1().truncate_to_3().extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<AntiScalar> for CircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: AntiScalar) -> Self::Output {
        ...
        return CircleRotorAligningOriginAtInfinity::from_groups(
            ...
            self.group0(),
            // e235, e315, e125, e12345
            self.group1() + Simd32x3::from(0.0).extend_to_4(other[e12345] * -1.0),
        );
    }
}
...
impl std::ops::Sub<Motor> for CircleRotorAligningOriginAtInfinity {
    ...
    fn sub(self, other: Motor) -> Self::Output {
        ...
        return Motor::from_groups(
            ...
            // e235, e315, e125, e5
            (self.group1().truncate_to_3() - other.group1().truncate_to_3()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl TryFrom<CircleRotorOnOrigin> for CircleRotorAligningOriginAtInfinity {
    ...
    fn try_from(circle_rotor_on_origin: CircleRotorOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(CircleRotorAligningOriginAtInfinity::from_groups(
            ...
            // e235, e315, e125, e12345
            Simd32x3::from(0.0).extend_to_4(circle_rotor_on_origin[e12345]),
        ));
    }
}
...
impl TryFrom<MysteryCircleRotor> for CircleRotorAligningOriginAtInfinity {
    ...
    fn try_from(mystery_circle_rotor: MysteryCircleRotor) -> Result<Self, Self::Error> {
        ...
        return Ok(CircleRotorAligningOriginAtInfinity::from_groups(
            ...
            // e235, e315, e125, e12345
            Simd32x3::from(0.0).extend_to_4(mystery_circle_rotor[e12345]),
        ));
    }
}
