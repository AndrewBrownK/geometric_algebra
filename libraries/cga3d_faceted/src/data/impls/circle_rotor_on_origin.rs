...
impl std::ops::Add<AntiDipoleInversionOnOrigin> for CircleRotorOnOrigin {
    ...
    fn add(self, other: AntiDipoleInversionOnOrigin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            // e423, e431, e412, e12345
            Simd32x4::from([self[e423], self[e431], self[e412], 0.0]) + other.group0().truncate_to_3().extend_to_4(self[e12345]),
            // e415, e425, e435, e321
...
impl std::ops::Add<AntiDipoleInversionOrthogonalOrigin> for CircleRotorOnOrigin {
    ...
    fn add(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorEvenAligningOrigin::from_groups(
            ...
            Simd32x4::from([self[e423], self[e431], self[e412], 0.0]) + other.group0().truncate_to_3().extend_to_4(self[e12345]),
            // e415, e425, e435, e4
            (other.group1() + self.group1()).extend_to_4(other[e4]),
            // e235, e315, e125, e5
            Simd32x4::from([other[e235], other[e315], other[e125], other[e5]]),
        );
    }
...
impl std::ops::Add<DualNum> for CircleRotorOnOrigin {
    ...
    fn add(self, other: DualNum) -> Self::Output {
        ...
        return VersorEvenOnOrigin::from_groups(
            // e423, e431, e412, e12345
            self.group0().truncate_to_3().extend_to_4(self[e12345] + other[e12345]),
            // e415, e425, e435, e4
...
impl std::ops::Add<LineOnOrigin> for CircleRotorOnOrigin {
    ...
    fn add(self, other: LineOnOrigin) -> Self::Output {
        return CircleRotorOnOrigin::from_groups(/* e423, e431, e412, e12345 */ self.group0(), /* e415, e425, e435 */ self.group1() + other.group0());
    }
}
...
impl std::ops::Add<Origin> for CircleRotorOnOrigin {
    ...
    fn add(self, other: Origin) -> Self::Output {
        use crate::elements::*;
        return VersorEvenOnOrigin::from_groups(/* e423, e431, e412, e12345 */ self.group0(), /* e415, e425, e435, e4 */ self.group1().extend_to_4(other[e4]));
    }
}
...
impl std::ops::Add<VersorEvenAligningOrigin> for CircleRotorOnOrigin {
    ...
    fn add(self, other: VersorEvenAligningOrigin) -> Self::Output {
        ...
        return VersorEvenAligningOrigin::from_groups(
            ...
            self.group0() + other.group0(),
            // e415, e425, e435, e4
            Simd32x4::from([other[e415], other[e425], other[e435], 0.0]) + self.group1().extend_to_4(other[e4]),
            // e235, e315, e125, e5
            other.group2(),
        );
    }
...
impl std::ops::Sub<AntiDipoleInversionOrthogonalOrigin> for CircleRotorOnOrigin {
    ...
    fn sub(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorEvenAligningOrigin::from_groups(
            ...
            Simd32x4::from([other[e423] * -1.0, other[e431] * -1.0, other[e412] * -1.0, 0.0]) + self.group0(),
            // e415, e425, e435, e4
            (self.group1() - other.group1()).extend_to_4(other[e4]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e235, e315, e125, e5
            other.group2().truncate_to_3().extend_to_4(other[e5]) * Simd32x4::from(-1.0),
        );
    }
...
impl TryFrom<CircleRotorAligningOriginAtInfinity> for CircleRotorOnOrigin {
    ...
    fn try_from(circle_rotor_aligning_origin_at_infinity: CircleRotorAligningOriginAtInfinity) -> Result<Self, Self::Error> {
        ...
        return Ok(CircleRotorOnOrigin::from_groups(
            // e423, e431, e412, e12345
            Simd32x3::from(0.0).extend_to_4(circle_rotor_aligning_origin_at_infinity[e12345]),
            // e415, e425, e435
...
impl TryFrom<CircleRotorAtInfinity> for CircleRotorOnOrigin {
    ...
    fn try_from(circle_rotor_at_infinity: CircleRotorAtInfinity) -> Result<Self, Self::Error> {
        ...
        return Ok(CircleRotorOnOrigin::from_groups(
            // e423, e431, e412, e12345
            Simd32x3::from(0.0).extend_to_4(circle_rotor_at_infinity[e12345]),
            // e415, e425, e435
...
impl TryFrom<Motor> for CircleRotorOnOrigin {
    ...
    fn try_from(motor: Motor) -> Result<Self, Self::Error> {
        ...
        return Ok(CircleRotorOnOrigin::from_groups(
            // e423, e431, e412, e12345
            Simd32x3::from(0.0).extend_to_4(motor[e12345]),
            // e415, e425, e435
...
impl TryFrom<VersorEvenAtInfinity> for CircleRotorOnOrigin {
    ...
    fn try_from(versor_even_at_infinity: VersorEvenAtInfinity) -> Result<Self, Self::Error> {
        ...
        return Ok(CircleRotorOnOrigin::from_groups(
            // e423, e431, e412, e12345
            Simd32x3::from(0.0).extend_to_4(versor_even_at_infinity[e12345]),
            // e415, e425, e435
