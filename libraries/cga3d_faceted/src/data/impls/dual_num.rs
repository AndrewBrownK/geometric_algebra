...
impl std::ops::Add<Infinity> for DualNum {
    ...
    fn add(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        let addition = DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([(self.group0()[0] + other[e5]), self.group0()[1]]));
        return addition;
    }
}
impl std::ops::AddAssign<Infinity> for DualNum {
...
impl std::ops::BitXor<CircleOnOrigin> for DualNum {
    type Output = PlaneOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd3        0        2        0
...
impl std::ops::BitXor<CircleRotorOnOrigin> for DualNum {
    type Output = PlaneOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd3        0        2        0
...
impl std::ops::BitXor<DipoleInversionOnOrigin> for DualNum {
    type Output = MotorOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        0        1        0
...
impl std::ops::BitXor<DipoleOnOrigin> for DualNum {
    type Output = LineOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd3        0        1        0
...
impl std::ops::BitXor<NullCircleAtOrigin> for DualNum {
    type Output = PlaneOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd3        0        2        0
...
impl std::ops::BitXor<NullDipoleAtOrigin> for DualNum {
    type Output = LineOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd3        0        1        0
...
impl std::ops::BitXor<NullDipoleInversionAtOrigin> for DualNum {
    type Output = MotorOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        0        1        0
...
impl std::ops::BitXor<NullSphereAtOrigin> for DualNum {
...
impl std::ops::BitXor<NullVersorEvenAtOrigin> for DualNum {
    type Output = FlectorOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        0        2        0
...
impl std::ops::BitXor<SphereOnOrigin> for DualNum {
    type Output = AntiScalar;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        1        0
...
impl std::ops::BitXor<VersorEvenOnOrigin> for DualNum {
    type Output = FlectorOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        0        2        0
...
impl From<Infinity> for DualNum {
    fn from(infinity: Infinity) -> Self {
        use crate::elements::*;
        return DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([infinity[e5], 0.0]));
    }
}
...
impl std::ops::Not for DualNum {
    ...
    fn not(self) -> Self::Output {
        let dual = AntiDualNum::from_groups(/* e3215, scalar */ (self.group0() * Simd32x2::from(-1.0)));
        return dual;
    }
}
...
impl std::ops::Sub<Infinity> for DualNum {
    ...
    fn sub(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        let subtraction = DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([(self.group0()[0] - other[e5]), self.group0()[1]]));
        return subtraction;
    }
}
impl std::ops::SubAssign<Infinity> for DualNum {
...
impl TryFrom<AntiDipoleInversion> for DualNum {
    ...
    fn try_from(anti_dipole_inversion: AntiDipoleInversion) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([anti_dipole_inversion[e5], 0.0])));
    }
}

impl TryFrom<AntiDipoleInversionAtInfinity> for DualNum {
    type Error = String;
    fn try_from(anti_dipole_inversion_at_infinity: AntiDipoleInversionAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiDipoleInversionAtInfinity do not fit into DualNum { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([anti_dipole_inversion_at_infinity[e5], 0.0])));
    }
}
...
impl TryFrom<AntiDipoleInversionOrthogonalOrigin> for DualNum {
    ...
    fn try_from(anti_dipole_inversion_orthogonal_origin: AntiDipoleInversionOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([anti_dipole_inversion_orthogonal_origin[e5], 0.0])));
    }
}
...
impl TryFrom<AntiFlector> for DualNum {
    ...
    fn try_from(anti_flector: AntiFlector) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([anti_flector[e5], 0.0])));
    }
}
...
impl TryFrom<AntiPlane> for DualNum {
    ...
    fn try_from(anti_plane: AntiPlane) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([anti_plane[e5], 0.0])));
    }
}
...
impl TryFrom<CircleRotorAligningOrigin> for DualNum {
    ...
    fn try_from(circle_rotor_aligning_origin: CircleRotorAligningOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([0.0, circle_rotor_aligning_origin[e12345]])));
    }
}
...
impl TryFrom<CircleRotorAligningOriginAtInfinity> for DualNum {
    ...
    fn try_from(circle_rotor_aligning_origin_at_infinity: CircleRotorAligningOriginAtInfinity) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([0.0, circle_rotor_aligning_origin_at_infinity[e12345]])));
    }
}
...
impl TryFrom<CircleRotorAtInfinity> for DualNum {
    ...
    fn try_from(circle_rotor_at_infinity: CircleRotorAtInfinity) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([0.0, circle_rotor_at_infinity[e12345]])));
    }
}
...
impl TryFrom<CircleRotorOnOrigin> for DualNum {
    ...
    fn try_from(circle_rotor_on_origin: CircleRotorOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([0.0, circle_rotor_on_origin[e12345]])));
    }
}
...
impl TryFrom<MotorAtInfinity> for DualNum {
    type Error = String;
    fn try_from(motor_at_infinity: MotorAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from MotorAtInfinity do not fit into DualNum { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([motor_at_infinity[e5], 0.0])));
    }
}
...
impl TryFrom<MotorOnOrigin> for DualNum {
    ...
    fn try_from(motor_on_origin: MotorOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([0.0, motor_on_origin[e12345]])));
    }
}
...
impl TryFrom<RoundPointAtOrigin> for DualNum {
    ...
    fn try_from(round_point_at_origin: RoundPointAtOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([round_point_at_origin[e5], 0.0])));
    }
}
...
impl TryFrom<VersorEvenAtOrigin> for DualNum {
    ...
    fn try_from(versor_even_at_origin: VersorEvenAtOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([versor_even_at_origin[e5], 0.0])));
    }
}
...
impl TryFrom<VersorEvenOnOrigin> for DualNum {
    ...
    fn try_from(versor_even_on_origin: VersorEvenOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([0.0, versor_even_on_origin[e12345]])));
    }
}
...
impl TryFrom<VersorEvenOrthogonalOrigin> for DualNum {
    ...
    fn try_from(versor_even_orthogonal_origin: VersorEvenOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(DualNum::from_groups(/* e5, e12345 */ Simd32x2::from([versor_even_orthogonal_origin[e5], 0.0])));
    }
}
