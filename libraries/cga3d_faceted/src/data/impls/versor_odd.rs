...
impl std::ops::Add<MultiVector> for VersorOdd {
    ...
    fn add(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            other[e5],
            // e41, e42, e43, e45
            other.group3() + self.group0().truncate_to_3().extend_to_4(self[e45]),
            // e15, e25, e35
...
impl From<AntiCircleRotorAtInfinity> for VersorOdd {
    fn from(from_anti_circle_rotor_at_infinity: AntiCircleRotorAtInfinity) -> Self {
        ...
        return VersorOdd::from_groups(
            // e41, e42, e43, scalar
            Simd32x3::from(0.0).extend_to_4(from_anti_circle_rotor_at_infinity[scalar]),
            // e23, e31, e12, e45
...
impl From<MysteryVersorOdd> for VersorOdd {
    fn from(from_mystery_versor_odd: MysteryVersorOdd) -> Self {
        ...
        return VersorOdd::from_groups(
            // e41, e42, e43, scalar
            Simd32x3::from(0.0).extend_to_4(from_mystery_versor_odd[scalar]),
            // e23, e31, e12, e45
...
impl From<VersorOddAtInfinity> for VersorOdd {
    fn from(from_versor_odd_at_infinity: VersorOddAtInfinity) -> Self {
        ...
        return VersorOdd::from_groups(
            // e41, e42, e43, scalar
            Simd32x3::from(0.0).extend_to_4(from_versor_odd_at_infinity[scalar]),
            // e23, e31, e12, e45
...
impl From<VersorOddOrthogonalOrigin> for VersorOdd {
    fn from(from_versor_odd_orthogonal_origin: VersorOddOrthogonalOrigin) -> Self {
        ...
        return VersorOdd::from_groups(
            ...
            // e4235, e4315, e4125, e3215
            Simd32x3::from(0.0).extend_to_4(from_versor_odd_orthogonal_origin[e3215]),
        );
    }
}
...
impl std::ops::Sub<MultiVector> for VersorOdd {
    ...
    fn sub(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            other[e5] * -1.0,
            // e41, e42, e43, e45
            self.group0().truncate_to_3().extend_to_4(self[e45]) - other.group3(),
            // e15, e25, e35
