...
impl std::ops::Add<AntiDipoleInversionOnOrigin> for VersorEven {
    ...
    fn add(self, other: AntiDipoleInversionOnOrigin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group2(),
            // e1, e2, e3, e4
            self.group3() + crate::swizzle!(other.group1(), 1, 2, 3, 0),
        );
    }
}
...
impl std::ops::Add<AntiDipoleInversionOrthogonalOrigin> for VersorEven {
    ...
    fn add(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group2() + other.group2().truncate_to_3().extend_to_4(other[e5]),
            // e1, e2, e3, e4
            self.group3().truncate_to_3().extend_to_4(other[e4] + self[e4]),
        );
    }
}
...
impl std::ops::Add<Origin> for VersorEven {
    ...
    fn add(self, other: Origin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group2(),
            // e1, e2, e3, e4
            self.group3() + Simd32x3::from(0.0).extend_to_4(other[e4]),
        );
    }
}
...
impl From<CircleRotorAtInfinity> for VersorEven {
    fn from(from_circle_rotor_at_infinity: CircleRotorAtInfinity) -> Self {
        ...
        return VersorEven::from_groups(
            // e423, e431, e412, e12345
            Simd32x3::from(0.0).extend_to_4(from_circle_rotor_at_infinity[e12345]),
            // e415, e425, e435, e321
...
impl From<MysteryVersorEven> for VersorEven {
    fn from(from_mystery_versor_even: MysteryVersorEven) -> Self {
        ...
        return VersorEven::from_groups(
            // e423, e431, e412, e12345
            Simd32x3::from(0.0).extend_to_4(from_mystery_versor_even[e12345]),
            // e415, e425, e435, e321
...
impl From<VersorEvenAtInfinity> for VersorEven {
    fn from(from_versor_even_at_infinity: VersorEvenAtInfinity) -> Self {
        ...
        return VersorEven::from_groups(
            // e423, e431, e412, e12345
            Simd32x3::from(0.0).extend_to_4(from_versor_even_at_infinity[e12345]),
            // e415, e425, e435, e321
...
impl std::ops::Sub<AntiDipoleInversionOrthogonalOrigin> for VersorEven {
    ...
    fn sub(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group2() - other.group2().truncate_to_3().extend_to_4(other[e5]),
            // e1, e2, e3, e4
            self.group3() + Simd32x3::from(0.0).extend_to_4(other[e4] * -1.0),
        );
    }
}
