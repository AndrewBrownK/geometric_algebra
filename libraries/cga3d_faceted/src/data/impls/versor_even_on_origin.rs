...
impl std::ops::Add<AntiDipoleInversionOnOrigin> for VersorEvenOnOrigin {
    ...
    fn add(self, other: AntiDipoleInversionOnOrigin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            // e415, e425, e435, e321
            self.group1().xyz().with_w(other[e321]),
            // e235, e315, e125, e5
            Simd32x4::from(0.0),
            // e1, e2, e3, e4
...
impl std::ops::Add<MultiVector> for VersorEvenOnOrigin {
    ...
    fn add(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            other.group5(),
            // e415, e425, e435, e321
            other.group6() + self.group1().xyz().with_w(0.0),
            // e423, e431, e412
...
impl TryFrom<AntiDipoleInversionOrthogonalOrigin> for VersorEvenOnOrigin {
    ...
    fn try_from(anti_dipole_inversion_orthogonal_origin: AntiDipoleInversionOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(VersorEvenOnOrigin::from_groups(
            ...
            // e415, e425, e435, e4
            anti_dipole_inversion_orthogonal_origin.group1().with_w(anti_dipole_inversion_orthogonal_origin[e4]),
        ));
    }
}
