...
impl From<Origin> for AntiSphereOnOrigin {
    fn from(from_origin: Origin) -> Self {
        use crate::elements::*;
        return AntiSphereOnOrigin::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from([0.0, 0.0, 0.0, from_origin[e4]]));
    }
}
...
impl TryFrom<DualNum> for AntiSphereOnOrigin {
    ...
    fn try_from(dual_num: DualNum) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiSphereOnOrigin::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from([0.0, 0.0, 0.0, dual_num[e4]])));
    }
}
