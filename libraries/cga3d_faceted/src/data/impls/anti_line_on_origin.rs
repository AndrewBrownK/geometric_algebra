...
impl std::ops::Add<AntiLineOnOrigin> for AntiLineOnOrigin {
    ...
    fn add(self, other: AntiLineOnOrigin) -> Self::Output {
        use crate::elements::*;
        return AntiLineOnOrigin::from_groups(/* e23, e31, e12 */ Simd32x3::from([other[e23] + self[e23], other[e31] + self[e31], other[e12] + self[e12]]));
    }
}
impl std::ops::AddAssign<AntiLineOnOrigin> for AntiLineOnOrigin {
    fn add_assign(&mut self, other: AntiLineOnOrigin) {
        use crate::elements::*;
        *self = AntiLineOnOrigin::from_groups(/* e23, e31, e12 */ Simd32x3::from([other[e23] + self[e23], other[e31] + self[e31], other[e12] + self[e12]]));
    }
}
...
impl std::ops::Add<FlatOrigin> for AntiLineOnOrigin {
    ...
    fn add(self, other: FlatOrigin) -> Self::Output {
        use crate::elements::*;
        return MysteryDipole::from_groups(/* e23, e31, e12, e45 */ crate::swizzle!(self.group0(), 0, 1, 2).extend_to_4(other[e45]));
    }
}
...
impl std::ops::Add<Scalar> for AntiLineOnOrigin {
    ...
    fn add(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        return AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ crate::swizzle!(self.group0(), 0, 1, 2).extend_to_4(other[scalar]));
    }
}
...
impl std::ops::Sub<AntiLineOnOrigin> for AntiLineOnOrigin {
    ...
    fn sub(self, other: AntiLineOnOrigin) -> Self::Output {
        use crate::elements::*;
        return AntiLineOnOrigin::from_groups(/* e23, e31, e12 */ Simd32x3::from([self[e23] - other[e23], self[e31] - other[e31], self[e12] - other[e12]]));
    }
}
impl std::ops::SubAssign<AntiLineOnOrigin> for AntiLineOnOrigin {
    fn sub_assign(&mut self, other: AntiLineOnOrigin) {
        use crate::elements::*;
        *self = AntiLineOnOrigin::from_groups(/* e23, e31, e12 */ Simd32x3::from([self[e23] - other[e23], self[e31] - other[e31], self[e12] - other[e12]]));
    }
}
impl std::ops::Sub<AntiMotor> for AntiLineOnOrigin {
    ...
    fn sub(self, other: AntiMotor) -> Self::Output {
        ...
        return AntiMotor::from_groups(
            // e23, e31, e12, scalar
            Simd32x4::from([self[e23] - other[e23], self[e31] - other[e31], self[e12] - other[e12], other[scalar]]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e15, e25, e35, e3215
            other.group1() * Simd32x4::from(-1.0),
        );
    }
...
impl std::ops::Sub<FlatOrigin> for AntiLineOnOrigin {
    ...
    fn sub(self, other: FlatOrigin) -> Self::Output {
        use crate::elements::*;
        return MysteryDipole::from_groups(/* e23, e31, e12, e45 */ crate::swizzle!(self.group0(), 0, 1, 2).extend_to_4((other[e45] * -1.0)));
    }
}
...
impl std::ops::Sub<Scalar> for AntiLineOnOrigin {
    ...
    fn sub(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        return AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ crate::swizzle!(self.group0(), 0, 1, 2).extend_to_4((other[scalar] * -1.0)));
    }
}
