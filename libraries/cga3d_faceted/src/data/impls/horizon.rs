...
impl std::ops::Add<AntiCircleRotorAligningOriginAtInfinity> for Horizon {
    ...
    fn add(self, other: AntiCircleRotorAligningOriginAtInfinity) -> Self::Output {
        ...
        return AntiMotor::from_groups(
            ...
            crate::swizzle!(other.group0(), 0, 1, 2).extend_to_4(other[scalar]),
            // e15, e25, e35, e3215
            Simd32x4::from([other[e15], other[e25], other[e35], self[e3215]]),
        );
    }
}
...
impl std::ops::Add<AntiMotor> for Horizon {
    ...
    fn add(self, other: AntiMotor) -> Self::Output {
        ...
        return AntiMotor::from_groups(
            ...
            other.group0(),
            // e15, e25, e35, e3215
            Simd32x4::from([other[e15], other[e25], other[e35], other[e3215] + self[e3215]]),
        );
    }
}
...
impl std::ops::Add<FlatPointAtInfinity> for Horizon {
    ...
    fn add(self, other: FlatPointAtInfinity) -> Self::Output {
        use crate::elements::*;
        return FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ crate::swizzle!(other.group0(), 0, 1, 2).extend_to_4(self[e3215]));
    }
}
...
impl std::ops::Add<FlectorAtInfinity> for Horizon {
    ...
    fn add(self, other: FlectorAtInfinity) -> Self::Output {
        use crate::elements::*;
        return FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ Simd32x4::from([other[e15], other[e25], other[e35], other[e3215] + self[e3215]]));
    }
}
...
impl std::ops::Add<PlaneOnOrigin> for Horizon {
    ...
    fn add(self, other: PlaneOnOrigin) -> Self::Output {
        use crate::elements::*;
        return Plane::from_groups(/* e4235, e4315, e4125, e3215 */ crate::swizzle!(other.group0(), 0, 1, 2).extend_to_4(self[e3215]));
    }
}
...
impl std::ops::Add<SphereAtOrigin> for Horizon {
    ...
    fn add(self, other: SphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([self[e3215] + other[e3215], other[e1234]]));
    }
}
...
impl std::ops::BitXor<AntiDualNum> for Horizon {
    type Output = Horizon;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        1        0
...
impl std::ops::BitXorAssign<AntiDualNum> for Horizon {
...
impl std::ops::Sub<AntiCircleRotorAligningOriginAtInfinity> for Horizon {
    ...
    fn sub(self, other: AntiCircleRotorAligningOriginAtInfinity) -> Self::Output {
        ...
        return AntiMotor::from_groups(
            ...
            // e15, e25, e35, e3215
            Simd32x4::from([other[e15] * -1.0, other[e25] * -1.0, other[e35] * -1.0, self[e3215]]),
        );
    }
}
...
impl std::ops::Sub<AntiMotor> for Horizon {
    ...
    fn sub(self, other: AntiMotor) -> Self::Output {
        ...
        return AntiMotor::from_groups(
            ...
            Simd32x4::from([other[e23], other[e31], other[e12], other[scalar]]) * Simd32x4::from(-1.0),
            // e15, e25, e35, e3215
            Simd32x4::from([other[e15] * -1.0, other[e25] * -1.0, other[e35] * -1.0, self[e3215] - other[e3215]]),
        );
    }
}
...
impl std::ops::Sub<FlatPointAtInfinity> for Horizon {
    ...
    fn sub(self, other: FlatPointAtInfinity) -> Self::Output {
        use crate::elements::*;
        return FlectorAtInfinity::from_groups(/* e15, e25, e35, e3215 */ Simd32x4::from([other[e15] * -1.0, other[e25] * -1.0, other[e35] * -1.0, self[e3215]]));
    }
}
...
impl std::ops::Sub<NullSphereAtOrigin> for Horizon {
    ...
    fn sub(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([self[e3215], other[e1234] * -1.0]));
    }
}
...
impl std::ops::Sub<SphereAtOrigin> for Horizon {
    ...
    fn sub(self, other: SphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([self[e3215] - other[e3215], other[e1234] * -1.0]));
    }
}
