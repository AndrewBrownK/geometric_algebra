...
impl std::ops::Add<AntiQuadNumAligningOrigin> for SphereAtOrigin {
...
impl std::ops::Add<AntiQuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = AntiQuadNumAligningOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        0        0
...
impl std::ops::Add<AntiQuadNumOnOrigin> for SphereAtOrigin {
    type Output = AntiQuadNumAligningOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        0        0
...
impl std::ops::Add<QuadNumAligningOrigin> for SphereAtOrigin {
    type Output = MultiVector;
...
impl std::ops::Add<QuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = MultiVector;
...
impl std::ops::Add<QuadNumOnOrigin> for SphereAtOrigin {
    type Output = MultiVector;
...
impl std::ops::Add<Scalar> for SphereAtOrigin {
    ...
    fn add(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let addition = AntiQuadNumAligningOrigin::from_groups(/* e1234, e3215, scalar */ Simd32x3::from([self.group0()[1], self.group0()[0], other[scalar]]));
        return addition;
    }
}
...
impl std::ops::BitXor<AntiQuadNumAligningOrigin> for SphereAtOrigin {
    type Output = SphereAtOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd2        0        1        0
...
impl std::ops::BitXorAssign<AntiQuadNumAligningOrigin> for SphereAtOrigin {
    fn bitxor_assign(&mut self, other: AntiQuadNumAligningOrigin) {
        *self = self.wedge(other);
    }
}
impl std::ops::BitXor<AntiQuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = SphereAtOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd2        0        1        0
...
impl std::ops::BitXorAssign<AntiQuadNumAligningOriginAtInfinity> for SphereAtOrigin {
...
impl std::ops::BitXor<AntiQuadNumOnOrigin> for SphereAtOrigin {
    type Output = SphereAtOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd2        0        1        0
...
impl std::ops::BitXorAssign<AntiQuadNumOnOrigin> for SphereAtOrigin {
...
impl std::ops::BitXor<QuadNumAligningOrigin> for SphereAtOrigin {
    type Output = AntiScalar;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        2        0
...
impl std::ops::BitXor<QuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = AntiScalar;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        1        0
...
impl std::ops::BitXor<QuadNumOnOrigin> for SphereAtOrigin {
    type Output = AntiScalar;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        1        0
...
impl std::ops::Mul<AntiQuadNumAligningOrigin> for SphereAtOrigin {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        6        0
...
impl std::ops::Mul<AntiQuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        0        4        0
...
impl std::ops::Mul<AntiQuadNumOnOrigin> for SphereAtOrigin {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        4        0
...
impl std::ops::Mul<QuadNumAligningOrigin> for SphereAtOrigin {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        6        0
...
impl std::ops::Mul<QuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        4        0
...
impl std::ops::Mul<QuadNumOnOrigin> for SphereAtOrigin {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        0        4        0
...
impl std::ops::Not for SphereAtOrigin {
    ...
    fn not(self) -> Self::Output {
        let right_dual = RoundPointAtOrigin::from_groups(/* e4, e5 */ Simd32x2::from([self.group0()[1], self.group0()[0]]));
        return right_dual;
    }
}
...
impl std::ops::Sub<AntiQuadNumAligningOrigin> for SphereAtOrigin {
    type Output = AntiQuadNumAligningOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        1        0
...
impl std::ops::Sub<AntiQuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = AntiQuadNumAligningOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        1        0
...
impl std::ops::Sub<AntiQuadNumOnOrigin> for SphereAtOrigin {
    type Output = AntiQuadNumAligningOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        1        0
...
impl std::ops::Sub<QuadNumAligningOrigin> for SphereAtOrigin {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        3        0
...
impl std::ops::Sub<QuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<QuadNumOnOrigin> for SphereAtOrigin {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<Scalar> for SphereAtOrigin {
    ...
    fn sub(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let subtraction = AntiQuadNumAligningOrigin::from_groups(/* e1234, e3215, scalar */ Simd32x3::from([self.group0()[1], self.group0()[0], (other[scalar] * -1.0)]));
        return subtraction;
    }
}
...
impl TryFrom<AntiQuadNumAligningOrigin> for SphereAtOrigin {
    type Error = String;
    fn try_from(anti_quad_num_aligning_origin: AntiQuadNumAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiQuadNumAligningOrigin do not fit into SphereAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
...
impl TryFrom<AntiQuadNumAligningOriginAtInfinity> for SphereAtOrigin {
    type Error = String;
    fn try_from(anti_quad_num_aligning_origin_at_infinity: AntiQuadNumAligningOriginAtInfinity) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiQuadNumAligningOriginAtInfinity do not fit into SphereAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(SphereAtOrigin::from_groups(
            // e3215, e1234
            Simd32x2::from([anti_quad_num_aligning_origin_at_infinity[e3215], 0.0]),
        ));
    }
}
...
impl TryFrom<AntiQuadNumOnOrigin> for SphereAtOrigin {
    type Error = String;
    fn try_from(anti_quad_num_on_origin: AntiQuadNumOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from AntiQuadNumOnOrigin do not fit into SphereAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([0.0, anti_quad_num_on_origin[e1234]])));
    }
}
