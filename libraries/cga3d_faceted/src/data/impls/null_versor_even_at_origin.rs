...
impl std::ops::Add<CircleAligningOrigin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: CircleAligningOrigin) -> Self::Output {
        ...
        return AntiDipoleInversionOrthogonalOrigin::from_groups(
            // e423, e431, e412, e5
            Simd32x4::from([other[e423] + self[e423], other[e431] + self[e431], other[e412] + self[e412], 0.0]),
            // e415, e425, e435
            other.group1(),
            // e235, e315, e125, e4
            crate::swizzle!(other.group2(), 0, 1, 2).extend_to_4(self[e4]),
...
impl std::ops::Add<CircleAtOrigin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: CircleAtOrigin) -> Self::Output {
        ...
        return VersorEvenAtOrigin::from_groups(
            // e423, e431, e412, e4
            Simd32x4::from([other[e423] + self[e423], other[e431] + self[e431], other[e412] + self[e412], self[e4]]),
            // e235, e315, e125, e5
            crate::swizzle!(other.group1(), 0, 1, 2).extend_to_4(0.0),
        );
    }
...
impl std::ops::Add<NullVersorEvenAtOrigin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: NullVersorEvenAtOrigin) -> Self::Output {
        ...
        return NullVersorEvenAtOrigin::from_groups(
            // e423, e431, e412, e4
            Simd32x4::from([other[e423] + self[e423], other[e431] + self[e431], other[e412] + self[e412], other[e4] + self[e4]]),
        );
    }
}
...
impl std::ops::Add<Origin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: Origin) -> Self::Output {
        use crate::elements::*;
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x4::from([self[e423], self[e431], self[e412], self[e4] + other[e4]]));
    }
}
impl std::ops::AddAssign<Origin> for NullVersorEvenAtOrigin {
    fn add_assign(&mut self, other: Origin) {
        use crate::elements::*;
        *self = NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x4::from([self[e423], self[e431], self[e412], self[e4] + other[e4]]));
    }
}
...
impl std::ops::Add<RoundPointAtOrigin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: RoundPointAtOrigin) -> Self::Output {
        ...
        return VersorEvenAtOrigin::from_groups(
            // e423, e431, e412, e4
            Simd32x4::from([self[e423], self[e431], self[e412], self[e4] + other[e4]]),
            // e235, e315, e125, e5
            Simd32x4::from([0.0, 0.0, 0.0, other[e5]]),
        );
    }
...
impl std::ops::Add<VersorEvenAtOrigin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: VersorEvenAtOrigin) -> Self::Output {
        ...
        return VersorEvenAtOrigin::from_groups(
            // e423, e431, e412, e4
            Simd32x4::from([self[e423] + other[e423], self[e431] + other[e431], self[e412] + other[e412], self[e4] + other[e4]]),
            // e235, e315, e125, e5
            other.group1(),
        );
    }
...
impl From<Origin> for NullVersorEvenAtOrigin {
    fn from(from_origin: Origin) -> Self {
        use crate::elements::*;
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x4::from([0.0, 0.0, 0.0, from_origin[e4]]));
    }
}
...
impl std::ops::Neg for NullVersorEvenAtOrigin {
    ...
    fn neg(self) -> Self::Output {
        use crate::elements::*;
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x4::from([self[e423], self[e431], self[e412], self[e4]]) * Simd32x4::from(-1.0));
    }
}
...
impl std::ops::Sub<AntiFlatOrigin> for NullVersorEvenAtOrigin {
    ...
    fn sub(self, other: AntiFlatOrigin) -> Self::Output {
        ...
        return AntiDipoleInversionOnOrigin::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([self[e423], self[e431], self[e412], other[e321] * -1.0]),
            // e4, e1, e2, e3
            Simd32x4::from([self[e4], 0.0, 0.0, 0.0]),
        );
    }
...
impl std::ops::Sub<CircleAligningOrigin> for NullVersorEvenAtOrigin {
    ...
    fn sub(self, other: CircleAligningOrigin) -> Self::Output {
        ...
        return AntiDipoleInversionOrthogonalOrigin::from_groups(
            // e423, e431, e412, e5
            Simd32x4::from([self[e423] - other[e423], self[e431] - other[e431], self[e412] - other[e412], 0.0]),
            // e415, e425, e435
            Simd32x3::from([other[e415], other[e425], other[e435]]) * Simd32x3::from(-1.0),
            // e235, e315, e125, e4
            Simd32x4::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0, self[e4]]),
...
impl std::ops::Sub<CircleAtOrigin> for NullVersorEvenAtOrigin {
    ...
    fn sub(self, other: CircleAtOrigin) -> Self::Output {
        ...
        return VersorEvenAtOrigin::from_groups(
            // e423, e431, e412, e4
            Simd32x4::from([self[e423] - other[e423], self[e431] - other[e431], self[e412] - other[e412], self[e4]]),
            // e235, e315, e125, e5
            Simd32x4::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0, 0.0]),
        );
    }
...
impl TryFrom<DualNum> for NullVersorEvenAtOrigin {
    ...
    fn try_from(dual_num: DualNum) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x4::from([0.0, 0.0, 0.0, dual_num[e4]])));
    }
}
