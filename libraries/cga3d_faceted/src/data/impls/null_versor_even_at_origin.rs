...
impl std::ops::Add<AntiSphereOnOrigin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: AntiSphereOnOrigin) -> Self::Output {
        ...
        return AntiDipoleInversionOnOrigin::from_groups(
            ...
            self.group0().xyz().with_w(0.0),
            // e4, e1, e2, e3
            Simd32x4::from([self[e4], 0.0, 0.0, 0.0]) + other.group0().wxyz(),
        );
    }
}
...
impl std::ops::Add<Infinity> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: Infinity) -> Self::Output {
        use crate::elements::*;
        return VersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ self.group0(), /* e235, e315, e125, e5 */ Simd32x3::from(0.0).with_w(other[e5]));
    }
}
...
impl std::ops::Add<LineAtInfinity> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: LineAtInfinity) -> Self::Output {
        return VersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ self.group0(), /* e235, e315, e125, e5 */ other.group0().with_w(0.0));
    }
}
...
impl std::ops::Add<NullCircleAtOrigin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: NullCircleAtOrigin) -> Self::Output {
        use crate::elements::*;
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ (other.group0() + self.group0().xyz()).with_w(self[e4]));
    }
}
impl std::ops::AddAssign<NullCircleAtOrigin> for NullVersorEvenAtOrigin {
    fn add_assign(&mut self, other: NullCircleAtOrigin) {
        use crate::elements::*;
        *self = NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ (other.group0() + self.group0().xyz()).with_w(self[e4]));
    }
}
...
impl std::ops::Add<Origin> for NullVersorEvenAtOrigin {
    ...
    fn add(self, other: Origin) -> Self::Output {
        use crate::elements::*;
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ self.group0() + Simd32x3::from(0.0).with_w(other[e4]));
    }
}
impl std::ops::AddAssign<Origin> for NullVersorEvenAtOrigin {
    fn add_assign(&mut self, other: Origin) {
        use crate::elements::*;
        *self = NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ self.group0() + Simd32x3::from(0.0).with_w(other[e4]));
    }
}
...
impl From<NullCircleAtOrigin> for NullVersorEvenAtOrigin {
    fn from(from_null_circle_at_origin: NullCircleAtOrigin) -> Self {
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ from_null_circle_at_origin.group0().with_w(0.0));
    }
}
...
impl From<Origin> for NullVersorEvenAtOrigin {
    fn from(from_origin: Origin) -> Self {
        use crate::elements::*;
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x3::from(0.0).with_w(from_origin[e4]));
    }
}
...
impl std::ops::Sub<AntiDipoleInversionOrthogonalOrigin> for NullVersorEvenAtOrigin {
    ...
    fn sub(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return AntiDipoleInversionOrthogonalOrigin::from_groups(
            // e423, e431, e412, e5
            (self.group0().xyz() - other.group0().xyz()).with_w(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e415, e425, e435
            other.group1() * Simd32x3::from(-1.0),
            // e235, e315, e125, e4
            other.group2().xyz().with_w(self[e4] - other[e4]) * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]),
...
impl std::ops::Sub<CircleAligningOrigin> for NullVersorEvenAtOrigin {
    ...
    fn sub(self, other: CircleAligningOrigin) -> Self::Output {
        ...
        return AntiDipoleInversionOrthogonalOrigin::from_groups(
            // e423, e431, e412, e5
            (self.group0().xyz() - other.group0()).with_w(0.0),
            // e415, e425, e435
            other.group1() * Simd32x3::from(-1.0),
            // e235, e315, e125, e4
            other.group2().with_w(self[e4]) * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]),
...
impl std::ops::Sub<Origin> for NullVersorEvenAtOrigin {
    ...
    fn sub(self, other: Origin) -> Self::Output {
        use crate::elements::*;
        return NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ self.group0() + Simd32x3::from(0.0).with_w(other[e4] * -1.0));
    }
}
impl std::ops::SubAssign<Origin> for NullVersorEvenAtOrigin {
    fn sub_assign(&mut self, other: Origin) {
        use crate::elements::*;
        *self = NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ self.group0() + Simd32x3::from(0.0).with_w(other[e4] * -1.0));
    }
}
...
impl TryFrom<AntiDipoleOnOrigin> for NullVersorEvenAtOrigin {
    ...
    fn try_from(anti_dipole_on_origin: AntiDipoleOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ anti_dipole_on_origin.group0().xyz().with_w(0.0)));
    }
}
...
impl TryFrom<Circle> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle: Circle) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle.group0().with_w(0.0)));
    }
}
...
impl TryFrom<CircleAligningOrigin> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle_aligning_origin: CircleAligningOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle_aligning_origin.group0().with_w(0.0)));
    }
}
...
impl TryFrom<CircleAtOrigin> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle_at_origin: CircleAtOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle_at_origin.group0().with_w(0.0)));
    }
}
...
impl TryFrom<CircleOnOrigin> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle_on_origin: CircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle_on_origin.group0().with_w(0.0)));
    }
}
...
impl TryFrom<CircleOrthogonalOrigin> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle_orthogonal_origin: CircleOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle_orthogonal_origin.group0().xyz().with_w(0.0)));
    }
}
...
impl TryFrom<CircleRotor> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle_rotor: CircleRotor) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle_rotor.group0().with_w(0.0)));
    }
}
...
impl TryFrom<CircleRotorAligningOrigin> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle_rotor_aligning_origin: CircleRotorAligningOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle_rotor_aligning_origin.group0().with_w(0.0)));
    }
}
...
impl TryFrom<CircleRotorOnOrigin> for NullVersorEvenAtOrigin {
    ...
    fn try_from(circle_rotor_on_origin: CircleRotorOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ circle_rotor_on_origin.group0().xyz().with_w(0.0)));
    }
}
...
impl TryFrom<DualNum> for NullVersorEvenAtOrigin {
    ...
    fn try_from(dual_num: DualNum) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x3::from(0.0).with_w(dual_num[e4])));
    }
}
...
impl TryFrom<MultiVector> for NullVersorEvenAtOrigin {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ multi_vector.group7().with_w(multi_vector[e4])));
    }
}
...
impl TryFrom<RoundPoint> for NullVersorEvenAtOrigin {
    ...
    fn try_from(round_point: RoundPoint) -> Result<Self, Self::Error> {
        ...
        return Ok(NullVersorEvenAtOrigin::from_groups(/* e423, e431, e412, e4 */ Simd32x3::from(0.0).with_w(round_point[e4])));
    }
}
