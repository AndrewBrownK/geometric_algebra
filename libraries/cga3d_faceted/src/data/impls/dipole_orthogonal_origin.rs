...
impl std::ops::Add<AntiCircleRotor> for DipoleOrthogonalOrigin {
    ...
    fn add(self, other: AntiCircleRotor) -> Self::Output {
        ...
        return AntiCircleRotor::from_groups(
            ...
            // e15, e25, e35, scalar
            Simd32x4::from([other[e15], other[e25], other[e35], 0.0]) + self.group2().extend_to_4(other[scalar]),
        );
    }
}
...
impl std::ops::Add<AntiCircleRotorOnOrigin> for DipoleOrthogonalOrigin {
    ...
    fn add(self, other: AntiCircleRotorOnOrigin) -> Self::Output {
        ...
        return AntiCircleRotorAligningOrigin::from_groups(
            ...
            other.group1() + self.group1(),
            // e15, e25, e35, scalar
            self.group2().extend_to_4(other[scalar]),
        );
    }
}
...
impl std::ops::Add<AntiDualNum> for DipoleOrthogonalOrigin {
    ...
    fn add(self, other: AntiDualNum) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            // e15, e25, e35, e1234
            self.group2().extend_to_4(other[e1234]),
        );
    }
}
...
impl std::ops::Add<AntiMotor> for DipoleOrthogonalOrigin {
    ...
    fn add(self, other: AntiMotor) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            // e15, e25, e35, e1234
            (self.group2() + other.group1().truncate_to_3()).extend_to_4(0.0),
        );
    }
}
...
impl std::ops::Add<DipoleInversion> for DipoleOrthogonalOrigin {
    ...
    fn add(self, other: DipoleInversion) -> Self::Output {
        ...
        return DipoleInversion::from_groups(
            ...
            Simd32x4::from([other[e23], other[e31], other[e12], 0.0]) + self.group1().extend_to_4(other[e45]),
            // e15, e25, e35, e1234
            Simd32x4::from([other[e15], other[e25], other[e35], 0.0]) + self.group2().extend_to_4(other[e1234]),
...
impl std::ops::Add<VersorOddAtInfinity> for DipoleOrthogonalOrigin {
    ...
    fn add(self, other: VersorOddAtInfinity) -> Self::Output {
        ...
        return VersorOdd::from_groups(
            ...
            Simd32x4::from([other[e23], other[e31], other[e12], 0.0]) + self.group1().extend_to_4(other[e45]),
            // e15, e25, e35, e1234
            (self.group2() + crate::swizzle!(other.group0(), 1, 2, 3, _)).extend_to_4(0.0),
            // e4235, e4315, e4125, e3215
            other.group2(),
        );
    }
...
impl std::ops::Sub<AntiCircleRotor> for DipoleOrthogonalOrigin {
    ...
    fn sub(self, other: AntiCircleRotor) -> Self::Output {
        ...
        return AntiCircleRotor::from_groups(
            ...
            // e15, e25, e35, scalar
            (self.group2() - other.group2().truncate_to_3()).extend_to_4(other[scalar]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<AntiCircleRotorAligningOriginAtInfinity> for DipoleOrthogonalOrigin {
    ...
    fn sub(self, other: AntiCircleRotorAligningOriginAtInfinity) -> Self::Output {
        ...
        return AntiCircleRotorAligningOrigin::from_groups(
            ...
            // e15, e25, e35, scalar
            (self.group2() - other.group1().truncate_to_3()).extend_to_4(other[scalar]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<AntiCircleRotorOnOrigin> for DipoleOrthogonalOrigin {
    ...
    fn sub(self, other: AntiCircleRotorOnOrigin) -> Self::Output {
        ...
        return AntiCircleRotorAligningOrigin::from_groups(
            ...
            self.group1() - other.group1(),
            // e15, e25, e35, scalar
            self.group2().extend_to_4(other[scalar] * -1.0),
        );
    }
}
...
impl std::ops::Sub<AntiDualNum> for DipoleOrthogonalOrigin {
    ...
    fn sub(self, other: AntiDualNum) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            self.group1().extend_to_4(0.0),
            // e15, e25, e35, e1234
            self.group2().extend_to_4(other[e1234] * -1.0),
        );
    }
}
...
impl std::ops::Sub<DipoleInversion> for DipoleOrthogonalOrigin {
    ...
    fn sub(self, other: DipoleInversion) -> Self::Output {
        ...
        return DipoleInversion::from_groups(
            ...
            (self.group1() - other.group1().truncate_to_3()).extend_to_4(other[e45]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e15, e25, e35, e1234
            (self.group2() - other.group2().truncate_to_3()).extend_to_4(other[e1234]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e4235, e4315, e4125, e3215
...
impl std::ops::Sub<DipoleInversionAligningOrigin> for DipoleOrthogonalOrigin {
    ...
    fn sub(self, other: DipoleInversionAligningOrigin) -> Self::Output {
        ...
        return DipoleInversion::from_groups(
            ...
            self.group1().extend_to_4(other[e45] * -1.0),
            // e15, e25, e35, e1234
            (self.group2() - other.group1().truncate_to_3()).extend_to_4(other[e1234]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e4235, e4315, e4125, e3215
