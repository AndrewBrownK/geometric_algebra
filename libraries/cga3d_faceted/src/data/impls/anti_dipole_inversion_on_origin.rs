...
impl std::ops::Add<DualNum> for AntiDipoleInversionOnOrigin {
    ...
    fn add(self, other: DualNum) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            Simd32x4::from(0.0),
            // e1, e2, e3, e4
            self.group1().yzw().extend_to_4(self[e4] + other[e4]),
        );
    }
}
...
impl std::ops::Add<VersorEvenAligningOrigin> for AntiDipoleInversionOnOrigin {
    ...
    fn add(self, other: VersorEvenAligningOrigin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            other.group2(),
            // e1, e2, e3, e4
            self.group1().yzwx() + Simd32x3::from(0.0).extend_to_4(other[e4]),
        );
    }
}
...
impl std::ops::Sub<AntiDipoleInversion> for AntiDipoleInversionOnOrigin {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            // e1, e2, e3, e5
            (self.group1().yzw() - other.group3().truncate_to_3()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
impl std::ops::Sub<AntiDipoleInversionAtInfinity> for AntiDipoleInversionOnOrigin {
    ...
    fn sub(self, other: AntiDipoleInversionAtInfinity) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            // e1, e2, e3, e5
            (self.group1().yzw() - other.group2().truncate_to_3()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<AntiDipoleInversionOrthogonalOrigin> for AntiDipoleInversionOnOrigin {
    ...
    fn sub(self, other: AntiDipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            other.group2().truncate_to_3().extend_to_4(self[e4] - other[e4]) * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]),
            // e1, e2, e3, e5
            self.group1().yzw().extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<DualNum> for AntiDipoleInversionOnOrigin {
    ...
    fn sub(self, other: DualNum) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            Simd32x4::from(0.0),
            // e1, e2, e3, e4
            self.group1().yzwx() + Simd32x3::from(0.0).extend_to_4(other[e4] * -1.0),
        );
    }
}
