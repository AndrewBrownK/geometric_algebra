...
impl std::ops::Add<AntiDipoleInversion> for AntiMysteryDipoleInversion {
    ...
    fn add(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            other.group2(),
            // e1, e2, e3, e5
            Simd32x4::from([other[e1], other[e2], other[e3], 0.0]) + self.group1().extend_to_4(other[e5]),
        );
    }
}
...
impl std::ops::Add<MultiVector> for AntiMysteryDipoleInversion {
    ...
    fn add(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            other.group0(),
            // e1, e2, e3, e4
            Simd32x4::from([other[e1], other[e2], other[e3], 0.0]) + self.group1().extend_to_4(other[e4]),
            // e5
            other[e5],
            // e41, e42, e43, e45
            other.group3(),
...
impl std::ops::BitXor<AntiDualNum> for AntiMysteryDipoleInversion {
    type Output = AntiMysteryDipoleInversion;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //    simd3        0        1        0
...
impl std::ops::BitXorAssign<AntiDualNum> for AntiMysteryDipoleInversion {
...
impl std::ops::BitXor<DualNum> for AntiMysteryDipoleInversion {
...
impl From<AntiFlectorOnOrigin> for AntiMysteryDipoleInversion {
    fn from(from_anti_flector_on_origin: AntiFlectorOnOrigin) -> Self {
        ...
        return AntiMysteryDipoleInversion::from_groups(
            ...
            // e1, e2, e3
            Simd32x3::from([from_anti_flector_on_origin[e1], from_anti_flector_on_origin[e2], from_anti_flector_on_origin[e3]]),
        );
    }
}
...
impl std::ops::Sub<AntiDipoleInversion> for AntiMysteryDipoleInversion {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            // e1, e2, e3, e5
            (self.group1() - other.group3().truncate_to_3()).extend_to_4(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl std::ops::Sub<MultiVector> for AntiMysteryDipoleInversion {
    ...
    fn sub(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (self.group1() - other.group1().truncate_to_3()).extend_to_4(other[e4]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e5
            other[e5] * -1.0,
            // e41, e42, e43, e45
...
impl std::ops::Sub<VersorEven> for AntiMysteryDipoleInversion {
    ...
    fn sub(self, other: VersorEven) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            other.group2() * Simd32x4::from(-1.0),
            // e1, e2, e3, e4
            (self.group1() - other.group3().truncate_to_3()).extend_to_4(other[e4]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
        );
    }
}
...
impl TryFrom<AntiDipoleInversion> for AntiMysteryDipoleInversion {
    ...
    fn try_from(anti_dipole_inversion: AntiDipoleInversion) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            // e1, e2, e3
            anti_dipole_inversion.group3().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<AntiDipoleInversionAtInfinity> for AntiMysteryDipoleInversion {
    ...
    fn try_from(anti_dipole_inversion_at_infinity: AntiDipoleInversionAtInfinity) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            // e1, e2, e3
            anti_dipole_inversion_at_infinity.group2().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<AntiFlector> for AntiMysteryDipoleInversion {
    ...
    fn try_from(anti_flector: AntiFlector) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            // e1, e2, e3
            anti_flector.group1().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<AntiPlane> for AntiMysteryDipoleInversion {
    ...
    fn try_from(anti_plane: AntiPlane) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            Simd32x4::from(0.0),
            // e1, e2, e3
            anti_plane.group0().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<AntiSphereOnOrigin> for AntiMysteryDipoleInversion {
    ...
    fn try_from(anti_sphere_on_origin: AntiSphereOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            Simd32x4::from(0.0),
            // e1, e2, e3
            anti_sphere_on_origin.group0().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<MultiVector> for AntiMysteryDipoleInversion {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            multi_vector.group6(),
            // e1, e2, e3
            multi_vector.group1().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<RoundPoint> for AntiMysteryDipoleInversion {
    ...
    fn try_from(round_point: RoundPoint) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            Simd32x4::from(0.0),
            // e1, e2, e3
            round_point.group0().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<VersorEven> for AntiMysteryDipoleInversion {
    ...
    fn try_from(versor_even: VersorEven) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            versor_even.group1(),
            // e1, e2, e3
            versor_even.group3().truncate_to_3(),
        ));
    }
}
...
impl TryFrom<VersorEvenOrthogonalOrigin> for AntiMysteryDipoleInversion {
    ...
    fn try_from(versor_even_orthogonal_origin: VersorEvenOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMysteryDipoleInversion::from_groups(
            ...
            // e1, e2, e3
            versor_even_orthogonal_origin.group2().truncate_to_3(),
        ));
    }
}
