...
impl std::ops::Add<AntiDualNum> for AntiCircleRotorOnOrigin {
    ...
    fn add(self, other: AntiDualNum) -> Self::Output {
        ...
        return AntiVersorEvenOnOrigin::from_groups(
            // e41, e42, e43, scalar
            self.group0().truncate_to_3().extend_to_4(self[scalar] + other[scalar]),
            // e23, e31, e12, e1234
...
impl std::ops::Add<AntiMotor> for AntiCircleRotorOnOrigin {
    ...
    fn add(self, other: AntiMotor) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            // e23, e31, e12, e3215
            Simd32x4::from([other[e23], other[e31], other[e12], 0.0]) + self.group1().extend_to_4(other[e3215]),
            // e15, e25, e35, e1234
...
impl std::ops::Add<AntiVersorEvenOnOrigin> for AntiCircleRotorOnOrigin {
    ...
    fn add(self, other: AntiVersorEvenOnOrigin) -> Self::Output {
        ...
        return AntiVersorEvenOnOrigin::from_groups(
            ...
            // e23, e31, e12, e1234
            Simd32x4::from([other[e23], other[e31], other[e12], 0.0]) + self.group1().extend_to_4(other[e1234]),
        );
    }
}
...
impl std::ops::Add<DipoleInversionAtOrigin> for AntiCircleRotorOnOrigin {
    ...
    fn add(self, other: DipoleInversionAtOrigin) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            Simd32x4::from([other[e41], other[e42], other[e43], 0.0]) + self.group0(),
            // e23, e31, e12, e3215
            self.group1().extend_to_4(other[e3215]),
            // e15, e25, e35, e1234
            other.group1(),
        );
    }
...
impl std::ops::Add<DipoleInversionOrthogonalOrigin> for AntiCircleRotorOnOrigin {
    ...
    fn add(self, other: DipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            Simd32x4::from([other[e41], other[e42], other[e43], 0.0]) + self.group0(),
            // e23, e31, e12, e3215
            (self.group1() + other.group1()).extend_to_4(other[e3215]),
            // e15, e25, e35, e1234
            other.group2(),
        );
    }
...
impl std::ops::Add<NullSphereAtOrigin> for AntiCircleRotorOnOrigin {
    ...
    fn add(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return AntiVersorEvenOnOrigin::from_groups(/* e41, e42, e43, scalar */ self.group0(), /* e23, e31, e12, e1234 */ self.group1().extend_to_4(other[e1234]));
    }
}
...
impl std::ops::BitXor<AntiDualNum> for AntiCircleRotorOnOrigin {
    type Output = AntiVersorEvenOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        0        2        0
...
impl std::ops::BitXor<DualNum> for AntiCircleRotorOnOrigin {
...
impl std::ops::Sub<AntiMotor> for AntiCircleRotorOnOrigin {
    ...
    fn sub(self, other: AntiMotor) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            self.group0() + Simd32x3::from(0.0).extend_to_4(other[scalar] * -1.0),
            // e23, e31, e12, e3215
            (self.group1() - other.group0().truncate_to_3()).extend_to_4(other[e3215]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e15, e25, e35, e1234
            (other.group1().truncate_to_3() * Simd32x3::from(-1.0)).extend_to_4(0.0),
        );
    }
...
impl std::ops::Sub<DipoleInversionAtOrigin> for AntiCircleRotorOnOrigin {
    ...
    fn sub(self, other: DipoleInversionAtOrigin) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            Simd32x4::from([other[e41] * -1.0, other[e42] * -1.0, other[e43] * -1.0, 0.0]) + self.group0(),
            // e23, e31, e12, e3215
            self.group1().extend_to_4(other[e3215] * -1.0),
            // e15, e25, e35, e1234
            other.group1() * Simd32x4::from(-1.0),
        );
    }
...
impl std::ops::Sub<DipoleInversionOrthogonalOrigin> for AntiCircleRotorOnOrigin {
    ...
    fn sub(self, other: DipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            Simd32x4::from([other[e41] * -1.0, other[e42] * -1.0, other[e43] * -1.0, 0.0]) + self.group0(),
            // e23, e31, e12, e3215
            (self.group1() - other.group1()).extend_to_4(other[e3215]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e15, e25, e35, e1234
            other.group2() * Simd32x4::from(-1.0),
        );
    }
...
impl std::ops::Sub<VersorOddOrthogonalOrigin> for AntiCircleRotorOnOrigin {
    ...
    fn sub(self, other: VersorOddOrthogonalOrigin) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            self.group0() - other.group0(),
            // e23, e31, e12, e3215
            (self.group1() - other.group1().truncate_to_3()).extend_to_4(other[e3215]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e15, e25, e35, e1234
            other.group2() * Simd32x4::from(-1.0),
        );
    }
