...
impl std::ops::AddAssign<AntiLineOnOrigin> for MysteryDipole {
    fn add_assign(&mut self, other: AntiLineOnOrigin) {
        *self = MysteryDipole::from_groups(/* e23, e31, e12, e45 */ Simd32x4::from([
            (other.group0()[0] + self.group0()[0]),
            (other.group0()[1] + self.group0()[1]),
            (other.group0()[2] + self.group0()[2]),
            self.group0()[3],
...
impl std::ops::Add<AntiMysteryCircleRotor> for MysteryDipole {
    ...
    fn add(self, other: AntiMysteryCircleRotor) -> Self::Output {
        use crate::elements::*;
        return AntiMysteryCircleRotor::from_groups(/* e23, e31, e12, e45 */ (other.group0() + self.group0()), /* scalar */ other[e31]);
    }
}
...
impl std::ops::Sub<AntiMysteryCircleRotor> for MysteryDipole {
    ...
    fn sub(self, other: AntiMysteryCircleRotor) -> Self::Output {
        use crate::elements::*;
        return AntiMysteryCircleRotor::from_groups(/* e23, e31, e12, e45 */ (-other.group0() + self.group0()), /* scalar */ (other[e31] * -1.0));
    }
}
