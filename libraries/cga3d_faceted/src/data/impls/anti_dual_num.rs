...
impl std::ops::Add<AntiDualNum> for AntiDualNum {
    ...
    fn add(self, other: AntiDualNum) -> Self::Output {
        let addition = AntiDualNum::from_groups(/* e1234, scalar */ (other.group0() + self.group0()));
        return addition;
    }
}
...
impl std::ops::Add<NullSphereAtOrigin> for AntiDualNum {
    ...
    fn add(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        let addition = AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([(self.group0()[0] + other[e1234]), self.group0()[1]]));
        return addition;
    }
}
...
impl std::ops::Add<Scalar> for AntiDualNum {
    ...
    fn add(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let addition = AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([self.group0()[0], (self.group0()[1] + other[scalar])]));
        return addition;
    }
}
...
impl From<NullSphereAtOrigin> for AntiDualNum {
    fn from(null_sphere_at_origin: NullSphereAtOrigin) -> Self {
        use crate::elements::*;
        return AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([null_sphere_at_origin[e1234], 0.0]));
    }
}
...
impl From<Scalar> for AntiDualNum {
    fn from(scalar: Scalar) -> Self {
        use crate::elements::*;
        return AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([0.0, scalar[scalar]]));
    }
}
...
impl std::ops::Neg for AntiDualNum {
    ...
    // no simd        0        2        0
    fn neg(self) -> Self {
        let negation = AntiDualNum::from_groups(/* e1234, scalar */ (self.group0() * Simd32x2::from(-1.0)));
        return negation;
    }
}
...
impl std::ops::Sub<AntiDualNum> for AntiDualNum {
    ...
    fn sub(self, other: AntiDualNum) -> Self::Output {
        let subtraction = AntiDualNum::from_groups(/* e1234, scalar */ (-other.group0() + self.group0()));
        return subtraction;
    }
}
...
impl std::ops::Sub<NullSphereAtOrigin> for AntiDualNum {
    ...
    fn sub(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        let subtraction = AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([(self.group0()[0] - other[e1234]), self.group0()[1]]));
        return subtraction;
    }
}
...
impl std::ops::Sub<Scalar> for AntiDualNum {
    ...
    fn sub(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let subtraction = AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([self.group0()[0], (self.group0()[1] - other[scalar])]));
        return subtraction;
    }
}
