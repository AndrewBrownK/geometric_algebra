...
impl std::ops::Add<AntiDipoleInversion> for CircleRotor {
    ...
    fn add(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            // e235, e315, e125, e5
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group2().xyz().with_w(other[e5]),
            // e1, e2, e3, e4
...
impl std::ops::Add<AntiDipoleInversionAtInfinity> for CircleRotor {
    ...
    fn add(self, other: AntiDipoleInversionAtInfinity) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            // e235, e315, e125, e5
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group1().with_w(other[e5]),
            // e1, e2, e3, e4
...
impl std::ops::Add<AntiDipoleInversionOnOrigin> for CircleRotor {
    ...
    fn add(self, other: AntiDipoleInversionOnOrigin) -> Self::Output {
        ...
        return VersorEven::from_groups(
            // e423, e431, e412, e12345
            Simd32x4::from([other[e423], other[e431], other[e412], 0.0]) + self.group0().with_w(self[e12345]),
            // e415, e425, e435, e321
...
impl std::ops::Add<AntiFlatPoint> for CircleRotor {
    ...
    fn add(self, other: AntiFlatPoint) -> Self::Output {
        ...
        return CircleRotor::from_groups(
            ...
            self.group1().xyz().with_w(other[e321] + self[e321]),
            // e235, e315, e125, e12345
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group0().xyz().with_w(self[e12345]),
        );
    }
}
...
impl std::ops::Add<AntiFlector> for CircleRotor {
    ...
    fn add(self, other: AntiFlector) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group1().xyz().with_w(other[e321] + self[e321]),
            // e235, e315, e125, e5
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group0().xyz().with_w(other[e5]),
            // e1, e2, e3, e4
            Simd32x4::from([other[e1], other[e2], other[e3], 0.0]),
        );
    }
...
impl std::ops::Add<AntiScalar> for CircleRotor {
    ...
    fn add(self, other: AntiScalar) -> Self::Output {
        ...
        return CircleRotor::from_groups(
            ...
            self.group1(),
            // e235, e315, e125, e12345
            self.group2() + Simd32x3::from(0.0).with_w(other[e12345]),
        );
    }
}
...
impl std::ops::Add<Circle> for CircleRotor {
    ...
    fn add(self, other: Circle) -> Self::Output {
        ...
        return CircleRotor::from_groups(
            ...
            other.group1() + self.group1(),
            // e235, e315, e125, e12345
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group2().with_w(self[e12345]),
        );
    }
}
...
impl std::ops::Add<CircleAtInfinity> for CircleRotor {
    ...
    fn add(self, other: CircleAtInfinity) -> Self::Output {
        ...
        return CircleRotor::from_groups(
            ...
            other.group0() + self.group1(),
            // e235, e315, e125, e12345
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group1().with_w(self[e12345]),
        );
    }
}
...
impl std::ops::Add<LineAtInfinity> for CircleRotor {
    ...
    fn add(self, other: LineAtInfinity) -> Self::Output {
        ...
        return CircleRotor::from_groups(
            ...
            self.group1(),
            // e235, e315, e125, e12345
            Simd32x4::from([self[e235], self[e315], self[e125], 0.0]) + other.group0().with_w(self[e12345]),
        );
    }
}
...
impl std::ops::Add<Motor> for CircleRotor {
    ...
    fn add(self, other: Motor) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            // e235, e315, e125, e5
            Simd32x4::from([other[e235], other[e315], other[e125], 0.0]) + self.group2().xyz().with_w(other[e5]),
            // e1, e2, e3, e4
            Simd32x4::from(0.0),
        );
    }
...
impl From<CircleRotorAligningOrigin> for CircleRotor {
    fn from(from_circle_rotor_aligning_origin: CircleRotorAligningOrigin) -> Self {
        ...
        return CircleRotor::from_groups(
            ...
            // e235, e315, e125, e12345
            from_circle_rotor_aligning_origin.group2(),
        );
    }
}
...
impl From<CircleRotorAtInfinity> for CircleRotor {
    fn from(from_circle_rotor_at_infinity: CircleRotorAtInfinity) -> Self {
        return CircleRotor::from_groups(
            ...
            // e235, e315, e125, e12345
            from_circle_rotor_at_infinity.group1(),
        );
    }
}
...
impl From<CircleRotorOnOrigin> for CircleRotor {
    fn from(from_circle_rotor_on_origin: CircleRotorOnOrigin) -> Self {
        ...
        return CircleRotor::from_groups(
            ...
            // e235, e315, e125, e12345
            Simd32x3::from(0.0).with_w(from_circle_rotor_on_origin[e12345]),
        );
    }
}
...
impl std::ops::Sub<AntiDipoleInversion> for CircleRotor {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return VersorEven::from_groups(
            // e423, e431, e412, e12345
            Simd32x4::from([other[e423] * -1.0, other[e431] * -1.0, other[e412] * -1.0, 0.0]) + self.group0().with_w(self[e12345]),
            // e415, e425, e435, e321
            self.group1() - other.group1(),
            // e235, e315, e125, e5
            (self.group2().xyz() - other.group2().xyz()).with_w(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e1, e2, e3, e4
...
impl std::ops::Sub<AntiDipoleInversionAtInfinity> for CircleRotor {
    ...
    fn sub(self, other: AntiDipoleInversionAtInfinity) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group1() - other.group0(),
            // e235, e315, e125, e5
            (self.group2().xyz() - other.group1()).with_w(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e1, e2, e3, e4
...
impl std::ops::Sub<AntiFlector> for CircleRotor {
    ...
    fn sub(self, other: AntiFlector) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group1() + Simd32x3::from(0.0).with_w(other[e321] * -1.0),
            // e235, e315, e125, e5
            (self.group2().xyz() - other.group0().xyz()).with_w(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e1, e2, e3, e4
...
impl std::ops::Sub<AntiPlane> for CircleRotor {
    ...
    fn sub(self, other: AntiPlane) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            self.group1(),
            // e235, e315, e125, e5
            self.group2().xyz().with_w(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e1, e2, e3, e4
            (other.group0().xyz() * Simd32x3::from(-1.0)).with_w(0.0),
        );
    }
...
impl std::ops::Sub<AntiScalar> for CircleRotor {
    ...
    fn sub(self, other: AntiScalar) -> Self::Output {
        ...
        return CircleRotor::from_groups(
            ...
            self.group1(),
            // e235, e315, e125, e12345
            self.group2() + Simd32x3::from(0.0).with_w(other[e12345] * -1.0),
        );
    }
}
...
impl std::ops::Sub<Motor> for CircleRotor {
    ...
    fn sub(self, other: Motor) -> Self::Output {
        ...
        return VersorEven::from_groups(
            ...
            Simd32x4::from([other[e415] * -1.0, other[e425] * -1.0, other[e435] * -1.0, 0.0]) + self.group1(),
            // e235, e315, e125, e5
            (self.group2().xyz() - other.group1().xyz()).with_w(other[e5]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e1, e2, e3, e4
            Simd32x4::from(0.0),
        );
    }
