...
impl std::ops::Add<AntiQuadNumAligningOrigin> for QuadNum {
    type Output = MultiVector;
...
impl std::ops::Add<AntiQuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = MultiVector;
...
impl std::ops::Add<AntiQuadNumOnOrigin> for QuadNum {
    type Output = MultiVector;
...
impl std::ops::Add<QuadNumAligningOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        3        0        0
...
impl std::ops::Add<QuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::AddAssign<QuadNumAligningOriginAtInfinity> for QuadNum {
...
impl std::ops::Add<QuadNumOnOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::BitXor<AntiQuadNumAligningOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        6        0
...
impl std::ops::BitXorAssign<AntiQuadNumAligningOrigin> for QuadNum {
    fn bitxor_assign(&mut self, other: AntiQuadNumAligningOrigin) {
        *self = self.wedge(other);
    }
}
impl std::ops::BitXor<AntiQuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        5        0
...
impl std::ops::BitXorAssign<AntiQuadNumAligningOriginAtInfinity> for QuadNum {
...
impl std::ops::BitXor<AntiQuadNumOnOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        5        0
...
impl std::ops::BitXorAssign<AntiQuadNumOnOrigin> for QuadNum {
...
impl std::ops::BitXor<QuadNumAligningOrigin> for QuadNum {
    type Output = AntiQuadNumOrthogonalOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        5        0
...
impl std::ops::BitXor<QuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = AntiQuadNumOrthogonalOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::BitXor<QuadNumOnOrigin> for QuadNum {
    type Output = AntiQuadNumOrthogonalOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        4        0
...
impl From<QuadNumAligningOrigin> for QuadNum {
    fn from(quad_num_aligning_origin: QuadNumAligningOrigin) -> Self {
        use crate::elements::*;
        return QuadNum::from_groups(
            // e4, e5, e321, e12345
            Simd32x4::from([quad_num_aligning_origin[e4], quad_num_aligning_origin[e5], 0.0, quad_num_aligning_origin[e12345]]),
        );
    }
}

impl From<QuadNumAligningOriginAtInfinity> for QuadNum {
    fn from(quad_num_aligning_origin_at_infinity: QuadNumAligningOriginAtInfinity) -> Self {
        use crate::elements::*;
        return QuadNum::from_groups(
            // e4, e5, e321, e12345
            Simd32x4::from([0.0, quad_num_aligning_origin_at_infinity[e5], 0.0, quad_num_aligning_origin_at_infinity[e12345]]),
        );
    }
}
...
impl From<QuadNumOnOrigin> for QuadNum {
    fn from(quad_num_on_origin: QuadNumOnOrigin) -> Self {
        use crate::elements::*;
        return QuadNum::from_groups(/* e4, e5, e321, e12345 */ Simd32x4::from([quad_num_on_origin[e4], 0.0, 0.0, quad_num_on_origin[e12345]]));
    }
}
...
impl std::ops::Mul<AntiQuadNumAligningOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        2        4        0
...
impl std::ops::MulAssign<AntiQuadNumAligningOrigin> for QuadNum {
    fn mul_assign(&mut self, other: AntiQuadNumAligningOrigin) {
        *self = self.geometric_product(other);
    }
}
impl std::ops::Mul<AntiQuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        8        0
...
impl std::ops::MulAssign<AntiQuadNumAligningOriginAtInfinity> for QuadNum {
...
impl std::ops::Mul<AntiQuadNumOnOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        8        0
...
impl std::ops::MulAssign<AntiQuadNumOnOrigin> for QuadNum {
...
impl std::ops::Mul<QuadNumAligningOrigin> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        4        8        0
...
impl std::ops::Mul<QuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        9        0
...
impl std::ops::Mul<QuadNumOnOrigin> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        9        0
...
impl std::ops::Sub<AntiQuadNumAligningOrigin> for QuadNum {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        3        0
...
impl std::ops::Sub<AntiQuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<AntiQuadNumOnOrigin> for QuadNum {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<QuadNumAligningOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        3        0        0
...
impl std::ops::Sub<QuadNumAligningOriginAtInfinity> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::SubAssign<QuadNumAligningOriginAtInfinity> for QuadNum {
...
impl std::ops::Sub<QuadNumOnOrigin> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
