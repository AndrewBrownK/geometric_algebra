...
impl std::ops::Add<AntiDipoleOnOrigin> for CircleOrthogonalOrigin {
    ...
    fn add(self, other: AntiDipoleOnOrigin) -> Self::Output {
        let addition = CircleOrthogonalOrigin::from_groups(/* e423, e431, e412, e321 */ (self.group0() + other.group0()), /* e235, e315, e125 */ self.group1());
        return addition;
    }
}
...
impl std::ops::Add<AntiQuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = MultiVector;
...
impl std::ops::Add<AntiQuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = MultiVector;
...
impl std::ops::Add<AntiQuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = MultiVector;
...
impl std::ops::Add<QuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = VersorEven;
...
impl std::ops::Add<QuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = VersorEven;
...
impl std::ops::Add<QuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = VersorEven;
...
impl std::ops::BitXor<AntiQuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = CircleOrthogonalOrigin;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //    simd3        0        1        0
...
impl std::ops::BitXorAssign<AntiQuadNumAligningOrigin> for CircleOrthogonalOrigin {
    fn bitxor_assign(&mut self, other: AntiQuadNumAligningOrigin) {
        *self = self.wedge(other);
    }
}
impl std::ops::BitXor<AntiQuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = CircleOrthogonalOrigin;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //    simd3        0        1        0
...
impl std::ops::BitXorAssign<AntiQuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
...
impl std::ops::BitXor<AntiQuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = CircleOrthogonalOrigin;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //    simd3        0        1        0
...
impl std::ops::BitXorAssign<AntiQuadNumOnOrigin> for CircleOrthogonalOrigin {
...
impl std::ops::BitXor<QuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = Sphere;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        3        9        0
...
impl std::ops::BitXor<QuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = Plane;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        0        1        0
...
impl std::ops::BitXor<QuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = SphereOnOrigin;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        0        2        0
...
impl std::ops::Mul<AntiQuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = AntiDipoleInversion;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        6       19        0
...
impl std::ops::Mul<AntiQuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = AntiDipoleInversion;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        0        3        0
...
impl std::ops::Mul<AntiQuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = AntiDipoleInversion;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        0       14        0
...
impl std::ops::Mul<QuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = DipoleInversion;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        6       18        0
...
impl std::ops::Mul<QuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = DipoleInversion;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        0        6        0
...
impl std::ops::Mul<QuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = DipoleInversion;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        0       14        0
...
impl std::ops::Not for CircleOrthogonalOrigin {
    ...
    fn not(self) -> Self::Output {
        let right_dual = DipoleAligningOrigin::from_groups(
            // e41, e42, e43, e45
...
impl std::ops::Sub<AntiDipoleOnOrigin> for CircleOrthogonalOrigin {
    ...
    fn sub(self, other: AntiDipoleOnOrigin) -> Self::Output {
        let subtraction = CircleOrthogonalOrigin::from_groups(/* e423, e431, e412, e321 */ (self.group0() - other.group0()), /* e235, e315, e125 */ self.group1());
        return subtraction;
    }
}
...
impl std::ops::Sub<AntiQuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        3        0
...
impl std::ops::Sub<AntiQuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<AntiQuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<QuadNumAligningOrigin> for CircleOrthogonalOrigin {
    type Output = VersorEven;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        3        0
...
impl std::ops::Sub<QuadNumAligningOriginAtInfinity> for CircleOrthogonalOrigin {
    type Output = VersorEven;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<QuadNumOnOrigin> for CircleOrthogonalOrigin {
    type Output = VersorEven;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
