...
impl std::ops::Add<MultiVector> for NullDipoleInversionAtOrigin {
    ...
    fn add(self, other: MultiVector) -> Self::Output {
        ...
        let addition = MultiVector::from_groups(
            ...
            other.group8(),
            // e1234, e4235, e4315, e4125
            Simd32x4::from([(self.group0()[3] + other.group9()[0]), other.group9()[1], other.group9()[2], other.group9()[3]]),
            // e3215
            other[e45],
        );
        return addition;
...
impl std::ops::Add<NullDipoleInversionAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn add(self, other: NullDipoleInversionAtOrigin) -> Self::Output {
        let addition = NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ (self.group0() + other.group0()));
        return addition;
    }
}
...
impl std::ops::Sub<NullDipoleInversionAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn sub(self, other: NullDipoleInversionAtOrigin) -> Self::Output {
        let subtraction = NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ (self.group0() - other.group0()));
        return subtraction;
    }
}
