...
impl std::ops::Add<DipoleInversionOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn add(self, other: DipoleInversionOnOrigin) -> Self::Output {
        ...
        return DipoleInversionOnOrigin::from_groups(
            ...
            other.group0() + self.group0().xyz().with_w(0.0),
            // e1234, e4235, e4315, e4125
            Simd32x4::from([self[e1234], 0.0, 0.0, 0.0]) + other.group1(),
        );
    }
}
...
impl std::ops::Add<NullDipoleAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn add(self, other: NullDipoleAtOrigin) -> Self::Output {
        use crate::elements::*;
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ (other.group0() + self.group0().xyz()).with_w(self[e1234]));
    }
}
impl std::ops::AddAssign<NullDipoleAtOrigin> for NullDipoleInversionAtOrigin {
    fn add_assign(&mut self, other: NullDipoleAtOrigin) {
        use crate::elements::*;
        *self = NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ (other.group0() + self.group0().xyz()).with_w(self[e1234]));
    }
}
impl std::ops::Add<NullDipoleInversionAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn add(self, other: NullDipoleInversionAtOrigin) -> Self::Output {
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ other.group0() + self.group0());
    }
}
impl std::ops::AddAssign<NullDipoleInversionAtOrigin> for NullDipoleInversionAtOrigin {
    fn add_assign(&mut self, other: NullDipoleInversionAtOrigin) {
        *self = NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ other.group0() + self.group0());
    }
}
impl std::ops::Add<NullSphereAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn add(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ self.group0() + Simd32x3::from(0.0).with_w(other[e1234]));
    }
}
impl std::ops::AddAssign<NullSphereAtOrigin> for NullDipoleInversionAtOrigin {
    fn add_assign(&mut self, other: NullSphereAtOrigin) {
        use crate::elements::*;
        *self = NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ self.group0() + Simd32x3::from(0.0).with_w(other[e1234]));
    }
}
...
impl std::ops::Add<SphereOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn add(self, other: SphereOnOrigin) -> Self::Output {
        ...
        return DipoleInversionOnOrigin::from_groups(
            ...
            self.group0().xyz().with_w(0.0),
            // e1234, e4235, e4315, e4125
            Simd32x4::from([self[e1234], 0.0, 0.0, 0.0]) + other.group0().wxyz(),
        );
    }
}
...
impl From<NullDipoleAtOrigin> for NullDipoleInversionAtOrigin {
    fn from(from_null_dipole_at_origin: NullDipoleAtOrigin) -> Self {
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ from_null_dipole_at_origin.group0().with_w(0.0));
    }
}
...
impl From<NullSphereAtOrigin> for NullDipoleInversionAtOrigin {
    fn from(from_null_sphere_at_origin: NullSphereAtOrigin) -> Self {
        use crate::elements::*;
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x3::from(0.0).with_w(from_null_sphere_at_origin[e1234]));
    }
}
...
impl std::ops::Sub<NullDipoleInversionAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn sub(self, other: NullDipoleInversionAtOrigin) -> Self::Output {
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ self.group0() - other.group0());
    }
}
impl std::ops::SubAssign<NullDipoleInversionAtOrigin> for NullDipoleInversionAtOrigin {
    fn sub_assign(&mut self, other: NullDipoleInversionAtOrigin) {
        *self = NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ self.group0() - other.group0());
    }
}
impl std::ops::Sub<NullSphereAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn sub(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ self.group0() + Simd32x3::from(0.0).with_w(other[e1234] * -1.0));
    }
}
impl std::ops::SubAssign<NullSphereAtOrigin> for NullDipoleInversionAtOrigin {
    fn sub_assign(&mut self, other: NullSphereAtOrigin) {
        use crate::elements::*;
        *self = NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ self.group0() + Simd32x3::from(0.0).with_w(other[e1234] * -1.0));
    }
}
...
impl TryFrom<AntiCircleOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(anti_circle_on_origin: AntiCircleOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ anti_circle_on_origin.group0().with_w(0.0)));
    }
}
...
impl TryFrom<AntiCircleRotor> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(anti_circle_rotor: AntiCircleRotor) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ anti_circle_rotor.group0().with_w(0.0)));
    }
}
...
impl TryFrom<Dipole> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole: Dipole) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole.group0().with_w(0.0)));
    }
}
...
impl TryFrom<DipoleAtOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_at_origin: DipoleAtOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole_at_origin.group0().with_w(0.0)));
    }
}
...
impl TryFrom<DipoleInversion> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_inversion: DipoleInversion) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(
            // e41, e42, e43, e1234
            dipole_inversion.group0().with_w(dipole_inversion[e1234]),
        ));
    }
}
...
impl TryFrom<DipoleOnOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_on_origin: DipoleOnOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole_on_origin.group0().xyz().with_w(0.0)));
    }
}
...
impl TryFrom<DipoleOrthogonalOrigin> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(dipole_orthogonal_origin: DipoleOrthogonalOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ dipole_orthogonal_origin.group0().with_w(0.0)));
    }
}
...
impl TryFrom<Sphere> for NullDipoleInversionAtOrigin {
    ...
    fn try_from(sphere: Sphere) -> Result<Self, Self::Error> {
        ...
        return Ok(NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x3::from(0.0).with_w(sphere[e1234])));
    }
}
