...
impl std::ops::Add<AntiDualNum> for AntiMotorOnOrigin {
    ...
    fn add(self, other: AntiDualNum) -> Self::Output {
        ...
        return AntiVersorEvenOnOrigin::from_groups(
            ...
            // e23, e31, e12, e1234
            Simd32x4::from([self[e23], self[e31], self[e12], other[e1234]]),
        );
    }
}
...
impl std::ops::Add<MysteryVersorOdd> for AntiMotorOnOrigin {
    ...
    fn add(self, other: MysteryVersorOdd) -> Self::Output {
        ...
        return MysteryVersorOdd::from_groups(
            // scalar, e4235, e4315, e4125
            Simd32x4::from([self[scalar] + other[scalar], other[e4235], other[e4315], other[e4125]]),
            // e23, e31, e12, e45
            Simd32x4::from([self[e23] + other[e23], self[e31] + other[e31], self[e12] + other[e12], other[e45]]),
        );
    }
...
impl std::ops::Add<Scalar> for AntiMotorOnOrigin {
    ...
    fn add(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        return AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ Simd32x4::from([self[e23], self[e31], self[e12], self[scalar] + other[scalar]]));
    }
}
impl std::ops::AddAssign<Scalar> for AntiMotorOnOrigin {
    fn add_assign(&mut self, other: Scalar) {
        use crate::elements::*;
        *self = AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ Simd32x4::from([self[e23], self[e31], self[e12], self[scalar] + other[scalar]]));
    }
}
...
impl std::ops::BitXor<AntiDualNum> for AntiMotorOnOrigin {
    type Output = AntiVersorEvenOnOrigin;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        5        0
...
impl std::ops::BitXor<DualNum> for AntiMotorOnOrigin {
...
impl From<Scalar> for AntiMotorOnOrigin {
    fn from(from_scalar: Scalar) -> Self {
        use crate::elements::*;
        return AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ Simd32x4::from([0.0, 0.0, 0.0, from_scalar[scalar]]));
    }
}
...
impl std::ops::Neg for AntiMotorOnOrigin {
    ...
    fn neg(self) -> Self::Output {
        use crate::elements::*;
        return AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ Simd32x4::from([self[e23], self[e31], self[e12], self[scalar]]) * Simd32x4::from(-1.0));
    }
}
...
impl std::ops::Sub<AntiCircleRotor> for AntiMotorOnOrigin {
    ...
    fn sub(self, other: AntiCircleRotor) -> Self::Output {
        ...
        return AntiCircleRotor::from_groups(
            ...
            // e23, e31, e12, e45
            Simd32x4::from([self[e23] - other[e23], self[e31] - other[e31], self[e12] - other[e12], other[e45] * -1.0]),
            // e15, e25, e35, scalar
...
impl std::ops::Sub<AntiDualNum> for AntiMotorOnOrigin {
    ...
    fn sub(self, other: AntiDualNum) -> Self::Output {
        ...
        return AntiVersorEvenOnOrigin::from_groups(
            ...
            // e23, e31, e12, e1234
            Simd32x4::from([self[e23], self[e31], self[e12], other[e1234] * -1.0]),
        );
    }
}
...
impl std::ops::Sub<AntiVersorEvenOnOrigin> for AntiMotorOnOrigin {
    ...
    fn sub(self, other: AntiVersorEvenOnOrigin) -> Self::Output {
        ...
        return AntiVersorEvenOnOrigin::from_groups(
            ...
            Simd32x4::from([other[e41] * -1.0, other[e42] * -1.0, other[e43] * -1.0, self[scalar] - other[scalar]]),
            // e23, e31, e12, e1234
            Simd32x4::from([self[e23] - other[e23], self[e31] - other[e31], self[e12] - other[e12], other[e1234] * -1.0]),
        );
    }
}
...
impl std::ops::Sub<DipoleAligningOrigin> for AntiMotorOnOrigin {
    ...
    fn sub(self, other: DipoleAligningOrigin) -> Self::Output {
        ...
        return AntiCircleRotor::from_groups(
            ...
            Simd32x3::from([other[e41], other[e42], other[e43]]) * Simd32x3::from(-1.0),
            // e23, e31, e12, e45
            Simd32x4::from([self[e23], self[e31], self[e12], other[e45] * -1.0]),
            // e15, e25, e35, scalar
            Simd32x4::from([other[e15] * -1.0, other[e25] * -1.0, other[e35] * -1.0, self[scalar]]),
        );
    }
...
impl std::ops::Sub<DipoleInversionAtOrigin> for AntiMotorOnOrigin {
    ...
    fn sub(self, other: DipoleInversionAtOrigin) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            Simd32x4::from([other[e41] * -1.0, other[e42] * -1.0, other[e43] * -1.0, self[scalar]]),
            // e23, e31, e12, e3215
            Simd32x4::from([self[e23], self[e31], self[e12], other[e3215] * -1.0]),
            // e15, e25, e35, e1234
            Simd32x4::from([other[e15], other[e25], other[e35], other[e1234]]) * Simd32x4::from(-1.0),
        );
    }
...
impl std::ops::Sub<DipoleInversionOrthogonalOrigin> for AntiMotorOnOrigin {
    ...
    fn sub(self, other: DipoleInversionOrthogonalOrigin) -> Self::Output {
        ...
        return VersorOddOrthogonalOrigin::from_groups(
            ...
            Simd32x4::from([other[e41] * -1.0, other[e42] * -1.0, other[e43] * -1.0, self[scalar]]),
            // e23, e31, e12, e3215
            Simd32x4::from([self[e23] - other[e23], self[e31] - other[e31], self[e12] - other[e12], other[e3215] * -1.0]),
            // e15, e25, e35, e1234
            Simd32x4::from([other[e15], other[e25], other[e35], other[e1234]]) * Simd32x4::from(-1.0),
        );
    }
...
impl TryFrom<AntiDualNum> for AntiMotorOnOrigin {
    ...
    fn try_from(anti_dual_num: AntiDualNum) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiMotorOnOrigin::from_groups(/* e23, e31, e12, scalar */ Simd32x4::from([0.0, 0.0, 0.0, anti_dual_num[scalar]])));
    }
}
