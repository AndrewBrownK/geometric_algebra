...
impl std::ops::Add<AntiDualNum> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: AntiDualNum) -> Self::Output {
        let addition = VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([(self.group1()[3] + other.group0()[1]), self.group1()[0], self.group1()[1], self.group1()[2]]),
            // e23, e31, e12, e45
            self.group0(),
...
impl std::ops::Add<AntiMotor> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: AntiMotor) -> Self::Output {
        let addition = VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            (swizzle!(self.group1(), 3, 0, 1, 2) + Simd32x4::from([other.group0()[3], other.group1()[0], other.group1()[1], other.group1()[2]])),
            // e23, e31, e12, e45
            Simd32x4::from([
                (self.group0()[0] + other.group0()[0]),
                (self.group0()[1] + other.group0()[1]),
...
impl std::ops::Not for AntiCircleRotorAtInfinity {
    ...
    fn not(self) -> Self::Output {
        let dual = CircleRotorAtInfinity::from_groups(
            // e415, e425, e435, e321
