...
impl std::ops::Add<AntiMotor> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: AntiMotor) -> Self::Output {
        ...
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([other[scalar], other[e15], other[e25], other[e35]]) + crate::swizzle!(self.group1(), 3, 0, 1, 2),
            // e23, e31, e12, e45
...
impl std::ops::Add<DipoleInversionAtInfinity> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: DipoleInversionAtInfinity) -> Self::Output {
        ...
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([0.0, other[e15], self[e25], self[e35]]) + crate::swizzle!(self.group1(), 3, 0, _, _).extend_to_4(other[e25], other[e35]),
            // e23, e31, e12, e45
            self.group0() + other.group0(),
            // e4235, e4315, e4125, e3215
            other.group2(),
...
impl std::ops::Add<Flector> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: Flector) -> Self::Output {
        ...
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([0.0, other[e15], other[e25], other[e35]]) + crate::swizzle!(self.group1(), 3, 0, 1, 2),
            // e23, e31, e12, e45
            self.group0() + Simd32x3::from(0.0).extend_to_4(other[e45]),
            // e4235, e4315, e4125, e3215
            other.group1(),
...
impl std::ops::Add<MysteryDipole> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: MysteryDipole) -> Self::Output {
        return AntiCircleRotorAtInfinity::from_groups(/* e23, e31, e12, e45 */ self.group0() + other.group0(), /* e15, e25, e35, scalar */ self.group1());
    }
}
impl std::ops::AddAssign<MysteryDipole> for AntiCircleRotorAtInfinity {
    fn add_assign(&mut self, other: MysteryDipole) {
        *self = AntiCircleRotorAtInfinity::from_groups(/* e23, e31, e12, e45 */ self.group0() + other.group0(), /* e15, e25, e35, scalar */ self.group1());
    }
}
...
impl std::ops::Add<MysteryVersorOdd> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: MysteryVersorOdd) -> Self::Output {
        ...
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([other[scalar], 0.0, 0.0, 0.0]) + crate::swizzle!(self.group1(), 3, 0, 1, 2),
            // e23, e31, e12, e45
            self.group0() + other.group1(),
            // e4235, e4315, e4125, e3215
            Simd32x4::from([other[e4235], other[e4315], other[e4125], 0.0]),
...
impl std::ops::Add<VersorOddAtInfinity> for AntiCircleRotorAtInfinity {
    ...
    fn add(self, other: VersorOddAtInfinity) -> Self::Output {
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            other.group0() + crate::swizzle!(self.group1(), 3, 0, 1, 2),
            // e23, e31, e12, e45
            self.group0() + other.group1(),
            // e4235, e4315, e4125, e3215
            other.group2(),
...
impl std::ops::Sub<AntiMotor> for AntiCircleRotorAtInfinity {
    ...
    fn sub(self, other: AntiMotor) -> Self::Output {
        ...
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([other[scalar] * -1.0, other[e15] * -1.0, other[e25] * -1.0, other[e35] * -1.0]) + crate::swizzle!(self.group1(), 3, 0, 1, 2),
            // e23, e31, e12, e45
            Simd32x4::from([other[e23] * -1.0, other[e31] * -1.0, other[e12] * -1.0, 0.0]) + self.group0(),
            // e4235, e4315, e4125, e3215
...
impl std::ops::Sub<DipoleInversionAtInfinity> for AntiCircleRotorAtInfinity {
    ...
    fn sub(self, other: DipoleInversionAtInfinity) -> Self::Output {
        ...
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([0.0, other[e15] * -1.0, other[e25] * -1.0, other[e35] * -1.0]) + crate::swizzle!(self.group1(), 3, 0, 1, 2),
            // e23, e31, e12, e45
            self.group0() - other.group0(),
            // e4235, e4315, e4125, e3215
            other.group2() * Simd32x4::from(-1.0),
...
impl std::ops::Sub<MysteryVersorOdd> for AntiCircleRotorAtInfinity {
    ...
    fn sub(self, other: MysteryVersorOdd) -> Self::Output {
        ...
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            Simd32x4::from([other[scalar] * -1.0, 0.0, 0.0, 0.0]) + crate::swizzle!(self.group1(), 3, 0, 1, 2),
            // e23, e31, e12, e45
            self.group0() - other.group1(),
            // e4235, e4315, e4125, e3215
            (crate::swizzle!(other.group0(), 1, 2, 3, _) * Simd32x3::from(-1.0)).extend_to_4(0.0),
...
impl std::ops::Sub<VersorOddAtInfinity> for AntiCircleRotorAtInfinity {
    ...
    fn sub(self, other: VersorOddAtInfinity) -> Self::Output {
        return VersorOddAtInfinity::from_groups(
            // scalar, e15, e25, e35
            crate::swizzle!(self.group1(), 3, 0, 1, 2) - other.group0(),
            // e23, e31, e12, e45
            self.group0() - other.group1(),
            // e4235, e4315, e4125, e3215
            other.group2() * Simd32x4::from(-1.0),
