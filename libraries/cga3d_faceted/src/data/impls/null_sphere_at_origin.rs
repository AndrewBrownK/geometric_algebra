...
impl std::ops::Add<AntiDualNum> for NullSphereAtOrigin {
    ...
    fn add(self, other: AntiDualNum) -> Self::Output {
        use crate::elements::*;
        return AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([(other.group0()[0] + self[e1234]), other.group0()[1]]));
    }
}
...
impl std::ops::Add<NullDipoleAtOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: NullDipoleAtOrigin) -> Self::Output {
        use crate::elements::*;
        return NullDipoleInversionAtOrigin::from_groups(/* e41, e42, e43, e1234 */ Simd32x4::from([other.group0()[0], other.group0()[1], other.group0()[2], self[e1234]]));
    }
}
...
impl std::ops::Add<Sphere> for NullSphereAtOrigin {
    ...
    fn add(self, other: Sphere) -> Self::Output {
        use crate::elements::*;
        return Sphere::from_groups(/* e4235, e4315, e4125, e3215 */ other.group0(), /* e1234 */ (self[e1234] + other[e4315]));
    }
}
impl std::ops::Add<SphereAtOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: SphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([other.group0()[0], (other.group0()[1] + self[e1234])]));
    }
}
...
impl std::ops::Sub<AntiDualNum> for NullSphereAtOrigin {
    ...
    fn sub(self, other: AntiDualNum) -> Self::Output {
        use crate::elements::*;
        return AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([(-other.group0()[0] + self[e1234]), (other.group0()[1] * -1.0)]));
    }
}
...
impl std::ops::Sub<Horizon> for NullSphereAtOrigin {
    ...
    fn sub(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        return SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([(other[e3215] * -1.0), self[e1234]]));
    }
}
...
impl std::ops::Sub<Scalar> for NullSphereAtOrigin {
    ...
    fn sub(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        return AntiDualNum::from_groups(/* e1234, scalar */ Simd32x2::from([self[e1234], (other[scalar] * -1.0)]));
    }
}
...
impl std::ops::Sub<SphereAtOrigin> for NullSphereAtOrigin {
    ...
    fn sub(self, other: SphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        return SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([(other.group0()[0] * -1.0), (-other.group0()[1] + self[e1234])]));
    }
}
