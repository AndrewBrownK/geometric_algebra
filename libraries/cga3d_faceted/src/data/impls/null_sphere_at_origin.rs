...
impl std::ops::Add<AntiQuadNum> for NullSphereAtOrigin {
    ...
    fn add(self, other: AntiQuadNum) -> Self::Output {
        ...
        let addition = AntiQuadNum::from_groups(
            ...
            Simd32x4::from([(self[e1234] + other.group0()[0]), other.group0()[1], other.group0()[2], other.group0()[3]]),
        );
        return addition;
    }
}
impl std::ops::Add<AntiQuadNumAligningOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: AntiQuadNumAligningOrigin) -> Self::Output {
        ...
        let addition = AntiQuadNumAligningOrigin::from_groups(
            // e1234, e3215, scalar
            Simd32x3::from([(self[e1234] + other.group0()[0]), other.group0()[1], other.group0()[2]]),
        );
        return addition;
    }
}
...
impl std::ops::Add<AntiQuadNumOnOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: AntiQuadNumOnOrigin) -> Self::Output {
        use crate::elements::*;
        let addition = AntiQuadNumOnOrigin::from_groups(/* e1234, scalar */ Simd32x2::from([(self[e1234] + other.group0()[0]), other.group0()[1]]));
        return addition;
    }
}
impl std::ops::Add<AntiQuadNumOrthogonalOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: AntiQuadNumOrthogonalOrigin) -> Self::Output {
        use crate::elements::*;
        let addition =
            AntiQuadNumOrthogonalOrigin::from_groups(/* e1234, e3215, e45 */ Simd32x3::from([(self[e1234] + other.group0()[0]), other.group0()[1], other.group0()[2]]));
        return addition;
    }
}
...
impl std::ops::Add<AntiVersorEvenOnOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: AntiVersorEvenOnOrigin) -> Self::Output {
        ...
        let addition = AntiVersorEvenOnOrigin::from_groups(
            ...
            other.group0(),
            // e23, e31, e12, e1234
            Simd32x4::from([other.group1()[0], other.group1()[1], other.group1()[2], (self[e1234] + other.group1()[3])]),
        );
        return addition;
    }
}
...
impl std::ops::Add<DipoleInversion> for NullSphereAtOrigin {
    ...
    fn add(self, other: DipoleInversion) -> Self::Output {
        ...
        let addition = DipoleInversion::from_groups(
            ...
            other.group1(),
            // e15, e25, e35, e1234
            Simd32x4::from([other.group2()[0], other.group2()[1], other.group2()[2], (self[e1234] + other.group2()[3])]),
            // e4235, e4315, e4125, e3215
            other.group3(),
        );
        return addition;
...
impl std::ops::Add<DipoleInversionOnOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: DipoleInversionOnOrigin) -> Self::Output {
        ...
        let addition = DipoleInversionOnOrigin::from_groups(
            ...
            other.group0(),
            // e1234, e4235, e4315, e4125
            Simd32x4::from([(self[e1234] + other.group1()[0]), other.group1()[1], other.group1()[2], other.group1()[3]]),
        );
        return addition;
    }
}
...
impl std::ops::Add<MultiVector> for NullSphereAtOrigin {
    ...
    fn add(self, other: MultiVector) -> Self::Output {
        ...
        let addition = MultiVector::from_groups(
            ...
            other.group8(),
            // e1234, e4235, e4315, e4125
            Simd32x4::from([(self[e1234] + other.group9()[0]), other.group9()[1], other.group9()[2], other.group9()[3]]),
            // e3215
            other[e45],
        );
        return addition;
...
impl std::ops::Add<NullSphereAtOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        let addition = NullSphereAtOrigin::from_groups(/* e1234 */ (self[e1234] + other[e1234]));
        return addition;
    }
}
...
impl std::ops::Add<SphereAtOrigin> for NullSphereAtOrigin {
    ...
    fn add(self, other: SphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        let addition = SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([other.group0()[0], (self[e1234] + other.group0()[1])]));
        return addition;
    }
}
...
impl std::ops::Sub<AntiQuadNumAligningOrigin> for NullSphereAtOrigin {
    ...
    fn sub(self, other: AntiQuadNumAligningOrigin) -> Self::Output {
        ...
        let subtraction = AntiQuadNumAligningOrigin::from_groups(
            // e1234, e3215, scalar
            Simd32x3::from([(self[e1234] - other.group0()[0]), (other.group0()[1] * -1.0), (other.group0()[2] * -1.0)]),
        );
        return subtraction;
    }
}
...
impl std::ops::Sub<AntiQuadNumOnOrigin> for NullSphereAtOrigin {
    ...
    fn sub(self, other: AntiQuadNumOnOrigin) -> Self::Output {
        use crate::elements::*;
        let subtraction = AntiQuadNumOnOrigin::from_groups(/* e1234, scalar */ Simd32x2::from([(self[e1234] - other.group0()[0]), (other.group0()[1] * -1.0)]));
        return subtraction;
    }
}
...
impl std::ops::Sub<AntiVersorEvenOnOrigin> for NullSphereAtOrigin {
    ...
    fn sub(self, other: AntiVersorEvenOnOrigin) -> Self::Output {
        ...
        let subtraction = AntiVersorEvenOnOrigin::from_groups(
            ...
            (other.group0() * Simd32x4::from(-1.0)),
            // e23, e31, e12, e1234
            Simd32x4::from([(other.group1()[0] * -1.0), (other.group1()[1] * -1.0), (other.group1()[2] * -1.0), (self[e1234] - other.group1()[3])]),
        );
        return subtraction;
    }
}
...
impl std::ops::Sub<DipoleInversion> for NullSphereAtOrigin {
    ...
    fn sub(self, other: DipoleInversion) -> Self::Output {
        ...
        let subtraction = DipoleInversion::from_groups(
            ...
            (other.group1() * Simd32x4::from(-1.0)),
            // e15, e25, e35, e1234
            Simd32x4::from([(other.group2()[0] * -1.0), (other.group2()[1] * -1.0), (other.group2()[2] * -1.0), (self[e1234] - other.group2()[3])]),
            // e4235, e4315, e4125, e3215
...
impl std::ops::Sub<DipoleInversionOnOrigin> for NullSphereAtOrigin {
    ...
    fn sub(self, other: DipoleInversionOnOrigin) -> Self::Output {
        ...
        let subtraction = DipoleInversionOnOrigin::from_groups(
            ...
            (other.group0() * Simd32x4::from(-1.0)),
            // e1234, e4235, e4315, e4125
            Simd32x4::from([(self[e1234] - other.group1()[0]), (other.group1()[1] * -1.0), (other.group1()[2] * -1.0), (other.group1()[3] * -1.0)]),
        );
        return subtraction;
    }
}
...
impl std::ops::Sub<MultiVector> for NullSphereAtOrigin {
    ...
    fn sub(self, other: MultiVector) -> Self::Output {
        ...
        let subtraction = MultiVector::from_groups(
            ...
            // e1234, e4235, e4315, e4125
            Simd32x4::from([(self[e1234] - other.group9()[0]), (other.group9()[1] * -1.0), (other.group9()[2] * -1.0), (other.group9()[3] * -1.0)]),
            // e3215
            (other[e45] * -1.0),
        );
        return subtraction;
...
impl std::ops::Sub<NullSphereAtOrigin> for NullSphereAtOrigin {
    ...
    fn sub(self, other: NullSphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        let subtraction = NullSphereAtOrigin::from_groups(/* e1234 */ (self[e1234] - other[e1234]));
        return subtraction;
    }
}
...
impl std::ops::Sub<SphereAtOrigin> for NullSphereAtOrigin {
    ...
    fn sub(self, other: SphereAtOrigin) -> Self::Output {
        use crate::elements::*;
        let subtraction = SphereAtOrigin::from_groups(/* e3215, e1234 */ Simd32x2::from([(other.group0()[0] * -1.0), (self[e1234] - other.group0()[1])]));
        return subtraction;
    }
}
