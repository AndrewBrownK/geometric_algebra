...
impl TryFrom<NullVersorOddAtOrigin> for NullSphereAtOrigin {
    type Error = String;
    fn try_from(null_versor_odd_at_origin: NullVersorOddAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from NullVersorOddAtOrigin do not fit into NullSphereAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullSphereAtOrigin::from_groups(/* e1234 */ null_versor_odd_at_origin[e1234]));
    }
}
...
impl TryFrom<VersorOddAligningOrigin> for NullSphereAtOrigin {
    type Error = String;
    fn try_from(versor_odd_aligning_origin: VersorOddAligningOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAligningOrigin do not fit into NullSphereAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullSphereAtOrigin::from_groups(/* e1234 */ versor_odd_aligning_origin[e1234]));
    }
}

impl TryFrom<VersorOddAtOrigin> for NullSphereAtOrigin {
    type Error = String;
    fn try_from(versor_odd_at_origin: VersorOddAtOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddAtOrigin do not fit into NullSphereAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullSphereAtOrigin::from_groups(/* e1234 */ versor_odd_at_origin[e1234]));
    }
}

impl TryFrom<VersorOddOnOrigin> for NullSphereAtOrigin {
    type Error = String;
    fn try_from(versor_odd_on_origin: VersorOddOnOrigin) -> Result<Self, Self::Error> {
        ...
        if fail {
            let mut error = "Elements from VersorOddOnOrigin do not fit into NullSphereAtOrigin { ".to_string();
            error.push_str(error_string.as_str());
            error.push('}');
            return Err(error);
        }
        return Ok(NullSphereAtOrigin::from_groups(/* e1234 */ versor_odd_on_origin[e1234]));
    }
}
