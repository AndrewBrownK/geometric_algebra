...
impl std::ops::Add<AntiDipoleInversion> for VersorEvenOrthogonalOrigin {
    ...
    fn add(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            // e235, e315, e125, e4
            other.group2() + self.group1().truncate_to_3().extend_to_4(self[e4]),
            // e1, e2, e3, e5
            other.group3() + self.group2().truncate_to_3().extend_to_4(self[e5]),
        );
    }
}
...
impl std::ops::Add<NullVersorEvenAtOrigin> for VersorEvenOrthogonalOrigin {
    ...
    fn add(self, other: NullVersorEvenAtOrigin) -> Self::Output {
        ...
        return VersorEvenOrthogonalOrigin::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([self[e423], self[e431], self[e412], 0.0]) + other.group0().truncate_to_3().extend_to_4(self[e321]),
            // e235, e315, e125, e5
            self.group1(),
            // e1, e2, e3, e4
            self.group2().truncate_to_3().extend_to_4(other[e4] + self[e4]),
...
impl std::ops::Sub<AntiDipoleInversion> for VersorEvenOrthogonalOrigin {
    ...
    fn sub(self, other: AntiDipoleInversion) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            // e235, e315, e125, e4
            self.group1().truncate_to_3().extend_to_4(self[e4]) - other.group2(),
            // e1, e2, e3, e5
            self.group2().truncate_to_3().extend_to_4(self[e5]) - other.group3(),
        );
    }
}
impl std::ops::Sub<AntiDipoleInversionAtInfinity> for VersorEvenOrthogonalOrigin {
    ...
    fn sub(self, other: AntiDipoleInversionAtInfinity) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            // e235, e315, e125, e4
            Simd32x4::from([other[e235] * -1.0, other[e315] * -1.0, other[e125] * -1.0, 0.0]) + self.group1().truncate_to_3().extend_to_4(self[e4]),
            // e1, e2, e3, e5
...
impl std::ops::Sub<AntiMysteryDipoleInversion> for VersorEvenOrthogonalOrigin {
    ...
    fn sub(self, other: AntiMysteryDipoleInversion) -> Self::Output {
        ...
        return AntiDipoleInversion::from_groups(
            ...
            Simd32x4::from([self[e235], self[e315], self[e125], self[e4]]),
            // e1, e2, e3, e5
            Simd32x4::from([other[e1] * -1.0, other[e2] * -1.0, other[e3] * -1.0, 0.0]) + self.group2().truncate_to_3().extend_to_4(self[e5]),
        );
    }
}
