...
pub mod reflection_4 {
    ...
    pub use crate::data::mystery_versor_round_point::MysteryVersorRoundPoint;
    ...
    pub use crate::data::versor_round_point_aligning_origin::VersorRoundPointAligningOrigin;
    pub use crate::data::versor_round_point_aligning_origin_at_infinity::VersorRoundPointAligningOriginAtInfinity;
    pub use crate::data::versor_round_point_at_infinity::VersorRoundPointAtInfinity;
    pub use crate::data::versor_round_point_on_origin::VersorRoundPointOnOrigin;
}
pub mod reflection_5 {
    ...
    pub use crate::data::anti_versor_round_point_aligning_origin_at_infinity::AntiVersorRoundPointAligningOriginAtInfinity;
    pub use crate::data::anti_versor_round_point_on_origin::AntiVersorRoundPointOnOrigin;
    pub use crate::data::mystery_versor_odd::MysteryVersorOdd;
    pub use crate::data::mystery_versor_sphere::MysteryVersorSphere;
    ...
    pub use crate::data::versor_sphere_at_infinity::VersorSphereAtInfinity;
    pub use crate::data::versor_sphere_orthogonal_origin::VersorSphereOrthogonalOrigin;
}
pub mod vector_0 {
    pub use crate::data::scalar::Scalar;
}
...
mod anti_versor_round_point_aligning_origin_at_infinity;
pub use anti_versor_round_point_aligning_origin_at_infinity::AntiVersorRoundPointAligningOriginAtInfinity;
mod anti_versor_round_point_on_origin;
pub use anti_versor_round_point_on_origin::AntiVersorRoundPointOnOrigin;
mod circle;
...
mod mystery_versor_round_point;
pub use mystery_versor_round_point::MysteryVersorRoundPoint;
mod mystery_versor_sphere;
pub use mystery_versor_sphere::MysteryVersorSphere;
...
mod versor_round_point_aligning_origin;
pub use versor_round_point_aligning_origin::VersorRoundPointAligningOrigin;
mod versor_round_point_aligning_origin_at_infinity;
pub use versor_round_point_aligning_origin_at_infinity::VersorRoundPointAligningOriginAtInfinity;
mod versor_round_point_at_infinity;
pub use versor_round_point_at_infinity::VersorRoundPointAtInfinity;
mod versor_round_point_on_origin;
pub use versor_round_point_on_origin::VersorRoundPointOnOrigin;
mod versor_sphere;
pub use versor_sphere::VersorSphere;
mod versor_sphere_at_infinity;
pub use versor_sphere_at_infinity::VersorSphereAtInfinity;
mod versor_sphere_orthogonal_origin;
pub use versor_sphere_orthogonal_origin::VersorSphereOrthogonalOrigin;
