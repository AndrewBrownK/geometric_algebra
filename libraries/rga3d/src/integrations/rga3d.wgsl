...
fn motor_antiWedge_motor(self_: Motor, other: Motor) -> Motor {
    ...
    let other_groups = motor_grouped(other);
    return motor_degroup(MotorGroups(
        /* e41, e42, e43, e1234 */ vec4<f32>(((vec4<f32>(other.e1234_) * vec4<f32>(1.0, 1.0, 1.0, 0.0)) * self_groups.group0_.xyz) + ((vec4<f32>(self_.e1234_) * vec4<f32>(1.0, 1.0, 1.0, 0.0)) * other_groups.group0_.xyz).xyz, other.e1234_ * self_.e1234_), 
...
fn motor_wedge_motor(self_: Motor, other: Motor) -> Motor {
    ...
    return motor_degroup(MotorGroups(
        ...
        /* e23, e31, e12, scalar */ vec4<f32>(((vec4<f32>(other.scalar) * vec4<f32>(1.0, 1.0, 1.0, 0.0)) * self_groups.group1_.xyz) + ((vec4<f32>(self_.scalar) * vec4<f32>(1.0, 1.0, 1.0, 0.0)) * other_groups.group1_.xyz).xyz, other.scalar * self_.scalar)
    ));
}
