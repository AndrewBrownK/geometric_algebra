...
fn antiScalar_antiFix(self_: AntiScalar) -> AntiScalar {
    ...
    let anti_square_root: AntiScalar = AntiScalar(/* e1234 */ pow(geometric_anti_product.g0_, 0.5));
    let anti_scalar_product: AntiScalar = AntiScalar(/* e1234 */ pow(anti_square_root.g0_, 2));
    let anti_inverse: AntiScalar = AntiScalar(/* e1234 */ (1.0/anti_scalar_product.g0_));
...
fn antiScalar_antiInverse(self_: AntiScalar) -> AntiScalar {
    ...
    return AntiScalar(/* e1234 */ (1.0/anti_scalar_product.g0_));
}
...
fn antiScalar_antiSquareRoot(self_: AntiScalar) -> AntiScalar {
    return AntiScalar(/* e1234 */ pow(self_.g0_, 0.5));
}
...
fn horizon_fix(self_: Horizon) -> Horizon {
    let reverse: Horizon = Horizon(/* e321 */ (self_.g0_ * -1.0));
    let geometric_product: Scalar = Scalar(/* scalar */ (reverse.g0_ * self_.g0_ * -1.0));
    let square_root: Scalar = Scalar(/* scalar */ pow(geometric_product.g0_, 0.5));
    let scalar_product: Scalar = Scalar(/* scalar */ pow(square_root.g0_, 2));
    let inverse: Scalar = Scalar(/* scalar */ (1.0/scalar_product.g0_));
...
fn antiScalar_into_dualNum(self_: AntiScalar) -> DualNum {
    return DualNum(/* scalar, e1234 */ vec2<f32>(0.0, self_.g0_));
}
fn antiScalar_into_motor(self_: AntiScalar) -> Motor {
    return Motor(/* e41, e42, e43, e1234 */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_), /* e23, e31, e12, scalar */ vec4<f32>(0.0));
}
fn antiScalar_into_multiVector(self_: AntiScalar) -> MultiVector {
    return MultiVector(/* scalar, e1234 */ vec2<f32>(0.0, self_.g0_), /* e1, e2, e3, e4 */ vec4<f32>(0.0), /* e41, e42, e43 */ vec3<f32>(0.0), /* e23, e31, e12 */ vec3<f32>(0.0), /* e423, e431, e412, e321 */ vec4<f32>(0.0));
}
...
fn horizon_into_flector(self_: Horizon) -> Flector {
    return Flector(/* e1, e2, e3, e4 */ vec4<f32>(0.0), /* e423, e431, e412, e321 */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_));
}
fn horizon_into_multiVector(self_: Horizon) -> MultiVector {
    return MultiVector(/* scalar, e1234 */ vec2<f32>(0.0), /* e1, e2, e3, e4 */ vec4<f32>(0.0), /* e41, e42, e43 */ vec3<f32>(0.0), /* e23, e31, e12 */ vec3<f32>(0.0), /* e423, e431, e412, e321 */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_));
}
fn horizon_into_plane(self_: Horizon) -> Plane {
    return Plane(/* e423, e431, e412, e321 */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_));
}
...
fn origin_into_flector(self_: Origin) -> Flector {
    return Flector(/* e1, e2, e3, e4 */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_), /* e423, e431, e412, e321 */ vec4<f32>(0.0));
}
fn origin_into_multiVector(self_: Origin) -> MultiVector {
    return MultiVector(/* scalar, e1234 */ vec2<f32>(0.0), /* e1, e2, e3, e4 */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_), /* e41, e42, e43 */ vec3<f32>(0.0), /* e23, e31, e12 */ vec3<f32>(0.0), /* e423, e431, e412, e321 */ vec4<f32>(0.0));
}
fn origin_into_point(self_: Origin) -> Point {
    return Point(/* e1, e2, e3, e4 */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_));
}
...
fn scalar_into_dualNum(self_: Scalar) -> DualNum {
    return DualNum(/* scalar, e1234 */ vec2<f32>(self_.g0_, 0.0));
}
fn scalar_into_motor(self_: Scalar) -> Motor {
    return Motor(/* e41, e42, e43, e1234 */ vec4<f32>(0.0), /* e23, e31, e12, scalar */ vec4<f32>(0.0, 0.0, 0.0, self_.g0_));
}
fn scalar_into_multiVector(self_: Scalar) -> MultiVector {
    return MultiVector(/* scalar, e1234 */ vec2<f32>(self_.g0_, 0.0), /* e1, e2, e3, e4 */ vec4<f32>(0.0), /* e41, e42, e43 */ vec3<f32>(0.0), /* e23, e31, e12 */ vec3<f32>(0.0), /* e423, e431, e412, e321 */ vec4<f32>(0.0));
}
fn dualNum_inverse(self_: DualNum) -> Scalar {
    let scalar_product: Scalar = Scalar(/* scalar */ pow(self_.g0_.x, 2));
    return Scalar(/* scalar */ (1.0/scalar_product.g0_));
}
...
fn scalar_squareRoot(self_: Scalar) -> Scalar {
    return Scalar(/* scalar */ pow(self_.g0_, 0.5));
}
