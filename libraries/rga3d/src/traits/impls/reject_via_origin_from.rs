...
impl RejectViaOriginFrom<DualNum> for AntiScalar {
    ...
    fn reject_via_origin_from(self, other: DualNum) -> Self::Output {
        ...
        return AntiScalar::from_groups(/* e1234 */ right_dual[e1234] * anti_wedge[scalar]);
    }
}
...
impl RejectViaOriginFrom<Horizon> for AntiScalar {
    ...
    fn reject_via_origin_from(self, other: Horizon) -> Self::Output {
        ...
        return AntiScalar::from_groups(/* e1234 */ anti_wedge[e321] * right_dual[e4] * -1.0);
    }
}
...
impl RejectViaOriginFrom<Plane> for AntiScalar {
    ...
    fn reject_via_origin_from(self, other: Plane) -> Self::Output {
        ...
        let right_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return AntiScalar::from_groups(/* e1234 */ right_dual[e4] * anti_wedge[e321] * -1.0);
    }
}
...
impl RejectViaOriginFrom<Point> for Flector {
    ...
    fn reject_via_origin_from(self, other: Point) -> Self::Output {
        ...
        return Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([anti_wedge[scalar], anti_wedge[scalar], anti_wedge[scalar], 0.0]) * right_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
...
impl RejectViaOriginFrom<Plane> for Horizon {
    ...
    fn reject_via_origin_from(self, other: Plane) -> Self::Output {
        ...
        return Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([right_dual[e4], right_dual[e4], right_dual[e4], 0.0]) * anti_wedge.group1().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
impl RejectViaOriginFrom<Point> for Horizon {
    ...
    fn reject_via_origin_from(self, other: Point) -> Self::Output {
        ...
        let right_dual = Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from([other[e1], other[e2], other[e3], 0.0]));
        return Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(anti_wedge[scalar]) * right_dual.group0());
    }
}
...
impl RejectViaOriginFrom<Horizon> for Motor {
    ...
    fn reject_via_origin_from(self, other: Horizon) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(right_dual[e4]) * anti_wedge.group0().xyz().with_w(anti_wedge[e321]) * Simd32x4::from(-1.0),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        );
    }
...
impl RejectViaOriginFrom<Horizon> for Origin {
    ...
    fn reject_via_origin_from(self, other: Horizon) -> Self::Output {
        ...
        let anti_wedge = Scalar::from_groups(/* scalar */ other[e321] * self[e4]);
        let right_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Origin::from_groups(/* e4 */ right_dual[e4] * anti_wedge[scalar]);
    }
}
