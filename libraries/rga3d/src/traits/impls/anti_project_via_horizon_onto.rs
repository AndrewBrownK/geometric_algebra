...
impl AntiProjectViaHorizonOnto<MultiVector> for AntiScalar {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([1.0, self[e1234] * right_dual[e1234]]) * Simd32x2::from([0.0, 1.0]),
            // e1, e2, e3, e4
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            (Simd32x3::from(self[e1234]) * right_dual.group4().xyz()).with_w(0.0),
        );
...
impl AntiProjectViaHorizonOnto<Flector> for DualNum {
    ...
    fn anti_project_via_horizon_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Flector::from_groups(
            ...
            Simd32x4::from(self[e1234]) * right_dual.group0(),
            // e423, e431, e412, e321
            self.group0().yy().with_zw(self[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_dual.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            (other.group0().wwwx() * anti_wedge.group0().xyz().with_w(anti_wedge[e423]))
...
impl AntiProjectViaHorizonOnto<Motor> for DualNum {
    ...
    fn anti_project_via_horizon_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            Simd32x4::from(self[e1234]) * right_dual.group0(),
            // e23, e31, e12, scalar
            Simd32x3::from(0.0).with_w((self[scalar] * right_dual[e1234]) + (self[e1234] * right_dual[scalar])),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x4::from(anti_wedge[scalar]) * other.group0())
...
impl AntiProjectViaHorizonOnto<MultiVector> for DualNum {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            self.group0().yy().with_zw(self[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_dual.group4().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl AntiProjectViaHorizonOnto<Motor> for Horizon {
    ...
    fn anti_project_via_horizon_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Flector::from_groups(
            // e1, e2, e3, e4
            (Simd32x3::from(self[e321]) * right_dual.group0().xyz()).with_w(0.0),
            // e423, e431, e412, e321
...
impl AntiProjectViaHorizonOnto<MultiVector> for Horizon {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (Simd32x3::from(self[e321]) * right_dual.group2()).with_w(0.0),
            // e41, e42, e43
            Simd32x3::from(0.0),
            // e23, e31, e12
...
impl AntiProjectViaHorizonOnto<Motor> for Line {
    ...
    fn anti_project_via_horizon_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            (Simd32x3::from(right_dual[e1234]) * self.group1()).with_w(
...
impl AntiProjectViaHorizonOnto<MultiVector> for Motor {
    ...
    fn anti_project_via_horizon_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x3::from(1.0).with_w(0.0) * self.group0().www().with_w(0.0) * right_dual.group4().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl AntiProjectViaHorizonOnto<Point> for MultiVector {
    ...
    fn anti_project_via_horizon_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            self.group0().yy().with_zw(self[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
