    ...
    fn project_via_origin_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            ...
            Simd32x4::from([right_dual[e41], right_dual[e42], right_dual[e43], 1.0])
                * self.group0().xx().with_zw(self[scalar], (self[scalar] * right_dual[e1234]) + (self[e1234] * right_dual[scalar])),
            // e23, e31, e12, scalar
            Simd32x4::from(self[scalar]) * right_dual.group1(),
        );
        return Motor::from_groups(
...
impl ProjectViaOriginOnto<MultiVector> for DualNum {
    ...
    fn project_via_origin_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([self[scalar] * right_dual[scalar], (self[scalar] * right_dual[e1234]) + (self[e1234] * right_dual[scalar])]),
            // e1, e2, e3, e4
            Simd32x4::from(self[scalar]) * right_dual.group1(),
            // e41, e42, e43
            Simd32x3::from(self[scalar]) * right_dual.group2(),
            // e23, e31, e12
            Simd32x3::from(self[scalar]) * right_dual.group3(),
            // e423, e431, e412, e321
...
impl ProjectViaOriginOnto<Motor> for Line {
    ...
    fn project_via_origin_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x3::from(1.0).with_w(0.0) * self.group1().with_w(0.0) * right_dual.group1().www().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((Simd32x3::from(other[e1234]) * wedge.group0().xyz()) + (Simd32x3::from(wedge[e1234]) * other.group0().xyz())).with_w(other[e1234] * wedge[e1234]),
...
impl ProjectViaOriginOnto<Horizon> for Motor {
    ...
    fn project_via_origin_onto(self, other: Horizon) -> Self::Output {
        ...
        let wedge = Flector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from([right_dual[e4], right_dual[e4], right_dual[e4], 0.0]) * self.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(0.0),
...
impl ProjectViaOriginOnto<Line> for Motor {
    ...
    fn project_via_origin_onto(self, other: Line) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x3::from(1.0).with_w(0.0) * right_dual.group1().with_w(0.0) * self.group1().www().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
...
impl ProjectViaOriginOnto<Motor> for Motor {
    ...
    fn project_via_origin_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x3::from(0.0).with_w(right_dual[scalar] * self[scalar]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((Simd32x3::from(other[e1234]) * wedge.group0().xyz()) + (Simd32x3::from(wedge[e1234]) * other.group0().xyz())).with_w(other[e1234] * wedge[e1234]),
...
impl ProjectViaOriginOnto<Horizon> for MultiVector {
    ...
    fn project_via_origin_onto(self, other: Horizon) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            Simd32x4::from([right_dual[e4], right_dual[e4], right_dual[e4], 0.0]) * self.group3().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
...
impl ProjectViaOriginOnto<Flector> for Origin {
    ...
    fn project_via_origin_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(self[e4]) * right_dual.group0().xyz().with_w(right_dual[e321]),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        );
        return Flector::from_groups(
...
impl ProjectViaOriginOnto<Motor> for Origin {
    ...
    fn project_via_origin_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(right_dual[scalar] * self[e4]),
            // e423, e431, e412, e321
            Simd32x4::from([self[e4], self[e4], self[e4], 0.0]) * right_dual.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
...
impl ProjectViaOriginOnto<MultiVector> for Origin {
    ...
    fn project_via_origin_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([1.0, right_dual[e321] * self[e4]]) * Simd32x2::from([0.0, 1.0]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(right_dual[scalar] * self[e4]),
            // e41, e42, e43
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            Simd32x4::from([self[e4], self[e4], self[e4], 0.0]) * right_dual.group3().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
