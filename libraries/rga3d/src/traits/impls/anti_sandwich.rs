...
impl AntiSandwich<DualNum> for AntiScalar {
    ...
    fn anti_sandwich(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let geometric_anti_product = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(self[e1234]) * Simd32x2::from([other[scalar], other[e1234]]));
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
impl AntiSandwich<Flector> for AntiScalar {
    ...
    fn anti_sandwich(self, other: Flector) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e1], other[e2], other[e3], other[e4]]),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e423], other[e431], other[e412], other[e321]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Motor> for AntiScalar {
    ...
    fn anti_sandwich(self, other: Motor) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e41], other[e42], other[e43], other[e1234]]),
            // e23, e31, e12, scalar
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e23], other[e31], other[e12], other[scalar]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
impl AntiSandwich<MultiVector> for AntiScalar {
    ...
    fn anti_sandwich(self, other: MultiVector) -> Self::Output {
        ...
        let geometric_anti_product = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from(self[e1234]) * Simd32x2::from([other[scalar], other[e1234]]),
            // e1, e2, e3, e4
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e1], other[e2], other[e3], other[e4]]),
            // e41, e42, e43
            Simd32x3::from(self[e1234]) * Simd32x3::from([other[e41], other[e42], other[e43]]),
...
impl AntiSandwich<Point> for AntiScalar {
    ...
    fn anti_sandwich(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let geometric_anti_product = Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(self[e1234]) * Simd32x4::from([other[e1], other[e2], other[e3], other[e4]]));
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<AntiScalar> for DualNum {
    ...
    fn anti_sandwich(self, other: AntiScalar) -> Self::Output {
        use crate::elements::*;
        let geometric_anti_product = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(other[e1234]) * Simd32x2::from([self[scalar], self[e1234]]));
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Motor> for DualNum {
    ...
    fn anti_sandwich(self, other: Motor) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            ...
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e41], other[e42], other[e43], other[e1234]]),
            // e23, e31, e12, scalar
            (Simd32x4::from(self[scalar]) * Simd32x4::from([other[e41], other[e42], other[e43], other[e1234]]))
                + (Simd32x4::from(self[e1234]) * Simd32x4::from([other[e23], other[e31], other[e12], other[scalar]])),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
...
impl AntiSandwich<Origin> for DualNum {
    ...
    fn anti_sandwich(self, other: Origin) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([0.0, 0.0, 0.0, self[e1234] * other[e4]]),
            // e423, e431, e412, e321
...
impl AntiSandwich<Plane> for DualNum {
    ...
    fn anti_sandwich(self, other: Plane) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([self[scalar] * other[e423], self[scalar] * other[e431], self[scalar] * other[e412], 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e423], other[e431], other[e412], other[e321]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
...
impl AntiSandwich<AntiScalar> for Flector {
    ...
    fn anti_sandwich(self, other: AntiScalar) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(other[e1234]) * Simd32x4::from([self[e1], self[e2], self[e3], self[e4]]),
            // e423, e431, e412, e321
            Simd32x4::from(other[e1234]) * Simd32x4::from([self[e423], self[e431], self[e412], self[e321]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Scalar> for Flector {
    ...
    fn anti_sandwich(self, other: Scalar) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([self[e423] * other[scalar] * -1.0, self[e431] * other[scalar] * -1.0, self[e412] * other[scalar] * -1.0, 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from([0.0, 0.0, 0.0, self[e4] * other[scalar] * -1.0]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Line> for Horizon {
    ...
    fn anti_sandwich(self, other: Line) -> Self::Output {
        ...
        let geometric_anti_product = Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([self[e321] * other[e41], self[e321] * other[e42], self[e321] * other[e43], 0.0]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
impl AntiSandwich<Motor> for Horizon {
    ...
    fn anti_sandwich(self, other: Motor) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            ...
            Simd32x4::from([self[e321] * other[e41], self[e321] * other[e42], self[e321] * other[e43], 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from([0.0, 0.0, 0.0, self[e321] * other[e1234]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Horizon> for Line {
    ...
    fn anti_sandwich(self, other: Horizon) -> Self::Output {
        ...
        let geometric_anti_product = Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([other[e321] * self[e41], other[e321] * self[e42], other[e321] * self[e43], 0.0]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Origin> for Line {
    ...
    fn anti_sandwich(self, other: Origin) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([self[e23] * other[e4], self[e31] * other[e4], self[e12] * other[e4], 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from([self[e41] * other[e4], self[e42] * other[e4], self[e43] * other[e4], 0.0]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<AntiScalar> for Motor {
    ...
    fn anti_sandwich(self, other: AntiScalar) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(other[e1234]) * Simd32x4::from([self[e41], self[e42], self[e43], self[e1234]]),
            // e23, e31, e12, scalar
            Simd32x4::from(other[e1234]) * Simd32x4::from([self[e23], self[e31], self[e12], self[scalar]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
impl AntiSandwich<DualNum> for Motor {
    ...
    fn anti_sandwich(self, other: DualNum) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            ...
            Simd32x4::from(other[e1234]) * Simd32x4::from([self[e41], self[e42], self[e43], self[e1234]]),
            // e23, e31, e12, scalar
            (Simd32x4::from(other[scalar]) * Simd32x4::from([self[e41], self[e42], self[e43], self[e1234]]))
                + (Simd32x4::from(other[e1234]) * Simd32x4::from([self[e23], self[e31], self[e12], self[scalar]])),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
...
impl AntiSandwich<Horizon> for Motor {
    ...
    fn anti_sandwich(self, other: Horizon) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            ...
            Simd32x4::from([other[e321] * self[e41], other[e321] * self[e42], other[e321] * self[e43], 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from([0.0, 0.0, 0.0, other[e321] * self[e1234]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<AntiScalar> for MultiVector {
    ...
    fn anti_sandwich(self, other: AntiScalar) -> Self::Output {
        ...
        let geometric_anti_product = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from(other[e1234]) * Simd32x2::from([self[scalar], self[e1234]]),
            // e1, e2, e3, e4
            Simd32x4::from(other[e1234]) * Simd32x4::from([self[e1], self[e2], self[e3], self[e4]]),
            // e41, e42, e43
            Simd32x3::from(other[e1234]) * Simd32x3::from([self[e41], self[e42], self[e43]]),
...
impl AntiSandwich<DualNum> for Origin {
    ...
    fn anti_sandwich(self, other: DualNum) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([0.0, 0.0, 0.0, other[e1234] * self[e4]]),
            // e423, e431, e412, e321
            Simd32x4::from([0.0, 0.0, 0.0, other[scalar] * self[e4] * -1.0]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Line> for Origin {
    ...
    fn anti_sandwich(self, other: Line) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([other[e23] * self[e4] * -1.0, other[e31] * self[e4] * -1.0, other[e12] * self[e4] * -1.0, 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from([other[e41] * self[e4], other[e42] * self[e4], other[e43] * self[e4], 0.0]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Plane> for Origin {
    ...
    fn anti_sandwich(self, other: Plane) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([self[e4] * other[e423] * -1.0, self[e4] * other[e431] * -1.0, self[e4] * other[e412] * -1.0, 0.0]),
            // e23, e31, e12, scalar
...
impl AntiSandwich<Point> for Origin {
    ...
    fn anti_sandwich(self, other: Point) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([0.0, 0.0, 0.0, self[e4] * other[e4] * -1.0]),
            // e23, e31, e12, scalar
...
impl AntiSandwich<DualNum> for Plane {
    ...
    fn anti_sandwich(self, other: DualNum) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([other[scalar] * self[e423] * -1.0, other[scalar] * self[e431] * -1.0, other[scalar] * self[e412] * -1.0, 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from(other[e1234]) * Simd32x4::from([self[e423], self[e431], self[e412], self[e321]]),
        );
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
...
impl AntiSandwich<Origin> for Plane {
    ...
    fn anti_sandwich(self, other: Origin) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([other[e4] * self[e423] * -1.0, other[e4] * self[e431] * -1.0, other[e4] * self[e412] * -1.0, 0.0]),
            // e23, e31, e12, scalar
...
impl AntiSandwich<Point> for Plane {
    ...
    fn anti_sandwich(self, other: Point) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([self[e423] * other[e4] * -1.0, self[e431] * other[e4] * -1.0, self[e412] * other[e4] * -1.0, 0.0]),
            // e23, e31, e12, scalar
            Simd32x4::from([
                (self[e431] * other[e3]) - (self[e412] * other[e2]),
                (self[e412] * other[e1]) - (self[e423] * other[e3]),
...
impl AntiSandwich<Scalar> for Plane {
    ...
    fn anti_sandwich(self, other: Scalar) -> Self::Output {
        ...
        let geometric_anti_product = Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from([
            self[e423] * other[scalar] * -1.0,
            self[e431] * other[scalar] * -1.0,
            self[e412] * other[scalar] * -1.0,
            0.0,
        ]));
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
...
impl AntiSandwich<AntiScalar> for Point {
    ...
    fn anti_sandwich(self, other: AntiScalar) -> Self::Output {
        use crate::elements::*;
        let geometric_anti_product = Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(other[e1234]) * Simd32x4::from([self[e1], self[e2], self[e3], self[e4]]));
        return geometric_anti_product.geometric_anti_product(self.anti_reverse());
    }
}
...
impl AntiSandwich<Origin> for Point {
    ...
    fn anti_sandwich(self, other: Origin) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([0.0, 0.0, 0.0, other[e4] * self[e4] * -1.0]),
            // e23, e31, e12, scalar
...
impl AntiSandwich<Plane> for Point {
    ...
    fn anti_sandwich(self, other: Plane) -> Self::Output {
        ...
        let geometric_anti_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([other[e423] * self[e4] * -1.0, other[e431] * self[e4] * -1.0, other[e412] * self[e4] * -1.0, 0.0]),
            // e23, e31, e12, scalar
            Simd32x4::from([
                (other[e431] * self[e3]) - (other[e412] * self[e2]),
                (other[e412] * self[e1]) - (other[e423] * self[e3]),
...
impl AntiSandwich<Flector> for Scalar {
    ...
    fn anti_sandwich(self, other: Flector) -> Self::Output {
        ...
        let geometric_anti_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([other[e423] * self[scalar], other[e431] * self[scalar], other[e412] * self[scalar], 0.0]),
            // e423, e431, e412, e321
