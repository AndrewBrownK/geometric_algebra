...
impl Sandwich<Plane> for DualNum {
    ...
    fn sandwich(self, other: Plane) -> Self::Output {
        ...
        let geometric_product = Flector::from_groups(
            ...
            Simd32x4::from([0.0, 0.0, 0.0, self[e1234] * other[e321] * -1.0]),
            // e423, e431, e412, e321
            Simd32x4::from(self[scalar]) * Simd32x4::from([other[e423], other[e431], other[e412], other[e321]]),
        );
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<Scalar> for DualNum {
    ...
    fn sandwich(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let geometric_product = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(other[scalar]) * Simd32x2::from([self[scalar], self[e1234]]));
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<AntiScalar> for Flector {
    ...
    fn sandwich(self, other: AntiScalar) -> Self::Output {
        ...
        let geometric_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([0.0, 0.0, 0.0, other[e1234] * self[e321]]),
            // e423, e431, e412, e321
...
impl Sandwich<DualNum> for Flector {
    ...
    fn sandwich(self, other: DualNum) -> Self::Output {
        ...
        let geometric_product = Flector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from([
                (other[scalar] * self[e423]) + (other[e1234] * self[e1]),
                (other[scalar] * self[e431]) + (other[e1234] * self[e2]),
                (other[scalar] * self[e412]) + (other[e1234] * self[e3]),
        ...
        let geometric_product = Flector::from_groups(
            ...
            Simd32x4::from([
                ...
                (self[e2] * other[e41]) + (self[e3] * other[e1234]) + (self[e4] * other[e12]) + (self[e431] * other[e23]) + (self[e321] * other[e43])
                    ...
                    - (self[e423] * other[e31]),
                -(self[e1] * other[e23]) - (self[e2] * other[e31]) - (self[e3] * other[e12]),
            ]) + (Simd32x4::from(other[scalar]) * Simd32x4::from([self[e423], self[e431], self[e412], self[e321]])),
        );
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<Line> for Horizon {
    ...
    fn sandwich(self, other: Line) -> Self::Output {
        ...
        let geometric_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([self[e321] * other[e23], self[e321] * other[e31], self[e321] * other[e12], 0.0]),
            // e423, e431, e412, e321
...
impl Sandwich<MultiVector> for Horizon {
    ...
    fn sandwich(self, other: MultiVector) -> Self::Output {
        ...
        let geometric_product = MultiVector::from_groups(
            ...
            // e23, e31, e12
            Simd32x3::from(self[e321]) * Simd32x3::from([other[e1], other[e2], other[e3]]) * Simd32x3::from(-1.0),
            // e423, e431, e412, e321
            Simd32x4::from(self[e321]) * Simd32x4::from([other[e41], other[e42], other[e43], other[scalar]]),
        );
        return geometric_product.geometric_product(self.reverse());
...
impl Sandwich<Plane> for Horizon {
    ...
    fn sandwich(self, other: Plane) -> Self::Output {
        ...
        let geometric_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([self[e321] * other[e423] * -1.0, self[e321] * other[e431] * -1.0, self[e321] * other[e412] * -1.0, 0.0]),
            // e23, e31, e12, scalar
            Simd32x4::from([0.0, 0.0, 0.0, self[e321] * other[e321] * -1.0]),
        );
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<Horizon> for Line {
    ...
    fn sandwich(self, other: Horizon) -> Self::Output {
        ...
        let geometric_product = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([other[e321] * self[e23], other[e321] * self[e31], other[e321] * self[e12], 0.0]),
            // e423, e431, e412, e321
            Simd32x4::from([other[e321] * self[e41] * -1.0, other[e321] * self[e42] * -1.0, other[e321] * self[e43] * -1.0, 0.0]),
        );
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<Plane> for Motor {
    ...
    fn sandwich(self, other: Plane) -> Self::Output {
        ...
        let geometric_product = Flector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from([
                (self[e12] * other[e431]) + (self[scalar] * other[e423]) - (self[e41] * other[e321]) - (self[e31] * other[e412]),
                (self[e23] * other[e412]) + (self[scalar] * other[e431]) - (self[e42] * other[e321]) - (self[e12] * other[e423]),
                (self[e31] * other[e423]) + (self[scalar] * other[e412]) - (self[e43] * other[e321]) - (self[e23] * other[e431]),
                self[scalar] * other[e321],
            ]),
        );
        return geometric_product.geometric_product(self.reverse());
...
impl Sandwich<Horizon> for MultiVector {
    ...
    fn sandwich(self, other: Horizon) -> Self::Output {
        ...
        let geometric_product = MultiVector::from_groups(
            ...
            Simd32x3::from(other[e321]) * Simd32x3::from([self[e423], self[e431], self[e412]]),
            // e23, e31, e12
            Simd32x3::from(other[e321]) * Simd32x3::from([self[e1], self[e2], self[e3]]) * Simd32x3::from(-1.0),
            // e423, e431, e412, e321
            Simd32x4::from(other[e321]) * Simd32x4::from([self[e41], self[e42], self[e43], self[scalar]]) * Simd32x4::from([-1.0, -1.0, -1.0, 1.0]),
        );
        return geometric_product.geometric_product(self.reverse());
...
impl Sandwich<Plane> for MultiVector {
    ...
    fn sandwich(self, other: Plane) -> Self::Output {
        ...
        let geometric_product = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from([
                (self[scalar] * other[e423]) + (self[e12] * other[e431]) - (self[e41] * other[e321]) - (self[e31] * other[e412]),
                (self[scalar] * other[e431]) + (self[e23] * other[e412]) - (self[e42] * other[e321]) - (self[e12] * other[e423]),
                (self[scalar] * other[e412]) + (self[e31] * other[e423]) - (self[e43] * other[e321]) - (self[e23] * other[e431]),
                self[scalar] * other[e321],
            ]),
        );
        return geometric_product.geometric_product(self.reverse());
...
impl Sandwich<Line> for Origin {
    ...
    fn sandwich(self, other: Line) -> Self::Output {
        ...
        let geometric_product = Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([other[e23] * self[e4], other[e31] * self[e4], other[e12] * self[e4], 0.0]),
        );
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<Horizon> for Plane {
    ...
    fn sandwich(self, other: Horizon) -> Self::Output {
        ...
        let geometric_product = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([other[e321] * self[e423], other[e321] * self[e431], other[e321] * self[e412], 0.0]),
            // e23, e31, e12, scalar
...
impl Sandwich<MultiVector> for Plane {
    ...
    fn sandwich(self, other: MultiVector) -> Self::Output {
        ...
        let geometric_product = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from([
                (other[scalar] * self[e423]) + (other[e41] * self[e321]) + (other[e31] * self[e412]) - (other[e12] * self[e431]),
                (other[scalar] * self[e431]) + (other[e42] * self[e321]) + (other[e12] * self[e423]) - (other[e23] * self[e412]),
                (other[scalar] * self[e412]) + (other[e43] * self[e321]) + (other[e23] * self[e431]) - (other[e31] * self[e423]),
                other[scalar] * self[e321],
            ]),
        );
        return geometric_product.geometric_product(self.reverse());
...
impl Sandwich<Scalar> for Point {
    ...
    fn sandwich(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let geometric_product = Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(other[scalar]) * Simd32x4::from([self[e1], self[e2], self[e3], self[e4]]));
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<DualNum> for Scalar {
    ...
    fn sandwich(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let geometric_product = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(self[scalar]) * Simd32x2::from([other[scalar], other[e1234]]));
        return geometric_product.geometric_product(self.reverse());
    }
}
...
impl Sandwich<Point> for Scalar {
    ...
    fn sandwich(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let geometric_product = Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(self[scalar]) * Simd32x4::from([other[e1], other[e2], other[e3], other[e4]]));
        return geometric_product.geometric_product(self.reverse());
    }
}
