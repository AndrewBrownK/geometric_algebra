...
impl ProjectOrthogonallyOnto<Horizon> for DualNum {
    ...
    fn project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        return Scalar::from_groups(/* scalar */ self[scalar] * other[e321] * right_anti_dual[e4] * -1.0);
    }
}
        ...
        let wedge = Motor::from_groups(
            ...
            Simd32x4::from([right_anti_dual[e41], right_anti_dual[e42], right_anti_dual[e43], 1.0])
                * self
                    .group0()
                    .xx()
                    .with_zw(self[scalar], (self[scalar] * right_anti_dual[e1234]) + (self[e1234] * right_anti_dual[scalar])),
            // e23, e31, e12, scalar
            Simd32x4::from(self[scalar]) * right_anti_dual.group1(),
        );
        return Motor::from_groups(
...
impl ProjectOrthogonallyOnto<MultiVector> for DualNum {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            // e23, e31, e12
            Simd32x3::from(self[scalar]) * right_anti_dual.group3(),
            // e423, e431, e412, e321
            Simd32x4::from(self[scalar]) * right_anti_dual.group4(),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl ProjectOrthogonallyOnto<Plane> for DualNum {
    ...
    fn project_orthogonally_onto(self, other: Plane) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Scalar::from_groups(/* scalar */ self[scalar] * right_anti_dual[e4] * other[e321] * -1.0);
    }
}
...
impl ProjectOrthogonallyOnto<Scalar> for DualNum {
    ...
    fn project_orthogonally_onto(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return Scalar::from_groups(/* scalar */ right_anti_dual[e1234] * self[scalar] * other[scalar]);
    }
}
...
impl ProjectOrthogonallyOnto<Flector> for Flector {
    ...
    fn project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            // e41, e42, e43, e1234
            (self.group0().wwwx() * right_anti_dual.group0().xyz().with_w(right_anti_dual[e423]))
                + Simd32x3::from(0.0).with_w(
                ...
                - (right_anti_dual.group0().wwwx() * self.group0().xyz().with_w(self[e423])),
            // e23, e31, e12, scalar
...
impl ProjectOrthogonallyOnto<Horizon> for Flector {
    ...
    fn project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([other[e321], other[e321], other[e321], 0.0]) * wedge.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
            // e423, e431, e412, e321
...
impl ProjectOrthogonallyOnto<Line> for Flector {
    ...
    fn project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let wedge = Plane::from_groups(
            // e423, e431, e412, e321
            (Simd32x3::from(self[e4]) * right_anti_dual.group1()).with_w(0.0) + (right_anti_dual.group0().yzx() * self.group0().zxy()).with_w(0.0)
                - (right_anti_dual.group0().zxy() * self.group0().yzx()).with_w(0.0),
        );
...
impl ProjectOrthogonallyOnto<Motor> for Flector {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Flector::from_groups(
            ...
            // e423, e431, e412, e321
            (Simd32x3::from(self[e4]) * right_anti_dual.group1().xyz()).with_w(0.0)
                + (Simd32x3::from(right_anti_dual[scalar]) * self.group1().xyz()).with_w(0.0)
                + (self.group0().zxy() * right_anti_dual.group0().yzx()).with_w(0.0)
                - (self.group0().yzx() * right_anti_dual.group0().zxy()).with_w(0.0),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (wedge[e412] * other[e31]) + (wedge[e321] * other[e41]),
                (wedge[e423] * other[e12]) + (wedge[e321] * other[e42]),
                (wedge[e431] * other[e23]) + (wedge[e321] * other[e43]),
                -(wedge[e431] * other[e42]) - (wedge[e412] * other[e43]),
            ]) + (Simd32x4::from(other[e1234]) * wedge.group0())
                - (wedge.group1().yzxx() * other.group1().zxy().with_w(other[e41])),
            // e423, e431, e412, e321
            Simd32x4::from(other[e1234]) * wedge.group1(),
        );
    }
...
impl ProjectOrthogonallyOnto<MultiVector> for Flector {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            (Simd32x3::from(self[e4]) * right_anti_dual.group3()).with_w(0.0)
                + (Simd32x3::from(right_anti_dual[scalar]) * self.group1().xyz()).with_w(0.0)
...
impl ProjectOrthogonallyOnto<Point> for Flector {
    ...
    fn project_orthogonally_onto(self, other: Point) -> Self::Output {
        ...
        return Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from((self[e1] * right_anti_dual[e423]) + (self[e2] * right_anti_dual[e431]) + (self[e3] * right_anti_dual[e412]) + (self[e4] * right_anti_dual[e321]))
                * other.group0(),
        );
    }
}
...
impl ProjectOrthogonallyOnto<Motor> for Horizon {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        return Flector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x3::from(0.0).with_w(wedge[e321] * other[e1234]),
        );
    }
}
impl ProjectOrthogonallyOnto<MultiVector> for Horizon {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([1.0, self[e321] * right_anti_dual[e4]]) * Simd32x2::from([0.0, -1.0]),
            // e1, e2, e3, e4
            Simd32x4::from(0.0),
            // e41, e42, e43
            Simd32x3::from(0.0),
...
impl ProjectOrthogonallyOnto<Flector> for Line {
    ...
    fn project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge = Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([
                (right_anti_dual[e3] * self[e42]) + (right_anti_dual[e4] * self[e23]),
                (right_anti_dual[e1] * self[e43]) + (right_anti_dual[e4] * self[e31]),
                (right_anti_dual[e2] * self[e41]) + (right_anti_dual[e4] * self[e12]),
...
impl ProjectOrthogonallyOnto<Horizon> for Line {
    ...
    fn project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        return Line::from_groups(
            ...
            Simd32x3::from(0.0),
            // e23, e31, e12
            Simd32x3::from(other[e321])
                * Simd32x4::from([self[e23] * right_anti_dual[e4], self[e31] * right_anti_dual[e4], self[e12] * right_anti_dual[e4], 0.0]).xyz()
                * Simd32x3::from(-1.0),
        );
    }
}
...
impl ProjectOrthogonallyOnto<Motor> for Line {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x3::from(1.0).with_w(0.0) * self.group1().with_w(0.0) * right_anti_dual.group1().www().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((Simd32x3::from(other[e1234]) * wedge.group0().xyz()) + (Simd32x3::from(wedge[e1234]) * other.group0().xyz())).with_w(other[e1234] * wedge[e1234]),
...
impl ProjectOrthogonallyOnto<MultiVector> for Line {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from([
                (self[e42] * right_anti_dual[e3]) + (self[e23] * right_anti_dual[e4]),
                (self[e43] * right_anti_dual[e1]) + (self[e31] * right_anti_dual[e4]),
                (self[e41] * right_anti_dual[e2]) + (self[e12] * right_anti_dual[e4]),
...
impl ProjectOrthogonallyOnto<Plane> for Line {
    ...
    fn project_orthogonally_onto(self, other: Plane) -> Self::Output {
        ...
        let wedge = Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([right_anti_dual[e4], right_anti_dual[e4], right_anti_dual[e4], 0.0]) * self.group1().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Line::from_groups(
            // e41, e42, e43
...
impl ProjectOrthogonallyOnto<Flector> for Motor {
    ...
    fn project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge = Flector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from([
                (right_anti_dual[e4] * self[e23]) + (right_anti_dual[e423] * self[scalar]),
                (right_anti_dual[e4] * self[e31]) + (right_anti_dual[e431] * self[scalar]),
                (right_anti_dual[e4] * self[e12]) + (right_anti_dual[e412] * self[scalar]),
                -(right_anti_dual[e2] * self[e31]) - (right_anti_dual[e3] * self[e12]),
            ]) + (right_anti_dual.group0().zxy() * self.group0().yzx()).with_w(right_anti_dual[e321] * self[scalar])
                - (right_anti_dual.group0().yzxx() * self.group0().zxy().with_w(self[e23])),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
...
impl ProjectOrthogonallyOnto<Horizon> for Motor {
    ...
    fn project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        let wedge = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(self[scalar] * right_anti_dual[e4]),
            // e423, e431, e412, e321
            Simd32x4::from([right_anti_dual[e4], right_anti_dual[e4], right_anti_dual[e4], 0.0]) * self.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(0.0),
...
impl ProjectOrthogonallyOnto<Line> for Motor {
    ...
    fn project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x3::from(1.0).with_w(0.0) * right_anti_dual.group1().with_w(0.0) * self.group1().www().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
...
impl ProjectOrthogonallyOnto<Motor> for Motor {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x3::from(0.0).with_w(right_anti_dual[scalar] * self[scalar]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((Simd32x3::from(other[e1234]) * wedge.group0().xyz()) + (Simd32x3::from(wedge[e1234]) * other.group0().xyz())).with_w(other[e1234] * wedge[e1234]),
...
impl ProjectOrthogonallyOnto<MultiVector> for Motor {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            Simd32x4::from(self[scalar]) * right_anti_dual.group1(),
            // e41, e42, e43
            (Simd32x3::from(self[scalar]) * right_anti_dual.group2()) + (Simd32x3::from(right_anti_dual[scalar]) * self.group0().xyz()),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            Simd32x4::from([
                ...
                -(self[e31] * right_anti_dual[e2]) - (self[e12] * right_anti_dual[e3]),
            ]) + (self.group0().yzx() * right_anti_dual.group1().zxy()).with_w(self[scalar] * right_anti_dual[e321])
                - (right_anti_dual.group1().yzxx() * self.group0().zxy().with_w(self[e23])),
        );
        return MultiVector::from_groups(
            // scalar, e1234
    ...
    fn project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (right_anti_dual.group0().yzxx() * self.group2().zxy().with_w(self[e23])),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl ProjectOrthogonallyOnto<Horizon> for MultiVector {
    ...
    fn project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            Simd32x4::from([right_anti_dual[e4], right_anti_dual[e4], right_anti_dual[e4], 0.0]) * self.group3().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([other[e321] * wedge[e4], 1.0]) * Simd32x2::from([-1.0, 0.0]),
            // e1, e2, e3, e4
            Simd32x4::from([other[e321], other[e321], other[e321], 0.0]) * wedge.group2().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
            // e41, e42, e43
            Simd32x3::from(0.0),
            // e23, e31, e12
...
impl ProjectOrthogonallyOnto<Line> for MultiVector {
    ...
    fn project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            Simd32x3::from(self[scalar]) * right_anti_dual.group1(),
            // e423, e431, e412, e321
            (Simd32x3::from(self[e4]) * right_anti_dual.group1()).with_w(0.0) + (right_anti_dual.group0().yzx() * self.group1().zxy()).with_w(0.0)
                - (right_anti_dual.group0().zxy() * self.group1().yzx()).with_w(0.0),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl ProjectOrthogonallyOnto<Motor> for MultiVector {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            // e41, e42, e43
            (Simd32x3::from(right_anti_dual[scalar]) * self.group2()) + (Simd32x3::from(self[scalar]) * right_anti_dual.group0().xyz()),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            (Simd32x3::from(right_anti_dual[scalar]) * self.group4().xyz()).with_w(0.0)
                + (Simd32x3::from(self[e4]) * right_anti_dual.group1().xyz()).with_w(0.0)
                + (right_anti_dual.group0().yzx() * self.group1().zxy()).with_w(0.0)
                - (right_anti_dual.group0().zxy() * self.group1().yzx()).with_w(0.0),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            ...
            // e423, e431, e412, e321
            Simd32x4::from(other[e1234]) * wedge.group4(),
        );
    }
}
impl ProjectOrthogonallyOnto<MultiVector> for MultiVector {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[scalar]) * self.group3())
                + (Simd32x3::from(self[scalar]) * right_anti_dual.group3())
                + (right_anti_dual.group1().zxy() * self.group1().yzx())
                - (right_anti_dual.group1().yzx() * self.group1().zxy()),
            // e423, e431, e412, e321
            Simd32x4::from([
                (right_anti_dual[e3] * self[e42]) + (right_anti_dual[e4] * self[e23]) + (right_anti_dual[e42] * self[e3]) + (right_anti_dual[e23] * self[e4]),
                (right_anti_dual[e1] * self[e43]) + (right_anti_dual[e4] * self[e31]) + (right_anti_dual[e43] * self[e1]) + (right_anti_dual[e31] * self[e4]),
                (right_anti_dual[e2] * self[e41]) + (right_anti_dual[e4] * self[e12]) + (right_anti_dual[e41] * self[e2]) + (right_anti_dual[e12] * self[e4]),
                -(right_anti_dual[e1] * self[e23]) - (right_anti_dual[e2] * self[e31]) - (right_anti_dual[e3] * self[e12]) - (right_anti_dual[e12] * self[e3]),
            ]) + (Simd32x4::from(right_anti_dual[scalar]) * self.group4())
                + (Simd32x4::from(self[scalar]) * right_anti_dual.group4())
                - (self.group1().yzxx() * right_anti_dual.group2().zxy().with_w(right_anti_dual[e23]))
                - (self.group2().zxy() * right_anti_dual.group1().yzx()).with_w(right_anti_dual[e31] * self[e2]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl ProjectOrthogonallyOnto<Flector> for Origin {
    ...
    fn project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(self[e4]) * right_anti_dual.group0().xyz().with_w(right_anti_dual[e321]),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        );
        return Flector::from_groups(
...
impl ProjectOrthogonallyOnto<Motor> for Origin {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(right_anti_dual[scalar] * self[e4]),
            // e423, e431, e412, e321
            Simd32x4::from([self[e4], self[e4], self[e4], 0.0]) * right_anti_dual.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
...
impl ProjectOrthogonallyOnto<MultiVector> for Origin {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([1.0, right_anti_dual[e321] * self[e4]]) * Simd32x2::from([0.0, 1.0]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(right_anti_dual[scalar] * self[e4]),
            // e41, e42, e43
            Simd32x3::from(self[e4]) * right_anti_dual.group1().xyz(),
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            Simd32x4::from([self[e4], self[e4], self[e4], 0.0]) * right_anti_dual.group3().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        return Plane::from_groups(
            ...
            Simd32x4::from(other[e1234])
                * Simd32x4::from([
                    right_anti_dual[scalar] * self[e423],
                    right_anti_dual[scalar] * self[e431],
                    right_anti_dual[scalar] * self[e412],
                    right_anti_dual[scalar] * self[e321],
                ]),
        );
    }
}
...
impl ProjectOrthogonallyOnto<Flector> for Point {
    ...
    fn project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let wedge = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from([
                right_anti_dual[e4] * self[e1] * -1.0,
                right_anti_dual[e4] * self[e2] * -1.0,
                right_anti_dual[e4] * self[e3] * -1.0,
                (right_anti_dual[e431] * self[e2]) + (right_anti_dual[e412] * self[e3]) + (right_anti_dual[e321] * self[e4]),
            ]) + (self.group0().wwwx() * right_anti_dual.group0().xyz().with_w(right_anti_dual[e423])),
            // e23, e31, e12, scalar
            ((right_anti_dual.group0().zxy() * self.group0().yzx()) - (right_anti_dual.group0().yzx() * self.group0().zxy())).with_w(0.0),
    ...
    fn project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        return Point::from_groups(
            ...
            Simd32x4::from([other[e321], other[e321], other[e321], 0.0])
                * Simd32x3::from([right_anti_dual[e4] * self[e1] * -1.0, right_anti_dual[e4] * self[e2] * -1.0, right_anti_dual[e4] * self[e3] * -1.0]).with_w(0.0)
...
impl ProjectOrthogonallyOnto<Motor> for Point {
    ...
    fn project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let wedge = Flector::from_groups(
            ...
            Simd32x4::from(right_anti_dual[scalar]) * self.group0(),
            // e423, e431, e412, e321
            (Simd32x3::from(self[e4]) * right_anti_dual.group1().xyz()).with_w(0.0) + (right_anti_dual.group0().yzx() * self.group0().zxy()).with_w(0.0)
                - (right_anti_dual.group0().zxy() * self.group0().yzx()).with_w(0.0),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
...
impl ProjectOrthogonallyOnto<MultiVector> for Point {
    ...
    fn project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let wedge = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            (Simd32x3::from(self[e4]) * right_anti_dual.group3()).with_w(0.0) + (right_anti_dual.group2().yzx() * self.group0().zxy()).with_w(0.0)
                - (right_anti_dual.group2().zxy() * self.group0().yzx()).with_w(0.0),
        );
        return MultiVector::from_groups(
            // scalar, e1234
...
impl ProjectOrthogonallyOnto<Horizon> for Scalar {
    ...
    fn project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Scalar::from_groups(/* scalar */ other[e321] * right_anti_dual[e4] * self[scalar] * -1.0);
    }
}
...
impl ProjectOrthogonallyOnto<Plane> for Scalar {
    ...
    fn project_orthogonally_onto(self, other: Plane) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Scalar::from_groups(/* scalar */ right_anti_dual[e4] * other[e321] * self[scalar] * -1.0);
    }
}
