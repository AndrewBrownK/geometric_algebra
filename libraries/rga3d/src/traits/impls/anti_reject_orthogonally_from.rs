...
impl AntiRejectOrthogonallyFrom<DualNum> for AntiScalar {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        ...
        return AntiScalar::from_groups(/* e1234 */ right_anti_dual[e1234] * wedge[e1234]);
    }
}
impl AntiRejectOrthogonallyFrom<Motor> for AntiScalar {
    ...
    fn anti_reject_orthogonally_from(self, other: Motor) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(wedge[e1234]) * right_anti_dual.group0(),
            // e23, e31, e12, scalar
            Simd32x4::from(wedge[e1234]) * right_anti_dual.group1(),
        );
    }
}
impl AntiRejectOrthogonallyFrom<MultiVector> for AntiScalar {
    ...
    fn anti_reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from(wedge[e1234]) * right_anti_dual.group0(),
            // e1, e2, e3, e4
            Simd32x4::from(wedge[e1234]) * right_anti_dual.group1(),
            // e41, e42, e43
            Simd32x3::from(wedge[e1234]) * right_anti_dual.group2(),
            // e23, e31, e12
            Simd32x3::from(wedge[e1234]) * right_anti_dual.group3(),
            // e423, e431, e412, e321
            Simd32x4::from(wedge[e1234]) * right_anti_dual.group4(),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let wedge = DualNum::from_groups(
            // scalar, e1234
            Simd32x2::from([other[scalar] * self[scalar], (other[scalar] * self[e1234]) + (other[e1234] * self[scalar])]),
        );
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(right_anti_dual[e1234]) * wedge.group0());
    }
}
impl AntiRejectOrthogonallyFrom<Flector> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((right_anti_dual.group1().yzx() * wedge.group1().zxy()) - (right_anti_dual.group1().zxy() * wedge.group1().yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            (right_anti_dual.group1().wwwx() * wedge.group1().xyz().with_w(wedge[e1]))
                + Simd32x3::from(0.0).with_w(
                    (right_anti_dual[e431] * wedge[e2]) + (right_anti_dual[e412] * wedge[e3]) + (right_anti_dual[e321] * wedge[e4])
                        - (right_anti_dual[e2] * wedge[e431])
                        - (right_anti_dual[e3] * wedge[e412])
                        - (right_anti_dual[e4] * wedge[e321]),
                )
                - (wedge.group1().wwwx() * right_anti_dual.group1().xyz().with_w(right_anti_dual[e1])),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Horizon> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        let wedge = Horizon::from_groups(/* e321 */ self[scalar] * other[e321]);
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Scalar::from_groups(/* scalar */ wedge[e321] * right_anti_dual[e4] * -1.0);
    }
}
impl AntiRejectOrthogonallyFrom<Line> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: Line) -> Self::Output {
        ...
        return Scalar::from_groups(
            // scalar
            -(right_anti_dual[e41] * wedge[e23])
                - (right_anti_dual[e42] * wedge[e31])
                - (right_anti_dual[e43] * wedge[e12])
                - (right_anti_dual[e23] * wedge[e41])
                - (right_anti_dual[e31] * wedge[e42])
                - (right_anti_dual[e12] * wedge[e43]),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Motor> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: Motor) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((Simd32x3::from(right_anti_dual[e1234]) * wedge.group0().xyz()) + (Simd32x3::from(wedge[e1234]) * right_anti_dual.group0().xyz()))
                .with_w(right_anti_dual[e1234] * wedge[e1234]),
            // e23, e31, e12, scalar
            (Simd32x4::from(right_anti_dual[e1234]) * wedge.group1())
                + (Simd32x4::from(wedge[e1234]) * right_anti_dual.group1())
                + Simd32x3::from(0.0).with_w(
                    -(right_anti_dual[e41] * wedge[e23])
                        - (right_anti_dual[e42] * wedge[e31])
...
impl AntiRejectOrthogonallyFrom<MultiVector> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (right_anti_dual[scalar] * wedge[e1234])
                    + (right_anti_dual[e1234] * wedge[scalar])
                    + (right_anti_dual[e423] * wedge[e1])
                    + (right_anti_dual[e431] * wedge[e2])
                    + (right_anti_dual[e412] * wedge[e3])
                    + (right_anti_dual[e321] * wedge[e4])
                    - (right_anti_dual[e1] * wedge[e423])
                    - (right_anti_dual[e2] * wedge[e431])
                    - (right_anti_dual[e3] * wedge[e412])
                    - (right_anti_dual[e4] * wedge[e321])
                    - (right_anti_dual[e41] * wedge[e23])
                    ...
                    - (right_anti_dual[e31] * wedge[e42])
                    - (right_anti_dual[e12] * wedge[e43]),
                right_anti_dual[e1234] * wedge[e1234],
            ]),
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e41] * wedge[e321]) + (right_anti_dual[e31] * wedge[e412]) + (right_anti_dual[e412] * wedge[e31]) + (right_anti_dual[e321] * wedge[e41]),
                (right_anti_dual[e42] * wedge[e321]) + (right_anti_dual[e12] * wedge[e423]) + (right_anti_dual[e423] * wedge[e12]) + (right_anti_dual[e321] * wedge[e42]),
                (right_anti_dual[e43] * wedge[e321]) + (right_anti_dual[e23] * wedge[e431]) + (right_anti_dual[e431] * wedge[e23]) + (right_anti_dual[e321] * wedge[e43]),
                -(right_anti_dual[e43] * wedge[e412]) - (right_anti_dual[e423] * wedge[e41]) - (right_anti_dual[e431] * wedge[e42]) - (right_anti_dual[e412] * wedge[e43]),
            ]) + (Simd32x4::from(right_anti_dual[e1234]) * wedge.group1())
                + (Simd32x4::from(wedge[e1234]) * right_anti_dual.group1())
                - (wedge.group4().yzxx() * right_anti_dual.group3().zxy().with_w(right_anti_dual[e41]))
                - (wedge.group3().zxy() * right_anti_dual.group4().yzx()).with_w(right_anti_dual[e42] * wedge[e431]),
            // e41, e42, e43
            (Simd32x3::from(right_anti_dual[e1234]) * wedge.group2())
                + (Simd32x3::from(wedge[e1234]) * right_anti_dual.group2())
                + (right_anti_dual.group4().yzx() * wedge.group4().zxy())
                - (right_anti_dual.group4().zxy() * wedge.group4().yzx()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e1234]) * wedge.group3())
                + (Simd32x3::from(right_anti_dual[e321]) * wedge.group4().xyz())
                + (Simd32x3::from(wedge[e1234]) * right_anti_dual.group3())
                - (Simd32x3::from(wedge[e321]) * right_anti_dual.group4().xyz()),
            // e423, e431, e412, e321
            (Simd32x4::from(right_anti_dual[e1234]) * wedge.group4()) + (Simd32x4::from(wedge[e1234]) * right_anti_dual.group4()),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Plane> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: Plane) -> Self::Output {
        use crate::elements::*;
        let wedge = Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(self[scalar]) * other.group0());
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Scalar::from_groups(/* scalar */ right_anti_dual[e4] * wedge[e321] * -1.0);
    }
}
...
impl AntiRejectOrthogonallyFrom<Scalar> for DualNum {
    ...
    fn anti_reject_orthogonally_from(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let wedge = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(other[scalar]) * self.group0());
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(right_anti_dual[e1234]) * wedge.group0());
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        ...
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(right_anti_dual[e1234]) * wedge.group0(),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * wedge.group1(),
        );
    }
...
impl AntiRejectOrthogonallyFrom<Flector> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e412] * wedge[e31]) + (right_anti_dual[e321] * wedge[e41]),
                (right_anti_dual[e423] * wedge[e12]) + (right_anti_dual[e321] * wedge[e42]),
                (right_anti_dual[e431] * wedge[e23]) + (right_anti_dual[e321] * wedge[e43]),
                -(right_anti_dual[e431] * wedge[e42]) - (right_anti_dual[e412] * wedge[e43]),
            ]) + (Simd32x4::from(wedge[e1234]) * right_anti_dual.group0())
                - (right_anti_dual.group1().yzxx() * wedge.group1().zxy().with_w(wedge[e41])),
            // e423, e431, e412, e321
            Simd32x3::from(1.0).with_w(0.0) * wedge.group0().www().with_w(0.0) * right_anti_dual.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Horizon> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        let wedge = AntiScalar::from_groups(/* e1234 */ self[e4] * other[e321]);
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Origin::from_groups(/* e4 */ wedge[e1234] * right_anti_dual[e4]);
    }
}
impl AntiRejectOrthogonallyFrom<Line> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Line) -> Self::Output {
        ...
        return Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e41] * wedge[e321]) + (right_anti_dual[e31] * wedge[e412]),
                (right_anti_dual[e42] * wedge[e321]) + (right_anti_dual[e12] * wedge[e423]),
                (right_anti_dual[e43] * wedge[e321]) + (right_anti_dual[e23] * wedge[e431]),
                -(right_anti_dual[e42] * wedge[e431]) - (right_anti_dual[e43] * wedge[e412]),
            ]) - (wedge.group0().yzxx() * right_anti_dual.group1().zxy().with_w(right_anti_dual[e41])),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Motor> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Motor) -> Self::Output {
        ...
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (wedge[e412] * right_anti_dual[e31]) + (wedge[e321] * right_anti_dual[e41]),
                (wedge[e423] * right_anti_dual[e12]) + (wedge[e321] * right_anti_dual[e42]),
                (wedge[e431] * right_anti_dual[e23]) + (wedge[e321] * right_anti_dual[e43]),
                -(wedge[e431] * right_anti_dual[e42]) - (wedge[e412] * right_anti_dual[e43]),
            ]) + (Simd32x4::from(right_anti_dual[e1234]) * wedge.group0())
                - (wedge.group1().yzxx() * right_anti_dual.group1().zxy().with_w(right_anti_dual[e41])),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * wedge.group1(),
        );
    }
...
impl AntiRejectOrthogonallyFrom<Point> for Flector {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (wedge[e41] * right_anti_dual[e321]) + (wedge[e31] * right_anti_dual[e412]),
                (wedge[e42] * right_anti_dual[e321]) + (wedge[e12] * right_anti_dual[e423]),
                (wedge[e43] * right_anti_dual[e321]) + (wedge[e23] * right_anti_dual[e431]),
                -(wedge[e42] * right_anti_dual[e431]) - (wedge[e43] * right_anti_dual[e412]),
            ]) - (right_anti_dual.group0().yzxx() * wedge.group1().zxy().with_w(wedge[e41])),
            // e423, e431, e412, e321
            Simd32x3::from(1.0).with_w(0.0) * wedge.group0().www().with_w(0.0) * right_anti_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for Horizon {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let wedge = Horizon::from_groups(/* e321 */ other[scalar] * self[e321]);
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return Horizon::from_groups(/* e321 */ right_anti_dual[e1234] * wedge[e321]);
    }
}
...
impl AntiRejectOrthogonallyFrom<Motor> for Horizon {
    ...
    fn anti_reject_orthogonally_from(self, other: Motor) -> Self::Output {
        ...
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([wedge[e321], wedge[e321], wedge[e321], 0.0]) * right_anti_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
            // e423, e431, e412, e321
            Simd32x3::from(0.0).with_w(wedge[e321] * right_anti_dual[e1234]),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<Point> for Horizon {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        let right_anti_dual = Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from([other[e1], other[e2], other[e3], 0.0]));
        return Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(wedge[e1234]) * right_anti_dual.group0());
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for Line {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        ...
        return Line::from_groups(
            // e41, e42, e43
            Simd32x3::from(right_anti_dual[e1234]) * wedge.group0(),
            // e23, e31, e12
            Simd32x3::from(right_anti_dual[e1234]) * wedge.group1(),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Flector> for Line {
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((right_anti_dual.group1().yzx() * wedge.group0().zxy()) - (right_anti_dual.group1().zxy() * wedge.group0().yzx())).with_w(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_anti_dual[e321] * wedge[e423],
                right_anti_dual[e321] * wedge[e431],
                right_anti_dual[e321] * wedge[e412],
                -(right_anti_dual[e2] * wedge[e431]) - (right_anti_dual[e3] * wedge[e412]) - (right_anti_dual[e4] * wedge[e321]),
            ]) - (wedge.group0().wwwx() * right_anti_dual.group1().xyz().with_w(right_anti_dual[e1])),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Line> for Line {
    ...
    fn anti_reject_orthogonally_from(self, other: Line) -> Self::Output {
        ...
        return Line::from_groups(
            // e41, e42, e43
            Simd32x3::from(wedge[e1234]) * right_anti_dual.group0(),
            // e23, e31, e12
            Simd32x3::from(0.0),
        );
    }
...
impl AntiRejectOrthogonallyFrom<Point> for Line {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        return Line::from_groups(
            ...
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * wedge.group0().xyz()) - (Simd32x3::from(wedge[e321]) * right_anti_dual.group0().xyz()),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<Horizon> for Motor {
    ...
    fn anti_reject_orthogonally_from(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        let wedge = Horizon::from_groups(/* e321 */ other[e321] * self[scalar]);
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Scalar::from_groups(/* scalar */ wedge[e321] * right_anti_dual[e4] * -1.0);
    }
}
impl AntiRejectOrthogonallyFrom<Line> for Motor {
    ...
    fn anti_reject_orthogonally_from(self, other: Line) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x3::from(1.0).with_w(0.0) * right_anti_dual.group0().with_w(0.0) * wedge.group0().www().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
            // e23, e31, e12, scalar
            Simd32x3::from(0.0).with_w(
                -(right_anti_dual[e41] * wedge[e23])
                    - (right_anti_dual[e42] * wedge[e31])
...
impl AntiRejectOrthogonallyFrom<Point> for Motor {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            ((wedge.group1().zxy() * right_anti_dual.group0().yzx()) - (wedge.group1().yzx() * right_anti_dual.group0().zxy())).with_w(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from([
                wedge[e321] * right_anti_dual[e423] * -1.0,
                wedge[e321] * right_anti_dual[e431] * -1.0,
                wedge[e321] * right_anti_dual[e412] * -1.0,
                (wedge[e2] * right_anti_dual[e431]) + (wedge[e3] * right_anti_dual[e412]) + (wedge[e4] * right_anti_dual[e321]),
            ]) + (right_anti_dual.group0().wwwx() * wedge.group1().xyz().with_w(wedge[e1])),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for MultiVector {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        ...
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from(right_anti_dual[e1234]) * wedge.group0(),
            // e1, e2, e3, e4
            Simd32x4::from(right_anti_dual[e1234]) * wedge.group1(),
            // e41, e42, e43
            Simd32x3::from(right_anti_dual[e1234]) * wedge.group2(),
            ...
            Simd32x3::from(right_anti_dual[e1234]) * wedge.group3(),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * wedge.group4(),
        );
    }
}
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (right_anti_dual.group1().yzxx() * wedge.group3().zxy().with_w(wedge[e41])),
            // e41, e42, e43
            (right_anti_dual.group1().yzx() * wedge.group4().zxy()) - (right_anti_dual.group1().zxy() * wedge.group4().yzx()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * wedge.group4().xyz()) - (Simd32x3::from(wedge[e321]) * right_anti_dual.group1().xyz()),
            // e423, e431, e412, e321
            wedge.group0().yy().with_zw(wedge[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_anti_dual.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
impl AntiRejectOrthogonallyFrom<Horizon> for MultiVector {
    ...
    fn anti_reject_orthogonally_from(self, other: Horizon) -> Self::Output {
        ...
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([wedge[e321] * right_anti_dual[e4], 1.0]) * Simd32x2::from([-1.0, 0.0]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(wedge[e1234] * right_anti_dual[e4]),
            // e41, e42, e43
            Simd32x3::from(0.0),
            // e23, e31, e12
            Simd32x3::from(0.0),
    ...
    fn anti_reject_orthogonally_from(self, other: Line) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                (right_anti_dual[e43] * wedge[e321]) + (right_anti_dual[e23] * wedge[e431]),
                -(right_anti_dual[e42] * wedge[e431]) - (right_anti_dual[e43] * wedge[e412]),
            ]) - (wedge.group4().yzxx() * right_anti_dual.group1().zxy().with_w(right_anti_dual[e41])),
            // e41, e42, e43
            Simd32x3::from(wedge[e1234]) * right_anti_dual.group0(),
            // e23, e31, e12
            Simd32x3::from(0.0),
...
impl AntiRejectOrthogonallyFrom<Motor> for MultiVector {
    ...
    fn anti_reject_orthogonally_from(self, other: Motor) -> Self::Output {
        ...
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (right_anti_dual[e1234] * wedge[scalar]) + (right_anti_dual[scalar] * wedge[e1234])
                    - (right_anti_dual[e41] * wedge[e23])
                    - (right_anti_dual[e42] * wedge[e31])
                    - (right_anti_dual[e43] * wedge[e12])
                    - (right_anti_dual[e23] * wedge[e41])
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e1234] * wedge[e1]) + (right_anti_dual[e31] * wedge[e412]),
                (right_anti_dual[e1234] * wedge[e2]) + (right_anti_dual[e12] * wedge[e423]),
                (right_anti_dual[e1234] * wedge[e3]) + (right_anti_dual[e23] * wedge[e431]),
                -(right_anti_dual[e42] * wedge[e431]) - (right_anti_dual[e43] * wedge[e412]),
            ]) + (right_anti_dual.group0() * wedge.group4().www().with_w(wedge[e4]))
                - (wedge.group4().yzxx() * right_anti_dual.group1().zxy().with_w(right_anti_dual[e41])),
            // e41, e42, e43
            (Simd32x3::from(right_anti_dual[e1234]) * wedge.group2()) + (Simd32x3::from(wedge[e1234]) * right_anti_dual.group0().xyz()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e1234]) * wedge.group3()) + (Simd32x3::from(wedge[e1234]) * right_anti_dual.group1().xyz()),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * wedge.group4(),
        );
    }
...
impl AntiRejectOrthogonallyFrom<Point> for MultiVector {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (wedge[e1] * right_anti_dual[e423]) + (wedge[e2] * right_anti_dual[e431]) + (wedge[e3] * right_anti_dual[e412]) + (wedge[e4] * right_anti_dual[e321]),
                0.0,
            ]),
            // e1, e2, e3, e4
            Simd32x4::from([
                ...
                (wedge[e43] * right_anti_dual[e321]) + (wedge[e23] * right_anti_dual[e431]),
                -(wedge[e42] * right_anti_dual[e431]) - (wedge[e43] * right_anti_dual[e412]),
            ]) - (right_anti_dual.group0().yzxx() * wedge.group3().zxy().with_w(wedge[e41])),
            // e41, e42, e43
            (wedge.group4().zxy() * right_anti_dual.group0().yzx()) - (wedge.group4().yzx() * right_anti_dual.group0().zxy()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * wedge.group4().xyz()) - (Simd32x3::from(wedge[e321]) * right_anti_dual.group0().xyz()),
            // e423, e431, e412, e321
            wedge.group0().yy().with_zw(wedge[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_anti_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for Origin {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let wedge = Origin::from_groups(/* e4 */ other[scalar] * self[e4]);
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return Origin::from_groups(/* e4 */ right_anti_dual[e1234] * wedge[e4]);
    }
}
...
impl AntiRejectOrthogonallyFrom<Horizon> for Origin {
    ...
    fn anti_reject_orthogonally_from(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        let wedge = AntiScalar::from_groups(/* e1234 */ other[e321] * self[e4]);
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        return Origin::from_groups(/* e4 */ wedge[e1234] * right_anti_dual[e4]);
    }
}
...
impl AntiRejectOrthogonallyFrom<MultiVector> for Origin {
    ...
    fn anti_reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            ((Simd32x3::from(right_anti_dual[e1234]) * wedge.group4().xyz()) + (Simd32x3::from(wedge[e1234]) * right_anti_dual.group4().xyz())).with_w(0.0),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<Scalar> for Origin {
    ...
    fn anti_reject_orthogonally_from(self, other: Scalar) -> Self::Output {
        use crate::elements::*;
        let wedge = Origin::from_groups(/* e4 */ self[e4] * other[scalar]);
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return Origin::from_groups(/* e4 */ right_anti_dual[e1234] * wedge[e4]);
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for Plane {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        ...
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(right_anti_dual[e1234]) * wedge.group0());
    }
}
impl AntiRejectOrthogonallyFrom<Flector> for Plane {
    ...
    fn anti_reject_orthogonally_from(self, other: Flector) -> Self::Output {
        ...
        return Flector::from_groups(
            ...
            Simd32x4::from(wedge[e1234]) * right_anti_dual.group0(),
            // e423, e431, e412, e321
            Simd32x4::from([wedge[e1234], wedge[e1234], wedge[e1234], 0.0]) * right_anti_dual.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<Point> for Plane {
    ...
    fn anti_reject_orthogonally_from(self, other: Point) -> Self::Output {
        ...
        return Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([wedge[e1234], wedge[e1234], wedge[e1234], 0.0]) * right_anti_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for Point {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let wedge = Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(other[scalar]) * self.group0());
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(right_anti_dual[e1234]) * wedge.group0());
    }
}
...
impl AntiRejectOrthogonallyFrom<DualNum> for Scalar {
    ...
    fn anti_reject_orthogonally_from(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let wedge = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(self[scalar]) * other.group0());
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(right_anti_dual[e1234]) * wedge.group0());
    }
}
...
impl AntiRejectOrthogonallyFrom<Scalar> for Scalar {
    ...
    fn anti_reject_orthogonally_from(self, other: Scalar) -> Self::Output {
        ...
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        return Scalar::from_groups(/* scalar */ right_anti_dual[e1234] * wedge[scalar]);
    }
}
