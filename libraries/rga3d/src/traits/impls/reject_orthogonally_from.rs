...
impl RejectOrthogonallyFrom<Plane> for Horizon {
    ...
    fn reject_orthogonally_from(self, other: Plane) -> Self::Output {
        ...
        return Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([right_anti_dual[e4], right_anti_dual[e4], right_anti_dual[e4], 0.0])
...
impl RejectOrthogonallyFrom<MultiVector> for Scalar {
    ...
    fn reject_orthogonally_from(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            Simd32x4::from([anti_wedge[scalar], anti_wedge[scalar], anti_wedge[scalar], 0.0]) * right_anti_dual.group4().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
    }
}
