...
impl AntiProjectOrthogonallyOnto<Line> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let anti_wedge = Line::from_groups(
            // e41, e42, e43
            Simd32x3::from(self[e1234]) * Simd32x3::from([other[e23] * -1.0, other[e31] * -1.0, other[e12] * -1.0]),
            // e23, e31, e12
            Simd32x3::from(0.0),
        );
...
impl AntiProjectOrthogonallyOnto<Motor> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            // e41, e42, e43, e1234
            Simd32x4::from(self[e1234]) * Simd32x4::from([other[e23] * -1.0, other[e31] * -1.0, other[e12] * -1.0, other[scalar]]),
            // e23, e31, e12, scalar
            Simd32x4::from(0.0),
        );
        return Motor::from_groups(
...
impl AntiProjectOrthogonallyOnto<MultiVector> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([1.0, self[e1234] * right_anti_dual[e1234]]) * Simd32x2::from([0.0, 1.0]),
            // e1, e2, e3, e4
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            (Simd32x3::from(self[e1234]) * right_anti_dual.group4().xyz()).with_w(0.0),
        );
...
impl AntiProjectOrthogonallyOnto<Point> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let anti_wedge = Plane::from_groups(/* e423, e431, e412, e321 */ (Simd32x3::from(self[e1234]) * other.group0().xyz()).with_w(0.0));
        return AntiScalar::from_groups(
            // e1234
...
impl AntiProjectOrthogonallyOnto<Flector> for DualNum {
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Flector::from_groups(
            ...
            Simd32x4::from(self[e1234]) * right_anti_dual.group0(),
            // e423, e431, e412, e321
            self.group0().yy().with_zw(self[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_anti_dual.group1().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            (other.group0().wwwx() * anti_wedge.group0().xyz().with_w(anti_wedge[e423]))
...
impl AntiProjectOrthogonallyOnto<Motor> for DualNum {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            Simd32x4::from(self[e1234]) * right_anti_dual.group0(),
            // e23, e31, e12, scalar
            Simd32x3::from(0.0).with_w((self[scalar] * right_anti_dual[e1234]) + (self[e1234] * right_anti_dual[scalar])),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x4::from(anti_wedge[scalar]) * other.group0())
...
impl AntiProjectOrthogonallyOnto<MultiVector> for DualNum {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            self.group0().yy().with_zw(self[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_anti_dual.group4().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl AntiProjectOrthogonallyOnto<Point> for Flector {
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = Plane::from_groups(/* e423, e431, e412, e321 */ other.group0().xyz().with_w(0.0));
        let anti_wedge = Motor::from_groups(
            // e41, e42, e43, e1234
...
impl AntiProjectOrthogonallyOnto<Line> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let anti_wedge = Point::from_groups(
            // e1, e2, e3, e4
            (Simd32x3::from(self[e321]) * Simd32x3::from([other[e23] * -1.0, other[e31] * -1.0, other[e12] * -1.0])).with_w(0.0),
        );
        return Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([
...
impl AntiProjectOrthogonallyOnto<Motor> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Flector::from_groups(
            // e1, e2, e3, e4
            (Simd32x3::from(self[e321]) * right_anti_dual.group0().xyz()).with_w(0.0),
            // e423, e431, e412, e321
...
impl AntiProjectOrthogonallyOnto<MultiVector> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            (Simd32x3::from(self[e321]) * right_anti_dual.group2()).with_w(0.0),
            // e41, e42, e43
            Simd32x3::from(0.0),
            // e23, e31, e12
...
impl AntiProjectOrthogonallyOnto<Motor> for Line {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            (Simd32x3::from(right_anti_dual[e1234]) * self.group1()).with_w(
...
impl AntiProjectOrthogonallyOnto<DualNum> for Motor {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            other.group0().xx().with_zw(other[scalar], (other[scalar] * anti_wedge[e1234]) + (other[e1234] * anti_wedge[scalar])) * anti_wedge.group0().xyz().with_w(1.0),
            // e23, e31, e12, scalar
            Simd32x4::from(other[scalar]) * anti_wedge.group1(),
        );
    }
...
impl AntiProjectOrthogonallyOnto<Line> for Motor {
    ...
    fn anti_project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        return Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x3::from(anti_wedge[scalar]) * other.group0()).with_w(
...
impl AntiProjectOrthogonallyOnto<MultiVector> for Motor {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x3::from(1.0).with_w(0.0) * self.group0().www().with_w(0.0) * right_anti_dual.group4().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl AntiProjectOrthogonallyOnto<Point> for MultiVector {
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e423, e431, e412, e321
            self.group0().yy().with_zw(self[e1234], 0.0) * Simd32x3::from(1.0).with_w(0.0) * right_anti_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
...
impl AntiProjectOrthogonallyOnto<Motor> for Origin {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        return Flector::from_groups(
            ...
            // e423, e431, e412, e321
            (Simd32x3::from(anti_wedge[e4]) * other.group1().xyz()).with_w(0.0),
        );
    }
}
impl AntiProjectOrthogonallyOnto<MultiVector> for Origin {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        use crate::elements::*;
        let anti_wedge = Origin::from_groups(/* e4 */ other[scalar] * self[e4]);
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([1.0, other[e321] * anti_wedge[e4]]) * Simd32x2::from([0.0, -1.0]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(other[scalar] * anti_wedge[e4]),
            // e41, e42, e43
            Simd32x3::from(anti_wedge[e4]) * other.group1().xyz() * Simd32x3::from(-1.0),
            // e23, e31, e12
            Simd32x3::from(0.0),
            // e423, e431, e412, e321
            (Simd32x3::from(anti_wedge[e4]) * other.group3()).with_w(0.0),
        );
    }
}
