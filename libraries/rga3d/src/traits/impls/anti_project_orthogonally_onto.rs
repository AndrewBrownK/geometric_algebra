...
//  Average:        16      30       0
//  Maximum:       130     166       0
impl std::ops::Div<anti_project_orthogonally_onto> for AntiScalar {
    type Output = anti_project_orthogonally_onto_partial<AntiScalar>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        ...
        let anti_wedge = AntiScalar::from_groups(/* e1234 */ right_anti_dual[e1234] * self[e1234]);
        return AntiScalar::from_groups(/* e1234 */ anti_wedge[e1234] * other[scalar]);
    }
}
impl AntiProjectOrthogonallyOnto<Flector> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Flector::from_groups(
            ...
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * right_anti_dual.group1(),
        );
...
impl AntiProjectOrthogonallyOnto<Horizon> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        let anti_wedge = Origin::from_groups(/* e4 */ self[e1234] * right_anti_dual[e4]);
        return AntiScalar::from_groups(/* e1234 */ other[e321] * anti_wedge[e4] * -1.0);
    }
}
...
impl AntiProjectOrthogonallyOnto<MultiVector> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from(self[e1234]) * right_anti_dual.group0(),
            // e1, e2, e3, e4
            Simd32x4::from(self[e1234]) * right_anti_dual.group1(),
            // e41, e42, e43
            Simd32x3::from(self[e1234]) * right_anti_dual.group2(),
            // e23, e31, e12
            Simd32x3::from(self[e1234]) * right_anti_dual.group3(),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * right_anti_dual.group4(),
        );
...
impl AntiProjectOrthogonallyOnto<Plane> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: Plane) -> Self::Output {
        ...
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        let anti_wedge = Origin::from_groups(/* e4 */ self[e1234] * right_anti_dual[e4]);
        return AntiScalar::from_groups(/* e1234 */ anti_wedge[e4] * other[e321] * -1.0);
    }
}
impl AntiProjectOrthogonallyOnto<Point> for AntiScalar {
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge = Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(self[e1234]) * right_anti_dual.group0());
        return AntiScalar::from_groups(
            // e1234
...
impl std::ops::Div<anti_project_orthogonally_onto> for DualNum {
    type Output = anti_project_orthogonally_onto_partial<DualNum>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for DualNum {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(right_anti_dual[e1234]) * self.group0());
...
impl AntiProjectOrthogonallyOnto<Motor> for DualNum {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            Simd32x4::from(self[e1234]) * right_anti_dual.group0(),
            // e23, e31, e12, scalar
            Simd32x4::from([right_anti_dual[e23], right_anti_dual[e31], right_anti_dual[e12], 1.0])
                * self
                    .group0()
                    .yy()
                    .with_zw(self[e1234], (self[scalar] * right_anti_dual[e1234]) + (self[e1234] * right_anti_dual[scalar])),
        );
        return Motor::from_groups(
            // e41, e42, e43, e1234
            (Simd32x4::from(anti_wedge[scalar]) * other.group0())
...
impl AntiProjectOrthogonallyOnto<MultiVector> for DualNum {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([(self[scalar] * right_anti_dual[e1234]) + (self[e1234] * right_anti_dual[scalar]), self[e1234] * right_anti_dual[e1234]]),
            // e1, e2, e3, e4
            Simd32x4::from(self[e1234]) * right_anti_dual.group1(),
            // e41, e42, e43
            Simd32x3::from(self[e1234]) * right_anti_dual.group2(),
...
impl AntiProjectOrthogonallyOnto<Scalar> for DualNum {
    ...
    fn anti_project_orthogonally_onto(self, other: Scalar) -> Self::Output {
        ...
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(right_anti_dual[e1234]) * self.group0());
        return DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(other[scalar]) * anti_wedge.group0());
    }
}
impl std::ops::Div<anti_project_orthogonally_onto> for Flector {
    type Output = anti_project_orthogonally_onto_partial<Flector>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for Flector {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        ...
        let anti_wedge = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(right_anti_dual[e1234]) * self.group0(),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * self.group1(),
        );
...
impl AntiProjectOrthogonallyOnto<Flector> for Flector {
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            (right_anti_dual.group1().wwwx() * self.group1().xyz().with_w(self[e1]))
                + Simd32x3::from(0.0).with_w(
                ...
                - (self.group1().wwwx() * right_anti_dual.group1().xyz().with_w(right_anti_dual[e1])),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(anti_wedge[scalar]) * other.group0(),
...
impl AntiProjectOrthogonallyOnto<Horizon> for Flector {
    ...
    fn anti_project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        let anti_wedge = Scalar::from_groups(/* scalar */ self[e321] * right_anti_dual[e4] * -1.0);
        return Horizon::from_groups(/* e321 */ other[e321] * anti_wedge[scalar]);
    }
}
impl AntiProjectOrthogonallyOnto<Line> for Flector {
    ...
    fn anti_project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let anti_wedge = Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (self[e412] * right_anti_dual[e31]) + (self[e321] * right_anti_dual[e41]),
                (self[e423] * right_anti_dual[e12]) + (self[e321] * right_anti_dual[e42]),
                (self[e431] * right_anti_dual[e23]) + (self[e321] * right_anti_dual[e43]),
                -(self[e431] * right_anti_dual[e42]) - (self[e412] * right_anti_dual[e43]),
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (self.group1().yzxx() * right_anti_dual.group3().zxy().with_w(right_anti_dual[e41])),
            // e41, e42, e43
            (self.group1().zxy() * right_anti_dual.group4().yzx()) - (self.group1().yzx() * right_anti_dual.group4().zxy()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * self.group1().xyz()) - (Simd32x3::from(self[e321]) * right_anti_dual.group4().xyz()),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * self.group1(),
        );
        return MultiVector::from_groups(
...
impl AntiProjectOrthogonallyOnto<Plane> for Flector {
    ...
    fn anti_project_orthogonally_onto(self, other: Plane) -> Self::Output {
        ...
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        let anti_wedge = Scalar::from_groups(/* scalar */ self[e321] * right_anti_dual[e4] * -1.0);
        return Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(anti_wedge[scalar]) * other.group0());
    }
}
impl AntiProjectOrthogonallyOnto<Point> for Flector {
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x4::from([
                self[e321] * right_anti_dual[e423] * -1.0,
                self[e321] * right_anti_dual[e431] * -1.0,
                self[e321] * right_anti_dual[e412] * -1.0,
                (self[e2] * right_anti_dual[e431]) + (self[e3] * right_anti_dual[e412]) + (self[e4] * right_anti_dual[e321]),
            ]) + (right_anti_dual.group0().wwwx() * self.group1().xyz().with_w(self[e1])),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(anti_wedge[scalar]) * other.group0(),
...
impl std::ops::Div<anti_project_orthogonally_onto> for Horizon {
    type Output = anti_project_orthogonally_onto_partial<Horizon>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = Horizon::from_groups(/* e321 */ right_anti_dual[e1234] * self[e321]);
        return Horizon::from_groups(/* e321 */ other[scalar] * anti_wedge[e321]);
    }
}
impl AntiProjectOrthogonallyOnto<Flector> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            Simd32x4::from(0.0),
            // e23, e31, e12, scalar
            Simd32x4::from(self[e321]) * right_anti_dual.group1().xyz().with_w(right_anti_dual[e4]) * Simd32x4::from(-1.0),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(anti_wedge[scalar]) * other.group0(),
...
impl AntiProjectOrthogonallyOnto<Line> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let anti_wedge = Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([self[e321], self[e321], self[e321], 0.0]) * right_anti_dual.group0().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
        );
        return Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([
...
impl AntiProjectOrthogonallyOnto<Motor> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([self[e321], self[e321], self[e321], 0.0]) * right_anti_dual.group0().xyz().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
            // e423, e431, e412, e321
            Simd32x3::from(0.0).with_w(self[e321] * right_anti_dual[e1234]),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(other[scalar]) * anti_wedge.group0(),
...
impl AntiProjectOrthogonallyOnto<MultiVector> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([self[e321] * right_anti_dual[e4], 1.0]) * Simd32x2::from([-1.0, 0.0]),
            // e1, e2, e3, e4
            Simd32x4::from([self[e321], self[e321], self[e321], 0.0]) * right_anti_dual.group2().with_w(0.0) * Simd32x4::from([1.0, 1.0, 1.0, 0.0]),
            // e41, e42, e43
            Simd32x3::from(0.0),
            // e23, e31, e12
            Simd32x3::from(self[e321]) * right_anti_dual.group4().xyz() * Simd32x3::from(-1.0),
            // e423, e431, e412, e321
            Simd32x3::from(0.0).with_w(self[e321] * right_anti_dual[e1234]),
        );
        return MultiVector::from_groups(
...
impl AntiProjectOrthogonallyOnto<Scalar> for Horizon {
    ...
    fn anti_project_orthogonally_onto(self, other: Scalar) -> Self::Output {
        ...
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = Horizon::from_groups(/* e321 */ right_anti_dual[e1234] * self[e321]);
        return Horizon::from_groups(/* e321 */ anti_wedge[e321] * other[scalar]);
    }
}
impl std::ops::Div<anti_project_orthogonally_onto> for Line {
    type Output = anti_project_orthogonally_onto_partial<Line>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
...
impl AntiProjectOrthogonallyOnto<Flector> for Line {
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Point::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e412] * self[e31]) + (right_anti_dual[e321] * self[e41]),
                (right_anti_dual[e423] * self[e12]) + (right_anti_dual[e321] * self[e42]),
                (right_anti_dual[e431] * self[e23]) + (right_anti_dual[e321] * self[e43]),
                -(right_anti_dual[e431] * self[e42]) - (right_anti_dual[e412] * self[e43]),
...
impl AntiProjectOrthogonallyOnto<MultiVector> for Line {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                (self[e41] * right_anti_dual[e321]) + (self[e31] * right_anti_dual[e412]),
                (self[e42] * right_anti_dual[e321]) + (self[e12] * right_anti_dual[e423]),
                (self[e43] * right_anti_dual[e321]) + (self[e23] * right_anti_dual[e431]),
                -(self[e42] * right_anti_dual[e431]) - (self[e43] * right_anti_dual[e412]),
            ]) - (right_anti_dual.group4().yzxx() * self.group1().zxy().with_w(self[e41])),
            // e41, e42, e43
            Simd32x3::from(right_anti_dual[e1234]) * self.group0(),
            // e23, e31, e12
            Simd32x3::from(right_anti_dual[e1234]) * self.group1(),
...
impl std::ops::Div<anti_project_orthogonally_onto> for Motor {
    type Output = anti_project_orthogonally_onto_partial<Motor>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
...
impl AntiProjectOrthogonallyOnto<Motor> for Motor {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            // e41, e42, e43, e1234
            ((Simd32x3::from(right_anti_dual[e1234]) * self.group0().xyz()) + (Simd32x3::from(self[e1234]) * right_anti_dual.group0().xyz()))
                .with_w(right_anti_dual[e1234] * self[e1234]),
            // e23, e31, e12, scalar
            (Simd32x4::from(right_anti_dual[e1234]) * self.group1())
                + (Simd32x4::from(self[e1234]) * right_anti_dual.group1())
                + Simd32x3::from(0.0).with_w(
...
impl AntiProjectOrthogonallyOnto<MultiVector> for Motor {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (self[e1234] * right_anti_dual[scalar]) + (self[scalar] * right_anti_dual[e1234])
                    - (self[e41] * right_anti_dual[e23])
                    - (self[e42] * right_anti_dual[e31])
                    - (self[e43] * right_anti_dual[e12])
                    - (self[e23] * right_anti_dual[e41])
                    - (self[e31] * right_anti_dual[e42])
                    - (self[e12] * right_anti_dual[e43]),
                self[e1234] * right_anti_dual[e1234],
            ]),
            // e1, e2, e3, e4
            Simd32x4::from([
                (self[e1234] * right_anti_dual[e1]) + (self[e31] * right_anti_dual[e412]),
                (self[e1234] * right_anti_dual[e2]) + (self[e12] * right_anti_dual[e423]),
                (self[e1234] * right_anti_dual[e3]) + (self[e23] * right_anti_dual[e431]),
                -(self[e42] * right_anti_dual[e431]) - (self[e43] * right_anti_dual[e412]),
            ]) + (self.group0() * right_anti_dual.group4().www().with_w(right_anti_dual[e4]))
                - (right_anti_dual.group4().yzxx() * self.group1().zxy().with_w(self[e41])),
            // e41, e42, e43
            (Simd32x3::from(self[e1234]) * right_anti_dual.group2()) + (Simd32x3::from(right_anti_dual[e1234]) * self.group0().xyz()),
            // e23, e31, e12
            (Simd32x3::from(self[e1234]) * right_anti_dual.group3()) + (Simd32x3::from(right_anti_dual[e1234]) * self.group1().xyz()),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * right_anti_dual.group4(),
        );
        return MultiVector::from_groups(
...
impl std::ops::Div<anti_project_orthogonally_onto> for MultiVector {
    type Output = anti_project_orthogonally_onto_partial<MultiVector>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for MultiVector {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from(right_anti_dual[e1234]) * self.group0(),
            // e1, e2, e3, e4
            Simd32x4::from(right_anti_dual[e1234]) * self.group1(),
            // e41, e42, e43
            Simd32x3::from(right_anti_dual[e1234]) * self.group2(),
            // e23, e31, e12
            Simd32x3::from(right_anti_dual[e1234]) * self.group3(),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * self.group4(),
        );
        return MultiVector::from_groups(
            // scalar, e1234
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                - (right_anti_dual.group1().yzxx() * self.group3().zxy().with_w(self[e41])),
            // e41, e42, e43
            (right_anti_dual.group1().yzx() * self.group4().zxy()) - (right_anti_dual.group1().zxy() * self.group4().yzx()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * self.group4().xyz()) - (Simd32x3::from(self[e321]) * right_anti_dual.group1().xyz()),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * right_anti_dual.group1(),
        );
        return MultiVector::from_groups(
...
impl AntiProjectOrthogonallyOnto<Horizon> for MultiVector {
    ...
    fn anti_project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            Simd32x2::from([self[e321] * right_anti_dual[e4], 1.0]) * Simd32x2::from([-1.0, 0.0]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(self[e1234] * right_anti_dual[e4]),
            // e41, e42, e43
            Simd32x3::from(0.0),
            // e23, e31, e12
            Simd32x3::from(0.0),
...
impl AntiProjectOrthogonallyOnto<Line> for MultiVector {
    ...
    fn anti_project_orthogonally_onto(self, other: Line) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e41] * self[e321]) + (right_anti_dual[e31] * self[e412]),
                (right_anti_dual[e42] * self[e321]) + (right_anti_dual[e12] * self[e423]),
                (right_anti_dual[e43] * self[e321]) + (right_anti_dual[e23] * self[e431]),
                -(right_anti_dual[e42] * self[e431]) - (right_anti_dual[e43] * self[e412]),
            ]) - (self.group4().yzxx() * right_anti_dual.group1().zxy().with_w(right_anti_dual[e41])),
            // e41, e42, e43
            Simd32x3::from(self[e1234]) * right_anti_dual.group0(),
            // e23, e31, e12
            Simd32x3::from(self[e1234]) * right_anti_dual.group1(),
...
impl AntiProjectOrthogonallyOnto<Motor> for MultiVector {
    ...
    fn anti_project_orthogonally_onto(self, other: Motor) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                (right_anti_dual[e1234] * self[scalar]) + (right_anti_dual[scalar] * self[e1234])
                    - (right_anti_dual[e41] * self[e23])
                    - (right_anti_dual[e42] * self[e31])
                    - (right_anti_dual[e43] * self[e12])
                    - (right_anti_dual[e23] * self[e41])
                    - (right_anti_dual[e31] * self[e42])
                    - (right_anti_dual[e12] * self[e43]),
                right_anti_dual[e1234] * self[e1234],
            ]),
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e1234] * self[e1]) + (right_anti_dual[e31] * self[e412]),
                (right_anti_dual[e1234] * self[e2]) + (right_anti_dual[e12] * self[e423]),
                (right_anti_dual[e1234] * self[e3]) + (right_anti_dual[e23] * self[e431]),
                -(right_anti_dual[e42] * self[e431]) - (right_anti_dual[e43] * self[e412]),
            ]) + (right_anti_dual.group0() * self.group4().www().with_w(self[e4]))
                - (self.group4().yzxx() * right_anti_dual.group1().zxy().with_w(right_anti_dual[e41])),
            // e41, e42, e43
            (Simd32x3::from(right_anti_dual[e1234]) * self.group2()) + (Simd32x3::from(self[e1234]) * right_anti_dual.group0().xyz()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e1234]) * self.group3()) + (Simd32x3::from(self[e1234]) * right_anti_dual.group1().xyz()),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * self.group4(),
        );
        return MultiVector::from_groups(
...
impl AntiProjectOrthogonallyOnto<MultiVector> for MultiVector {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            // e1, e2, e3, e4
            Simd32x4::from([
                (right_anti_dual[e41] * self[e321]) + (right_anti_dual[e31] * self[e412]) + (right_anti_dual[e412] * self[e31]) + (right_anti_dual[e321] * self[e41]),
                (right_anti_dual[e42] * self[e321]) + (right_anti_dual[e12] * self[e423]) + (right_anti_dual[e423] * self[e12]) + (right_anti_dual[e321] * self[e42]),
                (right_anti_dual[e43] * self[e321]) + (right_anti_dual[e23] * self[e431]) + (right_anti_dual[e431] * self[e23]) + (right_anti_dual[e321] * self[e43]),
                -(right_anti_dual[e43] * self[e412]) - (right_anti_dual[e423] * self[e41]) - (right_anti_dual[e431] * self[e42]) - (right_anti_dual[e412] * self[e43]),
            ]) + (Simd32x4::from(right_anti_dual[e1234]) * self.group1())
                + (Simd32x4::from(self[e1234]) * right_anti_dual.group1())
                - (self.group4().yzxx() * right_anti_dual.group3().zxy().with_w(right_anti_dual[e41]))
                - (self.group3().zxy() * right_anti_dual.group4().yzx()).with_w(right_anti_dual[e42] * self[e431]),
            // e41, e42, e43
            (Simd32x3::from(right_anti_dual[e1234]) * self.group2())
                + (Simd32x3::from(self[e1234]) * right_anti_dual.group2())
                + (right_anti_dual.group4().yzx() * self.group4().zxy())
                - (right_anti_dual.group4().zxy() * self.group4().yzx()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e1234]) * self.group3())
                + (Simd32x3::from(right_anti_dual[e321]) * self.group4().xyz())
                + (Simd32x3::from(self[e1234]) * right_anti_dual.group3())
                - (Simd32x3::from(self[e321]) * right_anti_dual.group4().xyz()),
            // e423, e431, e412, e321
            (Simd32x4::from(right_anti_dual[e1234]) * self.group4()) + (Simd32x4::from(self[e1234]) * right_anti_dual.group4()),
        );
        return MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            ...
            Simd32x4::from([
                ...
                (self[e43] * right_anti_dual[e321]) + (self[e23] * right_anti_dual[e431]),
                -(self[e42] * right_anti_dual[e431]) - (self[e43] * right_anti_dual[e412]),
            ]) - (right_anti_dual.group0().yzxx() * self.group3().zxy().with_w(self[e41])),
            // e41, e42, e43
            (self.group4().zxy() * right_anti_dual.group0().yzx()) - (self.group4().yzx() * right_anti_dual.group0().zxy()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * self.group4().xyz()) - (Simd32x3::from(self[e321]) * right_anti_dual.group0().xyz()),
            // e423, e431, e412, e321
            Simd32x4::from(self[e1234]) * right_anti_dual.group0(),
        );
        return MultiVector::from_groups(
...
impl std::ops::Div<anti_project_orthogonally_onto> for Origin {
    type Output = anti_project_orthogonally_onto_partial<Origin>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for Origin {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = Origin::from_groups(/* e4 */ right_anti_dual[e1234] * self[e4]);
        return Origin::from_groups(/* e4 */ other[scalar] * anti_wedge[e4]);
    }
}
impl AntiProjectOrthogonallyOnto<Flector> for Origin {
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Scalar::from_groups(/* scalar */ right_anti_dual[e321] * self[e4]);
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(anti_wedge[scalar]) * other.group0(),
            // e423, e431, e412, e321
...
impl AntiProjectOrthogonallyOnto<MultiVector> for Origin {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([right_anti_dual[e321] * self[e4], 1.0]) * Simd32x2::from([1.0, 0.0]),
            // e1, e2, e3, e4
            Simd32x3::from(0.0).with_w(right_anti_dual[e1234] * self[e4]),
            // e41, e42, e43
            Simd32x3::from(0.0),
            // e23, e31, e12
            Simd32x3::from(0.0),
...
impl AntiProjectOrthogonallyOnto<Point> for Origin {
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from([other[e1], other[e2], other[e3], 0.0]));
        let anti_wedge = Scalar::from_groups(/* scalar */ self[e4] * right_anti_dual[e321]);
        return Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(anti_wedge[scalar]) * other.group0());
    }
}
impl AntiProjectOrthogonallyOnto<Scalar> for Origin {
    ...
    fn anti_project_orthogonally_onto(self, other: Scalar) -> Self::Output {
        ...
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = Origin::from_groups(/* e4 */ right_anti_dual[e1234] * self[e4]);
        return Origin::from_groups(/* e4 */ anti_wedge[e4] * other[scalar]);
    }
}
impl std::ops::Div<anti_project_orthogonally_onto> for Plane {
    type Output = anti_project_orthogonally_onto_partial<Plane>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for Plane {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(right_anti_dual[e1234]) * self.group0());
        return Plane::from_groups(/* e423, e431, e412, e321 */ Simd32x4::from(other[scalar]) * anti_wedge.group0());
    }
}
impl AntiProjectOrthogonallyOnto<Flector> for Plane {
    ...
    fn anti_project_orthogonally_onto(self, other: Flector) -> Self::Output {
        ...
        let anti_wedge = Motor::from_groups(
            ...
            // e23, e31, e12, scalar
            Simd32x4::from([
                right_anti_dual[e321] * self[e423],
                right_anti_dual[e321] * self[e431],
                right_anti_dual[e321] * self[e412],
                -(right_anti_dual[e2] * self[e431]) - (right_anti_dual[e3] * self[e412]) - (right_anti_dual[e4] * self[e321]),
            ]) - (self.group0().wwwx() * right_anti_dual.group1().xyz().with_w(right_anti_dual[e1])),
        );
        return Flector::from_groups(
            // e1, e2, e3, e4
            Simd32x4::from(anti_wedge[scalar]) * other.group0(),
...
impl AntiProjectOrthogonallyOnto<Horizon> for Plane {
    ...
    fn anti_project_orthogonally_onto(self, other: Horizon) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = Origin::from_groups(/* e4 */ other[e321] * -1.0);
        let anti_wedge = Scalar::from_groups(/* scalar */ right_anti_dual[e4] * self[e321] * -1.0);
        return Horizon::from_groups(/* e321 */ other[e321] * anti_wedge[scalar]);
    }
}
...
impl AntiProjectOrthogonallyOnto<MultiVector> for Plane {
    ...
    fn anti_project_orthogonally_onto(self, other: MultiVector) -> Self::Output {
        ...
        let anti_wedge = MultiVector::from_groups(
            // scalar, e1234
            Simd32x2::from([
                -(right_anti_dual[e1] * self[e423]) - (right_anti_dual[e2] * self[e431]) - (right_anti_dual[e3] * self[e412]) - (right_anti_dual[e4] * self[e321]),
                0.0,
            ]),
            // e1, e2, e3, e4
            Simd32x4::from([
                ...
                (right_anti_dual[e43] * self[e321]) + (right_anti_dual[e23] * self[e431]),
                -(right_anti_dual[e42] * self[e431]) - (right_anti_dual[e43] * self[e412]),
            ]) - (self.group0().yzxx() * right_anti_dual.group3().zxy().with_w(right_anti_dual[e41])),
            // e41, e42, e43
            (right_anti_dual.group4().yzx() * self.group0().zxy()) - (right_anti_dual.group4().zxy() * self.group0().yzx()),
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * self.group0().xyz()) - (Simd32x3::from(self[e321]) * right_anti_dual.group4().xyz()),
            // e423, e431, e412, e321
            Simd32x4::from(right_anti_dual[e1234]) * self.group0(),
        );
        return MultiVector::from_groups(
...
impl AntiProjectOrthogonallyOnto<Point> for Plane {
    ...
    fn anti_project_orthogonally_onto(self, other: Point) -> Self::Output {
        ...
        let anti_wedge = Line::from_groups(
            ...
            // e23, e31, e12
            (Simd32x3::from(right_anti_dual[e321]) * self.group0().xyz()) - (Simd32x3::from(self[e321]) * right_anti_dual.group0().xyz()),
        );
        return Plane::from_groups(
            // e423, e431, e412, e321
            Simd32x4::from([
...
impl std::ops::Div<anti_project_orthogonally_onto> for Point {
    type Output = anti_project_orthogonally_onto_partial<Point>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for Point {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(right_anti_dual[e1234]) * self.group0());
        return Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from(other[scalar]) * anti_wedge.group0());
    }
}
...
impl std::ops::Div<anti_project_orthogonally_onto> for Scalar {
    type Output = anti_project_orthogonally_onto_partial<Scalar>;
    fn div(self, _rhs: anti_project_orthogonally_onto) -> Self::Output {
        anti_project_orthogonally_onto_partial(self)
    }
}
impl AntiProjectOrthogonallyOnto<DualNum> for Scalar {
    ...
    fn anti_project_orthogonally_onto(self, other: DualNum) -> Self::Output {
        use crate::elements::*;
        let right_anti_dual = AntiScalar::from_groups(/* e1234 */ other[scalar]);
        let anti_wedge = Scalar::from_groups(/* scalar */ right_anti_dual[e1234] * self[scalar]);
        return DualNum::from_groups(/* scalar, e1234 */ Simd32x2::from(anti_wedge[scalar]) * other.group0());
    }
}
