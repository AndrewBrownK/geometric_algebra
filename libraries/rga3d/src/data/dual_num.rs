...
impl DualNum {
    ...
    pub const fn from_elements(scalar: f32, e1234: f32) -> Self {
        Self {
...
impl std::fmt::Debug for DualNum {
    fn fmt(&self, formatter: &mut std::fmt::Formatter) -> std::fmt::Result {
        formatter.debug_struct("DualNum").field("scalar", &self[0]).field("e1234", &self[1]).finish()
    }
}
...
impl std::ops::Index<crate::elements::e1234> for DualNum {
    type Output = f32;
