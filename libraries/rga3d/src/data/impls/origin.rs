...
impl std::ops::Add<Point> for Origin {
    ...
    fn add(self, other: Point) -> Self::Output {
        use crate::elements::*;
        return Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from([other[e1], other[e2], other[e3], self[e4] + other[e4]]));
    }
}
...
impl std::ops::Sub<Point> for Origin {
    ...
    fn sub(self, other: Point) -> Self::Output {
        use crate::elements::*;
        return Point::from_groups(/* e1, e2, e3, e4 */ Simd32x4::from([other[e1] * -1.0, other[e2] * -1.0, other[e3] * -1.0, self[e4] - other[e4]]));
    }
}
