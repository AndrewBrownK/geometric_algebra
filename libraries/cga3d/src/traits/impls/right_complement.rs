...
impl RightComplement for AntiLine {
    ...
    fn right_complement(self) -> Self::Output {
        ...
        return Circle::from_groups(
            ...
            Simd32x3::from([self[e15], self[e25], self[e35]]) * Simd32x3::from(-1.0),
            // e415, e425, e435, e321
            Simd32x4::from([self[e23] * -1.0, self[e31] * -1.0, self[e12] * -1.0, 0.0]),
            // e235, e315, e125
            Simd32x3::from(0.0),
        );
    }
...
impl RightComplement for FlatPoint {
    ...
    fn right_complement(self) -> Self::Output {
        ...
        return Circle::from_groups(
            ...
            Simd32x3::from([self[e15], self[e25], self[e35]]) * Simd32x3::from(-1.0),
            // e415, e425, e435, e321
            Simd32x4::from([0.0, 0.0, 0.0, self[e45] * -1.0]),
            // e235, e315, e125
            Simd32x3::from(0.0),
        );
    }
...
impl RightComplement for Line {
    ...
    fn right_complement(self) -> Self::Output {
        ...
        return Dipole::from_groups(
            ...
            Simd32x3::from([self[e235], self[e315], self[e125]]) * Simd32x3::from(-1.0),
            // e23, e31, e12, e45
            Simd32x4::from([self[e415] * -1.0, self[e425] * -1.0, self[e435] * -1.0, 0.0]),
            // e15, e25, e35
            Simd32x3::from(0.0),
        );
    }
...
impl std::ops::DivAssign<right_complement> for RoundPoint {
    fn div_assign(&mut self, _rhs: right_complement) {
        *self = self.right_complement()
    }
}
...
impl std::ops::DivAssign<right_complement> for Sphere {
    fn div_assign(&mut self, _rhs: right_complement) {
        *self = self.right_complement()
    }
}
