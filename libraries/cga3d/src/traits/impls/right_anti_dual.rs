...
impl RightAntiDual for AntiDualNum321 {
    type Output = AntiDualNum321;
    fn right_anti_dual(self) -> Self::Output {
        return self;
    }
}
impl RightAntiDual for AntiDualNum4 {
    type Output = AntiDualNum4;
    fn right_anti_dual(self) -> Self::Output {
        return self;
    }
}
impl RightAntiDual for AntiDualNum5 {
...
impl RightAntiDual for AntiTripleNum {
...
impl RightAntiDual for DualNum321 {
    type Output = AntiDualNum321;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd2        0        1        0
...
impl RightAntiDual for DualNum4 {
    type Output = AntiDualNum4;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd2        0        1        0
...
impl RightAntiDual for DualNum5 {
    type Output = AntiDualNum5;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd2        0        1        0
...
impl RightAntiDual for TripleNum {
    type Output = AntiTripleNum;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd3        0        1        0
