    ...
    fn square(self) -> Self::Output {
        ...
        return VersorSphere::from_groups(
            ...
            (Simd32x2::from([0.0, (f32::powi(self[e415], 2) + f32::powi(self[e425], 2) + f32::powi(self[e435], 2) - f32::powi(self[e321], 2))])
                + Simd32x2::from(2.0) * (Simd32x2::from(self[e423]) * Simd32x2::from([self[e415], self[e235]]))
                + Simd32x2::from(2.0) * (Simd32x2::from(self[e431]) * Simd32x2::from([self[e425], self[e315]]))
                + Simd32x2::from(2.0) * (Simd32x2::from(self[e412]) * Simd32x2::from([self[e435], self[e125]]))),
        );
    }
}
    ...
    fn square(self) -> Self::Output {
        ...
        return VersorSphere::from_groups(
            ...
            (Simd32x2::from([0.0, (-f32::powi(self[e23], 2) - f32::powi(self[e31], 2) - f32::powi(self[e12], 2) + f32::powi(self[e45], 2))])
                - Simd32x2::from(2.0) * (Simd32x2::from(self[e41]) * Simd32x2::from([self[e23], self[e15]]))
                - Simd32x2::from(2.0) * (Simd32x2::from(self[e42]) * Simd32x2::from([self[e31], self[e25]]))
                - Simd32x2::from(2.0) * (Simd32x2::from(self[e43]) * Simd32x2::from([self[e12], self[e35]]))),
        );
    }
}
...
impl Square for VersorRoundPoint {
    type Output = VersorSphere;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        4        4        0
    ...
    fn square(self) -> Self::Output {
        ...
        return VersorSphere::from_groups(
            // e4235, e4315, e4125, e3215
            (Simd32x4::from(self[e12345]) * Simd32x4::from([self[e1], self[e2], self[e3], self[e5]]) * Simd32x4::from([2.0, 2.0, 2.0, -2.0])),
            // e1234, scalar
            Simd32x2::from([
                (self[e4] * self[e12345] * -2.0),
...
impl Square for VersorSphere {
    ...
    fn square(self) -> Self::Output {
        ...
        return VersorSphere::from_groups(
            // e4235, e4315, e4125, e3215
            (Simd32x4::from(self[scalar]) * Simd32x4::from([self[e4235], self[e4315], self[e4125], self[e3215]]) * Simd32x4::from(2.0)),
            // e1234, scalar
            Simd32x2::from([
                (self[e1234] * self[scalar] * 2.0),
