...
impl std::ops::Add<TripleNum> for TripleNum {
    ...
    fn add(self, other: TripleNum) -> Self::Output {
        let addition = TripleNum::from_groups(/* e4, e5, e12345 */ (self.group0() + other.group0()));
        return addition;
    }
}
...
impl std::ops::Not for TripleNum {
    ...
    fn not(self) -> Self::Output {
        let right_dual = AntiTripleNum::from_groups(/* e1234, e3215, scalar */ (self.group0() * Simd32x3::from(-1.0)));
        return right_dual;
    }
}
...
impl std::ops::Sub<TripleNum> for TripleNum {
    ...
    fn sub(self, other: TripleNum) -> Self::Output {
        let subtraction = TripleNum::from_groups(/* e4, e5, e12345 */ (self.group0() - other.group0()));
        return subtraction;
    }
}
