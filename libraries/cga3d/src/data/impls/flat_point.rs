...
impl std::ops::Add<AntiMotor> for FlatPoint {
    ...
    fn add(self, other: AntiMotor) -> Self::Output {
        ...
        return VersorOdd::from_groups(
            ...
            // e15, e25, e35, e1234
            (other.group1().truncate_to_3() + self.group0().truncate_to_3()).extend_to_4(0.0),
            // e4235, e4315, e4125, e3215
            Simd32x3::from(0.0).extend_to_4(other[e3215]),
        );
    }
...
impl std::ops::Sub<AntiMotor> for FlatPoint {
    ...
    fn sub(self, other: AntiMotor) -> Self::Output {
        ...
        return VersorOdd::from_groups(
            ...
            // e15, e25, e35, e1234
            (self.group0().truncate_to_3() - other.group1().truncate_to_3()).extend_to_4(0.0),
            // e4235, e4315, e4125, e3215
            Simd32x3::from(0.0).extend_to_4(other[e3215] * -1.0),
        );
    }
...
impl TryFrom<MultiVector> for FlatPoint {
    ...
    fn try_from(multi_vector: MultiVector) -> Result<Self, Self::Error> {
        ...
        return Ok(FlatPoint::from_groups(/* e15, e25, e35, e45 */ multi_vector.group3()));
    }
}
