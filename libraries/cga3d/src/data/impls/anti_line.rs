...
impl std::ops::Add<MultiVector> for AntiLine {
    ...
    fn add(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            other[e5],
            // e15, e25, e35, e45
            Simd32x4::from([other[e15], other[e25], other[e35], 0.0]) + self.group1().extend_to_4(other[e45]),
            // e41, e42, e43
            other.group4(),
            // e23, e31, e12
...
impl std::ops::Sub<MultiVector> for AntiLine {
    ...
    fn sub(self, other: MultiVector) -> Self::Output {
        ...
        return MultiVector::from_groups(
            ...
            other[e5] * -1.0,
            // e15, e25, e35, e45
            (self.group1() - other.group3().truncate_to_3()).extend_to_4(other[e45]) * Simd32x4::from([1.0, 1.0, 1.0, -1.0]),
            // e41, e42, e43
