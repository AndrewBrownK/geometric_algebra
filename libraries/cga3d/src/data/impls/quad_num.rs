...
impl std::ops::Add<AntiDualNum321> for QuadNum {
    type Output = MultiVector;
...
impl std::ops::Add<AntiDualNum4> for QuadNum {
    type Output = MultiVector;
...
impl std::ops::Add<AntiDualNum5> for QuadNum {
    type Output = MultiVector;
...
impl std::ops::Add<AntiTripleNum> for QuadNum {
    type Output = MultiVector;
...
impl std::ops::Add<DualNum321> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::AddAssign<DualNum321> for QuadNum {
...
impl std::ops::Add<DualNum4> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::AddAssign<DualNum4> for QuadNum {
...
impl std::ops::Add<DualNum5> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::AddAssign<DualNum5> for QuadNum {
...
impl std::ops::Add<TripleNum> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        3        0        0
...
impl std::ops::AddAssign<TripleNum> for QuadNum {
...
impl std::ops::BitXor<AntiDualNum321> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        5        0
...
impl std::ops::BitXorAssign<AntiDualNum321> for QuadNum {
    fn bitxor_assign(&mut self, other: AntiDualNum321) {
        *self = self.wedge(other);
    }
}
impl std::ops::BitXor<AntiDualNum4> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        5        0
...
impl std::ops::BitXorAssign<AntiDualNum4> for QuadNum {
    fn bitxor_assign(&mut self, other: AntiDualNum4) {
        *self = self.wedge(other);
    }
}
impl std::ops::BitXor<AntiDualNum5> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        5        0
...
impl std::ops::BitXorAssign<AntiDualNum5> for QuadNum {
...
impl std::ops::BitXor<AntiTripleNum> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        6        0
...
impl std::ops::BitXorAssign<AntiTripleNum> for QuadNum {
...
impl std::ops::BitXor<DualNum321> for QuadNum {
...
impl std::ops::BitXor<DualNum4> for QuadNum {
...
impl std::ops::BitXor<DualNum5> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::BitXor<TripleNum> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        1        5        0
...
impl From<DualNum321> for QuadNum {
    fn from(dual_num321: DualNum321) -> Self {
        use crate::elements::*;
        return QuadNum::from_groups(/* e4, e5, e321, e12345 */ Simd32x4::from([0.0, 0.0, dual_num321[e321], dual_num321[e12345]]));
    }
}

impl From<DualNum4> for QuadNum {
    fn from(dual_num4: DualNum4) -> Self {
        use crate::elements::*;
        return QuadNum::from_groups(/* e4, e5, e321, e12345 */ Simd32x4::from([dual_num4[e4], 0.0, 0.0, dual_num4[e12345]]));
    }
}

impl From<DualNum5> for QuadNum {
    fn from(dual_num5: DualNum5) -> Self {
        use crate::elements::*;
        return QuadNum::from_groups(/* e4, e5, e321, e12345 */ Simd32x4::from([0.0, dual_num5[e5], 0.0, dual_num5[e12345]]));
    }
}

impl From<TripleNum> for QuadNum {
    fn from(triple_num: TripleNum) -> Self {
        use crate::elements::*;
        return QuadNum::from_groups(/* e4, e5, e321, e12345 */ Simd32x4::from([triple_num[e4], triple_num[e5], 0.0, triple_num[e12345]]));
    }
}
...
impl std::ops::Mul<AntiDualNum321> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        1        3        0
...
impl std::ops::MulAssign<AntiDualNum321> for QuadNum {
    fn mul_assign(&mut self, other: AntiDualNum321) {
        *self = self.geometric_product(other);
    }
}
impl std::ops::Mul<AntiDualNum4> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        8        0
...
impl std::ops::MulAssign<AntiDualNum4> for QuadNum {
    fn mul_assign(&mut self, other: AntiDualNum4) {
        *self = self.geometric_product(other);
    }
}
impl std::ops::Mul<AntiDualNum5> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        8        0
...
impl std::ops::MulAssign<AntiDualNum5> for QuadNum {
...
impl std::ops::Mul<AntiTripleNum> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //          add/sub      mul      div
    //   simd4        2        4        0
...
impl std::ops::MulAssign<AntiTripleNum> for QuadNum {
...
impl std::ops::Mul<DualNum321> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        8        0
...
impl std::ops::Mul<DualNum4> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        9        0
...
impl std::ops::Mul<DualNum5> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        4        9        0
...
impl std::ops::Mul<TripleNum> for QuadNum {
    type Output = AntiQuadNum;
    // Operative Statistics for this implementation:
    //           add/sub      mul      div
    //      f32        4        8        0
...
impl std::ops::Sub<AntiDualNum321> for QuadNum {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<AntiDualNum4> for QuadNum {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<AntiDualNum5> for QuadNum {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        2        0
...
impl std::ops::Sub<AntiTripleNum> for QuadNum {
    type Output = MultiVector;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        0        3        0
...
impl std::ops::Sub<DualNum321> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::SubAssign<DualNum321> for QuadNum {
...
impl std::ops::Sub<DualNum4> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::SubAssign<DualNum4> for QuadNum {
...
impl std::ops::Sub<DualNum5> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        2        0        0
...
impl std::ops::SubAssign<DualNum5> for QuadNum {
...
impl std::ops::Sub<TripleNum> for QuadNum {
    type Output = QuadNum;
    // Operative Statistics for this implementation:
    //      add/sub      mul      div
    // f32        3        0        0
...
impl std::ops::SubAssign<TripleNum> for QuadNum {
