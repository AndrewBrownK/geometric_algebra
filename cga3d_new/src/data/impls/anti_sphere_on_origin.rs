...
impl From<Origin> for AntiSphereOnOrigin {
    fn from(origin: Origin) -> Self {
        use crate::elements::*;
        return AntiSphereOnOrigin::from_groups(/* e1, e2, e3 */ Simd32x3::from(0.0), /* e4 */ origin[e4]);
    }
}
...
impl TryFrom<RoundPointAtOrigin> for AntiSphereOnOrigin {
    ...
    fn try_from(round_point_at_origin: RoundPointAtOrigin) -> Result<Self, Self::Error> {
        ...
        return Ok(AntiSphereOnOrigin::from_groups(/* e1, e2, e3 */ Simd32x3::from(0.0), /* e4 */ round_point_at_origin[e4]));
    }
}
