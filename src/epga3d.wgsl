...
fn multi_vector_ideal_point_scalar_product(self_: MultiVector, other: IdealPoint) -> Scalar  {
    return Scalar(0.0 - self_.g3.y * other.g0.x - self_.g3.z * other.g0.y - self_.g3.w * other.g0.z);
}
...
fn multi_vector_plane_scalar_product(self_: MultiVector, other: Plane) -> Scalar  {
    return Scalar(self_.g1.x * other.g0.x + self_.g2.y * other.g0.y + self_.g2.z * other.g0.z + self_.g2.w * other.g0.w);
}
...
fn multi_vector_translator_geometric_product(self_: MultiVector, other: Translator) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g3.x) * other.g0.yyzw * vec4<f32>(0.0, -1.0, -1.0, -1.0) + vec4<f32>(self_.g3.y) * other.g0.yywz * vec4<f32>(-1.0, 0.0, 1.0, -1.0) + vec4<f32>(self_.g3.z) * other.g0.zwzy * vec4<f32>(-1.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g3.w) * other.g0.wzyw * vec4<f32>(-1.0, 1.0, -1.0, 0.0) + self_.g0 * vec4<f32>(other.g0.x), vec4<f32>(self_.g2.x) * other.g0.yyzw * vec4<f32>(0.0, 1.0, 1.0, 1.0) + vec4<f32>(self_.g2.y) * other.g0.yywz * vec4<f32>(-1.0, 0.0, -1.0, 1.0) + vec4<f32>(self_.g2.z) * other.g0.zwzy * vec4<f32>(-1.0, 1.0, 0.0, -1.0) + vec4<f32>(self_.g2.w) * other.g0.wzyw * vec4<f32>(-1.0, -1.0, 1.0, 0.0) + self_.g1 * vec4<f32>(other.g0.x), vec4<f32>(self_.g1.y) * other.g0.yywz * vec4<f32>(-1.0, 0.0, -1.0, 1.0) + vec4<f32>(self_.g1.z) * other.g0.zwzy * vec4<f32>(-1.0, 1.0, 0.0, -1.0) + vec4<f32>(self_.g1.w) * other.g0.wzyw * vec4<f32>(-1.0, -1.0, 1.0, 0.0) + vec4<f32>(self_.g2.y) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g2.z) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 1.0, 0.0) + vec4<f32>(self_.g2.w) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 0.0, 1.0) + vec4<f32>(self_.g2.x, self_.g1.x, self_.g1.x, self_.g1.x) * other.g0, vec4<f32>(self_.g0.y) * other.g0.yywz * vec4<f32>(1.0, 0.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.zwzy * vec4<f32>(1.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.wzyw * vec4<f32>(1.0, 1.0, -1.0, 0.0) + vec4<f32>(self_.g3.y) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g3.z) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 1.0, 0.0) + vec4<f32>(self_.g3.w) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 0.0, 1.0) + vec4<f32>(self_.g3.x, self_.g0.x, self_.g0.x, self_.g0.x) * other.g0);
}
...
fn multi_vector_point_and_plane_scalar_product(self_: MultiVector, other: PointAndPlane) -> Scalar  {
    return Scalar(self_.g1.x * other.g1.x - self_.g1.y * other.g0.y - self_.g1.z * other.g0.z - self_.g1.w * other.g0.w - self_.g2.x * other.g0.x + self_.g2.y * other.g1.y + self_.g2.z * other.g1.z + self_.g2.w * other.g1.w);
}
...
fn ideal_point_multi_vector_scalar_product(self_: IdealPoint, other: MultiVector) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g3.y - self_.g0.y * other.g3.z - self_.g0.z * other.g3.w);
}
...
fn ideal_point_motor_scalar_product(self_: IdealPoint, other: Motor) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g1.y - self_.g0.y * other.g1.z - self_.g0.z * other.g1.w);
}
...
fn plane_multi_vector_scalar_product(self_: Plane, other: MultiVector) -> Scalar  {
    return Scalar(self_.g0.x * other.g1.x + self_.g0.y * other.g2.y + self_.g0.z * other.g2.z + self_.g0.w * other.g2.w);
}
...
fn plane_point_inner_product(self_: Plane, other: Point) -> Line  {
    return Line(vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.w, other.g0.w, other.g0.y) * vec3<f32>(-1.0, 0.0, 1.0) + vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.z, other.g0.y, other.g0.z) * vec3<f32>(1.0, -1.0, 0.0) + vec3<f32>(self_.g0.x, self_.g0.y, self_.g0.y) * vec3<f32>(other.g0.x, other.g0.w, other.g0.z) * vec3<f32>(0.0, 1.0, -1.0), vec3<f32>(0.0) - vec3<f32>(self_.g0.x) * vec3<f32>(other.g0.y, other.g0.z, other.g0.w) + vec3<f32>(self_.g0.y, self_.g0.z, self_.g0.w) * vec3<f32>(other.g0.x));
}
...
fn line_multi_vector_scalar_product(self_: Line, other: MultiVector) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g3.y - self_.g0.y * other.g3.z - self_.g0.z * other.g3.w - self_.g1.x * other.g0.y - self_.g1.y * other.g0.z - self_.g1.z * other.g0.w);
}
...
fn line_line_inner_product(self_: Line, other: Line) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g0.x - self_.g0.y * other.g0.y - self_.g0.z * other.g0.z - self_.g1.x * other.g1.x - self_.g1.y * other.g1.y - self_.g1.z * other.g1.z);
}
...
fn line_motor_scalar_product(self_: Line, other: Motor) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g1.y - self_.g0.y * other.g1.z - self_.g0.z * other.g1.w - self_.g1.x * other.g0.y - self_.g1.y * other.g0.z - self_.g1.z * other.g0.w);
}
...
fn translator_ideal_point_inner_product(self_: Translator, other: IdealPoint) -> Translator  {
    return Translator(vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.y) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.z) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + self_.g0.yxxx * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
...
fn motor_point_right_contraction(self_: Motor, other: Point) -> Plane  {
    return Plane(vec4<f32>(0.0) - vec4<f32>(self_.g1.x) * other.g0);
}
...
fn motor_ideal_point_left_contraction(self_: Motor, other: IdealPoint) -> Translator  {
    return Translator(vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.y) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.z) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.y, self_.g0.x, self_.g0.x, self_.g0.x) * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}

fn motor_ideal_point_right_contraction(self_: Motor, other: IdealPoint) -> Rotor  {
    return Rotor(vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.y) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.z) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + self_.g1.yxxx * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(-1.0));
}

fn motor_ideal_point_scalar_product(self_: Motor, other: IdealPoint) -> Scalar  {
    return Scalar(0.0 - self_.g1.y * other.g0.x - self_.g1.z * other.g0.y - self_.g1.w * other.g0.z);
}
...
fn point_and_plane_ideal_point_left_contraction(self_: PointAndPlane, other: IdealPoint) -> Plane  {
    return Plane(vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.y) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.z) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + self_.g1.yxxx * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
...
fn point_and_plane_translator_left_contraction(self_: PointAndPlane, other: Translator) -> Plane  {
    return Plane(vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.z) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.w) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + self_.g1.yxxx * other.g0.yyzw * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
