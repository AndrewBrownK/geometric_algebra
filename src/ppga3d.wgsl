...
fn multi_vector_multi_vector_scalar_product(self_: MultiVector, other: MultiVector) -> Scalar  {
    return Scalar(self_.g0.x * other.g0.x - self_.g0.y * other.g0.y - self_.g0.z * other.g0.z - self_.g0.w * other.g0.w - self_.g2.x * other.g2.x + self_.g2.y * other.g2.y + self_.g2.z * other.g2.z + self_.g2.w * other.g2.w);
}
...
fn multi_vector_translator_right_contraction(self_: MultiVector, other: Translator) -> MultiVector  {
    return MultiVector(self_.g0 * vec4<f32>(other.g0.x), self_.g1 * vec4<f32>(other.g0.x), self_.g2 * vec4<f32>(other.g0.x), self_.g3 * vec4<f32>(other.g0.x));
}
...
fn multi_vector_point_and_plane_scalar_product(self_: MultiVector, other: PointAndPlane) -> Scalar  {
    return Scalar(0.0 - self_.g2.x * other.g0.x + self_.g2.y * other.g1.y + self_.g2.z * other.g1.z + self_.g2.w * other.g1.w);
}
...
fn point_multi_vector_scalar_product(self_: Point, other: MultiVector) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g2.x);
}
...
fn point_point_geometric_product(self_: Point, other: Point) -> Translator  {
    return Translator(vec4<f32>(0.0) - vec4<f32>(self_.g0.x) * other.g0 + self_.g0 * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 1.0, 1.0));
}
...
fn point_line_inner_product(self_: Point, other: Line) -> Plane  {
    return Plane(vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.y) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + self_.g0.yxxx * vec4<f32>(other.g1.x, other.g1.x, other.g1.y, other.g1.z) * vec4<f32>(1.0, -1.0, -1.0, -1.0));
}
...
fn point_translator_geometric_product(self_: Point, other: Translator) -> Point  {
    return Point(vec4<f32>(self_.g0.x) * other.g0 + self_.g0 * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 1.0, 1.0));
}
...
fn point_motor_geometric_product(self_: Point, other: Motor) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x, other.g1.y, other.g1.z, other.g1.w) + vec4<f32>(self_.g0.z) * other.g0.wwxy * vec4<f32>(0.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.zzyx * vec4<f32>(0.0, 1.0, -1.0, 1.0) + self_.g0.xyyy * other.g0.xxwz * vec4<f32>(0.0, 1.0, 1.0, -1.0), vec4<f32>(self_.g0.x) * vec4<f32>(other.g1.x, other.g0.y, other.g0.z, other.g0.w) * vec4<f32>(1.0, -1.0, -1.0, -1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + self_.g0.yxxx * other.g0.yxxx * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn plane_multi_vector_scalar_product(self_: Plane, other: MultiVector) -> Scalar  {
    return Scalar(self_.g0.y * other.g2.y + self_.g0.z * other.g2.z + self_.g0.w * other.g2.w);
}
...
fn plane_line_inner_product(self_: Plane, other: Line) -> Plane  {
    return Plane(vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.y, other.g1.z, other.g0.y, other.g1.x) * vec4<f32>(-1.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.z, other.g1.y, other.g1.x, other.g0.z) * vec4<f32>(-1.0, 1.0, -1.0, 0.0) + self_.g0.yxyy * vec4<f32>(other.g0.x, other.g0.x, other.g1.z, other.g1.y) * vec4<f32>(-1.0, 0.0, 1.0, -1.0));
}
...
fn plane_translator_inner_product(self_: Plane, other: Translator) -> Plane  {
    return Plane(vec4<f32>(self_.g0.y) * other.g0.yxyy * vec4<f32>(-1.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g0.z) * other.g0.zzxz * vec4<f32>(-1.0, 0.0, 1.0, 0.0) + vec4<f32>(self_.g0.w) * other.g0.wwwx * vec4<f32>(-1.0, 0.0, 0.0, 1.0) + vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn plane_point_and_plane_right_contraction(self_: Plane, other: PointAndPlane) -> Scalar  {
    return Scalar(self_.g0.y * other.g1.y + self_.g0.z * other.g1.z + self_.g0.w * other.g1.w);
}
...
fn line_point_inner_product(self_: Line, other: Point) -> Plane  {
    return Plane(vec4<f32>(self_.g1.y) * other.g0.zzxz * vec4<f32>(1.0, 0.0, -1.0, 0.0) + vec4<f32>(self_.g1.z) * other.g0.wwwx * vec4<f32>(1.0, 0.0, 0.0, -1.0) + vec4<f32>(self_.g1.x) * other.g0.yxxx * vec4<f32>(1.0, -1.0, 0.0, 0.0));
}
...
fn line_translator_inner_product(self_: Line, other: Translator) -> Line  {
    return Line(self_.g0 * vec3<f32>(other.g0.x), self_.g1 * vec3<f32>(other.g0.x));
}

fn line_translator_right_contraction(self_: Line, other: Translator) -> Line  {
    return Line(self_.g0 * vec3<f32>(other.g0.x), self_.g1 * vec3<f32>(other.g0.x));
}
...
fn line_motor_left_contraction(self_: Line, other: Motor) -> Translator  {
    return Translator(vec4<f32>(self_.g1.y) * vec4<f32>(other.g0.z, other.g0.z, other.g1.x, other.g0.z) * vec4<f32>(-1.0, 0.0, -1.0, 0.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.w, other.g0.w, other.g0.w, other.g1.x) * vec4<f32>(-1.0, 0.0, 0.0, -1.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.y, other.g1.x, other.g0.x, other.g0.x) * vec4<f32>(-1.0, -1.0, 0.0, 0.0));
}
...
fn line_point_and_plane_geometric_product(self_: Line, other: PointAndPlane) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.y) * vec4<f32>(other.g1.w, other.g1.w, other.g0.x, other.g1.y) * vec4<f32>(0.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.z, other.g1.z, other.g1.y, other.g0.x) * vec4<f32>(0.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g1.y, other.g1.x, other.g0.w, other.g0.z) * vec4<f32>(1.0, -1.0, 1.0, -1.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g1.z, other.g0.w, other.g1.x, other.g0.y) * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g1.w, other.g0.z, other.g0.y, other.g1.x) * vec4<f32>(1.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x, other.g0.x, other.g1.w, other.g1.z) * vec4<f32>(0.0, -1.0, 1.0, -1.0), vec4<f32>(self_.g0.y) * vec4<f32>(other.g1.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.y, other.g0.x, other.g1.w, other.g1.z) * vec4<f32>(1.0, -1.0, 1.0, -1.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g0.z, other.g1.w, other.g0.x, other.g1.y) * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.w, other.g1.z, other.g1.y, other.g0.x) * vec4<f32>(1.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g0.x) * other.g1.yxxx * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn line_point_and_plane_right_contraction(self_: Line, other: PointAndPlane) -> Plane  {
    return Plane(vec4<f32>(self_.g0.y) * vec4<f32>(other.g1.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.y) * other.g1.wwwy * vec4<f32>(0.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g1.z) * other.g1.zzyz * vec4<f32>(0.0, 1.0, -1.0, 0.0) + vec4<f32>(self_.g0.x, self_.g0.x, self_.g1.x, self_.g1.x) * other.g1.yxwz * vec4<f32>(1.0, 0.0, 1.0, -1.0));
}
...
fn translator_multi_vector_left_contraction(self_: Translator, other: MultiVector) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1, vec4<f32>(self_.g0.x) * other.g2, vec4<f32>(self_.g0.x) * other.g3);
}
...
fn translator_plane_inner_product(self_: Translator, other: Plane) -> Plane  {
    return Plane(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + self_.g0.yxxx * other.g0.yxxx * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn translator_line_inner_product(self_: Translator, other: Line) -> Line  {
    return Line(vec3<f32>(self_.g0.x) * other.g0, vec3<f32>(self_.g0.x) * other.g1);
}

fn translator_line_left_contraction(self_: Translator, other: Line) -> Line  {
    return Line(vec3<f32>(self_.g0.x) * other.g0, vec3<f32>(self_.g0.x) * other.g1);
}
...
fn translator_motor_geometric_product(self_: Translator, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1 + vec4<f32>(self_.g0.y) * other.g0.yxwz * vec4<f32>(1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.zwxy * vec4<f32>(1.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.wzyx * vec4<f32>(1.0, 1.0, -1.0, 1.0));
}
...
fn translator_motor_inner_product(self_: Translator, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1 + self_.g0 * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 1.0, 1.0));
}

fn translator_motor_left_contraction(self_: Translator, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1);
}
...
fn translator_point_and_plane_geometric_product(self_: Translator, other: PointAndPlane) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.w, other.g1.w, other.g0.x, other.g1.y) * vec4<f32>(0.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.z, other.g1.z, other.g1.y, other.g0.x) * vec4<f32>(0.0, 1.0, -1.0, -1.0) + self_.g0.xyyy * vec4<f32>(other.g0.x, other.g0.x, other.g1.w, other.g1.z) * vec4<f32>(0.0, -1.0, 1.0, -1.0), vec4<f32>(self_.g0.x) * other.g1 + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + self_.g0.yxxx * other.g1.yxxx * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn translator_point_and_plane_inner_product(self_: Translator, other: PointAndPlane) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1 + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + self_.g0.yxxx * other.g1.yxxx * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}

fn translator_point_and_plane_left_contraction(self_: Translator, other: PointAndPlane) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1);
}
...
fn motor_point_geometric_product(self_: Motor, other: Point) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.z) * other.g0.wwwy * vec4<f32>(0.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.zzyz * vec4<f32>(0.0, 1.0, -1.0, 0.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, -1.0, 0.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 0.0, -1.0) + vec4<f32>(self_.g0.x, self_.g1.y, self_.g0.y, self_.g0.y) * other.g0.xxwz * vec4<f32>(0.0, -1.0, 1.0, -1.0), vec4<f32>(self_.g0.z) * other.g0.zzxz * vec4<f32>(1.0, 0.0, -1.0, 0.0) + vec4<f32>(self_.g0.w) * other.g0.wwwx * vec4<f32>(1.0, 0.0, 0.0, -1.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.x) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + self_.g0.yyxx * other.g0.yxxx * vec4<f32>(1.0, -1.0, 0.0, 0.0));
}
...
fn motor_point_inner_product(self_: Motor, other: Point) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.z) * other.g0.zzxz * vec4<f32>(1.0, 0.0, -1.0, 0.0) + vec4<f32>(self_.g0.w) * other.g0.wwwx * vec4<f32>(1.0, 0.0, 0.0, -1.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.x) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + self_.g0.yyxx * other.g0.yxxx * vec4<f32>(1.0, -1.0, 0.0, 0.0));
}
...
fn motor_line_right_contraction(self_: Motor, other: Line) -> Translator  {
    return Translator(vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.y) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.z) * vec4<f32>(-1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.y, self_.g1.x, self_.g1.x, self_.g1.x) * vec4<f32>(other.g1.x, other.g1.x, other.g1.y, other.g1.z) * vec4<f32>(-1.0));
}
...
fn motor_translator_inner_product(self_: Motor, other: Translator) -> Motor  {
    return Motor(self_.g0 * vec4<f32>(other.g0.x), vec4<f32>(self_.g1.y) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 1.0, 0.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 0.0, 0.0, 1.0) + vec4<f32>(self_.g1.x, self_.g0.x, self_.g0.x, self_.g0.x) * other.g0);
}
...
fn motor_translator_right_contraction(self_: Motor, other: Translator) -> Motor  {
    return Motor(self_.g0 * vec4<f32>(other.g0.x), self_.g1 * vec4<f32>(other.g0.x));
}
...
fn motor_point_and_plane_geometric_product(self_: Motor, other: PointAndPlane) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.y) * vec4<f32>(other.g1.y, other.g1.x, other.g0.w, other.g0.z) * vec4<f32>(1.0, -1.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.z, other.g0.w, other.g1.x, other.g0.y) * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.w, other.g0.z, other.g0.y, other.g1.x) * vec4<f32>(1.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g0.x, other.g0.x, other.g1.w, other.g1.z) * vec4<f32>(0.0, -1.0, 1.0, -1.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g1.w, other.g1.w, other.g0.x, other.g1.y) * vec4<f32>(0.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g1.z, other.g1.z, other.g1.y, other.g0.x) * vec4<f32>(0.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g1.x) * other.g1 * vec4<f32>(0.0, -1.0, -1.0, -1.0), vec4<f32>(self_.g0.x) * other.g1 + vec4<f32>(self_.g0.y) * vec4<f32>(other.g0.y, other.g0.x, other.g1.w, other.g1.z) * vec4<f32>(1.0, -1.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z, other.g1.w, other.g0.x, other.g1.y) * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.w, other.g1.z, other.g1.y, other.g0.x) * vec4<f32>(1.0, 1.0, -1.0, -1.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g1.y) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g1.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g1.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.x) * vec4<f32>(-1.0, 0.0, 0.0, 0.0));
}
...
fn point_and_plane_multi_vector_scalar_product(self_: PointAndPlane, other: MultiVector) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g2.x + self_.g1.y * other.g2.y + self_.g1.z * other.g2.z + self_.g1.w * other.g2.w);
}
...
fn point_and_plane_plane_left_contraction(self_: PointAndPlane, other: Plane) -> Scalar  {
    return Scalar(self_.g1.y * other.g0.y + self_.g1.z * other.g0.z + self_.g1.w * other.g0.w);
}
...
fn point_and_plane_line_geometric_product(self_: PointAndPlane, other: Line) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.y) * vec4<f32>(other.g1.z, other.g1.z, other.g1.z, other.g1.y) * vec4<f32>(0.0, 0.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.z, other.g1.z, other.g1.z, other.g1.x) * vec4<f32>(0.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.y, other.g1.y, other.g1.x, other.g1.y) * vec4<f32>(0.0, 1.0, -1.0, 0.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g1.x, other.g1.x, other.g1.y, other.g1.z) * vec4<f32>(0.0, -1.0, -1.0, -1.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g1.x, other.g1.x, other.g0.z, other.g0.y) * vec4<f32>(1.0, 0.0, -1.0, 1.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g1.y, other.g0.z, other.g1.y, other.g0.x) * vec4<f32>(1.0, 1.0, 0.0, -1.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g1.z, other.g0.y, other.g0.x, other.g1.z) * vec4<f32>(1.0, -1.0, 1.0, 0.0) + vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(0.0, 1.0, 1.0, 1.0), vec4<f32>(self_.g0.z) * vec4<f32>(other.g1.y) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g1.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g0.x, other.g0.x, other.g1.z, other.g1.y) * vec4<f32>(-1.0, 0.0, 1.0, -1.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.y, other.g1.z, other.g0.y, other.g1.x) * vec4<f32>(-1.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.z, other.g1.y, other.g1.x, other.g0.z) * vec4<f32>(-1.0, 1.0, -1.0, 0.0) + self_.g0.yxxx * vec4<f32>(other.g1.x, other.g1.x, other.g1.y, other.g1.z) * vec4<f32>(1.0, -1.0, -1.0, -1.0));
}
...
fn point_and_plane_line_left_contraction(self_: PointAndPlane, other: Line) -> Plane  {
    return Plane(vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.y, other.g1.z, other.g0.y, other.g1.x) * vec4<f32>(-1.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.z, other.g1.y, other.g1.x, other.g0.z) * vec4<f32>(-1.0, 1.0, -1.0, 0.0) + self_.g1.yxyy * vec4<f32>(other.g0.x, other.g0.x, other.g1.z, other.g1.y) * vec4<f32>(-1.0, 0.0, 1.0, -1.0));
}
...
fn point_and_plane_translator_geometric_product(self_: PointAndPlane, other: Translator) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g1.y) * other.g0.wwwz * vec4<f32>(0.0, 0.0, -1.0, 1.0) + vec4<f32>(self_.g1.z) * other.g0.wwwy * vec4<f32>(0.0, 1.0, 0.0, -1.0) + vec4<f32>(self_.g1.w) * other.g0.zzyz * vec4<f32>(0.0, -1.0, 1.0, 0.0) + self_.g0 * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 1.0, 1.0), vec4<f32>(self_.g1.y) * other.g0.yxyy * vec4<f32>(-1.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g1.z) * other.g0.zzxz * vec4<f32>(-1.0, 0.0, 1.0, 0.0) + vec4<f32>(self_.g1.w) * other.g0.wwwx * vec4<f32>(-1.0, 0.0, 0.0, 1.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn point_and_plane_translator_inner_product(self_: PointAndPlane, other: Translator) -> PointAndPlane  {
    return PointAndPlane(self_.g0 * vec4<f32>(other.g0.x), vec4<f32>(self_.g1.y) * other.g0.yxyy * vec4<f32>(-1.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g1.z) * other.g0.zzxz * vec4<f32>(-1.0, 0.0, 1.0, 0.0) + vec4<f32>(self_.g1.w) * other.g0.wwwx * vec4<f32>(-1.0, 0.0, 0.0, 1.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}

fn point_and_plane_translator_right_contraction(self_: PointAndPlane, other: Translator) -> PointAndPlane  {
    return PointAndPlane(self_.g0 * vec4<f32>(other.g0.x), self_.g1 * vec4<f32>(other.g0.x));
}
...
fn point_and_plane_motor_geometric_product(self_: PointAndPlane, other: Motor) -> PointAndPlane  {
    return PointAndPlane(vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x, other.g1.y, other.g1.z, other.g1.w) + vec4<f32>(self_.g0.z) * other.g0.wwxy * vec4<f32>(0.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.zzyx * vec4<f32>(0.0, 1.0, -1.0, 1.0) + vec4<f32>(self_.g1.x) * other.g0.yyzw * vec4<f32>(0.0, -1.0, -1.0, -1.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g0.y, other.g1.x, other.g1.w, other.g1.z) * vec4<f32>(1.0, 1.0, -1.0, 1.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g0.z, other.g1.w, other.g1.x, other.g1.y) * vec4<f32>(1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g0.w, other.g1.z, other.g1.y, other.g1.x) * vec4<f32>(1.0, -1.0, 1.0, 1.0) + self_.g0.xyyy * other.g0.xxwz * vec4<f32>(0.0, 1.0, 1.0, -1.0), vec4<f32>(self_.g0.x) * vec4<f32>(other.g1.x, other.g0.y, other.g0.z, other.g0.w) * vec4<f32>(1.0, -1.0, -1.0, -1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.w) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.x) * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 0.0, 0.0) + vec4<f32>(self_.g1.y) * vec4<f32>(other.g1.y, other.g0.x, other.g0.w, other.g0.z) * vec4<f32>(-1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g1.z) * vec4<f32>(other.g1.z, other.g0.w, other.g0.x, other.g0.y) * vec4<f32>(-1.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g1.w) * vec4<f32>(other.g1.w, other.g0.z, other.g0.y, other.g0.x) * vec4<f32>(-1.0, 1.0, -1.0, 1.0) + self_.g0.yxxx * other.g0.yxxx * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn point_and_plane_point_and_plane_scalar_product(self_: PointAndPlane, other: PointAndPlane) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g0.x + self_.g1.y * other.g1.y + self_.g1.z * other.g1.z + self_.g1.w * other.g1.w);
}
