...
fn multi_vector_translator_right_contraction(self_: MultiVector, other: Translator) -> MultiVector  {
    return MultiVector(self_.g0 * vec4<f32>(other.g0.x), self_.g1 * vec4<f32>(other.g0.x));
}
...
fn multi_vector_motor_right_contraction(self_: MultiVector, other: Motor) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.y) * other.g0.yxyy * vec4<f32>(-1.0, 1.0, 0.0, 0.0) + self_.g0.xxzw * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 1.0, 1.0), vec4<f32>(self_.g1.y) * other.g0.yxyy * vec4<f32>(-1.0, 1.0, 0.0, 0.0) + self_.g1.xxzw * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 1.0, 1.0));
}
...
fn multi_vector_motor_dual_scalar_product(self_: MultiVector, other: MotorDual) -> Scalar  {
    return Scalar(self_.g0.z * other.g0.w + self_.g0.w * other.g0.z);
}
...
fn point_multi_vector_geometric_product(self_: Point, other: MultiVector) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.x) * other.g0.yxwz * vec4<f32>(-1.0, 1.0, 1.0, -1.0), vec4<f32>(self_.g0.x) * other.g1.yxwz * vec4<f32>(-1.0, 1.0, -1.0, 1.0) + vec4<f32>(self_.g0.y) * other.g0.zwxy * vec4<f32>(1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.wzyx * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
...
fn point_point_geometric_product(self_: Point, other: Point) -> Translator  {
    return Translator(vec3<f32>(self_.g0.x) * other.g0.xzy * vec3<f32>(-1.0, -1.0, 1.0) + self_.g0.xzy * vec3<f32>(other.g0.x) * vec3<f32>(0.0, 1.0, -1.0));
}
...
fn point_point_inner_product(self_: Point, other: Point) -> Scalar  {
    return Scalar(0.0 - self_.g0.x * other.g0.x);
}
...
fn point_ideal_point_geometric_product(self_: Point, other: IdealPoint) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * other.g0.yx * vec2<f32>(-1.0, 1.0));
}
...
fn point_translator_geometric_product(self_: Point, other: Translator) -> Point  {
    return Point(vec3<f32>(self_.g0.x) * other.g0.xzy * vec3<f32>(1.0, -1.0, 1.0) + self_.g0 * vec3<f32>(other.g0.x) * vec3<f32>(0.0, 1.0, 1.0));
}
...
fn point_translator_inner_product(self_: Point, other: Translator) -> Point  {
    return Point(self_.g0 * vec3<f32>(other.g0.x));
}

fn point_translator_right_contraction(self_: Point, other: Translator) -> Point  {
    return Point(self_.g0 * vec3<f32>(other.g0.x));
}
...
fn point_motor_geometric_product(self_: Point, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0.yxwz * vec4<f32>(-1.0, 1.0, -1.0, 1.0) + vec4<f32>(self_.g0.z) * other.g0.yyyx * vec4<f32>(0.0, 0.0, 1.0, 1.0) + vec4<f32>(self_.g0.x, self_.g0.x, self_.g0.y, self_.g0.y) * other.g0.xxxy * vec4<f32>(0.0, 0.0, 1.0, -1.0));
}
...
fn point_motor_inner_product(self_: Point, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x, self_.g0.x, self_.g0.y, self_.g0.z) * other.g0.yxxx * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
...
fn point_motor_dual_geometric_product(self_: Point, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0.yxwz * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.z) * other.g0.wzww * vec4<f32>(1.0, -1.0, 0.0, 0.0) + vec4<f32>(self_.g0.y, self_.g0.y, self_.g0.x, self_.g0.x) * other.g0.zwxx * vec4<f32>(1.0, 1.0, 0.0, 0.0));
}
...
fn point_motor_dual_inner_product(self_: Point, other: MotorDual) -> Plane  {
    return Plane(vec3<f32>(self_.g0.x) * vec3<f32>(other.g0.x, other.g0.w, other.g0.z) * vec3<f32>(-1.0, -1.0, 1.0) + vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.z) * vec3<f32>(-1.0, 0.0, 0.0) + self_.g0.yxx * vec3<f32>(other.g0.w, other.g0.x, other.g0.x) * vec3<f32>(1.0, 0.0, 0.0));
}

fn point_motor_dual_right_contraction(self_: Point, other: MotorDual) -> Plane  {
    return Plane(vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.z) * vec3<f32>(-1.0, 0.0, 0.0) + self_.g0.yxx * vec3<f32>(other.g0.w, other.g0.w, other.g0.z) * vec3<f32>(1.0, -1.0, 1.0));
}
...
fn ideal_point_point_geometric_product(self_: IdealPoint, other: Point) -> IdealPoint  {
    return IdealPoint(self_.g0.yx * vec2<f32>(other.g0.x) * vec2<f32>(1.0, -1.0));
}
...
fn ideal_point_translator_geometric_product(self_: IdealPoint, other: Translator) -> IdealPoint  {
    return IdealPoint(self_.g0 * vec2<f32>(other.g0.x));
}
...
fn ideal_point_translator_inner_product(self_: IdealPoint, other: Translator) -> IdealPoint  {
    return IdealPoint(self_.g0 * vec2<f32>(other.g0.x));
}

fn ideal_point_translator_right_contraction(self_: IdealPoint, other: Translator) -> IdealPoint  {
    return IdealPoint(self_.g0 * vec2<f32>(other.g0.x));
}
...
fn ideal_point_motor_geometric_product(self_: IdealPoint, other: Motor) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * vec2<f32>(other.g0.x, other.g0.y) * vec2<f32>(1.0, -1.0) + vec2<f32>(self_.g0.y) * vec2<f32>(other.g0.y, other.g0.x));
}
...
fn ideal_point_motor_inner_product(self_: IdealPoint, other: Motor) -> IdealPoint  {
    return IdealPoint(self_.g0 * vec2<f32>(other.g0.x));
}

fn ideal_point_motor_right_contraction(self_: IdealPoint, other: Motor) -> IdealPoint  {
    return IdealPoint(self_.g0 * vec2<f32>(other.g0.x));
}
...
fn plane_multi_vector_geometric_product(self_: Plane, other: MultiVector) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.y) * other.g0.wzyx * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.z) * other.g0.zwxy, vec4<f32>(self_.g0.x) * other.g0 * vec4<f32>(1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.y) * other.g1.wzyx + vec4<f32>(self_.g0.z) * other.g1.zwxy * vec4<f32>(-1.0, 1.0, -1.0, 1.0));
}

fn plane_multi_vector_scalar_product(self_: Plane, other: MultiVector) -> Scalar  {
    return Scalar(self_.g0.y * other.g0.w + self_.g0.z * other.g0.z);
}
...
fn plane_point_geometric_product(self_: Plane, other: Point) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.y) * vec4<f32>(other.g0.y, other.g0.z, other.g0.y, other.g0.x) * vec4<f32>(1.0, 1.0, 0.0, -1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z, other.g0.y, other.g0.x, other.g0.z) * vec4<f32>(1.0, -1.0, 1.0, 0.0) + vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 0.0, 0.0));
}
...
fn plane_translator_geometric_product(self_: Plane, other: Translator) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.y) * vec4<f32>(other.g0.y, other.g0.z, other.g0.x, other.g0.y) * vec4<f32>(1.0, 1.0, 1.0, 0.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z, other.g0.y, other.g0.z, other.g0.x) * vec4<f32>(1.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 0.0, 0.0));
}
...
fn plane_translator_inner_product(self_: Plane, other: Translator) -> Plane  {
    return Plane(vec3<f32>(self_.g0.y) * other.g0.zxz * vec3<f32>(1.0, 1.0, 0.0) + vec3<f32>(self_.g0.z) * other.g0.yyx * vec3<f32>(-1.0, 0.0, 1.0) + vec3<f32>(self_.g0.x) * vec3<f32>(other.g0.x) * vec3<f32>(1.0, 0.0, 0.0));
}
...
fn plane_motor_geometric_product(self_: Plane, other: Motor) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.y) * other.g0.zwxy * vec4<f32>(1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.wzyx * vec4<f32>(1.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.x) * other.g0.yxxx * vec4<f32>(1.0, 1.0, 0.0, 0.0));
}
...
fn plane_motor_inner_product(self_: Plane, other: Motor) -> Plane  {
    return Plane(vec3<f32>(self_.g0.y) * vec3<f32>(other.g0.w, other.g0.x, other.g0.y) * vec3<f32>(1.0, 1.0, -1.0) + vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.z, other.g0.y, other.g0.x) * vec3<f32>(-1.0, 1.0, 1.0) + vec3<f32>(self_.g0.x) * vec3<f32>(other.g0.x) * vec3<f32>(1.0, 0.0, 0.0));
}
...
fn plane_motor_dual_geometric_product(self_: Plane, other: MotorDual) -> Motor  {
    return Motor(vec4<f32>(self_.g0.y) * other.g0.zwxy * vec4<f32>(1.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.z) * other.g0.wzyx * vec4<f32>(1.0, 1.0, -1.0, 1.0) + vec4<f32>(self_.g0.x) * other.g0.xxwz * vec4<f32>(0.0, 0.0, 1.0, -1.0));
}
...
fn plane_motor_dual_inner_product(self_: Plane, other: MotorDual) -> Translator  {
    return Translator(vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.w, other.g0.w, other.g0.x) * vec3<f32>(1.0, 0.0, 1.0) + self_.g0.yyx * vec3<f32>(other.g0.z, other.g0.x, other.g0.x) * vec3<f32>(1.0, 1.0, 0.0));
}

fn plane_motor_dual_left_contraction(self_: Plane, other: MotorDual) -> Translator  {
    return Translator(vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.w, other.g0.w, other.g0.x) * vec3<f32>(1.0, 0.0, 1.0) + self_.g0.yyx * vec3<f32>(other.g0.z, other.g0.x, other.g0.x) * vec3<f32>(1.0, 1.0, 0.0));
}

fn plane_motor_dual_right_contraction(self_: Plane, other: MotorDual) -> Scalar  {
    return Scalar(self_.g0.y * other.g0.z + self_.g0.z * other.g0.w);
}
...
fn translator_multi_vector_geometric_product(self_: Translator, other: MultiVector) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1 + vec4<f32>(self_.g0.y) * other.g0.zwxy * vec4<f32>(1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.wzyx * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
...
fn translator_multi_vector_inner_product(self_: Translator, other: MultiVector) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1 + vec4<f32>(self_.g0.z) * other.g0.wwwx * vec4<f32>(-1.0, 0.0, 0.0, 1.0) + vec4<f32>(self_.g0.y, self_.g0.x, self_.g0.y, self_.g0.x) * other.g0.zxxx * vec4<f32>(1.0, 0.0, 1.0, 0.0));
}

fn translator_multi_vector_left_contraction(self_: Translator, other: MultiVector) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.x) * other.g0, vec4<f32>(self_.g0.x) * other.g1);
}
...
fn translator_point_geometric_product(self_: Translator, other: Point) -> Point  {
    return Point(vec3<f32>(self_.g0.x) * other.g0 + self_.g0.xzy * vec3<f32>(other.g0.x) * vec3<f32>(0.0, 1.0, -1.0));
}
...
fn translator_point_inner_product(self_: Translator, other: Point) -> Point  {
    return Point(vec3<f32>(self_.g0.x) * other.g0);
}

fn translator_point_left_contraction(self_: Translator, other: Point) -> Point  {
    return Point(vec3<f32>(self_.g0.x) * other.g0);
}
...
fn translator_ideal_point_geometric_product(self_: Translator, other: IdealPoint) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * other.g0);
}
...
fn translator_ideal_point_inner_product(self_: Translator, other: IdealPoint) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * other.g0);
}

fn translator_ideal_point_left_contraction(self_: Translator, other: IdealPoint) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * other.g0);
}
...
fn translator_plane_inner_product(self_: Translator, other: Plane) -> Plane  {
    return Plane(vec3<f32>(self_.g0.x) * other.g0 + vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.y) * vec3<f32>(-1.0, 0.0, 0.0) + self_.g0.yxx * other.g0.zxx * vec3<f32>(1.0, 0.0, 0.0));
}
...
fn translator_translator_geometric_product(self_: Translator, other: Translator) -> Translator  {
...
fn translator_motor_geometric_product(self_: Translator, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.z) * other.g0.yyyx * vec4<f32>(0.0, 0.0, 1.0, 1.0) + vec4<f32>(self_.g0.x, self_.g0.x, self_.g0.y, self_.g0.y) * other.g0.xxxy * vec4<f32>(0.0, 0.0, 1.0, -1.0));
}
...
fn translator_motor_left_contraction(self_: Translator, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0);
}
...
fn translator_motor_dual_geometric_product(self_: Translator, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.z) * other.g0.wzww * vec4<f32>(1.0, -1.0, 0.0, 0.0) + vec4<f32>(self_.g0.y, self_.g0.y, self_.g0.x, self_.g0.x) * other.g0.zwxx * vec4<f32>(1.0, 1.0, 0.0, 0.0));
}
...
fn translator_motor_dual_inner_product(self_: Translator, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z) * vec4<f32>(0.0, -1.0, 0.0, 0.0) + vec4<f32>(self_.g0.x, self_.g0.y, self_.g0.x, self_.g0.x) * other.g0.xwxx * vec4<f32>(0.0, 1.0, 0.0, 0.0));
}

fn translator_motor_dual_left_contraction(self_: Translator, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0);
}
...
fn motor_multi_vector_left_contraction(self_: Motor, other: MultiVector) -> MultiVector  {
    return MultiVector(vec4<f32>(self_.g0.x) * other.g0 + self_.g0.yxxx * other.g0.yxxx * vec4<f32>(-1.0, 0.0, 0.0, 0.0), vec4<f32>(self_.g0.x) * other.g1 + self_.g0.yxxx * other.g1.yxxx * vec4<f32>(-1.0, 0.0, 0.0, 0.0));
}
...
fn motor_point_inner_product(self_: Motor, other: Point) -> Motor  {
    return Motor(self_.g0.yxxx * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}
...
fn motor_ideal_point_geometric_product(self_: Motor, other: IdealPoint) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * other.g0 + vec2<f32>(self_.g0.y) * other.g0.yx * vec2<f32>(-1.0, 1.0));
}
...
fn motor_ideal_point_inner_product(self_: Motor, other: IdealPoint) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * other.g0);
}

fn motor_ideal_point_left_contraction(self_: Motor, other: IdealPoint) -> IdealPoint  {
    return IdealPoint(vec2<f32>(self_.g0.x) * other.g0);
}
...
fn motor_plane_inner_product(self_: Motor, other: Plane) -> Plane  {
    return Plane(vec3<f32>(self_.g0.x) * other.g0 + vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.y) * vec3<f32>(-1.0, 0.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.y, self_.g0.y) * other.g0.zzy * vec3<f32>(1.0, -1.0, 1.0));
}
...
fn motor_translator_right_contraction(self_: Motor, other: Translator) -> Motor  {
    return Motor(self_.g0 * vec4<f32>(other.g0.x));
}
...
fn motor_motor_geometric_product(self_: Motor, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.y) * other.g0.yxwz * vec4<f32>(-1.0, 1.0, -1.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.yyyx * vec4<f32>(0.0, 0.0, 1.0, 1.0) + self_.g0.xxzz * other.g0.xxxy * vec4<f32>(0.0, 0.0, 1.0, -1.0));
}
...
fn motor_motor_inner_product(self_: Motor, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0 + self_.g0.yyzw * other.g0.yxxx * vec4<f32>(-1.0, 1.0, 1.0, 1.0));
}

fn motor_motor_left_contraction(self_: Motor, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.x) * other.g0 + self_.g0.yxxx * other.g0.yxxx * vec4<f32>(-1.0, 0.0, 0.0, 0.0));
}

fn motor_motor_right_contraction(self_: Motor, other: Motor) -> Motor  {
    return Motor(vec4<f32>(self_.g0.y) * other.g0.yxyy * vec4<f32>(-1.0, 1.0, 0.0, 0.0) + self_.g0.xxzw * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 0.0, 1.0, 1.0));
}
...
fn motor_motor_dual_geometric_product(self_: Motor, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.y) * other.g0.yxwz * vec4<f32>(1.0, -1.0, -1.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.wzww * vec4<f32>(1.0, -1.0, 0.0, 0.0) + self_.g0.zzxx * other.g0.zwxx * vec4<f32>(1.0, 1.0, 0.0, 0.0));
}
...
fn motor_motor_dual_inner_product(self_: Motor, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0 + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.w) * vec4<f32>(0.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.z) * vec4<f32>(0.0, -1.0, 0.0, 0.0) + self_.g0.xyyy * other.g0.xxwz * vec4<f32>(0.0, -1.0, -1.0, 1.0));
}

fn motor_motor_dual_left_contraction(self_: Motor, other: MotorDual) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.x) * other.g0 + self_.g0.xyxx * vec4<f32>(other.g0.x) * vec4<f32>(0.0, -1.0, 0.0, 0.0));
}

fn motor_motor_dual_right_contraction(self_: Motor, other: MotorDual) -> Plane  {
    return Plane(vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.z) * vec3<f32>(-1.0, 0.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.y, self_.g0.y) * vec3<f32>(other.g0.w, other.g0.w, other.g0.z) * vec3<f32>(1.0, -1.0, 1.0));
}
...
fn motor_dual_point_geometric_product(self_: MotorDual, other: Point) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.y, other.g0.z, other.g0.y, other.g0.x) * vec4<f32>(1.0, 1.0, 0.0, -1.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.z, other.g0.y, other.g0.x, other.g0.z) * vec4<f32>(1.0, -1.0, 1.0, 0.0) + self_.g0.yxxx * vec4<f32>(other.g0.x) * vec4<f32>(1.0, -1.0, 0.0, 0.0));
}
...
fn motor_dual_point_inner_product(self_: MotorDual, other: Point) -> Plane  {
    return Plane(vec3<f32>(self_.g0.z) * other.g0.zzx * vec3<f32>(1.0, 0.0, -1.0) + vec3<f32>(self_.g0.w) * other.g0.yxy * vec3<f32>(-1.0, 1.0, 0.0) + vec3<f32>(self_.g0.x) * vec3<f32>(other.g0.x) * vec3<f32>(-1.0, 0.0, 0.0));
}

fn motor_dual_point_left_contraction(self_: MotorDual, other: Point) -> Plane  {
    return Plane(vec3<f32>(self_.g0.w) * other.g0.yxy * vec3<f32>(-1.0, 1.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.x, self_.g0.z) * other.g0.zxx * vec3<f32>(1.0, 0.0, -1.0));
}
...
fn motor_dual_plane_geometric_product(self_: MotorDual, other: Plane) -> Motor  {
    return Motor(vec4<f32>(self_.g0.y) * vec4<f32>(other.g0.z, other.g0.z, other.g0.z, other.g0.y) * vec4<f32>(0.0, 0.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.y, other.g0.z, other.g0.y, other.g0.x) * vec4<f32>(1.0, -1.0, 0.0, 1.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.z, other.g0.y, other.g0.x, other.g0.z) * vec4<f32>(1.0, 1.0, -1.0, 0.0) + vec4<f32>(self_.g0.x) * vec4<f32>(other.g0.x, other.g0.x, other.g0.y, other.g0.z) * vec4<f32>(0.0, 0.0, 1.0, 1.0));
}
...
fn motor_dual_plane_inner_product(self_: MotorDual, other: Plane) -> Translator  {
    return Translator(vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.z) * vec3<f32>(1.0, 0.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.x, self_.g0.x) * other.g0.yyz);
}

fn motor_dual_plane_left_contraction(self_: MotorDual, other: Plane) -> Scalar  {
    return Scalar(self_.g0.z * other.g0.y + self_.g0.w * other.g0.z);
}

fn motor_dual_plane_right_contraction(self_: MotorDual, other: Plane) -> Translator  {
    return Translator(vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.z) * vec3<f32>(1.0, 0.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.x, self_.g0.x) * other.g0.yyz);
}
...
fn motor_dual_translator_geometric_product(self_: MotorDual, other: Translator) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.y, other.g0.z, other.g0.x, other.g0.y) * vec4<f32>(1.0, 1.0, 1.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.z, other.g0.y, other.g0.z, other.g0.x) * vec4<f32>(1.0, -1.0, 0.0, 1.0) + self_.g0.xyxx * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 1.0, 0.0, 0.0));
}
...
fn motor_dual_translator_inner_product(self_: MotorDual, other: Translator) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.z) * vec4<f32>(other.g0.z, other.g0.z, other.g0.x, other.g0.z) * vec4<f32>(0.0, 1.0, 1.0, 0.0) + vec4<f32>(self_.g0.w) * vec4<f32>(other.g0.y, other.g0.y, other.g0.y, other.g0.x) * vec4<f32>(0.0, -1.0, 0.0, 1.0) + self_.g0.xyxx * vec4<f32>(other.g0.x) * vec4<f32>(1.0, 1.0, 0.0, 0.0));
}

fn motor_dual_translator_right_contraction(self_: MotorDual, other: Translator) -> MotorDual  {
    return MotorDual(self_.g0 * vec4<f32>(other.g0.x));
}
...
fn motor_dual_motor_geometric_product(self_: MotorDual, other: Motor) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.y) * other.g0.yxyy * vec4<f32>(1.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g0.z) * other.g0.zwxy * vec4<f32>(1.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.w) * other.g0.wzyx * vec4<f32>(1.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.x) * other.g0.xyxx * vec4<f32>(1.0, -1.0, 0.0, 0.0));
}
...
fn motor_dual_motor_inner_product(self_: MotorDual, other: Motor) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.y) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 0.0, 0.0) + vec4<f32>(self_.g0.z) * other.g0.wwxy * vec4<f32>(0.0, 1.0, 1.0, -1.0) + vec4<f32>(self_.g0.w) * other.g0.zzyx * vec4<f32>(0.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.x) * other.g0.xyxx * vec4<f32>(1.0, -1.0, 0.0, 0.0));
}

fn motor_dual_motor_left_contraction(self_: MotorDual, other: Motor) -> Plane  {
    return Plane(vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.z, other.g0.y, other.g0.z) * vec3<f32>(-1.0, 1.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.x, self_.g0.z) * vec3<f32>(other.g0.w, other.g0.x, other.g0.y) * vec3<f32>(1.0, 0.0, -1.0));
}

fn motor_dual_motor_right_contraction(self_: MotorDual, other: Motor) -> MotorDual  {
    return MotorDual(vec4<f32>(self_.g0.y) * vec4<f32>(other.g0.x) * vec4<f32>(0.0, 1.0, 0.0, 0.0) + self_.g0.xxzw * other.g0.xyxx * vec4<f32>(1.0, -1.0, 1.0, 1.0));
}
...
fn motor_dual_motor_dual_geometric_product(self_: MotorDual, other: MotorDual) -> Motor  {
    return Motor(vec4<f32>(self_.g0.y) * other.g0.wwwz * vec4<f32>(0.0, 0.0, 1.0, -1.0) + vec4<f32>(self_.g0.z) * other.g0.zwxy * vec4<f32>(1.0, -1.0, 1.0, 1.0) + vec4<f32>(self_.g0.w) * other.g0.wzyx * vec4<f32>(1.0, 1.0, -1.0, 1.0) + vec4<f32>(self_.g0.x) * other.g0.xxzw * vec4<f32>(0.0, 0.0, 1.0, 1.0));
}
...
fn motor_dual_motor_dual_inner_product(self_: MotorDual, other: MotorDual) -> Translator  {
    return Translator(vec3<f32>(self_.g0.z) * vec3<f32>(other.g0.z, other.g0.x, other.g0.z) * vec3<f32>(1.0, 1.0, 0.0) + vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.w, other.g0.w, other.g0.x) * vec3<f32>(1.0, 0.0, 1.0) + vec3<f32>(self_.g0.x) * vec3<f32>(other.g0.x, other.g0.z, other.g0.w) * vec3<f32>(0.0, 1.0, 1.0));
}

fn motor_dual_motor_dual_left_contraction(self_: MotorDual, other: MotorDual) -> Translator  {
    return Translator(vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.w, other.g0.w, other.g0.x) * vec3<f32>(1.0, 0.0, 1.0) + vec3<f32>(self_.g0.z, self_.g0.z, self_.g0.x) * vec3<f32>(other.g0.z, other.g0.x, other.g0.x) * vec3<f32>(1.0, 1.0, 0.0));
}

fn motor_dual_motor_dual_right_contraction(self_: MotorDual, other: MotorDual) -> Translator  {
    return Translator(vec3<f32>(self_.g0.w) * vec3<f32>(other.g0.w) * vec3<f32>(1.0, 0.0, 0.0) + vec3<f32>(self_.g0.z, self_.g0.x, self_.g0.x) * vec3<f32>(other.g0.z, other.g0.z, other.g0.w));
}

fn motor_dual_motor_dual_scalar_product(self_: MotorDual, other: MotorDual) -> Scalar  {
    return Scalar(self_.g0.z * other.g0.z + self_.g0.w * other.g0.w);
}
...
fn ideal_point_motor_geometric_quotient(self_: IdealPoint, other: Motor) -> IdealPoint  {
    return ideal_point_motor_geometric_product(self_, motor_inverse(other));
}

fn ideal_point_point_geometric_quotient(self_: IdealPoint, other: Point) -> IdealPoint  {
...
fn ideal_point_translator_geometric_quotient(self_: IdealPoint, other: Translator) -> IdealPoint  {
...
fn motor_ideal_point_transformation(self_: Motor, other: IdealPoint) -> IdealPoint  {
    return ideal_point_motor_geometric_product(motor_ideal_point_geometric_product(self_, other), motor_reversal(self_));
}
...
fn point_ideal_point_transformation(self_: Point, other: IdealPoint) -> IdealPoint  {
    return ideal_point_point_geometric_product(point_ideal_point_geometric_product(self_, other), point_reversal(self_));
}
...
fn point_point_geometric_quotient(self_: Point, other: Point) -> Translator  {
...
fn point_point_transformation(self_: Point, other: Point) -> Point  {
    return translator_point_geometric_product(point_point_geometric_product(self_, other), point_reversal(self_));
}
...
fn point_scalar_transformation(self_: Point, other: Scalar) -> Scalar  {
    return translator_scalar_into(point_point_geometric_product(point_scalar_geometric_product(self_, other), point_reversal(self_)));
}

fn point_translator_geometric_quotient(self_: Point, other: Translator) -> Point  {
...
fn point_translator_transformation(self_: Point, other: Translator) -> Translator  {
    return point_point_geometric_product(point_translator_geometric_product(self_, other), point_reversal(self_));
}
...
fn translator_ideal_point_transformation(self_: Translator, other: IdealPoint) -> IdealPoint  {
    return ideal_point_translator_geometric_product(translator_ideal_point_geometric_product(self_, other), translator_reversal(self_));
}
...
fn translator_point_geometric_quotient(self_: Translator, other: Point) -> Point  {
...
fn translator_point_transformation(self_: Translator, other: Point) -> Point  {
    return point_translator_geometric_product(translator_point_geometric_product(self_, other), translator_reversal(self_));
}
...
fn translator_scalar_transformation(self_: Translator, other: Scalar) -> Scalar  {
    return translator_scalar_into(translator_translator_geometric_product(translator_scalar_geometric_product(self_, other), translator_reversal(self_)));
}

fn translator_powi(self_: Translator, exponent: int) -> Translator  {
    if (exponent == 0) {
        return translator_one();
    }
    let x: Translator = select(self_, translator_inverse(self_), exponent < 0);
    let y: Translator = translator_one();
    let n: int = abs(exponent);
    while (1 < n) {
        if ((n & 1) == 1) {
            let y = translator_translator_geometric_product(x, y);
        }
        let x = translator_translator_geometric_product(x, x);
        let n = n >> 1;
    }
    return translator_translator_geometric_product(x, y);
}

fn translator_translator_geometric_quotient(self_: Translator, other: Translator) -> Translator  {
...
fn translator_translator_transformation(self_: Translator, other: Translator) -> Translator  {
    return translator_translator_geometric_product(translator_translator_geometric_product(self_, other), translator_reversal(self_));
}
